...
describe('analyse service', () => {
    describe('Gathering rules', () => {
        it('should return a multiple rules', async () => {
            const result = await (0, analyse_service_1.gatheringRules)("./src/__tests__/rules/test2", true);
            expect(result.length).to.be.above(1);
        });
        it('should return 0 rules', async () => {
            const result = await (0, analyse_service_1.gatheringRules)("./src/__tests__/rules/test3");
