...
export class TopicEventSubscriptionsImpl {
    ...
    listPagingAll(resourceGroupName, topicName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, topicName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    getDeliveryAttributes(resourceGroupName, topicName, eventSubscriptionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, topicName, eventSubscriptionName, options }, getDeliveryAttributesOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, topicName, eventSubscriptionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, topicName, eventSubscriptionName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, topicName, eventSubscriptionName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, topicName, eventSubscriptionName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
    ...
    getFullUrl(resourceGroupName, topicName, eventSubscriptionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, topicName, eventSubscriptionName, options }, getFullUrlOperationSpec);
    }
    /**
     * List all event subscriptions that have been created for a specific topic.
     * @param resourceGroupName The name of the resource group within the user's subscription.
    ...
    _list(resourceGroupName, topicName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, topicName, options }, listOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group within the user's subscription.
    ...
    _listNext(resourceGroupName, topicName, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, topicName, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=topicEventSubscriptions.js.map