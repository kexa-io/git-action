...
export class PartnerNamespacesImpl {
    /**
    ...
    get(resourceGroupName, partnerNamespaceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, partnerNamespaceName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, partnerNamespaceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, partnerNamespaceName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
