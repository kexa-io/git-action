...
export class PartnerRegistrationsImpl {
    /**
    ...
    get(resourceGroupName, partnerRegistrationName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, partnerRegistrationName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, partnerRegistrationName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, partnerRegistrationName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
