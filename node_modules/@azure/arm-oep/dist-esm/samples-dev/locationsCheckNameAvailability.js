...
function locationsCheckNameAvailability() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.locations.checkNameAvailability(body);
        console.log(result);
    });
}
locationsCheckNameAvailability().catch(console.error);
//# sourceMappingURL=locationsCheckNameAvailability.js.map