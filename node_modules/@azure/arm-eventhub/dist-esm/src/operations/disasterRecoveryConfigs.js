...
export class DisasterRecoveryConfigsImpl {
    /**
    ...
    listPagingAll(resourceGroupName, namespaceName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, namespaceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    listAuthorizationRulesPagingPage(resourceGroupName, namespaceName, alias, options, settings) {
        return __asyncGenerator(this, arguments, function* listAuthorizationRulesPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listAuthorizationRules(resourceGroupName, namespaceName, alias, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listAuthorizationRulesNext(resourceGroupName, namespaceName, alias, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listAuthorizationRulesPagingAll(resourceGroupName, namespaceName, alias, options) {
        return __asyncGenerator(this, arguments, function* listAuthorizationRulesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listAuthorizationRulesPagingPage(resourceGroupName, namespaceName, alias, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    createOrUpdate(resourceGroupName, namespaceName, alias, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, namespaceName, alias, parameters, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, namespaceName, alias, options) {
        return this.client.sendOperationRequest({ resourceGroupName, namespaceName, alias, options }, deleteOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, namespaceName, alias, options) {
        return this.client.sendOperationRequest({ resourceGroupName, namespaceName, alias, options }, getOperationSpec);
    }
    /**
