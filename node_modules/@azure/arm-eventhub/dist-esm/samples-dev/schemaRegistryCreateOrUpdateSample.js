...
function schemaRegistryCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.schemaRegistry.createOrUpdate(resourceGroupName, namespaceName, schemaGroupName, parameters);
        console.log(result);
    });
}
schemaRegistryCreate().catch(console.error);
//# sourceMappingURL=schemaRegistryCreateOrUpdateSample.js.map