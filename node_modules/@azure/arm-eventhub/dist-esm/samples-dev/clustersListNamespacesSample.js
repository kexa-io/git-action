 ...
 */
function listNamespacesInCluster() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.clusters.listNamespaces(resourceGroupName, clusterName);
        console.log(result);
    });
}
listNamespacesInCluster().catch(console.error);
//# sourceMappingURL=clustersListNamespacesSample.js.map