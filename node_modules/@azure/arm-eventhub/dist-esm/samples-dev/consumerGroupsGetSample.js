...
function consumerGroupGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.consumerGroups.get(resourceGroupName, namespaceName, eventHubName, consumerGroupName);
        console.log(result);
    });
}
consumerGroupGet().catch(console.error);
//# sourceMappingURL=consumerGroupsGetSample.js.map