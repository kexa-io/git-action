...
function eventHubDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.eventHubs.delete(resourceGroupName, namespaceName, eventHubName);
        console.log(result);
    });
}
eventHubDelete().catch(console.error);
//# sourceMappingURL=eventHubsDeleteSample.js.map