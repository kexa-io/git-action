 ...
 */
function nameSpacePrivateEndPointConnectionCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.createOrUpdate(resourceGroupName, namespaceName, privateEndpointConnectionName, parameters);
        console.log(result);
    });
}
