...
function eventHubCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.eventHubs.createOrUpdate(resourceGroupName, namespaceName, eventHubName, parameters);
        console.log(result);
    });
}
eventHubCreate().catch(console.error);
//# sourceMappingURL=eventHubsCreateOrUpdateSample.js.map