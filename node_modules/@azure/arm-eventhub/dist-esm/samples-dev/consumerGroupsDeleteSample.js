...
function consumerGroupDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.consumerGroups.delete(resourceGroupName, namespaceName, eventHubName, consumerGroupName);
        console.log(result);
    });
}
consumerGroupDelete().catch(console.error);
//# sourceMappingURL=consumerGroupsDeleteSample.js.map