 ...
 */
function eventHubAuthorizationRuleCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.eventHubs.createOrUpdateAuthorizationRule(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, parameters);
        console.log(result);
    });
}
eventHubAuthorizationRuleCreate().catch(console.error);
//# sourceMappingURL=eventHubsCreateOrUpdateAuthorizationRuleSample.js.map