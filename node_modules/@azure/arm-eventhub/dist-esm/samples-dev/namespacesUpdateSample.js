...
function namespacesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namespaces.update(resourceGroupName, namespaceName, parameters);
        console.log(result);
    });
}
namespacesUpdate().catch(console.error);
//# sourceMappingURL=namespacesUpdateSample.js.map