 ...
 */
function eventHubAuthorizationRuleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.eventHubs.getAuthorizationRule(resourceGroupName, namespaceName, eventHubName, authorizationRuleName);
        console.log(result);
    });
}
eventHubAuthorizationRuleGet().catch(console.error);
//# sourceMappingURL=eventHubsGetAuthorizationRuleSample.js.map