...
function schemaRegistryDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.schemaRegistry.delete(resourceGroupName, namespaceName, schemaGroupName);
        console.log(result);
    });
}
schemaRegistryDelete().catch(console.error);
//# sourceMappingURL=schemaRegistryDeleteSample.js.map