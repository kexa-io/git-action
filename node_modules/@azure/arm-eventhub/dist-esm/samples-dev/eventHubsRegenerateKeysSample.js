 ...
 */
function eventHubAuthorizationRuleRegenerateKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.eventHubs.regenerateKeys(resourceGroupName, namespaceName, eventHubName, authorizationRuleName, parameters);
        console.log(result);
    });
}
eventHubAuthorizationRuleRegenerateKey().catch(console.error);
//# sourceMappingURL=eventHubsRegenerateKeysSample.js.map