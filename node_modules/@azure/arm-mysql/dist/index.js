...
const TopQueryStatisticsResultList = {
    type: {
        name: "Composite",
...
const WaitStatisticsResultList = {
    type: {
        name: "Composite",
...
const QueryPerformanceInsightResetDataResult = {
    type: {
        name: "Composite",
...
const RecommendationActionsResultList = {
    type: {
        name: "Composite",
...
const RecommendedActionSessionsOperationStatus = {
    type: {
        name: "Composite",
...
const parameters2 = {
    parameterPath: "parameters",
    mapper: ServerUpgradeParameters
};
const parameters3 = {
    parameterPath: "parameters",
    mapper: FirewallRule
...
class LocationBasedPerformanceTierImpl {
    ...
    _list(locationName, options) {
        return this.client.sendOperationRequest({ locationName, options }, listOperationSpec$3);
    }
}
// Operation Specifications
...
class QueryTextsImpl {
     ...
     * @param options The options parameters.
     */
    listByServer(resourceGroupName, serverName, queryIds, options) {
        const iter = this.listByServerPagingAll(resourceGroupName, serverName, queryIds, options);
        return {
            next() {
                return iter.next();
            },
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, serverName, queryId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, queryId, options }, getOperationSpec$8);
    }
    /**
     * Retrieve the Query-Store query texts for specified queryIds.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
const listByServerOperationSpec$6 = {
    ...
    responses: {
        200: {
            bodyMapper: QueryTextsResultList
        },
        default: {
            bodyMapper: CloudError
        }
    },
    queryParameters: [apiVersion2, queryIds],
    urlParameters: [
        $host,
        subscriptionId,
        resourceGroupName,
...
class TopQueryStatisticsImpl {
     ...
     * @param options The options parameters.
     */
    listByServer(resourceGroupName, serverName, parameters, options) {
        const iter = this.listByServerPagingAll(resourceGroupName, serverName, parameters, options);
        return {
            next() {
                return iter.next();
            },
...
const listByServerOperationSpec$5 = {
    ...
    responses: {
        200: {
            bodyMapper: TopQueryStatisticsResultList
        },
        default: {
            bodyMapper: CloudError
        }
...
class WaitStatisticsImpl {
     ...
     */
    _listByServerNext(resourceGroupName, serverName, parameters, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, parameters, nextLink, options }, listByServerNextOperationSpec$4);
    }
}
// Operation Specifications
...
const listByServerOperationSpec$4 = {
    ...
    responses: {
        200: {
            bodyMapper: WaitStatisticsResultList
        },
        default: {
            bodyMapper: CloudError
        }
...
class RecommendedActionsImpl {
     ...
     * @param options The options parameters.
     */
    listByServer(resourceGroupName, serverName, advisorName, options) {
        const iter = this.listByServerPagingAll(resourceGroupName, serverName, advisorName, options);
        return {
            next() {
                return iter.next();
            },
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, serverName, advisorName, recommendedActionName, options) {
...
const getOperationSpec$4 = {
    ...
    responses: {
        200: {
            bodyMapper: RecommendationAction
        }
    },
    queryParameters: [apiVersion2],
    urlParameters: [
...
const listByServerOperationSpec$2 = {
    ...
    responses: {
        200: {
            bodyMapper: RecommendationActionsResultList
        }
    },
    queryParameters: [apiVersion2, sessionId],
    urlParameters: [
        $host,
        subscriptionId,
        resourceGroupName,
...
const getOperationSpec$3 = {
    ...
    responses: {
        200: {
            bodyMapper: RecommendedActionSessionsOperationStatus
        }
    },
    queryParameters: [apiVersion2],
    urlParameters: [
...
class LocationBasedRecommendedActionSessionsResultImpl {
    /**
     ...
     * @param options The options parameters.
     */
    list(locationName, operationId, options) {
...
const resetQueryPerformanceInsightDataOperationSpec = {
    ...
    responses: {
        200: {
            bodyMapper: QueryPerformanceInsightResetDataResult
        },
        default: {
            bodyMapper: CloudError
        }
...
const createRecommendedActionSessionOperationSpec = {
    ...
    queryParameters: [apiVersion2, databaseName1],
    urlParameters: [
        $host,
        subscriptionId,
        resourceGroupName,
