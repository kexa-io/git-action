 ...
 */
function recommendedActionSessionCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.beginCreateRecommendedActionSessionAndWait(resourceGroupName, serverName, advisorName, databaseName);
        console.log(result);
    });
}
recommendedActionSessionCreate().catch(console.error);
//# sourceMappingURL=createRecommendedActionSessionSample.js.map