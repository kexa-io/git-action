...
function configurationList() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverParameters.beginListUpdateConfigurationsAndWait(resourceGroupName, serverName, value);
        console.log(result);
    });
}
configurationList().catch(console.error);
//# sourceMappingURL=serverParametersListUpdateConfigurationsSample.js.map