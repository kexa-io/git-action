 ...
 */
function topQueryStatisticsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.topQueryStatistics.get(resourceGroupName, serverName, queryStatisticId);
        console.log(result);
    });
}
topQueryStatisticsGet().catch(console.error);
//# sourceMappingURL=topQueryStatisticsGetSample.js.map