...
function firewallRuleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.firewallRules.get(resourceGroupName, serverName, firewallRuleName);
        console.log(result);
    });
}
firewallRuleGet().catch(console.error);
//# sourceMappingURL=firewallRulesGetSample.js.map