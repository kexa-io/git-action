 ...
 */
function queryPerformanceInsightResetData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.resetQueryPerformanceInsightData(resourceGroupName, serverName);
        console.log(result);
    });
}
queryPerformanceInsightResetData().catch(console.error);
//# sourceMappingURL=resetQueryPerformanceInsightDataSample.js.map