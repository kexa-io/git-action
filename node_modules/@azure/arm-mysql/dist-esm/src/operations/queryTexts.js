...
export class QueryTextsImpl {
    ...
    listByServerPagingPage(resourceGroupName, serverName, queryIds, options, settings) {
        return __asyncGenerator(this, arguments, function* listByServerPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByServer(resourceGroupName, serverName, queryIds, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByServerNext(resourceGroupName, serverName, queryIds, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByServerPagingAll(resourceGroupName, serverName, queryIds, options) {
        return __asyncGenerator(this, arguments, function* listByServerPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByServerPagingPage(resourceGroupName, serverName, queryIds, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, serverName, queryId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, queryId, options }, getOperationSpec);
    }
    /**
     * Retrieve the Query-Store query texts for specified queryIds.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
