...
export class LocationBasedRecommendedActionSessionsResultImpl {
    ...
    listPagingPage(locationName, operationId, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(locationName, operationId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(locationName, operationId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(locationName, operationId, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(locationName, operationId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=locationBasedRecommendedActionSessionsResult.js.map