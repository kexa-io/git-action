...
export class FhirDestinationsImpl {
    /**
    ...
    listByIotConnectorPagingPage(resourceGroupName, workspaceName, iotConnectorName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByIotConnectorPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByIotConnector(resourceGroupName, workspaceName, iotConnectorName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByIotConnectorNext(resourceGroupName, workspaceName, iotConnectorName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByIotConnectorPagingAll(resourceGroupName, workspaceName, iotConnectorName, options) {
        return __asyncGenerator(this, arguments, function* listByIotConnectorPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByIotConnectorPagingPage(resourceGroupName, workspaceName, iotConnectorName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
//# sourceMappingURL=fhirDestinations.js.map