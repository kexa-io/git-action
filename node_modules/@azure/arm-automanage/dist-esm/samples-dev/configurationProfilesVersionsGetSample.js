 ...
 */
function getAConfigurationProfileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurationProfilesVersions.get(configurationProfileName, versionName, resourceGroupName);
        console.log(result);
    });
}
getAConfigurationProfileVersion().catch(console.error);
//# sourceMappingURL=configurationProfilesVersionsGetSample.js.map