 ...
 */
function getAHciConfigurationProfileAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurationProfileHCIAssignments.get(resourceGroupName, clusterName, configurationProfileAssignmentName);
        console.log(result);
    });
}
getAHciConfigurationProfileAssignment().catch(console.error);
//# sourceMappingURL=configurationProfileHciAssignmentsGetSample.js.map