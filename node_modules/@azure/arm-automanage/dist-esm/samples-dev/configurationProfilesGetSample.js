 ...
 */
function getAConfigurationProfile() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurationProfiles.get(configurationProfileName, resourceGroupName);
        console.log(result);
    });
}
getAConfigurationProfile().catch(console.error);
//# sourceMappingURL=configurationProfilesGetSample.js.map