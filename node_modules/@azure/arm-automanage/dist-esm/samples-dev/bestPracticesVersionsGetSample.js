 ...
 */
function getAnAutomanageBestPracticeVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bestPracticesVersions.get(bestPracticeName, versionName);
        console.log(result);
    });
}
getAnAutomanageBestPracticeVersion().catch(console.error);
//# sourceMappingURL=bestPracticesVersionsGetSample.js.map