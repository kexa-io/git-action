 ...
 */
function createOrUpdateConfigurationProfileVersion() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurationProfilesVersions.createOrUpdate(configurationProfileName, versionName, resourceGroupName, parameters);
        console.log(result);
    });
}
createOrUpdateConfigurationProfileVersion().catch(console.error);
//# sourceMappingURL=configurationProfilesVersionsCreateOrUpdateSample.js.map