 ...
 */
function getAReportForAHcrpConfigurationProfileAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.hcrpReports.get(resourceGroupName, machineName, configurationProfileAssignmentName, reportName);
        console.log(result);
    });
}
getAReportForAHcrpConfigurationProfileAssignment().catch(console.error);
//# sourceMappingURL=hcrpReportsGetSample.js.map