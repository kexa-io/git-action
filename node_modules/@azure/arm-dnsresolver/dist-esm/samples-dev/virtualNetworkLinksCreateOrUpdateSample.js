 ...
 */
function upsertVirtualNetworkLinkToADnsForwardingRuleset() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["DNSRESOLVER_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.virtualNetworkLinks.beginCreateOrUpdateAndWait(resourceGroupName, dnsForwardingRulesetName, virtualNetworkLinkName, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=virtualNetworkLinksCreateOrUpdateSample.js.map