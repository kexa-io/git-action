...
export class KeysImpl {
    ...
    get(resourceGroupName, workspaceName, keyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, keyName, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, workspaceName, keyName, keyProperties, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, keyName, keyProperties, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, workspaceName, keyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, keyName, options }, deleteOperationSpec);
    }
    /**
     * ListByWorkspaceNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
