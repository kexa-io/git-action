    ...
    listBySqlPoolPagingPage(resourceGroupName, workspaceName, sqlPoolName, options) {
        return __asyncGenerator(this, arguments, function* listBySqlPoolPagingPage_1() {
            ...
            while (continuationToken) {
                result = yield __await(this._listBySqlPoolNext(resourceGroupName, workspaceName, sqlPoolName, continuationToken, options));
...
//# sourceMappingURL=sqlPoolBlobAuditingPolicies.js.map