...
export class WorkspaceManagedSqlServerBlobAuditingPoliciesImpl {
    ...
    get(resourceGroupName, workspaceName, blobAuditingPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, blobAuditingPolicyName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=workspaceManagedSqlServerBlobAuditingPolicies.js.map