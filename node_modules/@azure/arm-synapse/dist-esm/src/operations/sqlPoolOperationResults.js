...
export class SqlPoolOperationResultsImpl {
    /**
    ...
    getLocationHeaderResult(resourceGroupName, workspaceName, sqlPoolName, operationId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, sqlPoolName, operationId, options }, getLocationHeaderResultOperationSpec);
    }
}
...
//# sourceMappingURL=sqlPoolOperationResults.js.map