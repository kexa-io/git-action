...
export class BigDataPoolsImpl {
    ...
    get(resourceGroupName, workspaceName, bigDataPoolName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, bigDataPoolName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, workspaceName, bigDataPoolName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, workspaceName, bigDataPoolName, options }, deleteOperationSpec);
            return new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
