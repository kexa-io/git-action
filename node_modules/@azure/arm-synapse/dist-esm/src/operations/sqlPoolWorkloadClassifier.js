...
export class SqlPoolWorkloadClassifierImpl {
    ...
    listPagingPage(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, options) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            let result = yield __await(this._list(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, options));
            yield yield __await(result.value || []);
            let continuationToken = result.nextLink;
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, continuationToken, options));
    ...
    listPagingAll(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, workspaceName, sqlPoolName, workloadGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
