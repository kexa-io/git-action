 ...
 */
function getUpdateExtendedInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.updateExtendedInformation(deviceName, resourceGroupName, parameters);
        console.log(result);
    });
}
getUpdateExtendedInfo().catch(console.error);
//# sourceMappingURL=devicesUpdateExtendedInformationSample.js.map