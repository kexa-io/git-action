...
function shareRefreshPost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.shares.beginRefreshAndWait(deviceName, name, resourceGroupName);
        console.log(result);
    });
}
shareRefreshPost().catch(console.error);
//# sourceMappingURL=sharesRefreshSample.js.map