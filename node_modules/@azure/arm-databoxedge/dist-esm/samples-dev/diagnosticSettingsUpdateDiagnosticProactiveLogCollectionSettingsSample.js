 ...
 */
function updateDiagnosticProactiveLogCollectionSettings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.diagnosticSettings.beginUpdateDiagnosticProactiveLogCollectionSettingsAndWait(deviceName, resourceGroupName, proactiveLogCollectionSettings);
        console.log(result);
    });
}
updateDiagnosticProactiveLogCollectionSettings().catch(console.error);
//# sourceMappingURL=diagnosticSettingsUpdateDiagnosticProactiveLogCollectionSettingsSample.js.map