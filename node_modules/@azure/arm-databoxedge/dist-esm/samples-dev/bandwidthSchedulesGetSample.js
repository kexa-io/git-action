...
function bandwidthScheduleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bandwidthSchedules.get(deviceName, name, resourceGroupName);
        console.log(result);
    });
}
bandwidthScheduleGet().catch(console.error);
//# sourceMappingURL=bandwidthSchedulesGetSample.js.map