...
function bandwidthSchedulePut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bandwidthSchedules.beginCreateOrUpdateAndWait(deviceName, name, resourceGroupName, parameters);
        console.log(result);
    });
}
bandwidthSchedulePut().catch(console.error);
//# sourceMappingURL=bandwidthSchedulesCreateOrUpdateSample.js.map