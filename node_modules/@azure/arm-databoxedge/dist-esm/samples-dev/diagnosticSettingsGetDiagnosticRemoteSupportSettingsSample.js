 ...
 */
function getDiagnosticRemoteSupportSettings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.diagnosticSettings.getDiagnosticRemoteSupportSettings(deviceName, resourceGroupName);
        console.log(result);
    });
}
getDiagnosticRemoteSupportSettings().catch(console.error);
//# sourceMappingURL=diagnosticSettingsGetDiagnosticRemoteSupportSettingsSample.js.map