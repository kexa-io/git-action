...
function scanForUpdatesPost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.beginScanForUpdatesAndWait(deviceName, resourceGroupName);
        console.log(result);
    });
}
scanForUpdatesPost().catch(console.error);
//# sourceMappingURL=devicesScanForUpdatesSample.js.map