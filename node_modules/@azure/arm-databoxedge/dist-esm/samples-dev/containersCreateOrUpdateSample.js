...
function containerPut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containers.beginCreateOrUpdateAndWait(deviceName, storageAccountName, containerName, resourceGroupName, container);
        console.log(result);
    });
}
containerPut().catch(console.error);
//# sourceMappingURL=containersCreateOrUpdateSample.js.map