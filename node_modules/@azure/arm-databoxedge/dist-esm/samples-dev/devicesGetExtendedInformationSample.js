...
function extendedInfoPost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.getExtendedInformation(deviceName, resourceGroupName);
        console.log(result);
    });
}
extendedInfoPost().catch(console.error);
//# sourceMappingURL=devicesGetExtendedInformationSample.js.map