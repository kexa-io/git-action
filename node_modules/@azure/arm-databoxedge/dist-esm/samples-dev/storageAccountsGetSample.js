...
function storageAccountGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.storageAccounts.get(deviceName, storageAccountName, resourceGroupName);
        console.log(result);
    });
}
storageAccountGet().catch(console.error);
//# sourceMappingURL=storageAccountsGetSample.js.map