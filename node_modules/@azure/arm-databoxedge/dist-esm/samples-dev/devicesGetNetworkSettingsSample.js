...
function networkSettingsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.getNetworkSettings(deviceName, resourceGroupName);
        console.log(result);
    });
}
networkSettingsGet().catch(console.error);
//# sourceMappingURL=devicesGetNetworkSettingsSample.js.map