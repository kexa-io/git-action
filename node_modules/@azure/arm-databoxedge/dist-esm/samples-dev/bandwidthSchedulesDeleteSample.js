 ...
 */
function bandwidthScheduleDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.bandwidthSchedules.beginDeleteAndWait(deviceName, name, resourceGroupName);
        console.log(result);
    });
}
bandwidthScheduleDelete().catch(console.error);
//# sourceMappingURL=bandwidthSchedulesDeleteSample.js.map