 ...
 */
function getDiagnosticProactiveLogCollectionSettings() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.diagnosticSettings.getDiagnosticProactiveLogCollectionSettings(deviceName, resourceGroupName);
        console.log(result);
    });
}
getDiagnosticProactiveLogCollectionSettings().catch(console.error);
//# sourceMappingURL=diagnosticSettingsGetDiagnosticProactiveLogCollectionSettingsSample.js.map