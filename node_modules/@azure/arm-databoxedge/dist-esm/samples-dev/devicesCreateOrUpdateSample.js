...
function dataBoxEdgeDevicePut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.createOrUpdate(deviceName, resourceGroupName, dataBoxEdgeDevice);
        console.log(result);
    });
}
 ...
 */
function dataBoxEdgeDevicePutWithDataResidency() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "4385cf00-2d3a-425a-832f-f4285b1c9dce";
        const deviceName = "testedgedevice";
        const resourceGroupName = "GroupForEdgeAutomation";
