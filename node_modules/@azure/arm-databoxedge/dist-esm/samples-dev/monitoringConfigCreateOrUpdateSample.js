...
function putMonitoringConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.monitoringConfig.beginCreateOrUpdateAndWait(deviceName, roleName, resourceGroupName, monitoringMetricConfiguration);
        console.log(result);
    });
}
putMonitoringConfig().catch(console.error);
//# sourceMappingURL=monitoringConfigCreateOrUpdateSample.js.map