...
function triggerPut() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.triggers.beginCreateOrUpdateAndWait(deviceName, name, resourceGroupName, trigger);
        console.log(result);
    });
}
triggerPut().catch(console.error);
//# sourceMappingURL=triggersCreateOrUpdateSample.js.map