...
function getDcAccessCode() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.orders.listDCAccessCode(deviceName, resourceGroupName);
        console.log(result);
    });
}
getDcAccessCode().catch(console.error);
//# sourceMappingURL=ordersListDcAccessCodeSample.js.map