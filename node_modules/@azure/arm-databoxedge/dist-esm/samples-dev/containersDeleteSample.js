...
function containerDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.containers.beginDeleteAndWait(deviceName, storageAccountName, containerName, resourceGroupName);
        console.log(result);
    });
}
containerDelete().catch(console.error);
//# sourceMappingURL=containersDeleteSample.js.map