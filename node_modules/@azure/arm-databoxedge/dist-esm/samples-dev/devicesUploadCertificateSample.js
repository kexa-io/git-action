 ...
 */
function uploadCertificatePost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.uploadCertificate(deviceName, resourceGroupName, parameters);
        console.log(result);
    });
}
uploadCertificatePost().catch(console.error);
//# sourceMappingURL=devicesUploadCertificateSample.js.map