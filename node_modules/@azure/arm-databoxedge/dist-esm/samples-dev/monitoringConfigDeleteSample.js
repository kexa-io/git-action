 ...
 */
function deleteMonitoringConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.monitoringConfig.beginDeleteAndWait(deviceName, roleName, resourceGroupName);
        console.log(result);
    });
}
deleteMonitoringConfig().catch(console.error);
//# sourceMappingURL=monitoringConfigDeleteSample.js.map