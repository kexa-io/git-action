...
function downloadUpdatesPost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.beginDownloadUpdatesAndWait(deviceName, resourceGroupName);
        console.log(result);
    });
}
downloadUpdatesPost().catch(console.error);
//# sourceMappingURL=devicesDownloadUpdatesSample.js.map