...
function installUpdatesPost() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.devices.beginInstallUpdatesAndWait(deviceName, resourceGroupName);
        console.log(result);
    });
}
installUpdatesPost().catch(console.error);
//# sourceMappingURL=devicesInstallUpdatesSample.js.map