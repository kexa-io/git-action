...
export class SharesImpl {
    ...
    beginCreateOrUpdate(deviceName, name, resourceGroupName, share, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { deviceName, name, resourceGroupName, share, options }, createOrUpdateOperationSpec);
    ...
    beginRefresh(deviceName, name, resourceGroupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { deviceName, name, resourceGroupName, options }, refreshOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
