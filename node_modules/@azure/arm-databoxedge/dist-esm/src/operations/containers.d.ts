...
import { Container, ContainersListByStorageAccountOptionalParams, ContainersGetOptionalParams, ContainersGetResponse, ContainersCreateOrUpdateOptionalParams, ContainersCreateOrUpdateResponse, ContainersDeleteOptionalParams, ContainersRefreshOptionalParams } from "../models";
...
export declare class ContainersImpl implements Containers {
    ...
    private listByStorageAccountPagingPage;
    private listByStorageAccountPagingAll;
    /**
     * Lists all the containers of a storage Account in a Data Box Edge/Data Box Gateway device.
     * @param deviceName The device name.
     * @param storageAccountName The storage Account name.
