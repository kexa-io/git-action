...
export class OrdersImpl {
    ...
    listByDataBoxEdgeDevicePagingPage(deviceName, resourceGroupName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByDataBoxEdgeDevicePagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByDataBoxEdgeDevice(deviceName, resourceGroupName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByDataBoxEdgeDeviceNext(deviceName, resourceGroupName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByDataBoxEdgeDevicePagingAll(deviceName, resourceGroupName, options) {
        return __asyncGenerator(this, arguments, function* listByDataBoxEdgeDevicePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByDataBoxEdgeDevicePagingPage(deviceName, resourceGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(deviceName, resourceGroupName, options) {
        return this.client.sendOperationRequest({ deviceName, resourceGroupName, options }, getOperationSpec);
    }
    /**
    ...
    beginCreateOrUpdate(deviceName, resourceGroupName, order, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { deviceName, resourceGroupName, order, options }, createOrUpdateOperationSpec);
    ...
    beginDelete(deviceName, resourceGroupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { deviceName, resourceGroupName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
