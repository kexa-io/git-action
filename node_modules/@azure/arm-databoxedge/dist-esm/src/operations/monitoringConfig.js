...
export class MonitoringConfigImpl {
    /**
    ...
    listPagingPage(deviceName, roleName, resourceGroupName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(deviceName, roleName, resourceGroupName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(deviceName, roleName, resourceGroupName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(deviceName, roleName, resourceGroupName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(deviceName, roleName, resourceGroupName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(deviceName, roleName, resourceGroupName, options) {
        return this.client.sendOperationRequest({ deviceName, roleName, resourceGroupName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(deviceName, roleName, resourceGroupName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { deviceName, roleName, resourceGroupName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
