 ...
 */
function listAllCustomResourceProvidersOnTheResourceGroup() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["PORTAL_SUBSCRIPTION_ID"] ||
        ...
        try {
            for (var _b = __asyncValues(client.dashboards.listByResourceGroup(resourceGroupName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=dashboardsListByResourceGroupSample.js.map