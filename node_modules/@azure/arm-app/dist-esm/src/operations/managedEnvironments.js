...
export class ManagedEnvironmentsImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, name, environmentEnvelope, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, name, environmentEnvelope, options }, createOrUpdateOperationSpec);
    ...
    update(resourceGroupName, name, environmentEnvelope, options) {
        return this.client.sendOperationRequest({ resourceGroupName, name, environmentEnvelope, options }, updateOperationSpec);
    }
    /**
