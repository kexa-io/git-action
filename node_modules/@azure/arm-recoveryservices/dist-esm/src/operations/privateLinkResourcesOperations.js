...
export class PrivateLinkResourcesOperationsImpl {
    ...
    get(resourceGroupName, vaultName, privateLinkResourceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, vaultName, privateLinkResourceName, options }, getOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
//# sourceMappingURL=privateLinkResourcesOperations.js.map