...
export class UsagesImpl {
    ...
    listByVaultsPagingPage(resourceGroupName, vaultName, options, _settings) {
        return __asyncGenerator(this, arguments, function* listByVaultsPagingPage_1() {
            let result;
            result = yield __await(this._listByVaults(resourceGroupName, vaultName, options));
            yield yield __await(result.value || []);
        });
    }
    listByVaultsPagingAll(resourceGroupName, vaultName, options) {
        return __asyncGenerator(this, arguments, function* listByVaultsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByVaultsPagingPage(resourceGroupName, vaultName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
