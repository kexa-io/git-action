...
function getOperationResult() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const operationId = "YWUzNDFkMzQtZmM5OS00MmUyLWEzNDMtZGJkMDIxZjlmZjgzOzdmYzBiMzhmLTc2NmItNDM5NS05OWQ1LTVmOGEzNzg4MWQzNA==";
        const credential = new DefaultAzureCredential();
        const client = new RecoveryServicesClient(credential, subscriptionId);
        const result = yield client.getOperationResult(resourceGroupName, vaultName, operationId);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=getOperationResultSample.js.map