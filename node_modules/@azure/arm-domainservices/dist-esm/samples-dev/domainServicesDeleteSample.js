...
function deleteDomainService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.domainServices.beginDeleteAndWait(resourceGroupName, domainServiceName);
        console.log(result);
    });
}
deleteDomainService().catch(console.error);
//# sourceMappingURL=domainServicesDeleteSample.js.map