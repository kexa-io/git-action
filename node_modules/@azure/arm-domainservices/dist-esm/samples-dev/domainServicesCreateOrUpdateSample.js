...
function createDomainService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.domainServices.beginCreateOrUpdateAndWait(resourceGroupName, domainServiceName, domainService);
        console.log(result);
    });
}
createDomainService().catch(console.error);
//# sourceMappingURL=domainServicesCreateOrUpdateSample.js.map