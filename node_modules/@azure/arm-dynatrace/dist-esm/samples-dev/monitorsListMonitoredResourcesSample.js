 ...
 */
function monitorsListMonitoredResourcesMaximumSetGen() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.monitors.listMonitoredResources(resourceGroupName, monitorName)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
 ...
 */
function monitorsListMonitoredResourcesMinimumSetGen() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["DYNATRACE_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
...
//# sourceMappingURL=monitorsListMonitoredResourcesSample.js.map