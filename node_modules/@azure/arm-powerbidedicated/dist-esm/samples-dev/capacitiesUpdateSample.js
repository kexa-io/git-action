 ...
 */
function updateCapacityParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POWERBIDEDICATED_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.capacities.beginUpdateAndWait(resourceGroupName, dedicatedCapacityName, capacityUpdateParameters);
        console.log(result);
    });
}
/**
 ...
 */
function updateCapacityToGeneration2() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POWERBIDEDICATED_SUBSCRIPTION_ID"] ||
            "613192d7-503f-477a-9cfe-4efc3ee2bd60";
        const resourceGroupName = process.env["POWERBIDEDICATED_RESOURCE_GROUP"] || "TestRG";
...
//# sourceMappingURL=capacitiesUpdateSample.js.map