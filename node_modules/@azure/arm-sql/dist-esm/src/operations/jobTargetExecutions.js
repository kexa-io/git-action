...
export class JobTargetExecutionsImpl {
    ...
    listByJobExecutionPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByJobExecutionPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByJobExecution(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, options));
    ...
    listByStepPagingPage(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByStepPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByStep(resourceGroupName, serverName, jobAgentName, jobName, jobExecutionId, stepName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
