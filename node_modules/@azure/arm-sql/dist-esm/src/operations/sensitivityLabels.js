...
export class SensitivityLabelsImpl {
    ...
    listCurrentByDatabasePagingPage(resourceGroupName, serverName, databaseName, options, settings) {
        return __asyncGenerator(this, arguments, function* listCurrentByDatabasePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listCurrentByDatabase(resourceGroupName, serverName, databaseName, options));
    ...
    listRecommendedByDatabasePagingPage(resourceGroupName, serverName, databaseName, options, settings) {
        return __asyncGenerator(this, arguments, function* listRecommendedByDatabasePagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listRecommendedByDatabase(resourceGroupName, serverName, databaseName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
