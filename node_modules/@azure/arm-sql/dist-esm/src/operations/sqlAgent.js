...
export class SqlAgentImpl {
    ...
    createOrUpdate(resourceGroupName, managedInstanceName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, parameters, options }, createOrUpdateOperationSpec);
    }
}
...
//# sourceMappingURL=sqlAgent.js.map