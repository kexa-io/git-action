...
export class DatabaseAdvancedThreatProtectionSettingsImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, serverName, databaseName, advancedThreatProtectionName, options) {
     ...
     * @param options The options parameters.
     */
    createOrUpdate(resourceGroupName, serverName, databaseName, advancedThreatProtectionName, parameters, options) {
        return this.client.sendOperationRequest({
            resourceGroupName,
            serverName,
            databaseName,
...
//# sourceMappingURL=databaseAdvancedThreatProtectionSettings.js.map