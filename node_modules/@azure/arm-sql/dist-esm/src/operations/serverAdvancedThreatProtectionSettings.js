...
export class ServerAdvancedThreatProtectionSettingsImpl {
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, serverName, advancedThreatProtectionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, advancedThreatProtectionName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdate(resourceGroupName, serverName, advancedThreatProtectionName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdateAndWait(resourceGroupName, serverName, advancedThreatProtectionName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCreateOrUpdate(resourceGroupName, serverName, advancedThreatProtectionName, parameters, options);
...
//# sourceMappingURL=serverAdvancedThreatProtectionSettings.js.map