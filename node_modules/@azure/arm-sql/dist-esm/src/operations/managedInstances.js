...
export class ManagedInstancesImpl {
    ...
    listByInstancePoolPagingPage(resourceGroupName, instancePoolName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByInstancePoolPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByInstancePool(resourceGroupName, instancePoolName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
     ...
     * @param options The options parameters.
     */
    listOutboundNetworkDependenciesByManagedInstance(resourceGroupName, managedInstanceName, options) {
        const iter = this.listOutboundNetworkDependenciesByManagedInstancePagingAll(resourceGroupName, managedInstanceName, options);
        return {
            next() {
                return iter.next();
            },
            ...
            byPage: (settings) => {
                ...
                return this.listOutboundNetworkDependenciesByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options, settings);
            }
        };
    }
    listOutboundNetworkDependenciesByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listOutboundNetworkDependenciesByManagedInstancePagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listOutboundNetworkDependenciesByManagedInstance(resourceGroupName, managedInstanceName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listOutboundNetworkDependenciesByManagedInstanceNext(resourceGroupName, managedInstanceName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listOutboundNetworkDependenciesByManagedInstancePagingAll(resourceGroupName, managedInstanceName, options) {
        return __asyncGenerator(this, arguments, function* listOutboundNetworkDependenciesByManagedInstancePagingAll_1() {
            var e_4, _a;
            try {
                for (var _b = __asyncValues(this.listOutboundNetworkDependenciesByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    listByManagedInstancePagingPage(resourceGroupName, managedInstanceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByManagedInstancePagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByManagedInstance(resourceGroupName, managedInstanceName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
     ...
     * @param options The options parameters.
     */
    _listOutboundNetworkDependenciesByManagedInstance(resourceGroupName, managedInstanceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, options }, listOutboundNetworkDependenciesByManagedInstanceOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginStart(resourceGroupName, managedInstanceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginStartAndWait(resourceGroupName, managedInstanceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginStart(resourceGroupName, managedInstanceName, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginStop(resourceGroupName, managedInstanceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginStopAndWait(resourceGroupName, managedInstanceName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginStop(resourceGroupName, managedInstanceName, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    _listOutboundNetworkDependenciesByManagedInstanceNext(resourceGroupName, managedInstanceName, nextLink, options) {
...
const listOutboundNetworkDependenciesByManagedInstanceOperationSpec = {
...
const listOutboundNetworkDependenciesByManagedInstanceNextOperationSpec = {
    path: "{nextLink}",
    httpMethod: "GET",
    responses: {
        200: {
