...
export class VirtualClustersImpl {
     ...
     * @param options The options parameters.
     */
    beginUpdateDnsServers(resourceGroupName, virtualClusterName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginUpdateDnsServersAndWait(resourceGroupName, virtualClusterName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginUpdateDnsServers(resourceGroupName, virtualClusterName, options);
            return poller.pollUntilDone();
        });
    }
    /**
