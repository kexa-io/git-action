...
export class DatabaseAdvisorsImpl {
    /**
    ...
    get(resourceGroupName, serverName, databaseName, advisorName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, databaseName, advisorName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=databaseAdvisors.js.map