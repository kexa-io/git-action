...
export class ServersImpl {
     ...
     * @param options The options parameters.
     */
    beginRefreshStatus(resourceGroupName, serverName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginRefreshStatusAndWait(resourceGroupName, serverName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginRefreshStatus(resourceGroupName, serverName, options);
            return poller.pollUntilDone();
        });
    }
    /**
...
const refreshStatusOperationSpec = {
