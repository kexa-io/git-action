...
export class ServerTrustCertificatesImpl {
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, managedInstanceName, certificateName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, certificateName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdate(resourceGroupName, managedInstanceName, certificateName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdateAndWait(resourceGroupName, managedInstanceName, certificateName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCreateOrUpdate(resourceGroupName, managedInstanceName, certificateName, parameters, options);
     ...
     * @param options The options parameters.
     */
    beginDelete(resourceGroupName, managedInstanceName, certificateName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginDeleteAndWait(resourceGroupName, managedInstanceName, certificateName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginDelete(resourceGroupName, managedInstanceName, certificateName, options);
            return poller.pollUntilDone();
        });
    }
    /**
...
//# sourceMappingURL=serverTrustCertificates.js.map