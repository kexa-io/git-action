...
export class ManagedDatabasesImpl {
    ...
    listByInstancePagingPage(resourceGroupName, managedInstanceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByInstancePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByInstance(resourceGroupName, managedInstanceName, options));
    ...
    listInaccessibleByInstancePagingPage(resourceGroupName, managedInstanceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listInaccessibleByInstancePagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listInaccessibleByInstance(resourceGroupName, managedInstanceName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
     ...
     * @param options The options parameters.
     */
    beginCancelMove(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginCancelMoveAndWait(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCancelMove(resourceGroupName, managedInstanceName, databaseName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginCompleteMove(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginCompleteMoveAndWait(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCompleteMove(resourceGroupName, managedInstanceName, databaseName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginStartMove(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginStartMoveAndWait(resourceGroupName, managedInstanceName, databaseName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginStartMove(resourceGroupName, managedInstanceName, databaseName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
...
const completeMoveOperationSpec = {
