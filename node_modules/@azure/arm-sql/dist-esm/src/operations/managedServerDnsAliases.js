...
export class ManagedServerDnsAliasesImpl {
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, managedInstanceName, dnsAliasName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, dnsAliasName, options }, getOperationSpec);
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdate(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options) {
     ...
     * @param options The options parameters.
     */
    beginCreateOrUpdateAndWait(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginCreateOrUpdate(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options);
     ...
     * @param options The options parameters.
     */
    beginDelete(resourceGroupName, managedInstanceName, dnsAliasName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginDeleteAndWait(resourceGroupName, managedInstanceName, dnsAliasName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginDelete(resourceGroupName, managedInstanceName, dnsAliasName, options);
            return poller.pollUntilDone();
        });
    }
    /**
     ...
     * @param options The options parameters.
     */
    beginAcquire(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const directSendOperation = (args, spec) => __awaiter(this, void 0, void 0, function* () {
                return this.client.sendOperationRequest(args, spec);
            });
     ...
     * @param options The options parameters.
     */
    beginAcquireAndWait(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const poller = yield this.beginAcquire(resourceGroupName, managedInstanceName, dnsAliasName, parameters, options);
            return poller.pollUntilDone();
        });
    }
    /**
...
//# sourceMappingURL=managedServerDnsAliases.js.map