...
import { ServerAzureADAdministrator, ServerAzureADAdministratorsListByServerOptionalParams, AdministratorName, ServerAzureADAdministratorsGetOptionalParams, ServerAzureADAdministratorsGetResponse, ServerAzureADAdministratorsCreateOrUpdateOptionalParams, ServerAzureADAdministratorsCreateOrUpdateResponse, ServerAzureADAdministratorsDeleteOptionalParams } from "../models";
/** Class containing ServerAzureADAdministrators operations. */
export declare class ServerAzureADAdministratorsImpl implements ServerAzureADAdministrators {
