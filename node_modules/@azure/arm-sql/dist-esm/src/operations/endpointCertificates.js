...
export class EndpointCertificatesImpl {
    /**
     ...
     * @param options The options parameters.
     */
    get(resourceGroupName, managedInstanceName, endpointType, options) {
        return this.client.sendOperationRequest({ resourceGroupName, managedInstanceName, endpointType, options }, getOperationSpec);
    }
    /**
     * ListByInstanceNext
     * @param resourceGroupName The name of the resource group that contains the resource. You can obtain
...
//# sourceMappingURL=endpointCertificates.js.map