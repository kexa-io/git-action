...
export class ElasticPoolsImpl {
    ...
    listMetricsPagingPage(resourceGroupName, serverName, elasticPoolName, filter, options, _settings) {
        return __asyncGenerator(this, arguments, function* listMetricsPagingPage_1() {
            let result;
            result = yield __await(this._listMetrics(resourceGroupName, serverName, elasticPoolName, filter, options));
    ...
    listMetricDefinitionsPagingPage(resourceGroupName, serverName, elasticPoolName, options, _settings) {
        return __asyncGenerator(this, arguments, function* listMetricDefinitionsPagingPage_1() {
            let result;
            result = yield __await(this._listMetricDefinitions(resourceGroupName, serverName, elasticPoolName, options));
            yield yield __await(result.value || []);
        });
    }
