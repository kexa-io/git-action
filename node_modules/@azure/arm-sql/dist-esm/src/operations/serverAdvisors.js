...
export class ServerAdvisorsImpl {
    /**
    ...
    update(resourceGroupName, serverName, advisorName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serverName, advisorName, parameters, options }, updateOperationSpec);
    }
}
...
//# sourceMappingURL=serverAdvisors.js.map