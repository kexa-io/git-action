...
export var KnownDevOpsAuditingSettingsName;
(function (KnownDevOpsAuditingSettingsName) {
    /** Default */
    KnownDevOpsAuditingSettingsName["Default"] = "Default";
})(KnownDevOpsAuditingSettingsName || (KnownDevOpsAuditingSettingsName = {}));
...
export var KnownSyncGroupsType;
(function (KnownSyncGroupsType) {
    /** All */
    KnownSyncGroupsType["All"] = "All";
    /** Error */
    KnownSyncGroupsType["Error"] = "Error";
    /** Warning */
    KnownSyncGroupsType["Warning"] = "Warning";
    /** Success */
    KnownSyncGroupsType["Success"] = "Success";
})(KnownSyncGroupsType || (KnownSyncGroupsType = {}));
...
(function (KnownReplicationMode) {
    /** Async */
    KnownReplicationMode["Async"] = "Async";
    /** Sync */
    KnownReplicationMode["Sync"] = "Sync";
})(KnownReplicationMode || (KnownReplicationMode = {}));
/** Known values of {@link AdvancedThreatProtectionName} that the service accepts. */
export var KnownAdvancedThreatProtectionName;
(function (KnownAdvancedThreatProtectionName) {
    /** Default */
    KnownAdvancedThreatProtectionName["Default"] = "Default";
})(KnownAdvancedThreatProtectionName || (KnownAdvancedThreatProtectionName = {}));
/** Known values of {@link BaselineName} that the service accepts. */
export var KnownBaselineName;
(function (KnownBaselineName) {
    /** Default */
    KnownBaselineName["Default"] = "default";
})(KnownBaselineName || (KnownBaselineName = {}));
/** Known values of {@link SQLVulnerabilityAssessmentName} that the service accepts. */
export var KnownSQLVulnerabilityAssessmentName;
(function (KnownSQLVulnerabilityAssessmentName) {
    /** Default */
    KnownSQLVulnerabilityAssessmentName["Default"] = "default";
...
(function (KnownReplicationLinkType) {
    ...
    /** Standby */
    KnownReplicationLinkType["Standby"] = "STANDBY";
})(KnownReplicationLinkType || (KnownReplicationLinkType = {}));
/** Known values of {@link MoveOperationMode} that the service accepts. */
export var KnownMoveOperationMode;
(function (KnownMoveOperationMode) {
    /** Move */
    KnownMoveOperationMode["Move"] = "Move";
    /** Copy */
    KnownMoveOperationMode["Copy"] = "Copy";
})(KnownMoveOperationMode || (KnownMoveOperationMode = {}));
/** Known values of {@link DtcName} that the service accepts. */
export var KnownDtcName;
(function (KnownDtcName) {
    /** Current */
    KnownDtcName["Current"] = "current";
})(KnownDtcName || (KnownDtcName = {}));
/** Known values of {@link DNSRefreshOperationStatus} that the service accepts. */
export var KnownDNSRefreshOperationStatus;
(function (KnownDNSRefreshOperationStatus) {
    /** Succeeded */
    KnownDNSRefreshOperationStatus["Succeeded"] = "Succeeded";
    /** Failed */
    KnownDNSRefreshOperationStatus["Failed"] = "Failed";
    /** InProgress */
    KnownDNSRefreshOperationStatus["InProgress"] = "InProgress";
})(KnownDNSRefreshOperationStatus || (KnownDNSRefreshOperationStatus = {}));
/** Known values of {@link SecondaryInstanceType} that the service accepts. */
export var KnownSecondaryInstanceType;
(function (KnownSecondaryInstanceType) {
    /** Geo */
    KnownSecondaryInstanceType["Geo"] = "Geo";
    /** Standby */
    KnownSecondaryInstanceType["Standby"] = "Standby";
})(KnownSecondaryInstanceType || (KnownSecondaryInstanceType = {}));
...
(function (KnownManagedDatabaseStatus) {
    ...
    /** Stopping */
    KnownManagedDatabaseStatus["Stopping"] = "Stopping";
    /** Stopped */
    KnownManagedDatabaseStatus["Stopped"] = "Stopped";
    /** Starting */
    KnownManagedDatabaseStatus["Starting"] = "Starting";
    /** DbMoving */
    KnownManagedDatabaseStatus["DbMoving"] = "DbMoving";
    /** DbCopying */
    KnownManagedDatabaseStatus["DbCopying"] = "DbCopying";
...
(function (KnownSecondaryType) {
    ...
    /** Standby */
    KnownSecondaryType["Standby"] = "Standby";
})(KnownSecondaryType || (KnownSecondaryType = {}));
/** Known values of {@link DatabaseKeyType} that the service accepts. */
export var KnownDatabaseKeyType;
(function (KnownDatabaseKeyType) {
    /** AzureKeyVault */
    KnownDatabaseKeyType["AzureKeyVault"] = "AzureKeyVault";
})(KnownDatabaseKeyType || (KnownDatabaseKeyType = {}));
/** Known values of {@link AlwaysEncryptedEnclaveType} that the service accepts. */
export var KnownAlwaysEncryptedEnclaveType;
(function (KnownAlwaysEncryptedEnclaveType) {
    /** Default */
    KnownAlwaysEncryptedEnclaveType["Default"] = "Default";
    /** VBS */
    KnownAlwaysEncryptedEnclaveType["VBS"] = "VBS";
})(KnownAlwaysEncryptedEnclaveType || (KnownAlwaysEncryptedEnclaveType = {}));
/** Known values of {@link AvailabilityZoneType} that the service accepts. */
export var KnownAvailabilityZoneType;
(function (KnownAvailabilityZoneType) {
    /** NoPreference */
    KnownAvailabilityZoneType["NoPreference"] = "NoPreference";
    /** One */
    KnownAvailabilityZoneType["One"] = "1";
    /** Two */
    KnownAvailabilityZoneType["Two"] = "2";
    /** Three */
    KnownAvailabilityZoneType["Three"] = "3";
})(KnownAvailabilityZoneType || (KnownAvailabilityZoneType = {}));
...
export var KnownManagedLedgerDigestUploadsState;
(function (KnownManagedLedgerDigestUploadsState) {
    /** Enabled */
    KnownManagedLedgerDigestUploadsState["Enabled"] = "Enabled";
    /** Disabled */
    KnownManagedLedgerDigestUploadsState["Disabled"] = "Disabled";
})(KnownManagedLedgerDigestUploadsState || (KnownManagedLedgerDigestUploadsState = {}));
/** Known values of {@link ManagedLedgerDigestUploadsName} that the service accepts. */
export var KnownManagedLedgerDigestUploadsName;
(function (KnownManagedLedgerDigestUploadsName) {
    /** Current */
    KnownManagedLedgerDigestUploadsName["Current"] = "current";
})(KnownManagedLedgerDigestUploadsName || (KnownManagedLedgerDigestUploadsName = {}));
/** Known values of {@link ServerConfigurationOptionName} that the service accepts. */
export var KnownServerConfigurationOptionName;
(function (KnownServerConfigurationOptionName) {
    /** AllowPolybaseExport */
    KnownServerConfigurationOptionName["AllowPolybaseExport"] = "allowPolybaseExport";
})(KnownServerConfigurationOptionName || (KnownServerConfigurationOptionName = {}));
/** Known values of {@link ServerPublicNetworkAccessFlag} that the service accepts. */
export var KnownServerPublicNetworkAccessFlag;
(function (KnownServerPublicNetworkAccessFlag) {
    /** Enabled */
    KnownServerPublicNetworkAccessFlag["Enabled"] = "Enabled";
    /** Disabled */
    KnownServerPublicNetworkAccessFlag["Disabled"] = "Disabled";
    /** SecuredByPerimeter */
    KnownServerPublicNetworkAccessFlag["SecuredByPerimeter"] = "SecuredByPerimeter";
})(KnownServerPublicNetworkAccessFlag || (KnownServerPublicNetworkAccessFlag = {}));
...
export var KnownExternalGovernanceStatus;
(function (KnownExternalGovernanceStatus) {
    /** Enabled */
    KnownExternalGovernanceStatus["Enabled"] = "Enabled";
    /** Disabled */
    KnownExternalGovernanceStatus["Disabled"] = "Disabled";
})(KnownExternalGovernanceStatus || (KnownExternalGovernanceStatus = {}));
/** Known values of {@link StartStopScheduleName} that the service accepts. */
export var KnownStartStopScheduleName;
(function (KnownStartStopScheduleName) {
    /** Default */
    KnownStartStopScheduleName["Default"] = "default";
})(KnownStartStopScheduleName || (KnownStartStopScheduleName = {}));
