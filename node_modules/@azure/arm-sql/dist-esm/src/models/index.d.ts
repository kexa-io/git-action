 ...
 * **Default**
 */
export declare type DevOpsAuditingSettingsName = string;
...
export declare enum KnownSyncGroupsType {
    /** All */
    All = "All",
    /** Error */
    Error = "Error",
 ...
 * **Success**
 */
export declare type SyncGroupsType = string;
 ...
 * **default**
 */
export declare type BaselineName = string;
/** Known values of {@link SQLVulnerabilityAssessmentName} that the service accepts. */
export declare enum KnownSQLVulnerabilityAssessmentName {
    /** Default */
    Default = "default"
}
/**
 ...
 * **default**
 */
export declare type SQLVulnerabilityAssessmentName = string;
 ...
 * **Copy**
 */
export declare type MoveOperationMode = string;
/** Known values of {@link DtcName} that the service accepts. */
export declare enum KnownDtcName {
    /** Current */
    Current = "current"
}
/**
 ...
 * **current**
 */
export declare type DtcName = string;
/** Known values of {@link DNSRefreshOperationStatus} that the service accepts. */
export declare enum KnownDNSRefreshOperationStatus {
    /** Succeeded */
    Succeeded = "Succeeded",
    /** Failed */
    Failed = "Failed",
 ...
 * **InProgress**
 */
export declare type DNSRefreshOperationStatus = string;
 ...
 * **Standby**
 */
export declare type SecondaryInstanceType = string;
...
export declare enum KnownDatabaseKeyType {
    /** AzureKeyVault */
    AzureKeyVault = "AzureKeyVault"
}
/**
 ...
 * **AzureKeyVault**
 */
export declare type DatabaseKeyType = string;
/** Known values of {@link AlwaysEncryptedEnclaveType} that the service accepts. */
export declare enum KnownAlwaysEncryptedEnclaveType {
    /** Default */
    Default = "Default",
    /** VBS */
    VBS = "VBS"
 ...
 * **VBS**
 */
export declare type AlwaysEncryptedEnclaveType = string;
 ...
 * **3**
 */
export declare type AvailabilityZoneType = string;
...
export declare enum KnownManagedLedgerDigestUploadsState {
    /** Enabled */
    Enabled = "Enabled",
    /** Disabled */
    Disabled = "Disabled"
 ...
 * **Disabled**
 */
export declare type ManagedLedgerDigestUploadsState = string;
 ...
 * **current**
 */
export declare type ManagedLedgerDigestUploadsName = string;
 ...
 * **allowPolybaseExport**
 */
export declare type ServerConfigurationOptionName = string;
 ...
 * **SecuredByPerimeter**
 */
export declare type ServerPublicNetworkAccessFlag = string;
 ...
 * **Disabled**
 */
export declare type ExternalGovernanceStatus = string;
 ...
 * **default**
 */
export declare type StartStopScheduleName = string;
...
export declare type AdvancedThreatProtectionState = "New" | "Enabled" | "Disabled";
/** Defines values for SqlVulnerabilityAssessmentState. */
export declare type SqlVulnerabilityAssessmentState = "Enabled" | "Disabled";
...
/** Contains response data for the listByInstance operation. */
export declare type DistributedAvailabilityGroupsListByInstanceResponse = DistributedAvailabilityGroupsListResult;
/** Optional parameters. */
export interface DistributedAvailabilityGroupsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DistributedAvailabilityGroupsGetResponse = DistributedAvailabilityGroup;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type DistributedAvailabilityGroupsCreateOrUpdateResponse = DistributedAvailabilityGroup;
/** Optional parameters. */
...
/** Contains response data for the update operation. */
export declare type DistributedAvailabilityGroupsUpdateResponse = DistributedAvailabilityGroup;
/** Optional parameters. */
export interface DistributedAvailabilityGroupsListByInstanceNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByInstanceNext operation. */
export declare type DistributedAvailabilityGroupsListByInstanceNextResponse = DistributedAvailabilityGroupsListResult;
/** Optional parameters. */
export interface ServerTrustCertificatesListByInstanceOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByInstance operation. */
export declare type ServerTrustCertificatesListByInstanceResponse = ServerTrustCertificatesListResult;
/** Optional parameters. */
export interface ServerTrustCertificatesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ServerTrustCertificatesGetResponse = ServerTrustCertificate;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ServerTrustCertificatesCreateOrUpdateResponse = ServerTrustCertificate;
/** Optional parameters. */
...
/** Contains response data for the listByInstanceNext operation. */
export declare type ServerTrustCertificatesListByInstanceNextResponse = ServerTrustCertificatesListResult;
/** Optional parameters. */
export interface IPv6FirewallRulesListByServerOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByServer operation. */
export declare type IPv6FirewallRulesListByServerResponse = IPv6FirewallRuleListResult;
/** Optional parameters. */
export interface IPv6FirewallRulesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type IPv6FirewallRulesGetResponse = IPv6FirewallRule;
/** Optional parameters. */
export interface IPv6FirewallRulesCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the createOrUpdate operation. */
export declare type IPv6FirewallRulesCreateOrUpdateResponse = IPv6FirewallRule;
/** Optional parameters. */
...
/** Contains response data for the listByServerNext operation. */
export declare type IPv6FirewallRulesListByServerNextResponse = IPv6FirewallRuleListResult;
/** Optional parameters. */
export interface EndpointCertificatesListByInstanceOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByInstance operation. */
export declare type EndpointCertificatesListByInstanceResponse = EndpointCertificateListResult;
/** Optional parameters. */
export interface EndpointCertificatesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type EndpointCertificatesGetResponse = EndpointCertificate;
/** Optional parameters. */
export interface EndpointCertificatesListByInstanceNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByInstanceNext operation. */
export declare type EndpointCertificatesListByInstanceNextResponse = EndpointCertificateListResult;
/** Optional parameters. */
...
/** Contains response data for the listByDatabase operation. */
export declare type DatabaseAdvancedThreatProtectionSettingsListByDatabaseResponse = DatabaseAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface DatabaseAdvancedThreatProtectionSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseAdvancedThreatProtectionSettingsGetResponse = DatabaseAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type DatabaseAdvancedThreatProtectionSettingsCreateOrUpdateResponse = DatabaseAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the listByDatabaseNext operation. */
export declare type DatabaseAdvancedThreatProtectionSettingsListByDatabaseNextResponse = DatabaseAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface ServerAdvancedThreatProtectionSettingsListByServerOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByServer operation. */
export declare type ServerAdvancedThreatProtectionSettingsListByServerResponse = LogicalServerAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface ServerAdvancedThreatProtectionSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ServerAdvancedThreatProtectionSettingsGetResponse = ServerAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ServerAdvancedThreatProtectionSettingsCreateOrUpdateResponse = ServerAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the listByServerNext operation. */
export declare type ServerAdvancedThreatProtectionSettingsListByServerNextResponse = LogicalServerAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface ManagedServerDnsAliasesListByManagedInstanceOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByManagedInstance operation. */
export declare type ManagedServerDnsAliasesListByManagedInstanceResponse = ManagedServerDnsAliasListResult;
/** Optional parameters. */
export interface ManagedServerDnsAliasesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedServerDnsAliasesGetResponse = ManagedServerDnsAlias;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ManagedServerDnsAliasesCreateOrUpdateResponse = ManagedServerDnsAlias;
/** Optional parameters. */
...
/** Contains response data for the acquire operation. */
export declare type ManagedServerDnsAliasesAcquireResponse = ManagedServerDnsAlias;
/** Optional parameters. */
export interface ManagedServerDnsAliasesListByManagedInstanceNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByManagedInstanceNext operation. */
export declare type ManagedServerDnsAliasesListByManagedInstanceNextResponse = ManagedServerDnsAliasListResult;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentBaselinesListBySqlVulnerabilityAssessmentResponse = DatabaseSqlVulnerabilityAssessmentBaselineSetListResult;
/** Optional parameters. */
export interface DatabaseSqlVulnerabilityAssessmentBaselinesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseSqlVulnerabilityAssessmentBaselinesGetResponse = DatabaseSqlVulnerabilityAssessmentBaselineSet;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type DatabaseSqlVulnerabilityAssessmentBaselinesCreateOrUpdateResponse = DatabaseSqlVulnerabilityAssessmentBaselineSet;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentBaselinesListBySqlVulnerabilityAssessmentNextResponse = DatabaseSqlVulnerabilityAssessmentBaselineSetListResult;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentRuleBaselinesListByBaselineResponse = DatabaseSqlVulnerabilityAssessmentRuleBaselineListResult;
/** Optional parameters. */
export interface DatabaseSqlVulnerabilityAssessmentRuleBaselinesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseSqlVulnerabilityAssessmentRuleBaselinesGetResponse = DatabaseSqlVulnerabilityAssessmentRuleBaseline;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type DatabaseSqlVulnerabilityAssessmentRuleBaselinesCreateOrUpdateResponse = DatabaseSqlVulnerabilityAssessmentRuleBaseline;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentRuleBaselinesListByBaselineNextResponse = DatabaseSqlVulnerabilityAssessmentRuleBaselineListResult;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentScanResultListByScanResponse = SQLVulnerabilityAssessmentScanListResult;
/** Optional parameters. */
export interface DatabaseSqlVulnerabilityAssessmentScanResultGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseSqlVulnerabilityAssessmentScanResultGetResponse = SqlVulnerabilityAssessmentScanResults;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentScanResultListByScanNextResponse = SQLVulnerabilityAssessmentScanListResult;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentScansListBySqlVulnerabilityAssessmentsResponse = SqlVulnerabilityAssessmentScanRecordListResult;
/** Optional parameters. */
export interface DatabaseSqlVulnerabilityAssessmentScansGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseSqlVulnerabilityAssessmentScansGetResponse = SqlVulnerabilityAssessmentScanRecord;
/** Optional parameters. */
...
export declare type DatabaseSqlVulnerabilityAssessmentScansListBySqlVulnerabilityAssessmentsNextResponse = SqlVulnerabilityAssessmentScanRecordListResult;
/** Optional parameters. */
...
/** Contains response data for the listByDatabase operation. */
export declare type DatabaseSqlVulnerabilityAssessmentsSettingsListByDatabaseResponse = SqlVulnerabilityAssessmentListResult;
/** Optional parameters. */
export interface DatabaseSqlVulnerabilityAssessmentsSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type DatabaseSqlVulnerabilityAssessmentsSettingsGetResponse = SqlVulnerabilityAssessment;
/** Optional parameters. */
...
/** Contains response data for the listByDatabaseNext operation. */
export declare type DatabaseSqlVulnerabilityAssessmentsSettingsListByDatabaseNextResponse = SqlVulnerabilityAssessmentListResult;
/** Optional parameters. */
...
/** Contains response data for the listByDatabase operation. */
export declare type ManagedDatabaseAdvancedThreatProtectionSettingsListByDatabaseResponse = ManagedDatabaseAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface ManagedDatabaseAdvancedThreatProtectionSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedDatabaseAdvancedThreatProtectionSettingsGetResponse = ManagedDatabaseAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ManagedDatabaseAdvancedThreatProtectionSettingsCreateOrUpdateResponse = ManagedDatabaseAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the listByDatabaseNext operation. */
export declare type ManagedDatabaseAdvancedThreatProtectionSettingsListByDatabaseNextResponse = ManagedDatabaseAdvancedThreatProtectionListResult;
/** Optional parameters. */
...
/** Contains response data for the listByInstance operation. */
export declare type ManagedInstanceAdvancedThreatProtectionSettingsListByInstanceResponse = ManagedInstanceAdvancedThreatProtectionListResult;
/** Optional parameters. */
export interface ManagedInstanceAdvancedThreatProtectionSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedInstanceAdvancedThreatProtectionSettingsGetResponse = ManagedInstanceAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ManagedInstanceAdvancedThreatProtectionSettingsCreateOrUpdateResponse = ManagedInstanceAdvancedThreatProtection;
/** Optional parameters. */
...
/** Contains response data for the listByInstanceNext operation. */
export declare type ManagedInstanceAdvancedThreatProtectionSettingsListByInstanceNextResponse = ManagedInstanceAdvancedThreatProtectionListResult;
/** Optional parameters. */
...
export declare type ReplicationLinksFailoverAllowDataLossResponse = ReplicationLink;
/** Optional parameters. */
...
/** Contains response data for the listBySqlVulnerabilityAssessment operation. */
export declare type SqlVulnerabilityAssessmentBaselineListBySqlVulnerabilityAssessmentResponse = DatabaseSqlVulnerabilityAssessmentBaselineSetListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentBaselineGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type SqlVulnerabilityAssessmentBaselineGetResponse = DatabaseSqlVulnerabilityAssessmentBaselineSet;
/** Optional parameters. */
...
/** Contains response data for the listBySqlVulnerabilityAssessmentNext operation. */
export declare type SqlVulnerabilityAssessmentBaselineListBySqlVulnerabilityAssessmentNextResponse = DatabaseSqlVulnerabilityAssessmentBaselineSetListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentBaselinesCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the createOrUpdate operation. */
export declare type SqlVulnerabilityAssessmentBaselinesCreateOrUpdateResponse = DatabaseSqlVulnerabilityAssessmentBaselineSet;
/** Optional parameters. */
...
/** Contains response data for the listByBaseline operation. */
export declare type SqlVulnerabilityAssessmentRuleBaselineListByBaselineResponse = DatabaseSqlVulnerabilityAssessmentRuleBaselineListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentRuleBaselineGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type SqlVulnerabilityAssessmentRuleBaselineGetResponse = DatabaseSqlVulnerabilityAssessmentRuleBaseline;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentRuleBaselineCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the createOrUpdate operation. */
export declare type SqlVulnerabilityAssessmentRuleBaselineCreateOrUpdateResponse = DatabaseSqlVulnerabilityAssessmentRuleBaseline;
/** Optional parameters. */
...
/** Contains response data for the listByBaselineNext operation. */
export declare type SqlVulnerabilityAssessmentRuleBaselineListByBaselineNextResponse = DatabaseSqlVulnerabilityAssessmentRuleBaselineListResult;
/** Optional parameters. */
...
/** Contains response data for the listByScan operation. */
export declare type SqlVulnerabilityAssessmentScanResultListByScanResponse = SQLVulnerabilityAssessmentScanListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentScanResultGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type SqlVulnerabilityAssessmentScanResultGetResponse = SqlVulnerabilityAssessmentScanResults;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentScanResultListByScanNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByScanNext operation. */
export declare type SqlVulnerabilityAssessmentScanResultListByScanNextResponse = SQLVulnerabilityAssessmentScanListResult;
/** Optional parameters. */
...
/** Contains response data for the listBySqlVulnerabilityAssessments operation. */
export declare type SqlVulnerabilityAssessmentScansListBySqlVulnerabilityAssessmentsResponse = SqlVulnerabilityAssessmentScanRecordListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentScansGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type SqlVulnerabilityAssessmentScansGetResponse = SqlVulnerabilityAssessmentScanRecord;
/** Optional parameters. */
...
/** Contains response data for the listBySqlVulnerabilityAssessmentsNext operation. */
export declare type SqlVulnerabilityAssessmentScansListBySqlVulnerabilityAssessmentsNextResponse = SqlVulnerabilityAssessmentScanRecordListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentsSettingsListByServerOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByServer operation. */
export declare type SqlVulnerabilityAssessmentsSettingsListByServerResponse = SqlVulnerabilityAssessmentListResult;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentsSettingsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type SqlVulnerabilityAssessmentsSettingsGetResponse = SqlVulnerabilityAssessment;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentsSettingsCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the createOrUpdate operation. */
export declare type SqlVulnerabilityAssessmentsSettingsCreateOrUpdateResponse = SqlVulnerabilityAssessment;
/** Optional parameters. */
export interface SqlVulnerabilityAssessmentsSettingsListByServerNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByServerNext operation. */
export declare type SqlVulnerabilityAssessmentsSettingsListByServerNextResponse = SqlVulnerabilityAssessmentListResult;
/** Optional parameters. */
...
/** Contains response data for the listByLocation operation. */
export declare type ManagedDatabaseMoveOperationsListByLocationResponse = ManagedDatabaseMoveOperationListResult;
/** Optional parameters. */
export interface ManagedDatabaseMoveOperationsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedDatabaseMoveOperationsGetResponse = ManagedDatabaseMoveOperationResult;
/** Optional parameters. */
export interface ManagedDatabaseMoveOperationsListByLocationNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByLocationNext operation. */
export declare type ManagedDatabaseMoveOperationsListByLocationNextResponse = ManagedDatabaseMoveOperationListResult;
/** Optional parameters. */
export interface ManagedInstanceDtcsListByManagedInstanceOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByManagedInstance operation. */
export declare type ManagedInstanceDtcsListByManagedInstanceResponse = ManagedInstanceDtcListResult;
/** Optional parameters. */
export interface ManagedInstanceDtcsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedInstanceDtcsGetResponse = ManagedInstanceDtc;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ManagedInstanceDtcsCreateOrUpdateResponse = ManagedInstanceDtc;
/** Optional parameters. */
export interface ManagedInstanceDtcsListByManagedInstanceNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByManagedInstanceNext operation. */
export declare type ManagedInstanceDtcsListByManagedInstanceNextResponse = ManagedInstanceDtcListResult;
/** Optional parameters. */
export interface SynapseLinkWorkspacesListByDatabaseOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByDatabase operation. */
export declare type SynapseLinkWorkspacesListByDatabaseResponse = SynapseLinkWorkspaceListResult;
/** Optional parameters. */
export interface SynapseLinkWorkspacesListByDatabaseNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByDatabaseNext operation. */
export declare type SynapseLinkWorkspacesListByDatabaseNextResponse = SynapseLinkWorkspaceListResult;
/** Optional parameters. */
...
export declare type VirtualClustersUpdateDnsServersResponse = UpdateVirtualClusterDnsServersOperation;
/** Optional parameters. */
...
export declare type ManagedInstancesListOutboundNetworkDependenciesByManagedInstanceResponse = OutboundEnvironmentEndpointCollection;
/** Optional parameters. */
...
export declare type ManagedInstancesListOutboundNetworkDependenciesByManagedInstanceNextResponse = OutboundEnvironmentEndpointCollection;
/** Optional parameters. */
...
/** Contains response data for the listByDatabase operation. */
export declare type ManagedLedgerDigestUploadsListByDatabaseResponse = ManagedLedgerDigestUploadsListResult;
/** Optional parameters. */
export interface ManagedLedgerDigestUploadsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ManagedLedgerDigestUploadsGetResponse = ManagedLedgerDigestUploads;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ManagedLedgerDigestUploadsCreateOrUpdateResponse = ManagedLedgerDigestUploads;
/** Optional parameters. */
...
/** Contains response data for the disable operation. */
export declare type ManagedLedgerDigestUploadsDisableResponse = ManagedLedgerDigestUploads;
/** Optional parameters. */
export interface ManagedLedgerDigestUploadsListByDatabaseNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByDatabaseNext operation. */
export declare type ManagedLedgerDigestUploadsListByDatabaseNextResponse = ManagedLedgerDigestUploadsListResult;
/** Optional parameters. */
...
/** Contains response data for the listByServerNext operation. */
export declare type RecoverableDatabasesListByServerNextResponse = RecoverableDatabaseListResult;
/** Optional parameters. */
...
/** Contains response data for the listByManagedInstance operation. */
export declare type ServerConfigurationOptionsListByManagedInstanceResponse = ServerConfigurationOptionListResult;
/** Optional parameters. */
export interface ServerConfigurationOptionsGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type ServerConfigurationOptionsGetResponse = ServerConfigurationOption;
/** Optional parameters. */
...
/** Contains response data for the createOrUpdate operation. */
export declare type ServerConfigurationOptionsCreateOrUpdateResponse = ServerConfigurationOption;
/** Optional parameters. */
export interface ServerConfigurationOptionsListByManagedInstanceNextOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the listByManagedInstanceNext operation. */
export declare type ServerConfigurationOptionsListByManagedInstanceNextResponse = ServerConfigurationOptionListResult;
/** Optional parameters. */
...
export declare type ServersRefreshStatusResponse = RefreshExternalGovernanceStatusOperationResult;
/** Optional parameters. */
...
/** Contains response data for the listByInstance operation. */
export declare type StartStopManagedInstanceSchedulesListByInstanceResponse = StartStopManagedInstanceScheduleListResult;
/** Optional parameters. */
export interface StartStopManagedInstanceSchedulesGetOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the get operation. */
export declare type StartStopManagedInstanceSchedulesGetResponse = StartStopManagedInstanceSchedule;
/** Optional parameters. */
export interface StartStopManagedInstanceSchedulesCreateOrUpdateOptionalParams extends coreClient.OperationOptions {
}
/** Contains response data for the createOrUpdate operation. */
export declare type StartStopManagedInstanceSchedulesCreateOrUpdateResponse = StartStopManagedInstanceSchedule;
/** Optional parameters. */
...
/** Contains response data for the listByInstanceNext operation. */
export declare type StartStopManagedInstanceSchedulesListByInstanceNextResponse = StartStopManagedInstanceScheduleListResult;
/** Optional parameters. */
