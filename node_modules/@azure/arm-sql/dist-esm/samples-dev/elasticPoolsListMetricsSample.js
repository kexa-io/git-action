 ...
 */
function listDatabaseUsageMetrics() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const filter = "name/value eq 'cpu_percent' and timeGrain eq '00:10:00' and startTime eq '2017-06-02T18:35:00Z' and endTime eq '2017-06-02T18:55:00Z'";
        const credential = new DefaultAzureCredential();
        const client = new SqlManagementClient(credential, subscriptionId);
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.elasticPools.listMetrics(resourceGroupName, serverName, elasticPoolName, filter)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=elasticPoolsListMetricsSample.js.map