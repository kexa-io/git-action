 ...
 */
function updatesServerAutomaticTuningSettingsWithAllProperties() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverAutomaticTuningOperations.update(resourceGroupName, serverName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function updatesServerAutomaticTuningSettingsWithMinimalProperties() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "c3aa9078-0000-0000-0000-e36f151182d7";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "default-sql-onebox";
...
//# sourceMappingURL=serverAutomaticTuningUpdateSample.js.map