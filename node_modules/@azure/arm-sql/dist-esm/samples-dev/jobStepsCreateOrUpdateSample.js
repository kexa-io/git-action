 ...
 */
function createOrUpdateAJobStepWithAllPropertiesSpecified() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.jobSteps.createOrUpdate(resourceGroupName, serverName, jobAgentName, jobName, stepName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateAJobStepWithMinimalPropertiesSpecified() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "group1";
...
//# sourceMappingURL=jobStepsCreateOrUpdateSample.js.map