 ...
 */
function createsDatawarehouseDatabaseRestorePoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.restorePoints.beginCreateAndWait(resourceGroupName, serverName, databaseName, parameters);
        console.log(result);
    });
}
function main() {
