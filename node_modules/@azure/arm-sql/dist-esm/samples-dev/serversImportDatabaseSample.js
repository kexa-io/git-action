 ...
 */
function importsToANewDatabaseUsingPrivateLinkForTheSqlServerAndStorageAccount() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.servers.beginImportDatabaseAndWait(resourceGroupName, serverName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function importsToANewDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "Default-SQL-SouthEastAsia";
...
//# sourceMappingURL=serversImportDatabaseSample.js.map