 ...
 */
function updateAServerExtendedBlobAuditingPolicyWithAllParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.extendedServerBlobAuditingPolicies.beginCreateOrUpdateAndWait(resourceGroupName, serverName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function updateAServerExtendedBlobAuditingPolicyWithMinimalParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "blobauditingtest-4799";
...
//# sourceMappingURL=extendedServerBlobAuditingPoliciesCreateOrUpdateSample.js.map