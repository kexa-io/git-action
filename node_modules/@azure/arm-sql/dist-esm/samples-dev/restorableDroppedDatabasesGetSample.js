 ...
 */
function getsARestorableDroppedDatabaseWithExpandEqualsKeys() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.restorableDroppedDatabases.get(resourceGroupName, serverName, restorableDroppedDatabaseId, options);
        console.log(result);
    });
}
/**
 ...
 */
function getsARestorableDroppedDatabase() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "Default-SQL-SouthEastAsia";
        ...
        const credential = new DefaultAzureCredential();
        const client = new SqlManagementClient(credential, subscriptionId);
        const result = yield client.restorableDroppedDatabases.get(resourceGroupName, serverName, restorableDroppedDatabaseId);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=restorableDroppedDatabasesGetSample.js.map