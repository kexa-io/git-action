 ...
 */
function filterDatabaseColumns() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.databaseColumns.listByDatabase(resourceGroupName, serverName, databaseName, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
function listDatabaseColumns() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.databaseColumns.listByDatabase(resourceGroupName, serverName, databaseName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=databaseColumnsListByDatabaseSample.js.map