 ...
 */
function createOrUpdateAnExtendedDatabaseAzureMonitorAuditingPolicyWithMinimalParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.extendedDatabaseBlobAuditingPolicies.createOrUpdate(resourceGroupName, serverName, databaseName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateAnExtendedDatabaseBlobAuditingPolicyWithAllParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "blobauditingtest-4799";
 ...
 */
function createOrUpdateAnExtendedDatabaseBlobAuditingPolicyWithMinimalParameters() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "blobauditingtest-4799";
...
//# sourceMappingURL=extendedDatabaseBlobAuditingPoliciesCreateOrUpdateSample.js.map