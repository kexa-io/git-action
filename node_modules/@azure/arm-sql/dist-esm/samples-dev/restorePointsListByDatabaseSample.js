 ...
 */
function listDatabaseRestorePoints() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.restorePoints.listByDatabase(resourceGroupName, serverName, databaseName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function listDatawarehouseDatabaseRestorePoints() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
...
//# sourceMappingURL=restorePointsListByDatabaseSample.js.map