 ...
 */
function createAdministratorOfManagedInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedInstanceAdministrators.beginCreateOrUpdateAndWait(resourceGroupName, managedInstanceName, administratorName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function updateAdministratorOfManagedInstance() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SQL_SUBSCRIPTION_ID"] ||
            "00000000-1111-2222-3333-444444444444";
        const resourceGroupName = process.env["SQL_RESOURCE_GROUP"] || "Default-SQL-SouthEastAsia";
...
//# sourceMappingURL=managedInstanceAdministratorsCreateOrUpdateSample.js.map