...
function approveAPrivateEndpointConnectionManually() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginCreateOrUpdateAndWait(resourceGroupName, clusterName, privateEndpointConnectionName, parameters);
        console.log(result);
    });
}
function main() {
