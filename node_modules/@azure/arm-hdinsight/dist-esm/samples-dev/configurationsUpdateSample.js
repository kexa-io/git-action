 ...
 */
function disableHttpConnectivity() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurations.beginUpdateAndWait(resourceGroupName, clusterName, configurationName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function enableHttpConnectivity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["HDINSIGHT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["HDINSIGHT_RESOURCE_GROUP"] || "rg1";
        const clusterName = "cluster1";
...
//# sourceMappingURL=configurationsUpdateSample.js.map