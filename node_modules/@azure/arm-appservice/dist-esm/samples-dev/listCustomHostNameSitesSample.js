...
function getCustomHostnamesUnderSubscription() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.listCustomHostNameSites()), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
 ...
 */
function getSpecificCustomHostnameUnderSubscription() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPSERVICE_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        ...
        const resArray = new Array();
        try {
            for (var _d = true, _e = __asyncValues(client.listCustomHostNameSites(options)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
