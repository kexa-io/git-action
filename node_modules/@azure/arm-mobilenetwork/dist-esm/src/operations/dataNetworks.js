...
export class DataNetworksImpl {
    ...
    listByMobileNetworkPagingPage(resourceGroupName, mobileNetworkName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByMobileNetworkPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByMobileNetwork(resourceGroupName, mobileNetworkName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByMobileNetworkNext(resourceGroupName, mobileNetworkName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByMobileNetworkPagingAll(resourceGroupName, mobileNetworkName, options) {
        return __asyncGenerator(this, arguments, function* listByMobileNetworkPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByMobileNetworkPagingPage(resourceGroupName, mobileNetworkName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    get(resourceGroupName, mobileNetworkName, dataNetworkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, mobileNetworkName, dataNetworkName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=dataNetworks.js.map