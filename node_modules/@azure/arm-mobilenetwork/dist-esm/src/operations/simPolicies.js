...
export class SimPoliciesImpl {
    ...
    get(resourceGroupName, mobileNetworkName, simPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, mobileNetworkName, simPolicyName, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=simPolicies.js.map