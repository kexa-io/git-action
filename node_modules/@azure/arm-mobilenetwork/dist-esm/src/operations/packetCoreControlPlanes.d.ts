...
import { PacketCoreControlPlane, PacketCoreControlPlanesListBySubscriptionOptionalParams, PacketCoreControlPlanesListByResourceGroupOptionalParams, PacketCoreControlPlanesDeleteOptionalParams, PacketCoreControlPlanesGetOptionalParams, PacketCoreControlPlanesGetResponse, PacketCoreControlPlanesCreateOrUpdateOptionalParams, PacketCoreControlPlanesCreateOrUpdateResponse, IdentityAndTagsObject, PacketCoreControlPlanesUpdateTagsOptionalParams, PacketCoreControlPlanesUpdateTagsResponse, PacketCoreControlPlanesRollbackOptionalParams, PacketCoreControlPlanesRollbackResponse, PacketCoreControlPlanesReinstallOptionalParams, PacketCoreControlPlanesReinstallResponse, PacketCoreControlPlaneCollectDiagnosticsPackage, PacketCoreControlPlanesCollectDiagnosticsPackageOptionalParams, PacketCoreControlPlanesCollectDiagnosticsPackageResponse } from "../models";
/** Class containing PacketCoreControlPlanes operations. */
export declare class PacketCoreControlPlanesImpl implements PacketCoreControlPlanes {
...
//# sourceMappingURL=packetCoreControlPlanes.d.ts.map