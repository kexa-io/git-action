...
export class DiagnosticsPackagesImpl {
    /**
    ...
    listByPacketCoreControlPlanePagingPage(resourceGroupName, packetCoreControlPlaneName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByPacketCoreControlPlanePagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByPacketCoreControlPlane(resourceGroupName, packetCoreControlPlaneName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByPacketCoreControlPlaneNext(resourceGroupName, packetCoreControlPlaneName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByPacketCoreControlPlanePagingAll(resourceGroupName, packetCoreControlPlaneName, options) {
        return __asyncGenerator(this, arguments, function* listByPacketCoreControlPlanePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByPacketCoreControlPlanePagingPage(resourceGroupName, packetCoreControlPlaneName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
...
//# sourceMappingURL=diagnosticsPackages.js.map