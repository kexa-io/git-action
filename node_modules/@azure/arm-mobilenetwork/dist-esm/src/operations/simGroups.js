...
export class SimGroupsImpl {
    ...
    get(resourceGroupName, simGroupName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, simGroupName, options }, getOperationSpec);
    }
    /**
    ...
    updateTags(resourceGroupName, simGroupName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, simGroupName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Gets all the SIM groups in a subscription.
     * @param options The options parameters.
...
//# sourceMappingURL=simGroups.js.map