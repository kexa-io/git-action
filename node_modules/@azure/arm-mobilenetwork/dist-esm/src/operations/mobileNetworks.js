...
export class MobileNetworksImpl {
    /**
    ...
    get(resourceGroupName, mobileNetworkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, mobileNetworkName, options }, getOperationSpec);
    }
    /**
    ...
    updateTags(resourceGroupName, mobileNetworkName, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, mobileNetworkName, parameters, options }, updateTagsOperationSpec);
    }
    /**
     * Lists all the mobile networks in a subscription.
     * @param options The options parameters.
...
//# sourceMappingURL=mobileNetworks.js.map