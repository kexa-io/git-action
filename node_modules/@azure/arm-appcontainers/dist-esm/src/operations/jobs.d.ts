...
import { Job, JobsListBySubscriptionOptionalParams, JobsListByResourceGroupOptionalParams, JobsGetOptionalParams, JobsGetResponse, JobsCreateOrUpdateOptionalParams, JobsCreateOrUpdateResponse, JobsDeleteOptionalParams, JobPatchProperties, JobsUpdateOptionalParams, JobsUpdateResponse, JobsStartOptionalParams, JobsStartResponse, JobsStopExecutionOptionalParams, JobsStopMultipleExecutionsOptionalParams, JobsStopMultipleExecutionsResponse, JobsListSecretsOptionalParams, JobsListSecretsResponse } from "../models";
