 ...
 */
function getTheListOfAvailableDiagnosticDataForAManagedEnvironments() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPCONTAINERS_SUBSCRIPTION_ID"] ||
            "f07f3711-b45e-40fe-a941-4e6d93f851e6";
        const resourceGroupName = process.env["APPCONTAINERS_RESOURCE_GROUP"] || "mikono-workerapp-test-rg";
        const environmentName = "mikonokubeenv";
        const credential = new DefaultAzureCredential();
        const client = new ContainerAppsAPIClient(credential, subscriptionId);
        const result = yield client.managedEnvironmentDiagnostics.listDetectors(resourceGroupName, environmentName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=managedEnvironmentDiagnosticsListDetectorsSample.js.map