 ...
 */
function createOrUpdateContainerAppsJob() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.jobs.beginCreateOrUpdateAndWait(resourceGroupName, jobName, jobEnvelope);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateContainerAppsJobWithEventDrivenTrigger() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APPCONTAINERS_SUBSCRIPTION_ID"] ||
            "34adfa4f-cedf-4dc0-ba29-b6d1a69ab345";
        const resourceGroupName = process.env["APPCONTAINERS_RESOURCE_GROUP"] || "rg";
