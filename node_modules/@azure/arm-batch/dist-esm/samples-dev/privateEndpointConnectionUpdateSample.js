...
function updatePrivateEndpointConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const privateEndpointConnectionName = "testprivateEndpointConnection5.24d6b4b5-e65c-4330-bbe9-3a290d62f8e0";
        const parameters = {
        ...
        const result = yield client.privateEndpointConnectionOperations.beginUpdateAndWait(resourceGroupName, accountName, privateEndpointConnectionName, parameters);
        console.log(result);
    });
}
function main() {
