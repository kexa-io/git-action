...
function listCertificates() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.certificateOperations.listByBatchAccount(resourceGroupName, accountName)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
...
function listCertificatesFilterAndSelect() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resArray = new Array();
        try {
            for (var _d = true, _e = __asyncValues(client.certificateOperations.listByBatchAccount(resourceGroupName, accountName, options)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                _c = _f.value;
                _d = false;
                let item = _c;
                resArray.push(item);
