 ...
 */
function getsTheIntegrationServiceEnvironmentManagedApis() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["LOGIC_SUBSCRIPTION_ID"] ||
        ...
        try {
            for (var _b = __asyncValues(client.integrationServiceEnvironmentManagedApiOperations.list(resourceGroup, integrationServiceEnvironmentName, apiName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=integrationServiceEnvironmentManagedApiOperationsListSample.js.map