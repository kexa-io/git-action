...
function getARepetitionRequestHistory() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.workflowRunActionRepetitionsRequestHistories.get(resourceGroupName, workflowName, runName, actionName, repetitionName, requestHistoryName);
        console.log(result);
    });
}
function main() {
