...
export class IntegrationAccountsImpl {
    /**
    ...
    listKeyVaultKeysPagingPage(resourceGroupName, integrationAccountName, listKeyVaultKeys, options, _settings) {
        return __asyncGenerator(this, arguments, function* listKeyVaultKeysPagingPage_1() {
            let result;
            result = yield __await(this._listKeyVaultKeys(resourceGroupName, integrationAccountName, listKeyVaultKeys, options));
            yield yield __await(result.value || []);
        });
    }
    listKeyVaultKeysPagingAll(resourceGroupName, integrationAccountName, listKeyVaultKeys, options) {
        return __asyncGenerator(this, arguments, function* listKeyVaultKeysPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listKeyVaultKeysPagingPage(resourceGroupName, integrationAccountName, listKeyVaultKeys, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
