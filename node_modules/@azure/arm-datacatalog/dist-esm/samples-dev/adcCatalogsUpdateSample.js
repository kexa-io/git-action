 ...
 */
function updateAzureDataCatalogService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.aDCCatalogs.update(resourceGroupName, catalogName, properties);
        console.log(result);
    });
}
updateAzureDataCatalogService().catch(console.error);
//# sourceMappingURL=adcCatalogsUpdateSample.js.map