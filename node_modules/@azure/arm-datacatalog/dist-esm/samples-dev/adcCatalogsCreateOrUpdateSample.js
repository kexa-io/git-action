 ...
 */
function createAzureDataCatalogService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.aDCCatalogs.createOrUpdate(resourceGroupName, catalogName, properties);
        console.log(result);
    });
}
createAzureDataCatalogService().catch(console.error);
//# sourceMappingURL=adcCatalogsCreateOrUpdateSample.js.map