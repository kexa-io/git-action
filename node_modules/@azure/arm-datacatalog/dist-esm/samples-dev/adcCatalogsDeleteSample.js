 ...
 */
function deleteAzureDataCatalogService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.aDCCatalogs.beginDeleteAndWait(resourceGroupName, catalogName);
        console.log(result);
    });
}
deleteAzureDataCatalogService().catch(console.error);
//# sourceMappingURL=adcCatalogsDeleteSample.js.map