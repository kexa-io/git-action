...
import { QueryPacks, Queries, DataExports, DataSources, IntelligencePacks, LinkedServices, LinkedStorageAccounts, ManagementGroups, OperationStatuses, SharedKeysOperations, Usages, StorageInsightConfigs, SavedSearches, AvailableServiceTiers, Gateways, SchemaOperations, WorkspacePurge, Clusters, Operations, Workspaces, DeletedWorkspaces, Tables } from "./operationsInterfaces";
