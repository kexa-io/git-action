 ...
 */
function queryPackCreateNoName() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["OPERATIONALINSIGHTS_SUBSCRIPTION_ID"] ||
            "86dc51d3-92ed-4d7e-947a-775ea79b4919";
        const resourceGroupName = process.env["OPERATIONALINSIGHTS_RESOURCE_GROUP"] || "my-resource-group";
        const logAnalyticsQueryPackPayload = {
            location: "South Central US"
        };
        const credential = new DefaultAzureCredential();
        const client = new OperationalInsightsManagementClient(credential, subscriptionId);
        const result = yield client.queryPacks.createOrUpdateWithoutName(resourceGroupName, logAnalyticsQueryPackPayload);
        console.log(result);
    });
}
/**
 ...
 */
function queryPackUpdateNoName() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["OPERATIONALINSIGHTS_SUBSCRIPTION_ID"] ||
            "86dc51d3-92ed-4d7e-947a-775ea79b4919";
        const resourceGroupName = process.env["OPERATIONALINSIGHTS_RESOURCE_GROUP"] || "my-resource-group";
...
//# sourceMappingURL=queryPacksCreateOrUpdateWithoutNameSample.js.map