...
function workspacePurge() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.workspacePurge.purge(resourceGroupName, workspaceName, body);
        console.log(result);
    });
}
/**
 ...
 */
function workspacePurgeResourceId() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["OPERATIONALINSIGHTS_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-00000000000";
        const resourceGroupName = process.env["OPERATIONALINSIGHTS_RESOURCE_GROUP"] || "OIAutoRest5123";
...
//# sourceMappingURL=workspacePurgeSample.js.map