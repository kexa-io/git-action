...
export class ConfigurationPolicyGroupsImpl {
    ...
    listByVpnServerConfigurationPagingAll(resourceGroupName, vpnServerConfigurationName, options) {
        return __asyncGenerator(this, arguments, function* listByVpnServerConfigurationPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByVpnServerConfigurationPagingPage(resourceGroupName, vpnServerConfigurationName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
