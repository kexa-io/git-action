 ...
 */
function singleSignOnConfigurationsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["DATADOG_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.singleSignOnConfigurations.beginCreateOrUpdateAndWait(resourceGroupName, monitorName, configurationName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=singleSignOnConfigurationsCreateOrUpdateSample.js.map