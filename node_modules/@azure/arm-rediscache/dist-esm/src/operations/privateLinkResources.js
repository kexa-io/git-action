...
export class PrivateLinkResourcesImpl {
    ...
    listByRedisCachePagingPage(resourceGroupName, cacheName, options, _settings) {
        return __asyncGenerator(this, arguments, function* listByRedisCachePagingPage_1() {
            let result;
            result = yield __await(this._listByRedisCache(resourceGroupName, cacheName, options));
    ...
    listByRedisCachePagingAll(resourceGroupName, cacheName, options) {
        return __asyncGenerator(this, arguments, function* listByRedisCachePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByRedisCachePagingPage(resourceGroupName, cacheName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
