...
export class AccessPolicyImpl {
    ...
    listPagingPage(resourceGroupName, cacheName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, cacheName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, cacheName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, cacheName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listPagingPage(resourceGroupName, cacheName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    get(resourceGroupName, cacheName, accessPolicyName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, cacheName, accessPolicyName, options }, getOperationSpec);
    }
    /**
     * Gets the list of access policies associated with this redis cache
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
