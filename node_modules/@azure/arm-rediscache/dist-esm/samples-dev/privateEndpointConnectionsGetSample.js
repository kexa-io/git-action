 ...
 */
function redisCacheGetPrivateEndpointConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.get(resourceGroupName, cacheName, privateEndpointConnectionName);
        console.log(result);
    });
}
function main() {
