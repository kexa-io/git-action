 ...
 */
function createOrUpdateAPolicySetDefinitionAtManagementGroupLevel() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.policySetDefinitions.createOrUpdateAtManagementGroup(policySetDefinitionName, managementGroupId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateAPolicySetDefinitionWithGroupsAtManagementGroupLevel() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POLICY_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const policySetDefinitionName = "CostManagement";
...
//# sourceMappingURL=policySetDefinitionsCreateOrUpdateAtManagementGroupSample.js.map