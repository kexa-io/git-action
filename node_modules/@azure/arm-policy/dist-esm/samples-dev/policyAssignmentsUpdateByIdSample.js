 ...
 */
function updatePolicyAssignmentWithAManagedIdentityById() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POLICY_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const policyAssignmentId = "providers/Microsoft.Management/managementGroups/MyManagementGroup/providers/Microsoft.Authorization/policyAssignments/LowCostStorage";
        const parameters = {
        ...
        const result = yield client.policyAssignments.updateById(policyAssignmentId, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=policyAssignmentsUpdateByIdSample.js.map