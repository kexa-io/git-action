...
describe("Databricks test", () => {
    ...
    it("workspaces update test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield client.workspaces.beginUpdateAndWait(resourceGroup, workSpaceName, { tags: { mytag1: "value1" } }, testPollingOptions);
            assert.equal(res.type, "Microsoft.Databricks/workspaces");
        });
    });
    it("workspaces delete test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield client.workspaces.beginDeleteAndWait(resourceGroup, workSpaceName, testPollingOptions);
        });
    });
});
//# sourceMappingURL=databricks_examples.js.map