...
export class VirtualNetworksImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, virtualNetworkName, body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualNetworkName, body, options }, createOrUpdateOperationSpec);
    ...
    beginUpdate(resourceGroupName, virtualNetworkName, body, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, virtualNetworkName, body, options }, updateOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs,
                lroResourceLocationConfig: "azure-async-operation"
