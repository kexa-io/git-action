 ...
 */
function loadTestsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.loadTests.createOrUpdate(resourceGroupName, loadTestName, loadTestResource);
        console.log(result);
    });
}
loadTestsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=loadTestsCreateOrUpdateSample.js.map