 ...
 */
function createADatabaseAsAGeoRestoreInGeoPairedLocation() {
 ...
 */
function createANewServerWithActiveDirectoryAuthenticationEnabled() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POSTGRESQL_SUBSCRIPTION_ID"] ||
            "ffffffff-ffff-ffff-ffff-ffffffffffff";
        const resourceGroupName = process.env["POSTGRESQL_RESOURCE_GROUP"] || "testrg";
 ...
 */
function serverCreateWithDataEncryptionEnabled() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["POSTGRESQL_SUBSCRIPTION_ID"] ||
            "ffffffff-ffff-ffff-ffff-ffffffffffff";
        const resourceGroupName = process.env["POSTGRESQL_RESOURCE_GROUP"] || "testrg";
