...
export class ClustersImpl {
    ...
    listStreamingJobsPagingPage(resourceGroupName, clusterName, options, settings) {
        return __asyncGenerator(this, arguments, function* listStreamingJobsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listStreamingJobs(resourceGroupName, clusterName, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listStreamingJobsNext(resourceGroupName, clusterName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listStreamingJobsPagingAll(resourceGroupName, clusterName, options) {
        return __asyncGenerator(this, arguments, function* listStreamingJobsPagingAll_1() {
            var e_3, _a;
            try {
                for (var _b = __asyncValues(this.listStreamingJobsPagingPage(resourceGroupName, clusterName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    beginCreateOrUpdate(resourceGroupName, clusterName, cluster, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, clusterName, cluster, options }, createOrUpdateOperationSpec);
