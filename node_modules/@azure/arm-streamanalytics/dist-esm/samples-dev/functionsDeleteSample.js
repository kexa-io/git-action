...
function deleteAFunction() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.functions.delete(resourceGroupName, jobName, functionName);
        console.log(result);
    });
}
deleteAFunction().catch(console.error);
//# sourceMappingURL=functionsDeleteSample.js.map