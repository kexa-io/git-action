 ...
 */
function listSubscriptionQuotaInformationInWestUs() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "56b5e0a9-b645-407d-99b0-c64f86013e3d";
        const location = "West US";
        const credential = new DefaultAzureCredential();
        const client = new StreamAnalyticsManagementClient(credential, subscriptionId);
        const result = yield client.subscriptions.listQuotas(location);
        console.log(result);
    });
}
listSubscriptionQuotaInformationInWestUs().catch(console.error);
//# sourceMappingURL=subscriptionsListQuotasSample.js.map