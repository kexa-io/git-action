 ...
 */
function testTheConnectionForAnInput() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.inputs.beginTestAndWait(resourceGroupName, jobName, inputName);
        console.log(result);
    });
}
testTheConnectionForAnInput().catch(console.error);
//# sourceMappingURL=inputsTestSample.js.map