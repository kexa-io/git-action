...
function stopAStreamingJob() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.streamingJobs.beginStopAndWait(resourceGroupName, jobName);
        console.log(result);
    });
}
stopAStreamingJob().catch(console.error);
//# sourceMappingURL=streamingJobsStopSample.js.map