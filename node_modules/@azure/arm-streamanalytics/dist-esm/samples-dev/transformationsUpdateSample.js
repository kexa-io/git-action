 ...
 */
function updateATransformation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.transformations.update(resourceGroupName, jobName, transformationName, transformation);
        console.log(result);
    });
}
updateATransformation().catch(console.error);
//# sourceMappingURL=transformationsUpdateSample.js.map