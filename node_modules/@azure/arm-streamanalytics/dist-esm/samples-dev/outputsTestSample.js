 ...
 */
function testTheConnectionForAnOutput() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.outputs.beginTestAndWait(resourceGroupName, jobName, outputName);
        console.log(result);
    });
}
testTheConnectionForAnOutput().catch(console.error);
//# sourceMappingURL=outputsTestSample.js.map