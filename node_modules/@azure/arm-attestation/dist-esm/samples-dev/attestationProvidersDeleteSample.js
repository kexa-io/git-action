 ...
 */
function attestationProvidersDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.attestationProviders.delete(resourceGroupName, providerName);
        console.log(result);
    });
}
attestationProvidersDelete().catch(console.error);
//# sourceMappingURL=attestationProvidersDeleteSample.js.map