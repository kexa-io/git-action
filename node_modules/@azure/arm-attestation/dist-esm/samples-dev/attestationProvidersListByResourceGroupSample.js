 ...
 */
function attestationProvidersListByResourceGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.attestationProviders.listByResourceGroup(resourceGroupName);
        console.log(result);
    });
}
attestationProvidersListByResourceGroup().catch(console.error);
//# sourceMappingURL=attestationProvidersListByResourceGroupSample.js.map