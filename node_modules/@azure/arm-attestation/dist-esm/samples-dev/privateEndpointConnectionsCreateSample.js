 ...
 */
function attestationProviderPutPrivateEndpointConnection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.create(resourceGroupName, providerName, privateEndpointConnectionName, properties);
        console.log(result);
    });
}
