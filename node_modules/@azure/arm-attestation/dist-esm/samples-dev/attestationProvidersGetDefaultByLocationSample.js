 ...
 */
function attestationProvidersGetDefaultWithLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.attestationProviders.getDefaultByLocation(location);
        console.log(result);
    });
}
attestationProvidersGetDefaultWithLocation().catch(console.error);
//# sourceMappingURL=attestationProvidersGetDefaultByLocationSample.js.map