 ...
 */
function attestationProvidersUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.attestationProviders.update(resourceGroupName, providerName, updateParams);
        console.log(result);
    });
}
attestationProvidersUpdate().catch(console.error);
//# sourceMappingURL=attestationProvidersUpdateSample.js.map