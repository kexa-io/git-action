...
function getConfiguration() {
    return __awaiter(this, void 0, void 0, function* () {
        const resourceUri = "subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/test-rg/providers/Microsoft.Web/sites/test-app";
        const linkerName = "linkName";
        const credential = new DefaultAzureCredential();
        const client = new ServiceLinkerManagementClient(credential);
        const result = yield client.linker.listConfigurations(resourceUri, linkerName);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=linkerListConfigurationsSample.js.map