...
export class SandboxCustomImagesImpl {
    /**
    ...
    get(resourceGroupName, clusterName, sandboxCustomImageName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, clusterName, sandboxCustomImageName, options }, getOperationSpec);
    }
    /**
    ...
    checkNameAvailability(resourceGroupName, clusterName, resourceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, clusterName, resourceName, options }, checkNameAvailabilityOperationSpec);
    }
}
...
//# sourceMappingURL=sandboxCustomImages.js.map