 ...
 */
function managedPrivateEndpointsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedPrivateEndpoints.beginDeleteAndWait(resourceGroupName, clusterName, managedPrivateEndpointName);
        console.log(result);
    });
}
function main() {
