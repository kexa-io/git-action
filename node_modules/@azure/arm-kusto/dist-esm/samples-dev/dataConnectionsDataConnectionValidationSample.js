 ...
 */
function kustoDataConnectionEventGridValidation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dataConnections.beginDataConnectionValidationAndWait(resourceGroupName, clusterName, databaseName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function kustoDataConnectionValidation() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["KUSTO_SUBSCRIPTION_ID"] ||
            "12345678-1234-1234-1234-123456789098";
        const resourceGroupName = process.env["KUSTO_RESOURCE_GROUP"] || "kustorptest";
...
//# sourceMappingURL=dataConnectionsDataConnectionValidationSample.js.map