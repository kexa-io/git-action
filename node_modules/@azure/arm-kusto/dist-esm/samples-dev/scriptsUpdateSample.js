...
function kustoScriptsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.scripts.beginUpdateAndWait(resourceGroupName, clusterName, databaseName, scriptName, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=scriptsUpdateSample.js.map