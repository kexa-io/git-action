 ...
 */
function kustoManagedPrivateEndpointsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managedPrivateEndpoints.beginUpdateAndWait(resourceGroupName, clusterName, managedPrivateEndpointName, parameters);
        console.log(result);
    });
}
function main() {
