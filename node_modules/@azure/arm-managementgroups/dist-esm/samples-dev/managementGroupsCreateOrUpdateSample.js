...
function putManagementGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managementGroups.beginCreateOrUpdateAndWait(groupId, createManagementGroupRequest, options);
        console.log(result);
    });
}
putManagementGroup().catch(console.error);
//# sourceMappingURL=managementGroupsCreateOrUpdateSample.js.map