 ...
 */
function getSubscriptionFromManagementGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managementGroupSubscriptions.getSubscription(groupId, subscriptionId, options);
        console.log(result);
    });
}
getSubscriptionFromManagementGroup().catch(console.error);
//# sourceMappingURL=managementGroupSubscriptionsGetSubscriptionSample.js.map