 ...
 */
function deleteSubscriptionFromManagementGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.managementGroupSubscriptions.delete(groupId, subscriptionId, options);
        console.log(result);
    });
}
deleteSubscriptionFromManagementGroup().catch(console.error);
//# sourceMappingURL=managementGroupSubscriptionsDeleteSample.js.map