 ...
 */
function getADigitalTwinsInstanceEndpoints() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.digitalTwinsEndpoint.list(resourceGroupName, resourceName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function getADigitalTwinsInstanceEndpointsWithIdentity() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["DIGITALTWINS_SUBSCRIPTION_ID"] ||
            "50016170-c839-41ba-a724-51e9df440b9e";
...
//# sourceMappingURL=digitalTwinsEndpointListSample.js.map