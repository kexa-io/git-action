 ...
 */
function deleteADigitalTwinsInstanceResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.digitalTwins.beginDeleteAndWait(resourceGroupName, resourceName);
        console.log(result);
    });
}
/**
 ...
 */
function deleteADigitalTwinsInstanceResourceWithIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["DIGITALTWINS_SUBSCRIPTION_ID"] ||
            "50016170-c839-41ba-a724-51e9df440b9e";
        const resourceGroupName = process.env["DIGITALTWINS_RESOURCE_GROUP"] || "resRg";
...
//# sourceMappingURL=digitalTwinsDeleteSample.js.map