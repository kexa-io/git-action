 ...
 */
function elevateAccessGlobalAdministrator() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["AUTHORIZATION_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const credential = new DefaultAzureCredential();
        const client = new AuthorizationManagementClient(credential, subscriptionId);
        const result = yield client.globalAdministrator.elevateAccess();
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=globalAdministratorElevateAccessSample.js.map