 ...
 */
function getRoleAssignmentScheduleInstancesByScope() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["AUTHORIZATION_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const scope = "providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f";
        ...
        try {
            for (var _b = __asyncValues(client.roleAssignmentScheduleInstances.listForScope(scope, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=roleAssignmentScheduleInstancesListForScopeSample.js.map