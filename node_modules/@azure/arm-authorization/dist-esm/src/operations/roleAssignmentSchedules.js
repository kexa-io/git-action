...
export class RoleAssignmentSchedulesImpl {
    /**
    ...
    get(scope, roleAssignmentScheduleName, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleName, options }, getOperationSpec);
    }
    /**
     * Gets role assignment schedules for a resource scope.
     * @param scope The scope of the role assignments schedules.
...
//# sourceMappingURL=roleAssignmentSchedules.js.map