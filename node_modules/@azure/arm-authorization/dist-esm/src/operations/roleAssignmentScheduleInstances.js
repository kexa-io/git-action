...
export class RoleAssignmentScheduleInstancesImpl {
    ...
    get(scope, roleAssignmentScheduleInstanceName, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleInstanceName, options }, getOperationSpec);
    }
    /**
     * ListForScopeNext
     * @param scope The scope of the role assignment schedule.
...
//# sourceMappingURL=roleAssignmentScheduleInstances.js.map