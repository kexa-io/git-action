...
export class RoleAssignmentScheduleRequestsImpl {
    ...
    create(scope, roleAssignmentScheduleRequestName, parameters, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleRequestName, parameters, options }, createOperationSpec);
    }
    /**
    ...
    get(scope, roleAssignmentScheduleRequestName, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleRequestName, options }, getOperationSpec);
    }
    /**
     * Gets role assignment schedule requests for a scope.
     * @param scope The scope of the role assignments schedule requests.
    ...
    cancel(scope, roleAssignmentScheduleRequestName, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleRequestName, options }, cancelOperationSpec);
    }
    /**
    ...
    validate(scope, roleAssignmentScheduleRequestName, parameters, options) {
        return this.client.sendOperationRequest({ scope, roleAssignmentScheduleRequestName, parameters, options }, validateOperationSpec);
    }
    /**
     * ListForScopeNext
     * @param scope The scope of the role assignments schedule requests.
...
//# sourceMappingURL=roleAssignmentScheduleRequests.js.map