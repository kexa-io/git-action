...
export class RoleEligibilitySchedulesImpl {
    /**
    ...
    get(scope, roleEligibilityScheduleName, options) {
        return this.client.sendOperationRequest({ scope, roleEligibilityScheduleName, options }, getOperationSpec);
    }
    /**
     * Gets role eligibility schedules for a resource scope.
     * @param scope The scope of the role eligibility schedules.
...
//# sourceMappingURL=roleEligibilitySchedules.js.map