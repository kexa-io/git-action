...
function listWebCommunicationCreatedOnOrAfterASpecificDateForASubscriptionSupportTicket() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.communications.list(supportTicketName, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=communicationsListSample.js.map