...
import { SBNamespace, NamespacesListOptionalParams, NamespacesListByResourceGroupOptionalParams, NetworkRuleSet, NamespacesListNetworkRuleSetsOptionalParams, SBAuthorizationRule, NamespacesListAuthorizationRulesOptionalParams, NamespacesCreateOrUpdateOptionalParams, NamespacesCreateOrUpdateResponse, NamespacesDeleteOptionalParams, NamespacesGetOptionalParams, NamespacesGetResponse, SBNamespaceUpdateParameters, NamespacesUpdateOptionalParams, NamespacesUpdateResponse, NamespacesCreateOrUpdateNetworkRuleSetOptionalParams, NamespacesCreateOrUpdateNetworkRuleSetResponse, NamespacesGetNetworkRuleSetOptionalParams, NamespacesGetNetworkRuleSetResponse, NamespacesCreateOrUpdateAuthorizationRuleOptionalParams, NamespacesCreateOrUpdateAuthorizationRuleResponse, NamespacesDeleteAuthorizationRuleOptionalParams, NamespacesGetAuthorizationRuleOptionalParams, NamespacesGetAuthorizationRuleResponse, NamespacesListKeysOptionalParams, NamespacesListKeysResponse, RegenerateAccessKeyParameters, NamespacesRegenerateKeysOptionalParams, NamespacesRegenerateKeysResponse, CheckNameAvailability, NamespacesCheckNameAvailabilityOptionalParams, NamespacesCheckNameAvailabilityResponse } from "../models";
...
export declare class NamespacesImpl implements Namespaces {
    ...
    private listNetworkRuleSetsPagingPage;
    private listNetworkRuleSetsPagingAll;
    /**
