...
function sbAliasFailOver() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.disasterRecoveryConfigs.failOver(resourceGroupName, namespaceName, alias);
        console.log(result);
    });
}
sbAliasFailOver().catch(console.error);
//# sourceMappingURL=disasterRecoveryConfigsFailOverSample.js.map