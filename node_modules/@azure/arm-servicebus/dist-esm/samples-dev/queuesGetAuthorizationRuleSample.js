 ...
 */
function queueAuthorizationRuleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.queues.getAuthorizationRule(resourceGroupName, namespaceName, queueName, authorizationRuleName);
        console.log(result);
    });
}
queueAuthorizationRuleGet().catch(console.error);
//# sourceMappingURL=queuesGetAuthorizationRuleSample.js.map