 ...
 */
function topicAuthorizationRuleCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.topics.createOrUpdateAuthorizationRule(resourceGroupName, namespaceName, topicName, authorizationRuleName, parameters);
        console.log(result);
    });
}
topicAuthorizationRuleCreate().catch(console.error);
//# sourceMappingURL=topicsCreateOrUpdateAuthorizationRuleSample.js.map