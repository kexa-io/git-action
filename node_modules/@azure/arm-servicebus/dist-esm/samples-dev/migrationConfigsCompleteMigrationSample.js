 ...
 */
function migrationConfigurationsCompleteMigration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.migrationConfigs.completeMigration(resourceGroupName, namespaceName, configName);
        console.log(result);
    });
}
migrationConfigurationsCompleteMigration().catch(console.error);
//# sourceMappingURL=migrationConfigsCompleteMigrationSample.js.map