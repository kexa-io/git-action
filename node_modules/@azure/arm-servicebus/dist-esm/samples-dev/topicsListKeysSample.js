 ...
 */
function topicAuthorizationRuleListKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.topics.listKeys(resourceGroupName, namespaceName, topicName, authorizationRuleName);
        console.log(result);
    });
}
topicAuthorizationRuleListKey().catch(console.error);
//# sourceMappingURL=topicsListKeysSample.js.map