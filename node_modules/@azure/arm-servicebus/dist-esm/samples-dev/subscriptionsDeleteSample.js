...
function subscriptionDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.subscriptions.delete(resourceGroupName, namespaceName, topicName, subscriptionName);
        console.log(result);
    });
}
subscriptionDelete().catch(console.error);
//# sourceMappingURL=subscriptionsDeleteSample.js.map