 ...
 */
function queueAuthorizationRuleDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.queues.deleteAuthorizationRule(resourceGroupName, namespaceName, queueName, authorizationRuleName);
        console.log(result);
    });
}
queueAuthorizationRuleDelete().catch(console.error);
//# sourceMappingURL=queuesDeleteAuthorizationRuleSample.js.map