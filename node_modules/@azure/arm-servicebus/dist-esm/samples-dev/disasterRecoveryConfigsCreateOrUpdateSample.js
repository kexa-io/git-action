...
function sbAliasCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.disasterRecoveryConfigs.createOrUpdate(resourceGroupName, namespaceName, alias, parameters);
        console.log(result);
    });
}
sbAliasCreate().catch(console.error);
//# sourceMappingURL=disasterRecoveryConfigsCreateOrUpdateSample.js.map