...
function subscriptionCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.subscriptions.createOrUpdate(resourceGroupName, namespaceName, topicName, subscriptionName, parameters);
        console.log(result);
    });
}
subscriptionCreate().catch(console.error);
//# sourceMappingURL=subscriptionsCreateOrUpdateSample.js.map