 ...
 */
function topicAuthorizationRuleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.topics.getAuthorizationRule(resourceGroupName, namespaceName, topicName, authorizationRuleName);
        console.log(result);
    });
}
topicAuthorizationRuleGet().catch(console.error);
//# sourceMappingURL=topicsGetAuthorizationRuleSample.js.map