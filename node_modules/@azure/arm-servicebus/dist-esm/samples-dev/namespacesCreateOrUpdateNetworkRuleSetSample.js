 ...
 */
function nameSpaceNetworkRuleSetCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namespaces.createOrUpdateNetworkRuleSet(resourceGroupName, namespaceName, parameters);
        console.log(result);
    });
}
nameSpaceNetworkRuleSetCreate().catch(console.error);
//# sourceMappingURL=namespacesCreateOrUpdateNetworkRuleSetSample.js.map