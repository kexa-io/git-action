...
function sbAliasDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.disasterRecoveryConfigs.delete(resourceGroupName, namespaceName, alias);
        console.log(result);
    });
}
sbAliasDelete().catch(console.error);
//# sourceMappingURL=disasterRecoveryConfigsDeleteSample.js.map