 ...
 */
function migrationConfigurationsRevert() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.migrationConfigs.revert(resourceGroupName, namespaceName, configName);
        console.log(result);
    });
}
migrationConfigurationsRevert().catch(console.error);
//# sourceMappingURL=migrationConfigsRevertSample.js.map