 ...
 */
function signalRSharedPrivateLinkResourcesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SIGNALR_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.signalRSharedPrivateLinkResources.beginCreateOrUpdateAndWait(sharedPrivateLinkResourceName, resourceGroupName, resourceName, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=signalRSharedPrivateLinkResourcesCreateOrUpdateSample.js.map