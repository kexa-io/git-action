    ...
    ***************************************************************************** */
    ...
    var beginCreateOperationSpec = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, WorkspaceCreateParameters), { required: true })
        },
        responses: {
            200: {
                bodyMapper: Workspace
    ...
    var beginCreateOperationSpec$3 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, FileServerCreateParameters), { required: true })
        },
        responses: {
            200: {
                bodyMapper: FileServer
    ...
    var updateOperationSpec$1 = {
        ...
        requestBody: {
            ...
            mapper: __assign(__assign({}, ClusterUpdateParameters), { required: true })
        },
        responses: {
            200: {
                bodyMapper: Cluster
    ...
    var beginCreateOperationSpec$4 = {
        ...
        requestBody: {
            parameterPath: "parameters",
            mapper: __assign(__assign({}, ClusterCreateParameters), { required: true })
        },
        responses: {
            200: {
                bodyMapper: Cluster
