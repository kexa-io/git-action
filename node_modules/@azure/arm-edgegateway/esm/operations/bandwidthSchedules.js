...
var BandwidthSchedules = /** @class */ (function () {
    ...
    BandwidthSchedules.prototype.listByDataBoxEdgeDevice = function (deviceName, resourceGroupName, options, callback) {
    ...
    BandwidthSchedules.prototype.get = function (deviceName, name, resourceGroupName, options, callback) {
        return this.client.sendOperationRequest({
            deviceName: deviceName,
            name: name,
            resourceGroupName: resourceGroupName,
     ...
     */
    BandwidthSchedules.prototype.createOrUpdate = function (deviceName, name, parameters, resourceGroupName, options) {
     ...
     */
    BandwidthSchedules.prototype.deleteMethod = function (deviceName, name, resourceGroupName, options) {
     ...
     */
    BandwidthSchedules.prototype.beginCreateOrUpdate = function (deviceName, name, parameters, resourceGroupName, options) {
     ...
     * @returns Promise<msRestAzure.LROPoller>
     */
    BandwidthSchedules.prototype.beginDeleteMethod = function (deviceName, name, resourceGroupName, options) {
        return this.client.sendLRORequest({
            deviceName: deviceName,
            name: name,
            resourceGroupName: resourceGroupName,
    ...
    BandwidthSchedules.prototype.listByDataBoxEdgeDeviceNext = function (nextPageLink, options, callback) {
        return this.client.sendOperationRequest({
...
var beginCreateOrUpdateOperationSpec = {
    ...
    requestBody: {
        ...
        mapper: __assign(__assign({}, Mappers.BandwidthSchedule), { required: true })
    },
    responses: {
        200: {
            bodyMapper: Mappers.BandwidthSchedule
...
//# sourceMappingURL=bandwidthSchedules.js.map