 ...
 * @enum {string}
 */
export declare type SkuName = 'Gateway' | 'Edge';
/**
 ...
 * @enum {string}
 */
export declare type DataBoxEdgeDeviceStatus = 'ReadyToSetup' | 'Online' | 'Offline' | 'NeedsAttention' | 'Disconnected' | 'PartiallyDisconnected';
/**
 ...
 * @enum {string}
 */
export declare type JobType = 'Invalid' | 'ScanForUpdates' | 'DownloadUpdates' | 'InstallUpdates' | 'RefreshShare';
/**
