...
export class VirtualMachineSchedulesImpl {
    ...
    listPagingPage(resourceGroupName, labName, virtualMachineName, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, labName, virtualMachineName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, labName, virtualMachineName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, labName, virtualMachineName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, labName, virtualMachineName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
