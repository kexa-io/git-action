...
import { Lab, LabsListBySubscriptionOptionalParams, LabsListByResourceGroupOptionalParams, LabVhd, LabsListVhdsOptionalParams, LabsGetOptionalParams, LabsGetResponse, LabsCreateOrUpdateOptionalParams, LabsCreateOrUpdateResponse, LabsDeleteOptionalParams, LabFragment, LabsUpdateOptionalParams, LabsUpdateResponse, LabsClaimAnyVmOptionalParams, LabVirtualMachineCreationParameter, LabsCreateEnvironmentOptionalParams, ExportResourceUsageParameters, LabsExportResourceUsageOptionalParams, GenerateUploadUriParameter, LabsGenerateUploadUriOptionalParams, LabsGenerateUploadUriResponse, ImportLabVirtualMachineRequest, LabsImportVirtualMachineOptionalParams } from "../models";
