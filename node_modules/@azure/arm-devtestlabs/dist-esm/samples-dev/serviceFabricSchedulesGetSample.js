 ...
 */
function serviceFabricSchedulesGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabricSchedules.get(resourceGroupName, labName, userName, serviceFabricName, name);
        console.log(result);
    });
}
serviceFabricSchedulesGet().catch(console.error);
//# sourceMappingURL=serviceFabricSchedulesGetSample.js.map