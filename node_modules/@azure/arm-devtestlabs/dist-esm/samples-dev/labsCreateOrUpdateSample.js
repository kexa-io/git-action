...
function labsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.labs.beginCreateOrUpdateAndWait(resourceGroupName, name, lab);
        console.log(result);
    });
}
labsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=labsCreateOrUpdateSample.js.map