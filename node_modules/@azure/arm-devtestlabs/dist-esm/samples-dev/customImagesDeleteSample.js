...
function customImagesDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customImages.beginDeleteAndWait(resourceGroupName, labName, name);
        console.log(result);
    });
}
customImagesDelete().catch(console.error);
//# sourceMappingURL=customImagesDeleteSample.js.map