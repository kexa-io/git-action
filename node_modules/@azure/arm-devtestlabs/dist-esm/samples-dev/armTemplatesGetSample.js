...
function armTemplatesGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.armTemplates.get(resourceGroupName, labName, artifactSourceName, name);
        console.log(result);
    });
}
armTemplatesGet().catch(console.error);
//# sourceMappingURL=armTemplatesGetSample.js.map