 ...
 */
function formulasCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.formulas.beginCreateOrUpdateAndWait(resourceGroupName, labName, name, formula);
        console.log(result);
    });
}
formulasCreateOrUpdate().catch(console.error);
//# sourceMappingURL=formulasCreateOrUpdateSample.js.map