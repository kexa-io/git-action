 ...
 */
function notificationChannelsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationChannels.get(resourceGroupName, labName, name);
        console.log(result);
    });
}
notificationChannelsGet().catch(console.error);
//# sourceMappingURL=notificationChannelsGetSample.js.map