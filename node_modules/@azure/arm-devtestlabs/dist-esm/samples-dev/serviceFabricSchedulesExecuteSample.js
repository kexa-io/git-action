 ...
 */
function serviceFabricSchedulesExecute() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabricSchedules.beginExecuteAndWait(resourceGroupName, labName, userName, serviceFabricName, name);
        console.log(result);
    });
}
serviceFabricSchedulesExecute().catch(console.error);
//# sourceMappingURL=serviceFabricSchedulesExecuteSample.js.map