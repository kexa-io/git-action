 ...
 */
function artifactSourcesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.artifactSources.update(resourceGroupName, labName, name, artifactSource);
        console.log(result);
    });
}
artifactSourcesUpdate().catch(console.error);
//# sourceMappingURL=artifactSourcesUpdateSample.js.map