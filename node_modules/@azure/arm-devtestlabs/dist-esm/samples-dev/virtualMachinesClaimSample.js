...
function virtualMachinesClaim() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachines.beginClaimAndWait(resourceGroupName, labName, name);
        console.log(result);
    });
}
virtualMachinesClaim().catch(console.error);
//# sourceMappingURL=virtualMachinesClaimSample.js.map