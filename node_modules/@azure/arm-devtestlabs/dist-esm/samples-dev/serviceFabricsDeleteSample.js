...
function serviceFabricsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabrics.beginDeleteAndWait(resourceGroupName, labName, userName, name);
        console.log(result);
    });
}
serviceFabricsDelete().catch(console.error);
//# sourceMappingURL=serviceFabricsDeleteSample.js.map