 ...
 */
function virtualMachinesTransferDisks() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachines.beginTransferDisksAndWait(resourceGroupName, labName, name);
        console.log(result);
    });
}
virtualMachinesTransferDisks().catch(console.error);
//# sourceMappingURL=virtualMachinesTransferDisksSample.js.map