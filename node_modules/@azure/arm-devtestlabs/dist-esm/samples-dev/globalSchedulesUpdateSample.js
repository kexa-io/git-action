 ...
 */
function globalSchedulesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.globalSchedules.update(resourceGroupName, name, schedule);
        console.log(result);
    });
}
globalSchedulesUpdate().catch(console.error);
//# sourceMappingURL=globalSchedulesUpdateSample.js.map