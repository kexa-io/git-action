 ...
 */
function policySetsEvaluatePolicies() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.policySets.evaluatePolicies(resourceGroupName, labName, name, evaluatePoliciesRequest);
        console.log(result);
    });
}
policySetsEvaluatePolicies().catch(console.error);
//# sourceMappingURL=policySetsEvaluatePoliciesSample.js.map