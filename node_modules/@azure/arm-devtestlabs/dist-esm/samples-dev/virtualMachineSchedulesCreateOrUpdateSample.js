 ...
 */
function virtualMachineSchedulesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineSchedules.createOrUpdate(resourceGroupName, labName, virtualMachineName, name, schedule);
        console.log(result);
    });
}
virtualMachineSchedulesCreateOrUpdate().catch(console.error);
//# sourceMappingURL=virtualMachineSchedulesCreateOrUpdateSample.js.map