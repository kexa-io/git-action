 ...
 */
function notificationChannelsNotify() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationChannels.notify(resourceGroupName, labName, name, notifyParameters);
        console.log(result);
    });
}
notificationChannelsNotify().catch(console.error);
//# sourceMappingURL=notificationChannelsNotifySample.js.map