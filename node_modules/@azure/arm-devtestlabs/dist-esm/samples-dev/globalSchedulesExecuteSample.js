 ...
 */
function globalSchedulesExecute() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.globalSchedules.beginExecuteAndWait(resourceGroupName, name);
        console.log(result);
    });
}
globalSchedulesExecute().catch(console.error);
//# sourceMappingURL=globalSchedulesExecuteSample.js.map