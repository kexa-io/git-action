...
function serviceFabricsStart() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabrics.beginStartAndWait(resourceGroupName, labName, userName, name);
        console.log(result);
    });
}
serviceFabricsStart().catch(console.error);
//# sourceMappingURL=serviceFabricsStartSample.js.map