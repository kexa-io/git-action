 ...
 */
function virtualMachinesResize() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachines.beginResizeAndWait(resourceGroupName, labName, name, resizeLabVirtualMachineProperties);
        console.log(result);
    });
}
virtualMachinesResize().catch(console.error);
//# sourceMappingURL=virtualMachinesResizeSample.js.map