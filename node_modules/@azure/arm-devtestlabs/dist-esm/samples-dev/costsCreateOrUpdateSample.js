...
function costsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.costs.createOrUpdate(resourceGroupName, labName, name, labCost);
        console.log(result);
    });
}
costsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=costsCreateOrUpdateSample.js.map