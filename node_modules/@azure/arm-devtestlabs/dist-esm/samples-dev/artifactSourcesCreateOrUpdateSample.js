 ...
 */
function artifactSourcesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.artifactSources.createOrUpdate(resourceGroupName, labName, name, artifactSource);
        console.log(result);
    });
}
artifactSourcesCreateOrUpdate().catch(console.error);
//# sourceMappingURL=artifactSourcesCreateOrUpdateSample.js.map