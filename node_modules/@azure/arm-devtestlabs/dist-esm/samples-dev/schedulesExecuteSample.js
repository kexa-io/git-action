...
function schedulesExecute() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.schedules.beginExecuteAndWait(resourceGroupName, labName, name);
        console.log(result);
    });
}
schedulesExecute().catch(console.error);
//# sourceMappingURL=schedulesExecuteSample.js.map