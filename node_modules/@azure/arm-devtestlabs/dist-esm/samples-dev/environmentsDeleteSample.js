...
function environmentsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.environments.beginDeleteAndWait(resourceGroupName, labName, userName, name);
        console.log(result);
    });
}
environmentsDelete().catch(console.error);
//# sourceMappingURL=environmentsDeleteSample.js.map