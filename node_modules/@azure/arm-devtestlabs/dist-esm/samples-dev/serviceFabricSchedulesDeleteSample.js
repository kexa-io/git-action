 ...
 */
function serviceFabricSchedulesDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabricSchedules.delete(resourceGroupName, labName, userName, serviceFabricName, name);
        console.log(result);
    });
}
serviceFabricSchedulesDelete().catch(console.error);
//# sourceMappingURL=serviceFabricSchedulesDeleteSample.js.map