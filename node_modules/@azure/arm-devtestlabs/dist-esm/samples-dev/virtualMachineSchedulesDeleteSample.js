 ...
 */
function virtualMachineSchedulesDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineSchedules.delete(resourceGroupName, labName, virtualMachineName, name);
        console.log(result);
    });
}
virtualMachineSchedulesDelete().catch(console.error);
//# sourceMappingURL=virtualMachineSchedulesDeleteSample.js.map