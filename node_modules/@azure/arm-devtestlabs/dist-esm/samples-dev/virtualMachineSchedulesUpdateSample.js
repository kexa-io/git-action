 ...
 */
function virtualMachineSchedulesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineSchedules.update(resourceGroupName, labName, virtualMachineName, name, schedule);
        console.log(result);
    });
}
virtualMachineSchedulesUpdate().catch(console.error);
//# sourceMappingURL=virtualMachineSchedulesUpdateSample.js.map