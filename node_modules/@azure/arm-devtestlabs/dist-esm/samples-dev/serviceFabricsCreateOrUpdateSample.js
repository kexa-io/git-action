 ...
 */
function serviceFabricsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serviceFabrics.beginCreateOrUpdateAndWait(resourceGroupName, labName, userName, name, serviceFabric);
        console.log(result);
    });
}
serviceFabricsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=serviceFabricsCreateOrUpdateSample.js.map