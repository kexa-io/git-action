 ...
 */
function connectAnApiPollingV2LogsDataConnector() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dataConnectors.connect(resourceGroupName, workspaceName, dataConnectorId, connectBody);
        console.log(result);
    });
}
/**
 ...
 */
function connectAnApiPollingDataConnector() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SECURITYINSIGHT_SUBSCRIPTION_ID"] ||
            "d0cfe6b2-9ac0-4464-9919-dccaee2e48c0";
        const resourceGroupName = process.env["SECURITYINSIGHT_RESOURCE_GROUP"] || "myRg";
...
//# sourceMappingURL=dataConnectorsConnectSample.js.map