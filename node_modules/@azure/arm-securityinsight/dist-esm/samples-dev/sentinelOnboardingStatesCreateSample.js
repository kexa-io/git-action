...
function createSentinelOnboardingState() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.sentinelOnboardingStates.create(resourceGroupName, workspaceName, sentinelOnboardingStateName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=sentinelOnboardingStatesCreateSample.js.map