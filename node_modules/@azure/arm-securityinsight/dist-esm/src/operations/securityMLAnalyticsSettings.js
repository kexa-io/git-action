...
export class SecurityMLAnalyticsSettingsImpl {
    ...
    get(resourceGroupName, workspaceName, settingsResourceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, settingsResourceName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, workspaceName, settingsResourceName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, workspaceName, settingsResourceName, options }, deleteOperationSpec);
    }
    /**
     * ListNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
...
//# sourceMappingURL=securityMLAnalyticsSettings.js.map