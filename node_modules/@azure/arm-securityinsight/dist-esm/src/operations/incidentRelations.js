...
export class IncidentRelationsImpl {
    /**
    ...
    listPagingPage(resourceGroupName, workspaceName, incidentId, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(resourceGroupName, workspaceName, incidentId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(resourceGroupName, workspaceName, incidentId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(resourceGroupName, workspaceName, incidentId, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(resourceGroupName, workspaceName, incidentId, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
