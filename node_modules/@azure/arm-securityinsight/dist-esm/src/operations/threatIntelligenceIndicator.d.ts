...
import { ThreatIntelligenceInformationUnion, ThreatIntelligenceFilteringCriteria, ThreatIntelligenceIndicatorQueryIndicatorsOptionalParams, ThreatIntelligenceIndicatorModel, ThreatIntelligenceIndicatorCreateIndicatorOptionalParams, ThreatIntelligenceIndicatorCreateIndicatorResponse, ThreatIntelligenceIndicatorGetOptionalParams, ThreatIntelligenceIndicatorGetResponse, ThreatIntelligenceIndicatorCreateOptionalParams, ThreatIntelligenceIndicatorCreateResponse, ThreatIntelligenceIndicatorDeleteOptionalParams, ThreatIntelligenceAppendTags, ThreatIntelligenceIndicatorAppendTagsOptionalParams, ThreatIntelligenceIndicatorReplaceTagsOptionalParams, ThreatIntelligenceIndicatorReplaceTagsResponse } from "../models";
/** Class containing ThreatIntelligenceIndicator operations. */
export declare class ThreatIntelligenceIndicatorImpl implements ThreatIntelligenceIndicator {
    ...
    private queryIndicatorsPagingPage;
    private queryIndicatorsPagingAll;
    /**
