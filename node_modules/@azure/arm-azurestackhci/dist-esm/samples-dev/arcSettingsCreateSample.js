...
function createArcSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.arcSettings.create(resourceGroupName, clusterName, arcSettingName, arcSetting);
        console.log(result);
    });
}
createArcSetting().catch(console.error);
//# sourceMappingURL=arcSettingsCreateSample.js.map