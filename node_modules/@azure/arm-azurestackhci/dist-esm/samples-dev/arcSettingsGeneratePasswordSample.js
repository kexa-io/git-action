...
function generatePassword() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.arcSettings.generatePassword(resourceGroupName, clusterName, arcSettingName);
        console.log(result);
    });
}
generatePassword().catch(console.error);
//# sourceMappingURL=arcSettingsGeneratePasswordSample.js.map