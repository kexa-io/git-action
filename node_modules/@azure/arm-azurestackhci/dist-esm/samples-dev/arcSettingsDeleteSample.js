...
function deleteArcSetting() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.arcSettings.beginDeleteAndWait(resourceGroupName, clusterName, arcSettingName);
        console.log(result);
    });
}
deleteArcSetting().catch(console.error);
//# sourceMappingURL=arcSettingsDeleteSample.js.map