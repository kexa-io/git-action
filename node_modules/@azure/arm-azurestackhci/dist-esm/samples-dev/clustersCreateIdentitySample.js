 ...
 */
function createClusterIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.clusters.beginCreateIdentityAndWait(resourceGroupName, clusterName);
        console.log(result);
    });
}
createClusterIdentity().catch(console.error);
//# sourceMappingURL=clustersCreateIdentitySample.js.map