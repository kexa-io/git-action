...
function createArcExtension() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.extensions.beginCreateAndWait(resourceGroupName, clusterName, arcSettingName, extensionName, extension);
        console.log(result);
    });
}
