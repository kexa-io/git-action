...
function createArcIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.arcSettings.beginCreateIdentityAndWait(resourceGroupName, clusterName, arcSettingName);
        console.log(result);
    });
}
createArcIdentity().catch(console.error);
//# sourceMappingURL=arcSettingsCreateIdentitySample.js.map