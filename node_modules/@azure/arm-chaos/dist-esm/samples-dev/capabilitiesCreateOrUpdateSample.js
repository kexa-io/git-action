 ...
 */
function createOrUpdateACapabilityThatExtendsAVirtualMachineTargetResource() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CHAOS_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.capabilities.createOrUpdate(resourceGroupName, parentProviderNamespace, parentResourceType, parentResourceName, targetName, capabilityName, capability);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=capabilitiesCreateOrUpdateSample.js.map