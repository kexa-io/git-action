...
function tasksCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tasks.beginCreateAndWait(resourceGroupName, registryName, taskName, taskCreateParameters);
        console.log(result);
    });
}
/**
 ...
 */
function tasksCreateWithSystemAndUserIdentities() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONTAINERREGISTRY_SUBSCRIPTION_ID"] ||
            "4385cf00-2d3a-425a-832f-f4285b1c9dce";
        const resourceGroupName = process.env["CONTAINERREGISTRY_RESOURCE_GROUP"] || "myResourceGroup";
 ...
 */
function tasksCreateWithUserIdentities() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONTAINERREGISTRY_SUBSCRIPTION_ID"] ||
            "4385cf00-2d3a-425a-832f-f4285b1c9dce";
        const resourceGroupName = process.env["CONTAINERREGISTRY_RESOURCE_GROUP"] || "myResourceGroup";
 ...
 */
function tasksCreateWithUserIdentitiesWithSystemIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONTAINERREGISTRY_SUBSCRIPTION_ID"] ||
            "4385cf00-2d3a-425a-832f-f4285b1c9dce";
        const resourceGroupName = process.env["CONTAINERREGISTRY_RESOURCE_GROUP"] || "myResourceGroup";
...
//# sourceMappingURL=tasksCreateSample.js.map