 ...
 */
function getMinimumAndMaximumCodeVersions() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["SERVICEFABRIC_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["SERVICEFABRIC_RESOURCE_GROUP"] || "resRg";
        const clusterName = "myCluster";
        const credential = new DefaultAzureCredential();
        const client = new ServiceFabricManagementClient(credential, subscriptionId);
        const result = yield client.clusters.listUpgradableVersions(resourceGroupName, clusterName);
        console.log(result);
    });
}
/**
...
function getUpgradePath() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = new DefaultAzureCredential();
        const client = new ServiceFabricManagementClient(credential, subscriptionId);
        const result = yield client.clusters.listUpgradableVersions(resourceGroupName, clusterName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=clustersListUpgradableVersionsSample.js.map