...
function cachesCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.caches.beginCreateOrUpdateAndWait(resourceGroupName, cacheName, cache);
        console.log(result);
    });
}
/**
 ...
 */
function cachesCreateOrUpdateLdapOnly() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["STORAGECACHE_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["STORAGECACHE_RESOURCE_GROUP"] || "scgroup";
...
//# sourceMappingURL=cachesCreateOrUpdateSample.js.map