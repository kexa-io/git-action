...
export class ComputeOperationsImpl {
    ...
    listNodesPagingAll(resourceGroupName, workspaceName, computeName, options) {
        return __asyncGenerator(this, arguments, function* listNodesPagingAll_1() {
            var e_2, _a;
            try {
                for (var _b = __asyncValues(this.listNodesPagingPage(resourceGroupName, workspaceName, computeName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
                    yield __await(yield* __asyncDelegator(__asyncValues(page)));
                }
            }
    ...
    beginCreateOrUpdate(resourceGroupName, workspaceName, computeName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, workspaceName, computeName, parameters, options }, createOrUpdateOperationSpec);
