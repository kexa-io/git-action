 ...
 */
function createOrUpdateModelContainer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.modelContainers.createOrUpdate(resourceGroupName, workspaceName, name, body);
        console.log(result);
    });
}
createOrUpdateModelContainer().catch(console.error);
//# sourceMappingURL=modelContainersCreateOrUpdateSample.js.map