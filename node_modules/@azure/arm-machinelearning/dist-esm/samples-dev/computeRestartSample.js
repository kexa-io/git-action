...
function restartComputeInstanceCompute() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.computeOperations.beginRestartAndWait(resourceGroupName, workspaceName, computeName);
        console.log(result);
    });
}
restartComputeInstanceCompute().catch(console.error);
//# sourceMappingURL=computeRestartSample.js.map