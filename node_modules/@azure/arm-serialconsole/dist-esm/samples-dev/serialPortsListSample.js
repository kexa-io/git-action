 ...
 */
function listSerialPortsForParentResources() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serialPorts.list(resourceGroupName, resourceProviderNamespace, parentResourceType, parentResource);
        console.log(result);
    });
}
listSerialPortsForParentResources().catch(console.error);
//# sourceMappingURL=serialPortsListSample.js.map