 ...
 */
function connectToAScaleSetInstanceSerialPort() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serialPorts.connect(resourceGroupName, resourceProviderNamespace, parentResourceType, parentResource, serialPort);
        console.log(result);
    });
}
 ...
 */
function connectToAVirtualMachineSerialPort() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-00000-0000-0000-000000000000";
        const resourceGroupName = "myResourceGroup";
        const resourceProviderNamespace = "Microsoft.Compute";
...
//# sourceMappingURL=serialPortsConnectSample.js.map