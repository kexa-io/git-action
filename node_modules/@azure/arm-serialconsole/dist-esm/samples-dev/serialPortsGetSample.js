 ...
 */
function getTheSerialPortForAParentResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serialPorts.get(resourceGroupName, resourceProviderNamespace, parentResourceType, parentResource, serialPort);
        console.log(result);
    });
}
getTheSerialPortForAParentResource().catch(console.error);
//# sourceMappingURL=serialPortsGetSample.js.map