...
export declare interface AvailabilityZoneMappings {
    /**
...
export declare interface AvailabilityZonePeers {
    /**
...
export declare interface CheckZonePeersRequest {
...
export declare interface CheckZonePeersResult {
    /**
     * The subscription ID.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
...
/** Optional parameters. */
export declare interface SubscriptionsCheckZonePeersOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the checkZonePeers operation. */
export declare type SubscriptionsCheckZonePeersResponse = CheckZonePeersResult;
