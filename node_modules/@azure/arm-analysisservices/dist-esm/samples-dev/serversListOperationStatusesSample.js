...
function getDetailsOfAServer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.servers.listOperationStatuses(location, operationId);
        console.log(result);
    });
}
getDetailsOfAServer().catch(console.error);
//# sourceMappingURL=serversListOperationStatusesSample.js.map