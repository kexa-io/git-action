 ...
 */
function listEligibleSkUsForAnExistingServer() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.servers.listSkusForExisting(resourceGroupName, serverName);
        console.log(result);
    });
}
listEligibleSkUsForAnExistingServer().catch(console.error);
//# sourceMappingURL=serversListSkusForExistingSample.js.map