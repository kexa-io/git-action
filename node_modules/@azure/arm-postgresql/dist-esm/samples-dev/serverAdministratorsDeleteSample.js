 ...
 */
function serverAdministratorsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverAdministrators.beginDeleteAndWait(resourceGroupName, serverName);
        console.log(result);
    });
}
serverAdministratorsDelete().catch(console.error);
//# sourceMappingURL=serverAdministratorsDeleteSample.js.map