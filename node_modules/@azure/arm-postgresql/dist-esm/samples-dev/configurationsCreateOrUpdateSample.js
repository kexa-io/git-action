 ...
 */
function configurationCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.configurations.beginCreateOrUpdateAndWait(resourceGroupName, serverName, configurationName, parameters);
        console.log(result);
    });
}
configurationCreateOrUpdate().catch(console.error);
//# sourceMappingURL=configurationsCreateOrUpdateSample.js.map