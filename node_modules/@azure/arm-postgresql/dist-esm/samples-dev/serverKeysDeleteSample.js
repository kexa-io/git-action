 ...
 */
function deleteThePostgreSqlServerKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverKeys.beginDeleteAndWait(serverName, keyName, resourceGroupName);
        console.log(result);
    });
}
deleteThePostgreSqlServerKey().catch(console.error);
//# sourceMappingURL=serverKeysDeleteSample.js.map