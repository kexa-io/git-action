 ...
 */
function serverAdministratorGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverAdministrators.get(resourceGroupName, serverName);
        console.log(result);
    });
}
serverAdministratorGet().catch(console.error);
//# sourceMappingURL=serverAdministratorsGetSample.js.map