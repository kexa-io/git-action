 ...
 */
function getThePostgreSqlServerKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverKeys.get(resourceGroupName, serverName, keyName);
        console.log(result);
    });
}
getThePostgreSqlServerKey().catch(console.error);
//# sourceMappingURL=serverKeysGetSample.js.map