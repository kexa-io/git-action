 ...
 */
function createsOrUpdatesAPostgreSqlServerKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.serverKeys.beginCreateOrUpdateAndWait(serverName, keyName, resourceGroupName, parameters);
        console.log(result);
    });
}
createsOrUpdatesAPostgreSqlServerKey().catch(console.error);
//# sourceMappingURL=serverKeysCreateOrUpdateSample.js.map