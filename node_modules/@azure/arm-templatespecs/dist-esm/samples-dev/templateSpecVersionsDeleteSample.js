 ...
 */
function templateSpecVersionsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.templateSpecVersions.delete(resourceGroupName, templateSpecName, templateSpecVersion);
        console.log(result);
    });
}
templateSpecVersionsDelete().catch(console.error);
//# sourceMappingURL=templateSpecVersionsDeleteSample.js.map