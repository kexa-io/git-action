 ...
 */
function templateSpecVersionsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.templateSpecVersions.get(resourceGroupName, templateSpecName, templateSpecVersion);
        console.log(result);
    });
}
templateSpecVersionsGet().catch(console.error);
//# sourceMappingURL=templateSpecVersionsGetSample.js.map