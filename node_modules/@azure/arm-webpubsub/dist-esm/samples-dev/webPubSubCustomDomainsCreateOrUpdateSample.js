 ...
 */
function webPubSubCustomDomainsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.webPubSubCustomDomains.beginCreateOrUpdateAndWait(resourceGroupName, resourceName, name, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=webPubSubCustomDomainsCreateOrUpdateSample.js.map