...
function defaultAccountsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.defaultAccounts.get(scopeTenantId, scopeType, options);
        console.log(result);
    });
}
defaultAccountsGet().catch(console.error);
//# sourceMappingURL=defaultAccountsGetSample.js.map