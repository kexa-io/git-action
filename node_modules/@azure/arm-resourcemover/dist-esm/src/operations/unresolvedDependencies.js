...
export class UnresolvedDependenciesImpl {
    /**
    ...
    getPagingPage(resourceGroupName, moveCollectionName, options, settings) {
        return __asyncGenerator(this, arguments, function* getPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._get(resourceGroupName, moveCollectionName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._getNext(resourceGroupName, moveCollectionName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    getPagingAll(resourceGroupName, moveCollectionName, options) {
        return __asyncGenerator(this, arguments, function* getPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.getPagingPage(resourceGroupName, moveCollectionName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
//# sourceMappingURL=unresolvedDependencies.js.map