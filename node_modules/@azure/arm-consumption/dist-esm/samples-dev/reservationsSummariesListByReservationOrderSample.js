 ...
 */
function reservationSummariesDaily() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.reservationsSummaries.listByReservationOrder(reservationOrderId, grain, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function reservationSummariesMonthly() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONSUMPTION_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        ...
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.reservationsSummaries.listByReservationOrder(reservationOrderId, grain)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=reservationsSummariesListByReservationOrderSample.js.map