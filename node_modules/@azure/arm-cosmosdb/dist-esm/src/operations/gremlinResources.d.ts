...
export declare class GremlinResourcesImpl implements GremlinResources {
    ...
    private listGremlinDatabasesPagingPage;
    private listGremlinDatabasesPagingAll;
    /**
    ...
    private listGremlinGraphsPagingPage;
    private listGremlinGraphsPagingAll;
    /**
     * Lists the Gremlin databases under an existing Azure Cosmos DB database account.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param accountName Cosmos DB database account name.
...
//# sourceMappingURL=gremlinResources.d.ts.map