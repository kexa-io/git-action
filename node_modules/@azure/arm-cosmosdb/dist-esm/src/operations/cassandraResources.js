...
export class CassandraResourcesImpl {
    ...
    listCassandraKeyspacesPagingAll(resourceGroupName, accountName, options) {
        return __asyncGenerator(this, arguments, function* listCassandraKeyspacesPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listCassandraKeyspacesPagingPage(resourceGroupName, accountName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listCassandraTablesPagingAll(resourceGroupName, accountName, keyspaceName, options) {
        return __asyncGenerator(this, arguments, function* listCassandraTablesPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listCassandraTablesPagingPage(resourceGroupName, accountName, keyspaceName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
