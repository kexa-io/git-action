...
export declare class CassandraResourcesImpl implements CassandraResources {
    ...
    private listCassandraKeyspacesPagingPage;
    private listCassandraKeyspacesPagingAll;
    /**
    ...
    private listCassandraTablesPagingPage;
    private listCassandraTablesPagingAll;
    /**
     * Lists the Cassandra keyspaces under an existing Azure Cosmos DB database account.
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
     * @param accountName Cosmos DB database account name.
...
//# sourceMappingURL=cassandraResources.d.ts.map