...
function controllersDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.controllers.beginDeleteAndWait(resourceGroupName, name);
        console.log(result);
    });
}
controllersDelete().catch(console.error);
//# sourceMappingURL=controllersDeleteSample.js.map