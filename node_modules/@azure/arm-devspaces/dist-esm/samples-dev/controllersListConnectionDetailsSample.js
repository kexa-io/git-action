 ...
 */
function controllersListConnectionDetails() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.controllers.listConnectionDetails(resourceGroupName, name, listConnectionDetailsParameters);
        console.log(result);
    });
}
controllersListConnectionDetails().catch(console.error);
//# sourceMappingURL=controllersListConnectionDetailsSample.js.map