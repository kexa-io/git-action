...
function controllersUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.controllers.update(resourceGroupName, name, controllerUpdateParameters);
        console.log(result);
    });
}
controllersUpdate().catch(console.error);
//# sourceMappingURL=controllersUpdateSample.js.map