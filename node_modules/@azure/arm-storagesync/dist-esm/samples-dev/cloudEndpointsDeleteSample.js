...
function cloudEndpointsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginDeleteAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName);
        console.log(result);
    });
}
cloudEndpointsDelete().catch(console.error);
//# sourceMappingURL=cloudEndpointsDeleteSample.js.map