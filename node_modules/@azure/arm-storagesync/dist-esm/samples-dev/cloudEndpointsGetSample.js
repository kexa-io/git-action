...
function cloudEndpointsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.get(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName);
        console.log(result);
    });
}
cloudEndpointsGet().catch(console.error);
//# sourceMappingURL=cloudEndpointsGetSample.js.map