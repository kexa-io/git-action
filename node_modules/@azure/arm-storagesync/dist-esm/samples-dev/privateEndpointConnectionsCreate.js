...
function privateEndpointConnectionsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginCreateAndWait(resourceGroupName, storageSyncServiceName, privateEndpointConnectionName, properties);
        console.log(result);
    });
}
privateEndpointConnectionsCreate().catch(console.error);
//# sourceMappingURL=privateEndpointConnectionsCreate.js.map