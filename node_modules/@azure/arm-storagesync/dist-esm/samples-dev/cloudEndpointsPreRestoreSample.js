 ...
 */
function cloudEndpointsPreRestore() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginPreRestoreAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsPreRestore().catch(console.error);
//# sourceMappingURL=cloudEndpointsPreRestoreSample.js.map