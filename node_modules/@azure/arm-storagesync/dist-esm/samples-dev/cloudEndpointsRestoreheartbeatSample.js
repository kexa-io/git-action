 ...
 */
function cloudEndpointsRestoreheartbeat() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.restoreheartbeat(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName);
        console.log(result);
    });
}
cloudEndpointsRestoreheartbeat().catch(console.error);
//# sourceMappingURL=cloudEndpointsRestoreheartbeatSample.js.map