...
function workflowsAbort() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.workflows.abort(resourceGroupName, storageSyncServiceName, workflowId);
        console.log(result);
    });
}
workflowsAbort().catch(console.error);
//# sourceMappingURL=workflowsAbortSample.js.map