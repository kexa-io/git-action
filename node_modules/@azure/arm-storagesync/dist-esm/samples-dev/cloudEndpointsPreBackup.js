...
function cloudEndpointsPreBackup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginPreBackupAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsPreBackup().catch(console.error);
//# sourceMappingURL=cloudEndpointsPreBackup.js.map