 ...
 */
function cloudEndpointsPostRestore() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginPostRestoreAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsPostRestore().catch(console.error);
//# sourceMappingURL=cloudEndpointsPostRestoreSample.js.map