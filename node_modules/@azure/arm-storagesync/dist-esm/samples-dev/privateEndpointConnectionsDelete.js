...
function privateEndpointConnectionsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginDeleteAndWait(resourceGroupName, storageSyncServiceName, privateEndpointConnectionName);
        console.log(result);
    });
}
privateEndpointConnectionsDelete().catch(console.error);
//# sourceMappingURL=privateEndpointConnectionsDelete.js.map