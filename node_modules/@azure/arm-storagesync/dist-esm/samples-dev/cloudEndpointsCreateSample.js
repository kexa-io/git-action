...
function cloudEndpointsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginCreateAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsCreate().catch(console.error);
//# sourceMappingURL=cloudEndpointsCreateSample.js.map