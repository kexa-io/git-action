 ...
 */
function cloudEndpointsTriggerChangeDetection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginTriggerChangeDetectionAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsTriggerChangeDetection().catch(console.error);
//# sourceMappingURL=cloudEndpointsTriggerChangeDetectionSample.js.map