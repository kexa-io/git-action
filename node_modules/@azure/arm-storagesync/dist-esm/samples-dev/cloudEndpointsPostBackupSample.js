 ...
 */
function cloudEndpointsPostBackup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.cloudEndpoints.beginPostBackupAndWait(resourceGroupName, storageSyncServiceName, syncGroupName, cloudEndpointName, parameters);
        console.log(result);
    });
}
cloudEndpointsPostBackup().catch(console.error);
//# sourceMappingURL=cloudEndpointsPostBackupSample.js.map