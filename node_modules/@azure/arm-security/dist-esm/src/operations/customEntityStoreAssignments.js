...
export class CustomEntityStoreAssignmentsImpl {
    ...
    get(resourceGroupName, customEntityStoreAssignmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, customEntityStoreAssignmentName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, customEntityStoreAssignmentName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, customEntityStoreAssignmentName, options }, deleteOperationSpec);
    }
    /**
     * List custom entity store assignments by a provided subscription and resource group
     * @param resourceGroupName The name of the resource group within the user's subscription. The name is
...
//# sourceMappingURL=customEntityStoreAssignments.js.map