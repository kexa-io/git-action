 ...
 */
function getASingleAdaptiveNetworkHardeningResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.adaptiveNetworkHardenings.get(resourceGroupName, resourceNamespace, resourceType, resourceName, adaptiveNetworkHardeningResourceName);
        console.log(result);
    });
}
getASingleAdaptiveNetworkHardeningResource().catch(console.error);
//# sourceMappingURL=adaptiveNetworkHardeningsGetSample.js.map