 ...
 */
function getSecurityAssessmentMetadataForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assessmentsMetadata.getInSubscription(assessmentMetadataName);
        console.log(result);
    });
}
getSecurityAssessmentMetadataForSubscription().catch(console.error);
//# sourceMappingURL=assessmentsMetadataGetInSubscriptionSample.js.map