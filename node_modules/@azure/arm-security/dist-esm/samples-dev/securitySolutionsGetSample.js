 ...
 */
function getASecuritySolutionFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.securitySolutions.get(resourceGroupName, ascLocation, securitySolutionName);
        console.log(result);
    });
}
getASecuritySolutionFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=securitySolutionsGetSample.js.map