 ...
 */
function getDiscoveredSecuritySolutionFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.discoveredSecuritySolutions.get(resourceGroupName, ascLocation, discoveredSecuritySolutionName);
        console.log(result);
    });
}
getDiscoveredSecuritySolutionFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=discoveredSecuritySolutionsGetSample.js.map