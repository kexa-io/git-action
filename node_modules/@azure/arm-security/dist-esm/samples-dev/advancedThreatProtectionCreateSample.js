 ...
 */
function createsOrUpdatesTheAdvancedThreatProtectionSettingsOnASpecifiedResource() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceId = "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Storage/storageAccounts/samplestorageaccount";
        ...
        const result = yield client.advancedThreatProtection.create(resourceId, advancedThreatProtectionSetting);
        console.log(result);
    });
}
createsOrUpdatesTheAdvancedThreatProtectionSettingsOnASpecifiedResource().catch(console.error);
//# sourceMappingURL=advancedThreatProtectionCreateSample.js.map