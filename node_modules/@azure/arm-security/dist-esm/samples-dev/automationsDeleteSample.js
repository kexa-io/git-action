 ...
 */
function deleteASecurityAutomation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.automations.delete(resourceGroupName, automationName);
        console.log(result);
    });
}
deleteASecurityAutomation().catch(console.error);
//# sourceMappingURL=automationsDeleteSample.js.map