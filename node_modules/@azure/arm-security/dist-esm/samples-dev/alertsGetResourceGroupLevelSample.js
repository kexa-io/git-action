 ...
 */
function getSecurityAlertOnAResourceGroupFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.alerts.getResourceGroupLevel(ascLocation, alertName, resourceGroupName);
        console.log(result);
    });
}
getSecurityAlertOnAResourceGroupFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=alertsGetResourceGroupLevelSample.js.map