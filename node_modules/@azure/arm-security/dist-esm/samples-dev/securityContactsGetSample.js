 ...
 */
function getSecurityContactDataFull() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const securityContactName = "default1";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.securityContacts.get(securityContactName);
        console.log(result);
    });
}
 ...
 */
function getSecurityContactDataMinimal() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
...
//# sourceMappingURL=securityContactsGetSample.js.map