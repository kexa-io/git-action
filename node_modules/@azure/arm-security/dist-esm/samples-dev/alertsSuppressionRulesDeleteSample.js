 ...
 */
function deleteSuppressionRuleDataForASubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const alertsSuppressionRuleName = "dismissIpAnomalyAlerts";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.alertsSuppressionRules.delete(alertsSuppressionRuleName);
        console.log(result);
    });
}
deleteSuppressionRuleDataForASubscription().catch(console.error);
//# sourceMappingURL=alertsSuppressionRulesDeleteSample.js.map