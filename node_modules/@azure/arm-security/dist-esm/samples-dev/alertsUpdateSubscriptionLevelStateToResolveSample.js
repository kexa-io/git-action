...
function updateSecurityAlertStateOnASubscriptionFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.alerts.updateSubscriptionLevelStateToResolve(ascLocation, alertName);
        console.log(result);
    });
}
updateSecurityAlertStateOnASubscriptionFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=alertsUpdateSubscriptionLevelStateToResolveSample.js.map