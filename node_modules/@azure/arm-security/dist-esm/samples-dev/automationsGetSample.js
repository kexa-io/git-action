 ...
 */
function retrieveASecurityAutomation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.automations.get(resourceGroupName, automationName);
        console.log(result);
    });
}
retrieveASecurityAutomation().catch(console.error);
//# sourceMappingURL=automationsGetSample.js.map