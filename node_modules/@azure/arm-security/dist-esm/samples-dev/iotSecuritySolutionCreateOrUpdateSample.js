 ...
 */
function createOrUpdateAIoTSecuritySolution() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotSecuritySolution.createOrUpdate(resourceGroupName, solutionName, iotSecuritySolutionData);
        console.log(result);
    });
}
createOrUpdateAIoTSecuritySolution().catch(console.error);
//# sourceMappingURL=iotSecuritySolutionCreateOrUpdateSample.js.map