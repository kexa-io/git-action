 ...
 */
function getAnAutoProvisioningSettingForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const settingName = "default";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.autoProvisioningSettings.get(settingName);
        console.log(result);
    });
}
getAnAutoProvisioningSettingForSubscription().catch(console.error);
//# sourceMappingURL=autoProvisioningSettingsGetSample.js.map