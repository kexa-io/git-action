...
function updateSecurityAlertStateOnAResourceGroupFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.alerts.updateResourceGroupLevelStateToDismiss(ascLocation, alertName, resourceGroupName);
        console.log(result);
    });
}
updateSecurityAlertStateOnAResourceGroupFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=alertsUpdateResourceGroupLevelStateToDismissSample.js.map