 ...
 */
function getSecurityRecommendationTaskInAResourceGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.tasks.getResourceGroupLevelTask(resourceGroupName, ascLocation, taskName);
        console.log(result);
    });
}
getSecurityRecommendationTaskInAResourceGroup().catch(console.error);
//# sourceMappingURL=tasksGetResourceGroupLevelTaskSample.js.map