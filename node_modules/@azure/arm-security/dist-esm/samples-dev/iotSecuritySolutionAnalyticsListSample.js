 ...
 */
function getSecuritySolutionAnalytics() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotSecuritySolutionAnalytics.list(resourceGroupName, solutionName);
        console.log(result);
    });
}
getSecuritySolutionAnalytics().catch(console.error);
//# sourceMappingURL=iotSecuritySolutionAnalyticsListSample.js.map