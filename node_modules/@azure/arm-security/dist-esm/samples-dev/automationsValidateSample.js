 ...
 */
function validateTheSecurityAutomationModelBeforeCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.automations.validate(resourceGroupName, automationName, automation);
        console.log(result);
    });
}
validateTheSecurityAutomationModelBeforeCreateOrUpdate().catch(console.error);
//# sourceMappingURL=automationsValidateSample.js.map