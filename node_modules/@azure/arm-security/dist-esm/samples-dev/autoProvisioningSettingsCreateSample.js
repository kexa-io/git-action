 ...
 */
function createAutoProvisioningSettingsForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.autoProvisioningSettings.create(settingName, setting);
        console.log(result);
    });
}
createAutoProvisioningSettingsForSubscription().catch(console.error);
//# sourceMappingURL=autoProvisioningSettingsCreateSample.js.map