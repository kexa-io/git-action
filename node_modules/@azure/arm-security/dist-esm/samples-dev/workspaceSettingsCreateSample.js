 ...
 */
function createAWorkspaceSettingDataForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.workspaceSettings.create(workspaceSettingName, workspaceSetting);
        console.log(result);
    });
}
createAWorkspaceSettingDataForSubscription().catch(console.error);
//# sourceMappingURL=workspaceSettingsCreateSample.js.map