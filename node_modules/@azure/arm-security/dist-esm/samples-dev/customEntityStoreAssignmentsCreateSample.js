 ...
 */
function createACustomEntityStoreAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customEntityStoreAssignments.create(resourceGroupName, customEntityStoreAssignmentName, customEntityStoreAssignmentRequestBody);
        console.log(result);
    });
}
createACustomEntityStoreAssignment().catch(console.error);
//# sourceMappingURL=customEntityStoreAssignmentsCreateSample.js.map