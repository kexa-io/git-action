 ...
 */
function createOrUpdateADeviceSecurityGroupForTheSpecifiedIoTHubResource() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceId = "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/SampleRG/providers/Microsoft.Devices/iotHubs/sampleiothub";
        ...
        const result = yield client.deviceSecurityGroups.createOrUpdate(resourceId, deviceSecurityGroupName, deviceSecurityGroup);
        console.log(result);
    });
}
createOrUpdateADeviceSecurityGroupForTheSpecifiedIoTHubResource().catch(console.error);
//# sourceMappingURL=deviceSecurityGroupsCreateOrUpdateSample.js.map