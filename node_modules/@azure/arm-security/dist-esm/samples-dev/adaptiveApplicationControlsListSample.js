 ...
 */
function getsAListOfApplicationControlGroupsOfMachinesForTheSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.adaptiveApplicationControls.list(options);
        console.log(result);
    });
}
getsAListOfApplicationControlGroupsOfMachinesForTheSubscription().catch(console.error);
//# sourceMappingURL=adaptiveApplicationControlsListSample.js.map