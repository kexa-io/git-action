 ...
 */
function createJitNetworkAccessPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.jitNetworkAccessPolicies.createOrUpdate(resourceGroupName, ascLocation, jitNetworkAccessPolicyName, body);
        console.log(result);
    });
}
createJitNetworkAccessPolicy().catch(console.error);
//# sourceMappingURL=jitNetworkAccessPoliciesCreateOrUpdateSample.js.map