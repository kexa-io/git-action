 ...
 */
function getSecuritySolutionsFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const ascLocation = "westcentralus";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.securitySolutionsReferenceDataOperations.listByHomeRegion(ascLocation);
        console.log(result);
    });
}
getSecuritySolutionsFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=securitySolutionsReferenceDataListByHomeRegionSample.js.map