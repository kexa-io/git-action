 ...
 */
function getADeviceSecurityGroupForTheSpecifiedIoTHubResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.deviceSecurityGroups.get(resourceId, deviceSecurityGroupName);
        console.log(result);
    });
}
getADeviceSecurityGroupForTheSpecifiedIoTHubResource().catch(console.error);
//# sourceMappingURL=deviceSecurityGroupsGetSample.js.map