 ...
 */
function createSecurityAssessmentMetadataForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assessmentsMetadata.createInSubscription(assessmentMetadataName, assessmentMetadata);
        console.log(result);
    });
}
createSecurityAssessmentMetadataForSubscription().catch(console.error);
//# sourceMappingURL=assessmentsMetadataCreateInSubscriptionSample.js.map