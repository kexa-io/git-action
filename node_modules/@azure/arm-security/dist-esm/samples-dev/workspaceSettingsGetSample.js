 ...
 */
function getAWorkspaceSettingOnSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const workspaceSettingName = "default";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.workspaceSettings.get(workspaceSettingName);
        console.log(result);
    });
}
getAWorkspaceSettingOnSubscription().catch(console.error);
//# sourceMappingURL=workspaceSettingsGetSample.js.map