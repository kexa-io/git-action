 ...
 */
function listIoTSecuritySolutionsByResourceGroup() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.iotSecuritySolution.listByResourceGroup(resourceGroupName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function listIoTSecuritySolutionsByResourceGroupAndIoTHub() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "20ff7fc3-e762-44dd-bd96-b71116dcdc23";
        const resourceGroupName = "MyRg";
        const filter = 'properties.iotHubs/any(i eq "/subscriptions/075423e9-7d33-4166-8bdf-3920b04e3735/resourceGroups/myRg/providers/Microsoft.Devices/IotHubs/FirstIotHub")';
        const options = {
            filter
        };
        const credential = new DefaultAzureCredential();
        ...
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.iotSecuritySolution.listByResourceGroup(resourceGroupName, options)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
...
//# sourceMappingURL=iotSecuritySolutionListByResourceGroupSample.js.map