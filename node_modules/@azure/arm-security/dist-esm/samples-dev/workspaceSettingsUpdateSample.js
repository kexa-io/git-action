 ...
 */
function updateAWorkspaceSettingDataForSubscription() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.workspaceSettings.update(workspaceSettingName, workspaceSetting);
        console.log(result);
    });
}
updateAWorkspaceSettingDataForSubscription().catch(console.error);
//# sourceMappingURL=workspaceSettingsUpdateSample.js.map