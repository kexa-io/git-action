 ...
 */
function deleteACustomEntityStoreAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customEntityStoreAssignments.delete(resourceGroupName, customEntityStoreAssignmentName);
        console.log(result);
    });
}
deleteACustomEntityStoreAssignment().catch(console.error);
//# sourceMappingURL=customEntityStoreAssignmentsDeleteSample.js.map