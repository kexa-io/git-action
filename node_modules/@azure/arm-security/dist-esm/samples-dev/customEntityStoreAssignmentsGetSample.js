 ...
 */
function getACustomEntityStoreAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.customEntityStoreAssignments.get(resourceGroupName, customEntityStoreAssignmentName);
        console.log(result);
    });
}
getACustomEntityStoreAssignment().catch(console.error);
//# sourceMappingURL=customEntityStoreAssignmentsGetSample.js.map