 ...
 */
function deleteAnIoTSecuritySolution() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotSecuritySolution.delete(resourceGroupName, solutionName);
        console.log(result);
    });
}
deleteAnIoTSecuritySolution().catch(console.error);
//# sourceMappingURL=iotSecuritySolutionDeleteSample.js.map