 ...
 */
function createOrUpdateAnInformationProtectionPolicyForAManagementGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.informationProtectionPolicies.createOrUpdate(scope, informationProtectionPolicyName, informationProtectionPolicy);
        console.log(result);
    });
}
createOrUpdateAnInformationProtectionPolicyForAManagementGroup().catch(console.error);
//# sourceMappingURL=informationProtectionPoliciesCreateOrUpdateSample.js.map