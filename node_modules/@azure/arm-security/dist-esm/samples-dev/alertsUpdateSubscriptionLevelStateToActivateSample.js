 ...
 */
function updateSecurityAlertStateOnASubscriptionFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.alerts.updateSubscriptionLevelStateToActivate(ascLocation, alertName);
        console.log(result);
    });
}
updateSecurityAlertStateOnASubscriptionFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=alertsUpdateSubscriptionLevelStateToActivateSample.js.map