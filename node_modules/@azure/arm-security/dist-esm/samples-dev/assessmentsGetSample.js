 ...
 */
function getSecurityRecommendationTaskFromSecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const resourceId = "subscriptions/20ff7fc3-e762-44dd-bd96-b71116dcdc23/resourceGroups/myRg/providers/Microsoft.Compute/virtualMachineScaleSets/vmss2";
        const assessmentName = "21300918-b2e3-0346-785f-c77ff57d243b";
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.assessments.get(resourceId, assessmentName);
        console.log(result);
    });
}
...
function getSecurityRecommendationTaskFromSecurityDataLocationWithExpandParameter() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const credential = new DefaultAzureCredential();
        const client = new SecurityCenter(credential, subscriptionId);
        const result = yield client.assessments.get(resourceId, assessmentName, options);
        console.log(result);
    });
}
getSecurityRecommendationTaskFromSecurityDataLocationWithExpandParameter().catch(console.error);
//# sourceMappingURL=assessmentsGetSample.js.map