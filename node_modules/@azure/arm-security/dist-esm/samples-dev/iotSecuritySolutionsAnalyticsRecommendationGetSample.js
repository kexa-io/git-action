 ...
 */
function getTheAggregatedSecurityAnalyticsRecommendationOfYoursIoTSecuritySolution() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.iotSecuritySolutionsAnalyticsRecommendation.get(resourceGroupName, solutionName, aggregatedRecommendationName);
        console.log(result);
    });
}
getTheAggregatedSecurityAnalyticsRecommendationOfYoursIoTSecuritySolution().catch(console.error);
//# sourceMappingURL=iotSecuritySolutionsAnalyticsRecommendationGetSample.js.map