 ...
 */
function getSecurityAlertOnASubscriptionFromASecurityDataLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.alerts.getSubscriptionLevel(ascLocation, alertName);
        console.log(result);
    });
}
getSecurityAlertOnASubscriptionFromASecurityDataLocation().catch(console.error);
//# sourceMappingURL=alertsGetSubscriptionLevelSample.js.map