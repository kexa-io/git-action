 ...
 */
function deleteASecurityRecommendationTaskOnAResource() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.assessments.delete(resourceId, assessmentName);
        console.log(result);
    });
}
deleteASecurityRecommendationTaskOnAResource().catch(console.error);
//# sourceMappingURL=assessmentsDeleteSample.js.map