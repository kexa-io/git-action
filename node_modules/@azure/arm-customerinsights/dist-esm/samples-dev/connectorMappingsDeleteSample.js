 ...
 */
function connectorMappingsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectorMappings.delete(resourceGroupName, hubName, connectorName, mappingName);
        console.log(result);
    });
}
connectorMappingsDelete().catch(console.error);
//# sourceMappingURL=connectorMappingsDeleteSample.js.map