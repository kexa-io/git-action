 ...
 */
function authorizationPoliciesRegeneratePrimaryKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.authorizationPolicies.regeneratePrimaryKey(resourceGroupName, hubName, authorizationPolicyName);
        console.log(result);
    });
}
authorizationPoliciesRegeneratePrimaryKey().catch(console.error);
//# sourceMappingURL=authorizationPoliciesRegeneratePrimaryKeySample.js.map