...
function roleAssignmentsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.roleAssignments.get(resourceGroupName, hubName, assignmentName);
        console.log(result);
    });
}
roleAssignmentsGet().catch(console.error);
//# sourceMappingURL=roleAssignmentsGetSample.js.map