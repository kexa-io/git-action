 ...
 */
function predictionsGetTrainingResults() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.predictions.getTrainingResults(resourceGroupName, hubName, predictionName);
        console.log(result);
    });
}
predictionsGetTrainingResults().catch(console.error);
//# sourceMappingURL=predictionsGetTrainingResultsSample.js.map