...
function connectorsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectors.beginDeleteAndWait(resourceGroupName, hubName, connectorName);
        console.log(result);
    });
}
connectorsDelete().catch(console.error);
//# sourceMappingURL=connectorsDeleteSample.js.map