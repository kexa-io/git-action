 ...
 */
function interactionsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.interactions.beginCreateOrUpdateAndWait(resourceGroupName, hubName, interactionName, parameters);
        console.log(result);
    });
}
interactionsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=interactionsCreateOrUpdateSample.js.map