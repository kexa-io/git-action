 ...
 */
function imagesGetUploadUrlForEntityType() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.images.getUploadUrlForEntityType(resourceGroupName, hubName, parameters);
        console.log(result);
    });
}
imagesGetUploadUrlForEntityType().catch(console.error);
//# sourceMappingURL=imagesGetUploadUrlForEntityTypeSample.js.map