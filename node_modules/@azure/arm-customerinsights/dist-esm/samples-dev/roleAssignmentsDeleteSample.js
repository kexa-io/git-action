 ...
 */
function roleAssignmentsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.roleAssignments.delete(resourceGroupName, hubName, assignmentName);
        console.log(result);
    });
}
roleAssignmentsDelete().catch(console.error);
//# sourceMappingURL=roleAssignmentsDeleteSample.js.map