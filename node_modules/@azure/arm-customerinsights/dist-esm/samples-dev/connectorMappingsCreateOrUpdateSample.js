 ...
 */
function connectorMappingsCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectorMappings.createOrUpdate(resourceGroupName, hubName, connectorName, mappingName, parameters);
        console.log(result);
    });
}
connectorMappingsCreateOrUpdate().catch(console.error);
//# sourceMappingURL=connectorMappingsCreateOrUpdateSample.js.map