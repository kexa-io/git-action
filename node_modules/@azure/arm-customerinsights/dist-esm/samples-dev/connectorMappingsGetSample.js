...
function connectorMappingsGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectorMappings.get(resourceGroupName, hubName, connectorName, mappingName);
        console.log(result);
    });
}
connectorMappingsGet().catch(console.error);
//# sourceMappingURL=connectorMappingsGetSample.js.map