...
function relationshipsDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.relationships.beginDeleteAndWait(resourceGroupName, hubName, relationshipName);
        console.log(result);
    });
}
relationshipsDelete().catch(console.error);
//# sourceMappingURL=relationshipsDeleteSample.js.map