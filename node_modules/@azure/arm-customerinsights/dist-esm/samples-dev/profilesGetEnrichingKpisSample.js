 ...
 */
function profilesGetEnrichingKpis() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.profiles.getEnrichingKpis(resourceGroupName, hubName, profileName);
        console.log(result);
    });
}
profilesGetEnrichingKpis().catch(console.error);
//# sourceMappingURL=profilesGetEnrichingKpisSample.js.map