 ...
 */
function relationshipLinksDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.relationshipLinks.beginDeleteAndWait(resourceGroupName, hubName, relationshipLinkName);
        console.log(result);
    });
}
relationshipLinksDelete().catch(console.error);
//# sourceMappingURL=relationshipLinksDeleteSample.js.map