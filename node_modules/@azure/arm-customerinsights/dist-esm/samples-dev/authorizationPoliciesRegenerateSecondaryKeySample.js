 ...
 */
function authorizationPoliciesRegenerateSecondaryKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.authorizationPolicies.regenerateSecondaryKey(resourceGroupName, hubName, authorizationPolicyName);
        console.log(result);
    });
}
authorizationPoliciesRegenerateSecondaryKey().catch(console.error);
//# sourceMappingURL=authorizationPoliciesRegenerateSecondaryKeySample.js.map