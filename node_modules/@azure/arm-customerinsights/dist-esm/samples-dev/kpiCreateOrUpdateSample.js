...
function kpiCreateOrUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.kpi.beginCreateOrUpdateAndWait(resourceGroupName, hubName, kpiName, parameters);
        console.log(result);
    });
}
kpiCreateOrUpdate().catch(console.error);
//# sourceMappingURL=kpiCreateOrUpdateSample.js.map