...
export class LinksImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, hubName, linkName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, linkName, parameters, options }, createOrUpdateOperationSpec);
    ...
    get(resourceGroupName, hubName, linkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, hubName, linkName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, hubName, linkName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, hubName, linkName, options }, deleteOperationSpec);
    }
    /**
     * Gets all the links in the specified hub.
     * @param resourceGroupName The name of the resource group.
