...
export class InteractionsImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, hubName, interactionName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, interactionName, parameters, options }, createOrUpdateOperationSpec);
    ...
    get(resourceGroupName, hubName, interactionName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, hubName, interactionName, options }, getOperationSpec);
    }
    /**
     * Gets all interactions in the hub.
     * @param resourceGroupName The name of the resource group.
