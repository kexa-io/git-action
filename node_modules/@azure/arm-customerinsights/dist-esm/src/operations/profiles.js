...
export class ProfilesImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, hubName, profileName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, profileName, parameters, options }, createOrUpdateOperationSpec);
    ...
    get(resourceGroupName, hubName, profileName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, hubName, profileName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, hubName, profileName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, profileName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
