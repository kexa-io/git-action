...
export class KpiImpl {
    ...
    beginCreateOrUpdate(resourceGroupName, hubName, kpiName, parameters, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, kpiName, parameters, options }, createOrUpdateOperationSpec);
    ...
    get(resourceGroupName, hubName, kpiName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, hubName, kpiName, options }, getOperationSpec);
    }
    /**
    ...
    beginDelete(resourceGroupName, hubName, kpiName, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const lro = new LroImpl(sendOperation, { resourceGroupName, hubName, kpiName, options }, deleteOperationSpec);
            const poller = new LroEngine(lro, {
                resumeFrom: options === null || options === void 0 ? void 0 : options.resumeFrom,
                intervalInMs: options === null || options === void 0 ? void 0 : options.updateIntervalInMs
            });
