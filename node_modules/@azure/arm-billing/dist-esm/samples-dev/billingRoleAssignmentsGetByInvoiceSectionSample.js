 ...
 */
function invoiceSectionRoleAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.billingRoleAssignments.getByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, billingRoleAssignmentName);
        console.log(result);
    });
}
invoiceSectionRoleAssignment().catch(console.error);
//# sourceMappingURL=billingRoleAssignmentsGetByInvoiceSectionSample.js.map