 ...
 */
function invoicesListByBillingProfile() {
    var e_1, _a;
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _b = __asyncValues(client.invoices.listByBillingProfile(billingAccountName, billingProfileName, periodStartDate, periodEndDate)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
 ...
 */
function invoicesListByBillingProfileWithRebillDetails() {
    var e_2, _a;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "00000000-0000-0000-0000-000000000000";
        const billingAccountName = "{billingAccountName}";
...
//# sourceMappingURL=invoicesListByBillingProfileSample.js.map