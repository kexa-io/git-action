...
function invoiceDownload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.invoices.beginDownloadInvoiceAndWait(billingAccountName, invoiceName, downloadToken);
        console.log(result);
    });
}
invoiceDownload().catch(console.error);
//# sourceMappingURL=invoicesDownloadInvoiceSample.js.map