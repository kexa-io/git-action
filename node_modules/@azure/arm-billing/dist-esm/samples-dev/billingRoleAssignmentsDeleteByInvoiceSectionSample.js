 ...
 */
function invoiceSectionRoleAssignmentDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.billingRoleAssignments.deleteByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, billingRoleAssignmentName);
        console.log(result);
    });
}
invoiceSectionRoleAssignmentDelete().catch(console.error);
//# sourceMappingURL=billingRoleAssignmentsDeleteByInvoiceSectionSample.js.map