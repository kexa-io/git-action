...
function invoiceSection() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.invoiceSections.get(billingAccountName, billingProfileName, invoiceSectionName);
        console.log(result);
    });
}
invoiceSection().catch(console.error);
//# sourceMappingURL=invoiceSectionsGetSample.js.map