 ...
 */
function billingProfileInvoiceDownload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.invoices.beginDownloadMultipleBillingProfileInvoicesAndWait(billingAccountName, downloadUrls);
        console.log(result);
    });
}
billingProfileInvoiceDownload().catch(console.error);
//# sourceMappingURL=invoicesDownloadMultipleBillingProfileInvoicesSample.js.map