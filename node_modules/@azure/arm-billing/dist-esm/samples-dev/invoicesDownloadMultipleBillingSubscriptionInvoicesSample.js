 ...
 */
function billingSubscriptionInvoiceDownload() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.invoices.beginDownloadMultipleBillingSubscriptionInvoicesAndWait(downloadUrls);
        console.log(result);
    });
}
billingSubscriptionInvoiceDownload().catch(console.error);
//# sourceMappingURL=invoicesDownloadMultipleBillingSubscriptionInvoicesSample.js.map