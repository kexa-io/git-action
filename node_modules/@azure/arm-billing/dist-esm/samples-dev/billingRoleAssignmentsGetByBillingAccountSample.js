 ...
 */
function billingAccountRoleAssignment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.billingRoleAssignments.getByBillingAccount(billingAccountName, billingRoleAssignmentName);
        console.log(result);
    });
}
billingAccountRoleAssignment().catch(console.error);
//# sourceMappingURL=billingRoleAssignmentsGetByBillingAccountSample.js.map