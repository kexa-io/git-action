 ...
 */
function billingProfileRoleDefinition() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.billingRoleDefinitions.getByBillingProfile(billingAccountName, billingProfileName, billingRoleDefinitionName);
        console.log(result);
    });
}
billingProfileRoleDefinition().catch(console.error);
//# sourceMappingURL=billingRoleDefinitionsGetByBillingProfileSample.js.map