...
function putInstruction() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.instructions.put(billingAccountName, billingProfileName, instructionName, parameters);
        console.log(result);
    });
}
putInstruction().catch(console.error);
//# sourceMappingURL=instructionsPutSample.js.map