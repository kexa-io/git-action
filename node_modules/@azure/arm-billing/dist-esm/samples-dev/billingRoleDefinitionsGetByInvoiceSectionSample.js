 ...
 */
function invoiceSectionRoleDefinition() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.billingRoleDefinitions.getByInvoiceSection(billingAccountName, billingProfileName, invoiceSectionName, billingRoleDefinitionName);
        console.log(result);
    });
}
invoiceSectionRoleDefinition().catch(console.error);
//# sourceMappingURL=billingRoleDefinitionsGetByInvoiceSectionSample.js.map