...
export class BillingRoleDefinitionsImpl {
    /**
    ...
    getByBillingAccount(billingAccountName, billingRoleDefinitionName, options) {
        return this.client.sendOperationRequest({ billingAccountName, billingRoleDefinitionName, options }, getByBillingAccountOperationSpec);
    }
    /**
...
//# sourceMappingURL=billingRoleDefinitions.js.map