...
describe("netapp test", () => {
    ...
    it("accounts create test", function () {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield client.accounts.beginCreateOrUpdateAndWait(resourceGroup, accountName, {
                location: location
            }, testPollingOptions);
    ...
    it("accounts list test", function () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                for (var _d = true, _e = __asyncValues(client.accounts.list(resourceGroup)), _f; _f = yield _e.next(), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    let item = _c;
                    resArray.push(item);
...
//# sourceMappingURL=netapp_examples.spec.js.map