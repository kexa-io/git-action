 ...
 */
function networkFeaturesUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const subnetId = "/subscriptions/9760acf5-4638-11e7-9bdb-020073ca7778/resourceGroups/myRP/providers/Microsoft.Network/virtualNetworks/testVnet/subnets/testSubnet";
        const networkSiblingSetStateId = "12345_44420.8001578125";
        const networkFeatures = "Standard";
        const credential = new DefaultAzureCredential();
        const client = new NetAppManagementClient(credential, subscriptionId);
        const result = yield client.netAppResource.beginUpdateNetworkSiblingSetAndWait(location, networkSiblingSetId, subnetId, networkSiblingSetStateId, networkFeatures);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=netAppResourceUpdateNetworkSiblingSetSample.js.map