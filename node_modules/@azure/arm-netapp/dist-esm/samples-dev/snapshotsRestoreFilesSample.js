...
function snapshotsSingleFileRestore() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.snapshots.beginRestoreFilesAndWait(resourceGroupName, accountName, poolName, volumeName, snapshotName, body);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=snapshotsRestoreFilesSample.js.map