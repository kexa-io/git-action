...
function checkFilePathAvailability() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const subnetId = "/subscriptions/9760acf5-4638-11e7-9bdb-020073ca7778/resourceGroups/myRP/providers/Microsoft.Network/virtualNetworks/testvnet3/subnets/testsubnet3";
        const credential = new DefaultAzureCredential();
        const client = new NetAppManagementClient(credential, subscriptionId);
        const result = yield client.netAppResource.checkFilePathAvailability(location, name, subnetId);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=netAppResourceCheckFilePathAvailabilitySample.js.map