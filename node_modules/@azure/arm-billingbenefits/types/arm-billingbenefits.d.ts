...
export declare class BillingBenefitsRP extends coreClient.ServiceClient {
    $host: string;
    apiVersion: string;
    /**
...
/** Optional parameters. */
export declare interface BillingBenefitsRPOptionalParams extends coreClient.ServiceClientOptions {
    /** server parameter */
    $host?: string;
    /** Api Version */
    apiVersion?: string;
...
export declare interface BillingPlanInformation {
...
export declare enum KnownPricingCurrencyDuration {
    /** P1M */
    P1M = "P1M",
    /** P1Y */
    P1Y = "P1Y",
 ...
 * **P3Y**
 */
export declare type PricingCurrencyDuration = string;

export declare interface PricingCurrencyTotal extends Price {
...
export declare interface RenewProperties {
    purchaseProperties?: PurchaseRequest;
}

/** Interface representing a ReservationOrderAlias. */
export declare interface ReservationOrderAlias {
    /**
...
export declare interface ReservationOrderAliasCreateHeaders {
...
/** Optional parameters. */
export declare interface ReservationOrderAliasCreateOptionalParams extends coreClient.OperationOptions {
...
export declare type ReservationOrderAliasCreateResponse = ReservationOrderAliasResponse;

/** Optional parameters. */
export declare interface ReservationOrderAliasGetOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the get operation. */
export declare type ReservationOrderAliasGetResponse = ReservationOrderAliasResponse;

/** Reservation order alias */
export declare interface ReservationOrderAliasRequest extends Resource {
...
/** Properties specific to each reserved resource type. Not required if not applicable. */
export declare interface ReservationOrderAliasRequestPropertiesReservedResourceProperties {
    /** Turning this on will apply the reservation discount to other VMs in the same VM size group. */
    instanceFlexibility?: InstanceFlexibility;
}

/** Reservation order alias */
export declare interface ReservationOrderAliasResponse extends Resource {
    /** Reservation order SKU */
    sku: Sku;
...
/** Properties specific to each reserved resource type. Not required if not applicable. */
export declare interface ReservationOrderAliasResponsePropertiesReservedResourceProperties {
    /** Turning this on will apply the reservation discount to other VMs in the same VM size group. */
    instanceFlexibility?: InstanceFlexibility;
}
...
export declare interface RoleAssignmentEntity {
...
export declare interface SavingsPlan {
    /**
...
/** Optional parameters. */
export declare interface SavingsPlanGetOptionalParams extends coreClient.OperationOptions {
    /** May be used to expand the detail information of some properties. */
    expand?: string;
}

/** Contains response data for the get operation. */
export declare type SavingsPlanGetResponse = SavingsPlanModel;

/** Optional parameters. */
export declare interface SavingsPlanListAllNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listAllNext operation. */
export declare type SavingsPlanListAllNextResponse = SavingsPlanModelListResult;

/** Optional parameters. */
export declare interface SavingsPlanListAllOptionalParams extends coreClient.OperationOptions {
...
export declare type SavingsPlanListAllResponse = SavingsPlanModelListResult;

/** Optional parameters. */
export declare interface SavingsPlanListNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listNext operation. */
export declare type SavingsPlanListNextResponse = SavingsPlanModelList;

/** Optional parameters. */
export declare interface SavingsPlanListOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the list operation. */
export declare type SavingsPlanListResponse = SavingsPlanModelList;

/** Savings plan */
export declare interface SavingsPlanModel extends Resource {
    /** Savings plan SKU */
    sku: Sku;
    /** Display name */
    displayName?: string;
...
export declare interface SavingsPlanModelList {
    value?: SavingsPlanModel[];
    /** Url to get the next page. */
    nextLink?: string;
}

export declare interface SavingsPlanModelListResult {
    /**
...
export declare interface SavingsPlanOrder {
    /**
...
export declare interface SavingsPlanOrderAlias {
    /**
...
export declare interface SavingsPlanOrderAliasCreateHeaders {
    /** URL for checking the ongoing status of the operation. */
    azureAsyncOperation?: string;
    /** Clients should wait for the Retry-After interval before polling again */
    retryAfter?: number;
...
/** Optional parameters. */
export declare interface SavingsPlanOrderAliasCreateOptionalParams extends coreClient.OperationOptions {
    /** Delay to wait until next poll, in milliseconds. */
    updateIntervalInMs?: number;
    /** A serialized poller which can be used to resume an existing paused Long-Running-Operation. */
    resumeFrom?: string;
...
/** Contains response data for the create operation. */
export declare type SavingsPlanOrderAliasCreateResponse = SavingsPlanOrderAliasModel;

/** Optional parameters. */
export declare interface SavingsPlanOrderAliasGetOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the get operation. */
export declare type SavingsPlanOrderAliasGetResponse = SavingsPlanOrderAliasModel;

/** Savings plan order alias */
export declare interface SavingsPlanOrderAliasModel extends Resource {
    /** Savings plan SKU */
    sku: Sku;
...
/** Optional parameters. */
export declare interface SavingsPlanOrderElevateOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the elevate operation. */
export declare type SavingsPlanOrderElevateResponse = RoleAssignmentEntity;

/** Optional parameters. */
export declare interface SavingsPlanOrderGetOptionalParams extends coreClient.OperationOptions {
    /** May be used to expand the detail information of some properties. */
    expand?: string;
}

/** Contains response data for the get operation. */
export declare type SavingsPlanOrderGetResponse = SavingsPlanOrderModel;

/** Optional parameters. */
export declare interface SavingsPlanOrderListNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listNext operation. */
export declare type SavingsPlanOrderListNextResponse = SavingsPlanOrderModelList;

/** Optional parameters. */
export declare interface SavingsPlanOrderListOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the list operation. */
export declare type SavingsPlanOrderListResponse = SavingsPlanOrderModelList;

/** Savings plan order */
export declare interface SavingsPlanOrderModel extends Resource {
    /** Savings plan SKU */
    sku: Sku;
    /** Display name */
    displayName?: string;
...
export declare interface SavingsPlanOrderModelList {
    value?: SavingsPlanOrderModel[];
    /** Url to get the next page. */
    nextLink?: string;
}

export declare interface SavingsPlanPurchaseValidateRequest {
    benefits?: SavingsPlanOrderAliasModel[];
}

/** Savings plans list summary */
export declare interface SavingsPlanSummary {
    /**
...
/** The roll up count summary of savings plans in each state */
export declare interface SavingsPlanSummaryCount {
    /**
...
export declare interface SavingsPlanUpdateHeaders {
    location?: string;
}

/** Optional parameters. */
export declare interface SavingsPlanUpdateOptionalParams extends coreClient.OperationOptions {
}

/** Savings plan patch request */
export declare interface SavingsPlanUpdateRequest {
    /** Savings plan patch request */
    properties?: SavingsPlanUpdateRequestProperties;
}

/** Savings plan patch request */
export declare interface SavingsPlanUpdateRequestProperties {
    /** Display name */
    displayName?: string;
    /** Type of the Applied Scope. */
    appliedScopeType?: AppliedScopeType;
...
export declare type SavingsPlanUpdateResponse = SavingsPlanModel;

export declare interface SavingsPlanUpdateValidateRequest {
    benefits?: SavingsPlanUpdateRequestProperties[];
}

export declare interface SavingsPlanValidateResponse {
...
/** Optional parameters. */
export declare interface SavingsPlanValidateUpdateOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the validateUpdate operation. */
export declare type SavingsPlanValidateUpdateResponse = SavingsPlanValidateResponse;

/** Benefit scope response property */
export declare interface SavingsPlanValidResponseProperty {
...
/** Savings plan utilization */
export declare interface Utilization {
    /**
...
export declare interface UtilizationAggregates {
    /**
...
/** Optional parameters. */
export declare interface ValidatePurchaseOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the validatePurchase operation. */
export declare type ValidatePurchaseResponse = SavingsPlanValidateResponse;
