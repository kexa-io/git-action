...
function savingsPlanUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.savingsPlan.update(savingsPlanOrderId, savingsPlanId, body);
        console.log(result);
    });
}
savingsPlanUpdate().catch(console.error);
//# sourceMappingURL=savingsPlanUpdateSample.js.map