...
function getChange() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.changes.get(resourceGroupName, resourceProviderNamespace, resourceType, resourceName, changeResourceId);
        console.log(result);
    });
}
getChange().catch(console.error);
//# sourceMappingURL=changesGetSample.js.map