 ...
 * @enum {string}
 */
export declare type ProvisioningState = 'Provisioning' | 'Deleting' | 'Succeeded' | 'Failed' | 'Canceled';
/**
 ...
 * @enum {string}
 */
export declare type IoTSpacesSku = 'F1' | 'S1' | 'S2' | 'S3';
/**
 ...
 */
export declare type IoTSpacesDeleteMethodResponse = IoTSpacesDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type IoTSpacesBeginCreateOrUpdateResponse = IoTSpacesDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type IoTSpacesBeginUpdateResponse = IoTSpacesDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
 ...
 */
export declare type IoTSpacesBeginDeleteMethodResponse = IoTSpacesDescription & {
    /**
     * The underlying HTTP response.
     */
    _response: msRest.HttpResponse & {
