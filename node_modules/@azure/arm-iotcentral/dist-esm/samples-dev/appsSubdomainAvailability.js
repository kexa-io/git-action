...
function appsSubdomainAvailability() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apps.checkSubdomainAvailability(operationInputs);
        console.log(result);
    });
}
appsSubdomainAvailability().catch(console.error);
//# sourceMappingURL=appsSubdomainAvailability.js.map