 ...
 */
export declare type DirectoryObjectUnion = DirectoryObject | Application | ADGroup | ServicePrincipal | User;
/**
 ...
 * @enum {string}
 */
export declare type UserType = 'Member' | 'Guest';
/**
 ...
 * @enum {string}
 */
export declare type ConsentType = 'AllPrincipals' | 'Principal';
/**
