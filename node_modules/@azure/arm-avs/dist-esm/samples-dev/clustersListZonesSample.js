...
function clustersListZoneData() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.clusters.listZones(resourceGroupName, privateCloudName, clusterName);
        console.log(result);
    });
}
/**
 ...
 */
function clustersListZoneDataStretched() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["AVS_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["AVS_RESOURCE_GROUP"] || "group1";
...
//# sourceMappingURL=clustersListZonesSample.js.map