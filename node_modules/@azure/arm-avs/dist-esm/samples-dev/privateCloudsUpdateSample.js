...
function privateCloudsUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateClouds.beginUpdateAndWait(resourceGroupName, privateCloudName, privateCloudUpdate);
        console.log(result);
    });
}
/**
 ...
 */
function privateCloudsUpdateStretched() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["AVS_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["AVS_RESOURCE_GROUP"] || "group1";
...
//# sourceMappingURL=privateCloudsUpdateSample.js.map