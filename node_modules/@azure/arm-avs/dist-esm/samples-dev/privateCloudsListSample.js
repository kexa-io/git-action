...
function privateCloudsList() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.privateClouds.list(resourceGroupName)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
 ...
 */
function privateCloudsListStretched() {
    var _a, e_2, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["AVS_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
...
//# sourceMappingURL=privateCloudsListSample.js.map