...
export class ImpactedResourcesImpl {
    ...
    listBySubscriptionIdAndEventIdPagingPage(eventTrackingId, options, settings) {
        return __asyncGenerator(this, arguments, function* listBySubscriptionIdAndEventIdPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listBySubscriptionIdAndEventId(eventTrackingId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listBySubscriptionIdAndEventIdNext(eventTrackingId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listBySubscriptionIdAndEventIdPagingAll(eventTrackingId, options) {
        return __asyncGenerator(this, arguments, function* listBySubscriptionIdAndEventIdPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
    ...
    listByTenantIdAndEventIdPagingPage(eventTrackingId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByTenantIdAndEventIdPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByTenantIdAndEventId(eventTrackingId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
            ...
            while (continuationToken) {
                result = yield __await(this._listByTenantIdAndEventIdNext(eventTrackingId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByTenantIdAndEventIdPagingAll(eventTrackingId, options) {
        return __asyncGenerator(this, arguments, function* listByTenantIdAndEventIdPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
    ...
    get(eventTrackingId, impactedResourceName, options) {
        return this.client.sendOperationRequest({ eventTrackingId, impactedResourceName, options }, getOperationSpec);
    }
    /**
     * Lists impacted resources in the tenant by an event.
     * @param eventTrackingId Event Id which uniquely identifies ServiceHealth event.
...
//# sourceMappingURL=impactedResources.js.map