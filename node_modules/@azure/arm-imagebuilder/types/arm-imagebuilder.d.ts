...
export declare interface DistributeVersioner {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    scheme: "Latest" | "Source";
}

/** Generates version number that will be latest based on existing version numbers. */
export declare interface DistributeVersionerLatest extends DistributeVersioner {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    scheme: "Latest";
...
export declare interface DistributeVersionerSource extends DistributeVersioner {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    scheme: "Source";
}

export declare type DistributeVersionerUnion = DistributeVersioner | DistributeVersionerLatest | DistributeVersionerSource;
...
export declare interface ImageTemplate extends TrackedResource {
...
export declare interface ImageTemplateFileCustomizer extends ImageTemplateCustomizer {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "File";
...
export declare interface ImageTemplateFileValidator extends ImageTemplateInVMValidator {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "File";
...
export declare interface ImageTemplateInVMValidator {
    /** Polymorphic discriminator, which specifies the different types this object can be */
...
export declare type ImageTemplateInVMValidatorUnion = ImageTemplateInVMValidator | ImageTemplateShellValidator | ImageTemplatePowerShellValidator | ImageTemplateFileValidator;
...
export declare interface ImageTemplateManagedImageDistributor extends ImageTemplateDistributor {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "ManagedImage";
...
export declare interface ImageTemplateManagedImageSource extends ImageTemplateSource {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "ManagedImage";
...
export declare interface ImageTemplatePlatformImageSource extends ImageTemplateSource {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "PlatformImage";
...
export declare interface ImageTemplatePowerShellCustomizer extends ImageTemplateCustomizer {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "PowerShell";
...
export declare interface ImageTemplatePowerShellValidator extends ImageTemplateInVMValidator {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "PowerShell";
...
/** Error handling options upon a build failure */
export declare interface ImageTemplatePropertiesErrorHandling {
...
/** Specifies optimization to be performed on image. */
export declare interface ImageTemplatePropertiesOptimize {
    /** Optimization is applied on the image for a faster VM boot. */
    vmBoot?: ImageTemplatePropertiesOptimizeVmBoot;
}

/** Optimization is applied on the image for a faster VM boot. */
export declare interface ImageTemplatePropertiesOptimizeVmBoot {
    /** Enabling this field will improve VM boot time by optimizing the final customized image output. */
    state?: VMBootOptimizationState;
}

/** Configuration options and list of validations to be performed on the resulting image. */
export declare interface ImageTemplatePropertiesValidate {
...
export declare interface ImageTemplateRestartCustomizer extends ImageTemplateCustomizer {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "WindowsRestart";
...
export declare interface ImageTemplateSharedImageDistributor extends ImageTemplateDistributor {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "SharedImage";
...
export declare interface ImageTemplateSharedImageVersionSource extends ImageTemplateSource {
    /** Polymorphic discriminator, which specifies the different types this object can be */
...
export declare interface ImageTemplateShellCustomizer extends ImageTemplateCustomizer {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "Shell";
...
export declare interface ImageTemplateShellValidator extends ImageTemplateInVMValidator {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "Shell";
...
/** Parameters for updating an image template. */
export declare interface ImageTemplateUpdateParametersProperties {
    /** The distribution targets where the image output needs to go to. */
    distribute?: ImageTemplateDistributorUnion[];
}

/** Distribute via VHD in a storage account. */
export declare interface ImageTemplateVhdDistributor extends ImageTemplateDistributor {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "VHD";
...
export declare interface ImageTemplateWindowsUpdateCustomizer extends ImageTemplateCustomizer {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    type: "WindowsUpdate";
...
export declare enum KnownOnBuildError {
    /** Cleanup */
    Cleanup = "cleanup",
    /** Abort */
    Abort = "abort"
 ...
 * **abort**
 */
export declare type OnBuildError = string;
...
export declare type ProvisioningState = "Creating" | "Updating" | "Succeeded" | "Failed" | "Deleting" | "Canceled";
...
export declare interface RunOutput extends ProxyResource {
...
export declare type RunSubState = "Queued" | "Building" | "Customizing" | "Optimizing" | "Validating" | "Distributing";
...
export declare interface SourceImageTriggerProperties extends TriggerProperties {
    /** Polymorphic discriminator, which specifies the different types this object can be */
    kind: "SourceImage";
}
...
export declare interface TriggerCollection {
...
export declare type TriggerPropertiesUnion = TriggerProperties | SourceImageTriggerProperties;
...
export declare type TriggersCreateOrUpdateResponse = Trigger;

/** Defines headers for Triggers_delete operation. */
export declare interface TriggersDeleteHeaders {
...
export declare type TriggersDeleteResponse = TriggersDeleteHeaders;
...
export declare type TriggersGetResponse = Trigger;

/** Optional parameters. */
export declare interface TriggersListByImageTemplateNextOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listByImageTemplateNext operation. */
export declare type TriggersListByImageTemplateNextResponse = TriggerCollection;

/** Optional parameters. */
export declare interface TriggersListByImageTemplateOptionalParams extends coreClient.OperationOptions {
}

/** Contains response data for the listByImageTemplate operation. */
export declare type TriggersListByImageTemplateResponse = TriggerCollection;

/** Describes the status of a trigger */
export declare interface TriggerStatus {
    /**
     * The status code.
     * NOTE: This property will not be serialized. It can only be populated by the server.
     */
...
export declare interface VirtualMachineImageTemplatesDeleteHeaders {
    /** The URI to poll for completion status. */
    location?: string;
}
...
/** Contains response data for the delete operation. */
export declare type VirtualMachineImageTemplatesDeleteResponse = VirtualMachineImageTemplatesDeleteHeaders;
...
export declare type VMBootOptimizationState = "Enabled" | "Disabled";
