 ...
 */
function createAnImageTemplateForLinux() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.virtualMachineImageTemplates.beginCreateOrUpdateAndWait(resourceGroupName, imageTemplateName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createAnImageTemplateForWindows() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["IMAGEBUILDER_SUBSCRIPTION_ID"] || "{subscription-id}";
        const resourceGroupName = process.env["IMAGEBUILDER_RESOURCE_GROUP"] || "myResourceGroup";
        const imageTemplateName = "myImageTemplate";
...
//# sourceMappingURL=virtualMachineImageTemplatesCreateOrUpdateSample.js.map