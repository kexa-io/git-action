 ...
 */
function getsTheManagedApplication() {
    return __awaiter(this, void 0, void 0, function* () {
        const applicationId = "subscriptions/subid/resourceGroups/rg/providers/Microsoft.Solutions/applications/myManagedApplication";
        const credential = new DefaultAzureCredential();
        const client = new ApplicationClient(credential);
        const result = yield client.applications.getById(applicationId);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=applicationsGetByIdSample.js.map