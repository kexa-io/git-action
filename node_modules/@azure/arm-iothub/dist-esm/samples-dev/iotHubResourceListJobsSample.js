 ...
 */
function iotHubResourceListJobs() {
    var _a, e_1, _b, _c;
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["IOTHUB_SUBSCRIPTION_ID"] ||
        ...
        try {
            for (var _d = true, _e = __asyncValues(client.iotHubResource.listJobs(resourceGroupName, resourceName)), _f; _f = yield _e.next(), _a = _f.done, !_a;) {
                _c = _f.value;
                _d = false;
                try {
                    let item = _c;
...
//# sourceMappingURL=iotHubResourceListJobsSample.js.map