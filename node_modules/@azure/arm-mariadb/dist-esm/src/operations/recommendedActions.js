...
export class RecommendedActionsImpl {
    /**
    ...
    listByServerPagingPage(resourceGroupName, serverName, advisorName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByServerPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByServer(resourceGroupName, serverName, advisorName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByServerNext(resourceGroupName, serverName, advisorName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByServerPagingAll(resourceGroupName, serverName, advisorName, options) {
        return __asyncGenerator(this, arguments, function* listByServerPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByServerPagingPage(resourceGroupName, serverName, advisorName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
