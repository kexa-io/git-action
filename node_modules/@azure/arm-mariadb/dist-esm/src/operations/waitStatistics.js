...
export class WaitStatisticsImpl {
    /**
    ...
    listByServerPagingPage(resourceGroupName, serverName, parameters, options, settings) {
        return __asyncGenerator(this, arguments, function* listByServerPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByServer(resourceGroupName, serverName, parameters, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByServerNext(resourceGroupName, serverName, parameters, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByServerPagingAll(resourceGroupName, serverName, parameters, options) {
        return __asyncGenerator(this, arguments, function* listByServerPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByServerPagingPage(resourceGroupName, serverName, parameters, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
...
//# sourceMappingURL=waitStatistics.js.map