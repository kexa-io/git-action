 ...
 */
function recommendedActionSessionOperationStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.locationBasedRecommendedActionSessionsOperationStatus.get(locationName, operationId);
        console.log(result);
    });
}
recommendedActionSessionOperationStatus().catch(console.error);
//# sourceMappingURL=locationBasedRecommendedActionSessionsOperationStatusGetSample.js.map