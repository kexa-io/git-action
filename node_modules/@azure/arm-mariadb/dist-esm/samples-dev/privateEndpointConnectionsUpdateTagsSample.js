 ...
 */
function updatePrivateEndpointConnectionTags() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginUpdateTagsAndWait(resourceGroupName, serverName, privateEndpointConnectionName, parameters);
        console.log(result);
    });
}
updatePrivateEndpointConnectionTags().catch(console.error);
//# sourceMappingURL=privateEndpointConnectionsUpdateTagsSample.js.map