 ...
 */
function federatedIdentityCredentialCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["MSI_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.federatedIdentityCredentials.createOrUpdate(resourceGroupName, resourceName, federatedIdentityCredentialResourceName, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=federatedIdentityCredentialsCreateOrUpdateSample.js.map