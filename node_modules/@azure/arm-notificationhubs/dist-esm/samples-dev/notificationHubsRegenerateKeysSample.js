 ...
 */
function notificationHubAuthorizationRuleRegenrateKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.regenerateKeys(resourceGroupName, namespaceName, notificationHubName, authorizationRuleName, parameters);
        console.log(result);
    });
}
notificationHubAuthorizationRuleRegenrateKey().catch(console.error);
//# sourceMappingURL=notificationHubsRegenerateKeysSample.js.map