...
function debugsend() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.debugSend(resourceGroupName, namespaceName, notificationHubName, options);
        console.log(result);
    });
}
debugsend().catch(console.error);
//# sourceMappingURL=notificationHubsDebugSendSample.js.map