...
function notificationHubPatch() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.patch(resourceGroupName, namespaceName, notificationHubName, options);
        console.log(result);
    });
}
notificationHubPatch().catch(console.error);
//# sourceMappingURL=notificationHubsPatchSample.js.map