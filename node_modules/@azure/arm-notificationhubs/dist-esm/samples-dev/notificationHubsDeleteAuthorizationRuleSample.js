 ...
 */
function notificationHubAuthorizationRuleDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.deleteAuthorizationRule(resourceGroupName, namespaceName, notificationHubName, authorizationRuleName);
        console.log(result);
    });
}
notificationHubAuthorizationRuleDelete().catch(console.error);
//# sourceMappingURL=notificationHubsDeleteAuthorizationRuleSample.js.map