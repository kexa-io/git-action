...
function notificationHubGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.get(resourceGroupName, namespaceName, notificationHubName);
        console.log(result);
    });
}
notificationHubGet().catch(console.error);
//# sourceMappingURL=notificationHubsGetSample.js.map