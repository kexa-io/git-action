 ...
 */
function notificationHubPnsCredentials() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.getPnsCredentials(resourceGroupName, namespaceName, notificationHubName);
        console.log(result);
    });
}
notificationHubPnsCredentials().catch(console.error);
//# sourceMappingURL=notificationHubsGetPnsCredentialsSample.js.map