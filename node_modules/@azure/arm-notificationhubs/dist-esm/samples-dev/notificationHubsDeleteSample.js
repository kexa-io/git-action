 ...
 */
function notificationHubDelete() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.delete(resourceGroupName, namespaceName, notificationHubName);
        console.log(result);
    });
}
notificationHubDelete().catch(console.error);
//# sourceMappingURL=notificationHubsDeleteSample.js.map