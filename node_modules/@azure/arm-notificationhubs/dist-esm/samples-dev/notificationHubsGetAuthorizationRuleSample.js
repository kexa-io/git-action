 ...
 */
function notificationHubAuthorizationRuleGet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.notificationHubs.getAuthorizationRule(resourceGroupName, namespaceName, notificationHubName, authorizationRuleName);
        console.log(result);
    });
}
notificationHubAuthorizationRuleGet().catch(console.error);
//# sourceMappingURL=notificationHubsGetAuthorizationRuleSample.js.map