 ...
 */
function nameSpaceAuthorizationRuleRegenerateKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namespaces.regenerateKeys(resourceGroupName, namespaceName, authorizationRuleName, parameters);
        console.log(result);
    });
}
nameSpaceAuthorizationRuleRegenerateKey().catch(console.error);
//# sourceMappingURL=namespacesRegenerateKeysSample.js.map