...
export class RulesImpl {
    ...
    listByRuleSetPagingAll(resourceGroupName, profileName, ruleSetName, options) {
        return __asyncGenerator(this, arguments, function* listByRuleSetPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByRuleSetPagingPage(resourceGroupName, profileName, ruleSetName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
