...
function guestUsagesCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.guestUsages.create(resourceGroupName, resourceName, options);
        console.log(result);
    });
}
guestUsagesCreate().catch(console.error);
//# sourceMappingURL=guestUsagesCreateSample.js.map