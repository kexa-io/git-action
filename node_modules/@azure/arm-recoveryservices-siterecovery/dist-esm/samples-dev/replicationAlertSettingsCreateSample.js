...
function configuresEmailNotificationsForThisVault() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.replicationAlertSettings.create(resourceName, resourceGroupName, alertSettingName, request);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=replicationAlertSettingsCreateSample.js.map