...
function getsARecoveryPoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.recoveryPoints.get(resourceName, resourceGroupName, fabricName, protectionContainerName, replicatedProtectedItemName, recoveryPointName);
        console.log(result);
    });
}
function main() {
