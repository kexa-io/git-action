...
export class ReplicationvCentersImpl {
    /**
    ...
    listByReplicationFabricsPagingAll(resourceName, resourceGroupName, fabricName, options) {
        return __asyncGenerator(this, arguments, function* listByReplicationFabricsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByReplicationFabricsPagingPage(resourceName, resourceGroupName, fabricName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
    ...
    get(resourceName, resourceGroupName, fabricName, vcenterName, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, fabricName, vcenterName, options }, getOperationSpec);
    }
    /**
