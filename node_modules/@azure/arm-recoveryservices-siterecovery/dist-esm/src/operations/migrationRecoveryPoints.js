...
export class MigrationRecoveryPointsImpl {
    /**
    ...
    listByReplicationMigrationItemsPagingPage(resourceName, resourceGroupName, fabricName, protectionContainerName, migrationItemName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByReplicationMigrationItemsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByReplicationMigrationItems(resourceName, resourceGroupName, fabricName, protectionContainerName, migrationItemName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByReplicationMigrationItemsNext(resourceName, resourceGroupName, fabricName, protectionContainerName, migrationItemName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByReplicationMigrationItemsPagingAll(resourceName, resourceGroupName, fabricName, protectionContainerName, migrationItemName, options) {
        return __asyncGenerator(this, arguments, function* listByReplicationMigrationItemsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByReplicationMigrationItemsPagingPage(resourceName, resourceGroupName, fabricName, protectionContainerName, migrationItemName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a; _d = true) {
                    _c = _f.value;
                    _d = false;
                    const page = _c;
...
//# sourceMappingURL=migrationRecoveryPoints.js.map