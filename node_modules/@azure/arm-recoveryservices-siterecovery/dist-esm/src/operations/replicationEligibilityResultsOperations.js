...
export class ReplicationEligibilityResultsOperationsImpl {
    ...
    list(resourceGroupName, virtualMachineName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, virtualMachineName, options }, listOperationSpec);
    }
    /**
     * Validates whether a given VM can be protected or not in which case returns list of errors.
     * @param resourceGroupName The name of the resource group where the recovery services vault is
...
//# sourceMappingURL=replicationEligibilityResultsOperations.js.map