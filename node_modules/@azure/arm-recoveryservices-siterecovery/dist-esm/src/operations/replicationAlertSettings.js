...
export class ReplicationAlertSettingsImpl {
    ...
    get(resourceName, resourceGroupName, alertSettingName, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, alertSettingName, options }, getOperationSpec);
    }
    /**
    ...
    create(resourceName, resourceGroupName, alertSettingName, request, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, alertSettingName, request, options }, createOperationSpec);
    }
    /**
     * ListNext
     * @param resourceName The name of the recovery services vault.
