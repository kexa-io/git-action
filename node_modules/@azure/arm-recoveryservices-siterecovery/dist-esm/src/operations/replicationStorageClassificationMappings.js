...
export class ReplicationStorageClassificationMappingsImpl {
    ...
    listByReplicationStorageClassificationsPagingPage(resourceName, resourceGroupName, fabricName, storageClassificationName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByReplicationStorageClassificationsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByReplicationStorageClassifications(resourceName, resourceGroupName, fabricName, storageClassificationName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByReplicationStorageClassificationsNext(resourceName, resourceGroupName, fabricName, storageClassificationName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByReplicationStorageClassificationsPagingAll(resourceName, resourceGroupName, fabricName, storageClassificationName, options) {
        return __asyncGenerator(this, arguments, function* listByReplicationStorageClassificationsPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByReplicationStorageClassificationsPagingPage(resourceName, resourceGroupName, fabricName, storageClassificationName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
