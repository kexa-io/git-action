...
export class ReplicationProtectionIntentsImpl {
    ...
    get(resourceName, resourceGroupName, intentObjectName, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, intentObjectName, options }, getOperationSpec);
    }
    /**
    ...
    create(resourceName, resourceGroupName, intentObjectName, input, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, intentObjectName, input, options }, createOperationSpec);
    }
    /**
     * ListNext
     * @param resourceName The name of the recovery services vault.
...
//# sourceMappingURL=replicationProtectionIntents.js.map