...
export class SupportedOperatingSystemsOperationsImpl {
    ...
    get(resourceName, resourceGroupName, options) {
        return this.client.sendOperationRequest({ resourceName, resourceGroupName, options }, getOperationSpec);
    }
}
...
//# sourceMappingURL=supportedOperatingSystemsOperations.js.map