...
export class ReplicationNetworkMappingsImpl {
    ...
    listByReplicationNetworksPagingPage(resourceName, resourceGroupName, fabricName, networkName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByReplicationNetworksPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByReplicationNetworks(resourceName, resourceGroupName, fabricName, networkName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByReplicationNetworksNext(resourceName, resourceGroupName, fabricName, networkName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByReplicationNetworksPagingAll(resourceName, resourceGroupName, fabricName, networkName, options) {
        return __asyncGenerator(this, arguments, function* listByReplicationNetworksPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByReplicationNetworksPagingPage(resourceName, resourceGroupName, fabricName, networkName, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
