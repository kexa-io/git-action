 ...
 */
function apiManagementGetPolicyFragment() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.policyFragment.get(resourceGroupName, serviceName, id);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementGetPolicyFragmentFormat() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ApiManagementClient(credential, subscriptionId);
        const result = yield client.policyFragment.get(resourceGroupName, serviceName, id, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=policyFragmentGetSample.js.map