 ...
 */
function apiManagementCreateNamedValue() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.namedValue.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, namedValueId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateNamedValueWithKeyVault() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=namedValueCreateOrUpdateSample.js.map