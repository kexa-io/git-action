 ...
 */
function apiManagementServiceGetMultiRegionInternalVnet() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiManagementService.get(resourceGroupName, serviceName);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementServiceGetService() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
 ...
 */
function apiManagementServiceGetServiceHavingMsi() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=apiManagementServiceGetSample.js.map