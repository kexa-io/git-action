 ...
 */
function apiManagementUpdateDocumentation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.documentation.update(resourceGroupName, serviceName, documentationId, ifMatch, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=documentationUpdateSample.js.map