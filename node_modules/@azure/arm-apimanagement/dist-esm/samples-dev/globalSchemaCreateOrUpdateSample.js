 ...
 */
function apiManagementCreateSchema1() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.globalSchema.beginCreateOrUpdateAndWait(resourceGroupName, serviceName, schemaId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateSchema2() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=globalSchemaCreateOrUpdateSample.js.map