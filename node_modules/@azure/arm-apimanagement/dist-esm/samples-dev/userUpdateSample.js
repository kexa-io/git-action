 ...
 */
function apiManagementUpdateUser() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.user.update(resourceGroupName, serviceName, userId, ifMatch, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=userUpdateSample.js.map