 ...
 */
function apiManagementCreateGroup() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.group.createOrUpdate(resourceGroupName, serviceName, groupId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateGroupExternal() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=groupCreateOrUpdateSample.js.map