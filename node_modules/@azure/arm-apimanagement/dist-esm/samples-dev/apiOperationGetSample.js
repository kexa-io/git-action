 ...
 */
function apiManagementGetApiOperation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiOperation.get(resourceGroupName, serviceName, apiId, operationId);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementGetApiOperationPetStore() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=apiOperationGetSample.js.map