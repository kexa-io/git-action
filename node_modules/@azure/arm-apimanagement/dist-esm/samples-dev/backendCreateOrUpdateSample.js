 ...
 */
function apiManagementCreateBackendProxyBackend() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.backend.createOrUpdate(resourceGroupName, serviceName, backendId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateBackendServiceFabric() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=backendCreateOrUpdateSample.js.map