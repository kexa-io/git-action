 ...
 */
function apiManagementCreateAuthorizationProviderAadAuthCode() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.authorizationProvider.createOrUpdate(resourceGroupName, serviceName, authorizationProviderId, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateAuthorizationProviderAadClientCred() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
 ...
 */
function apiManagementCreateAuthorizationProviderGenericOAuth2() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
 ...
 */
function apiManagementCreateAuthorizationProviderOobGoogle() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=authorizationProviderCreateOrUpdateSample.js.map