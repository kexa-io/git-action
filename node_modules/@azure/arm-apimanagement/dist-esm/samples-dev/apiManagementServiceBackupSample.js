 ...
 */
function apiManagementBackupWithAccessKey() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiManagementService.beginBackupAndWait(resourceGroupName, serviceName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementBackupWithSystemManagedIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
 ...
 */
function apiManagementBackupWithUserAssignedManagedIdentity() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=apiManagementServiceBackupSample.js.map