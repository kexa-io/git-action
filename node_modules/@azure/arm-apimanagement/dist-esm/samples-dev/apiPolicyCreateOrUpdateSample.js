 ...
 */
function apiManagementCreateApiPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.apiPolicy.createOrUpdate(resourceGroupName, serviceName, apiId, policyId, parameters, options);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementCreateApiPolicyNonXmlEncoded() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
...
//# sourceMappingURL=apiPolicyCreateOrUpdateSample.js.map