 ...
 */
function apiManagementUpdateGraphQlApiResolver() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.graphQLApiResolver.update(resourceGroupName, serviceName, apiId, resolverId, ifMatch, parameters);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=graphQlApiResolverUpdateSample.js.map