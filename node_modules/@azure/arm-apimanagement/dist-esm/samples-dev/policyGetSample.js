 ...
 */
function apiManagementGetPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.policy.get(resourceGroupName, serviceName, policyId);
        console.log(result);
    });
}
/**
 ...
 */
function apiManagementGetPolicyFormat() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["APIMANAGEMENT_SUBSCRIPTION_ID"] || "subid";
        const resourceGroupName = process.env["APIMANAGEMENT_RESOURCE_GROUP"] || "rg1";
        const serviceName = "apimService1";
        ...
        const credential = new DefaultAzureCredential();
        const client = new ApiManagementClient(credential, subscriptionId);
        const result = yield client.policy.get(resourceGroupName, serviceName, policyId, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=policyGetSample.js.map