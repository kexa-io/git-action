...
export class AuthorizationProviderImpl {
    /**
    ...
    get(resourceGroupName, serviceName, authorizationProviderId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, authorizationProviderId, options }, getOperationSpec);
    }
    /**
