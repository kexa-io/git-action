...
import { OperationContract, ApiOperationListByApiOptionalParams, ApiOperationGetEntityTagOptionalParams, ApiOperationGetEntityTagResponse, ApiOperationGetOptionalParams, ApiOperationGetResponse, ApiOperationCreateOrUpdateOptionalParams, ApiOperationCreateOrUpdateResponse, OperationUpdateContract, ApiOperationUpdateOptionalParams, ApiOperationUpdateResponse, ApiOperationDeleteOptionalParams } from "../models";
/** Class containing ApiOperation operations. */
export declare class ApiOperationImpl implements ApiOperation {
