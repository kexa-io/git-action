...
import { NotificationName, NotificationRecipientEmailListByNotificationOptionalParams, NotificationRecipientEmailListByNotificationResponse, NotificationRecipientEmailCheckEntityExistsOptionalParams, NotificationRecipientEmailCheckEntityExistsResponse, NotificationRecipientEmailCreateOrUpdateOptionalParams, NotificationRecipientEmailCreateOrUpdateResponse, NotificationRecipientEmailDeleteOptionalParams } from "../models";
/** Class containing NotificationRecipientEmail operations. */
export declare class NotificationRecipientEmailImpl implements NotificationRecipientEmail {
