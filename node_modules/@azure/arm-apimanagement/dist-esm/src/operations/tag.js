...
export class TagImpl {
    ...
    listByOperationPagingPage(resourceGroupName, serviceName, apiId, operationId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByOperationPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByOperation(resourceGroupName, serviceName, apiId, operationId, options));
    ...
    listByOperationPagingAll(resourceGroupName, serviceName, apiId, operationId, options) {
        return __asyncGenerator(this, arguments, function* listByOperationPagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByOperationPagingPage(resourceGroupName, serviceName, apiId, operationId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listByApiPagingPage(resourceGroupName, serviceName, apiId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByApiPagingPage_1() {
            ...
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByApi(resourceGroupName, serviceName, apiId, options));
                let page = result.value || [];
                continuationToken = result.nextLink;
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByApiPagingAll(resourceGroupName, serviceName, apiId, options) {
        return __asyncGenerator(this, arguments, function* listByApiPagingAll_1() {
            var _a, e_2, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByApiPagingPage(resourceGroupName, serviceName, apiId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    listByProductPagingAll(resourceGroupName, serviceName, productId, options) {
        return __asyncGenerator(this, arguments, function* listByProductPagingAll_1() {
            var _a, e_3, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByProductPagingPage(resourceGroupName, serviceName, productId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
