...
export class PortalConfigImpl {
    ...
    getEntityTag(resourceGroupName, serviceName, portalConfigId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, portalConfigId, options }, getEntityTagOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, serviceName, portalConfigId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, portalConfigId, options }, getOperationSpec);
    }
    /**
...
//# sourceMappingURL=portalConfig.js.map