...
export class ApiIssueAttachmentImpl {
    /**
    ...
    listByServicePagingPage(resourceGroupName, serviceName, apiId, issueId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByServicePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByService(resourceGroupName, serviceName, apiId, issueId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByServiceNext(resourceGroupName, serviceName, apiId, issueId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByServicePagingAll(resourceGroupName, serviceName, apiId, issueId, options) {
        return __asyncGenerator(this, arguments, function* listByServicePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByServicePagingPage(resourceGroupName, serviceName, apiId, issueId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    _listByService(resourceGroupName, serviceName, apiId, issueId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, issueId, options }, listByServiceOperationSpec);
    }
    /**
    ...
    getEntityTag(resourceGroupName, serviceName, apiId, issueId, attachmentId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, issueId, attachmentId, options }, getEntityTagOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, serviceName, apiId, issueId, attachmentId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, issueId, attachmentId, options }, getOperationSpec);
    }
    /**
    ...
    _listByServiceNext(resourceGroupName, serviceName, apiId, issueId, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, issueId, nextLink, options }, listByServiceNextOperationSpec);
    }
}
