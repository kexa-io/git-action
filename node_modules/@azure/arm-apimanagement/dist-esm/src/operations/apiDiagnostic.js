...
export class ApiDiagnosticImpl {
    /**
    ...
    getEntityTag(resourceGroupName, serviceName, apiId, diagnosticId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, diagnosticId, options }, getEntityTagOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, serviceName, apiId, diagnosticId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, diagnosticId, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serviceName, apiId, diagnosticId, ifMatch, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, diagnosticId, ifMatch, options }, deleteOperationSpec);
    }
    /**
     * ListByServiceNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
