...
import { TagDescriptionContract, ApiTagDescriptionListByServiceOptionalParams, ApiTagDescriptionGetEntityTagOptionalParams, ApiTagDescriptionGetEntityTagResponse, ApiTagDescriptionGetOptionalParams, ApiTagDescriptionGetResponse, TagDescriptionCreateParameters, ApiTagDescriptionCreateOrUpdateOptionalParams, ApiTagDescriptionCreateOrUpdateResponse, ApiTagDescriptionDeleteOptionalParams } from "../models";
/** Class containing ApiTagDescription operations. */
export declare class ApiTagDescriptionImpl implements ApiTagDescription {
