...
export class ApiReleaseImpl {
    ...
    listByServicePagingPage(resourceGroupName, serviceName, apiId, options, settings) {
        return __asyncGenerator(this, arguments, function* listByServicePagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._listByService(resourceGroupName, serviceName, apiId, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByServiceNext(resourceGroupName, serviceName, apiId, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByServicePagingAll(resourceGroupName, serviceName, apiId, options) {
        return __asyncGenerator(this, arguments, function* listByServicePagingAll_1() {
            var _a, e_1, _b, _c;
            try {
                for (var _d = true, _e = __asyncValues(this.listByServicePagingPage(resourceGroupName, serviceName, apiId, options)), _f; _f = yield __await(_e.next()), _a = _f.done, !_a;) {
                    _c = _f.value;
                    _d = false;
                    try {
                        const page = _c;
    ...
    _listByService(resourceGroupName, serviceName, apiId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, options }, listByServiceOperationSpec);
    }
    /**
    ...
    getEntityTag(resourceGroupName, serviceName, apiId, releaseId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, releaseId, options }, getEntityTagOperationSpec);
    }
    /**
    ...
    get(resourceGroupName, serviceName, apiId, releaseId, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, releaseId, options }, getOperationSpec);
    }
    /**
    ...
    createOrUpdate(resourceGroupName, serviceName, apiId, releaseId, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, releaseId, parameters, options }, createOrUpdateOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, serviceName, apiId, releaseId, ifMatch, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, releaseId, ifMatch, options }, deleteOperationSpec);
    }
    /**
     * ListByServiceNext
     * @param resourceGroupName The name of the resource group. The name is case insensitive.
    ...
    _listByServiceNext(resourceGroupName, serviceName, apiId, nextLink, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, apiId, nextLink, options }, listByServiceNextOperationSpec);
    }
}
