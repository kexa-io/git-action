...
import { IssueAttachmentContract, ApiIssueAttachmentListByServiceOptionalParams, ApiIssueAttachmentGetEntityTagOptionalParams, ApiIssueAttachmentGetEntityTagResponse, ApiIssueAttachmentGetOptionalParams, ApiIssueAttachmentGetResponse, ApiIssueAttachmentCreateOrUpdateOptionalParams, ApiIssueAttachmentCreateOrUpdateResponse, ApiIssueAttachmentDeleteOptionalParams } from "../models";
/** Class containing ApiIssueAttachment operations. */
export declare class ApiIssueAttachmentImpl implements ApiIssueAttachment {
