...
export class QuotaByCounterKeysImpl {
    /**
    ...
    listByService(resourceGroupName, serviceName, quotaCounterKey, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, quotaCounterKey, options }, listByServiceOperationSpec);
    }
    /**
    ...
    update(resourceGroupName, serviceName, quotaCounterKey, parameters, options) {
        return this.client.sendOperationRequest({ resourceGroupName, serviceName, quotaCounterKey, parameters, options }, updateOperationSpec);
    }
}
