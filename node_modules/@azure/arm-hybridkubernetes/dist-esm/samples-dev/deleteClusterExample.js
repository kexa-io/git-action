...
function deleteClusterExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectedClusterOperations.beginDeleteAndWait(resourceGroupName, clusterName);
        console.log(result);
    });
}
deleteClusterExample().catch(console.error);
//# sourceMappingURL=deleteClusterExample.js.map