...
function createClusterExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectedClusterOperations.beginCreateAndWait(resourceGroupName, clusterName, connectedCluster);
        console.log(result);
    });
}
createClusterExample().catch(console.error);
//# sourceMappingURL=connectedClusterCreateSample.js.map