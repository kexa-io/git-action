...
function getClusterExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectedClusterOperations.get(resourceGroupName, clusterName);
        console.log(result);
    });
}
getClusterExample().catch(console.error);
//# sourceMappingURL=connectedClusterGetSample.js.map