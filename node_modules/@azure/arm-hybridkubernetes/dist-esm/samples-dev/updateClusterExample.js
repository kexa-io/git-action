...
function updateClusterExample() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectedClusterOperations.update(resourceGroupName, clusterName, connectedClusterPatch);
        console.log(result);
    });
}
updateClusterExample().catch(console.error);
//# sourceMappingURL=updateClusterExample.js.map