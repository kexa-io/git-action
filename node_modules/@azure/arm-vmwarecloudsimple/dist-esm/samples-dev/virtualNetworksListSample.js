...
function listVirtualNetworks() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resourcePoolName = "/subscriptions/{subscription-id}/providers/Microsoft.VMwareCloudSimple/locations/westus2/privateClouds/myPrivateCloud/resourcePools/resgroup-26";
        const credential = new DefaultAzureCredential();
        const client = new VMwareCloudSimple(credential, subscriptionId);
        const resArray = new Array();
        try {
            for (var _b = __asyncValues(client.virtualNetworks.list(regionId, pcName, resourcePoolName)), _c; _c = yield _b.next(), !_c.done;) {
                let item = _c.value;
                resArray.push(item);
            }
        }
