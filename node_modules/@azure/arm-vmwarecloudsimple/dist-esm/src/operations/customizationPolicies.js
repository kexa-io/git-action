...
export class CustomizationPoliciesImpl {
    ...
    listPagingAll(regionId, pcName, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(regionId, pcName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(regionId, pcName, customizationPolicyName, options) {
        return this.client.sendOperationRequest({ regionId, pcName, customizationPolicyName, options }, getOperationSpec);
    }
    /**
     * ListNext
     * @param regionId The region Id (westus, eastus)
