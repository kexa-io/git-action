...
function createOrUpdateMaintenanceConfiguration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.maintenanceConfigurations.createOrUpdate(resourceGroupName, resourceName, configName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function createOrUpdateMaintenanceConfigurationWithMaintenanceWindow() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONTAINERSERVICE_SUBSCRIPTION_ID"] || "subid1";
        const resourceGroupName = process.env["CONTAINERSERVICE_RESOURCE_GROUP"] || "rg1";
        const resourceName = "clustername1";
...
//# sourceMappingURL=maintenanceConfigurationsCreateOrUpdateSample.js.map