...
function getMaintenanceConfiguration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.maintenanceConfigurations.get(resourceGroupName, resourceName, configName);
        console.log(result);
    });
}
/**
 ...
 */
function getMaintenanceConfigurationConfiguredWithMaintenanceWindow() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["CONTAINERSERVICE_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["CONTAINERSERVICE_RESOURCE_GROUP"] || "rg1";
...
//# sourceMappingURL=maintenanceConfigurationsGetSample.js.map