 ...
 */
function getTheRehydrationCostForRecoveryPoint() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.fetchTieringCost.beginPostAndWait(resourceGroupName, vaultName, parameters);
        console.log(result);
    });
}
/**
 ...
 */
function getTheTieringSavingsCostInfoForPolicy() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["RECOVERYSERVICESBACKUP_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["RECOVERYSERVICESBACKUP_RESOURCE_GROUP"] || "netsdktestrg";
 ...
 */
function getTheTieringSavingsCostInfoForProtectedItem() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["RECOVERYSERVICESBACKUP_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["RECOVERYSERVICESBACKUP_RESOURCE_GROUP"] || "netsdktestrg";
 ...
 */
function getTheTieringSavingsCostInfoForVault() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["RECOVERYSERVICESBACKUP_SUBSCRIPTION_ID"] ||
            "00000000-0000-0000-0000-000000000000";
        const resourceGroupName = process.env["RECOVERYSERVICESBACKUP_RESOURCE_GROUP"] || "netsdktestrg";
...
//# sourceMappingURL=fetchTieringCostPostSample.js.map