 ...
 */
function deletesAFeatureRegistration() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.subscriptionFeatureRegistrations.delete(providerNamespace, featureName);
        console.log(result);
    });
}
deletesAFeatureRegistration().catch(console.error);
//# sourceMappingURL=subscriptionFeatureRegistrationsDeleteSample.js.map