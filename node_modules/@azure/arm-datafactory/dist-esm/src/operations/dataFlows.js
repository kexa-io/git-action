...
export class DataFlowsImpl {
    ...
    createOrUpdate(resourceGroupName, factoryName, dataFlowName, dataFlow, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, dataFlowName, dataFlow, options }, createOrUpdateOperationSpec);
    }
    /**
     * Gets a data flow.
     * @param resourceGroupName The resource group name.
    ...
    get(resourceGroupName, factoryName, dataFlowName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, dataFlowName, options }, getOperationSpec);
    }
    /**
     * Deletes a data flow.
     * @param resourceGroupName The resource group name.
    ...
    delete(resourceGroupName, factoryName, dataFlowName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, dataFlowName, options }, deleteOperationSpec);
    }
    /**
     * Lists data flows.
     * @param resourceGroupName The resource group name.
...
//# sourceMappingURL=dataFlows.js.map