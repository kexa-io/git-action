...
export class GlobalParametersImpl {
    /**
    ...
    get(resourceGroupName, factoryName, globalParameterName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, globalParameterName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, factoryName, globalParameterName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, globalParameterName, options }, deleteOperationSpec);
    }
    /**
     * ListByFactoryNext
     * @param resourceGroupName The resource group name.
