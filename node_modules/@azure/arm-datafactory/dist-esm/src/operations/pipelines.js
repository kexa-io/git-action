...
export class PipelinesImpl {
    ...
    createOrUpdate(resourceGroupName, factoryName, pipelineName, pipeline, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, pipelineName, pipeline, options }, createOrUpdateOperationSpec);
    }
    /**
     * Gets a pipeline.
     * @param resourceGroupName The resource group name.
    ...
    get(resourceGroupName, factoryName, pipelineName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, pipelineName, options }, getOperationSpec);
    }
    /**
     * Deletes a pipeline.
     * @param resourceGroupName The resource group name.
    ...
    delete(resourceGroupName, factoryName, pipelineName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, factoryName, pipelineName, options }, deleteOperationSpec);
    }
    /**
