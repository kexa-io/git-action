 ...
 */
function vMwareCollectorsCreate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.vMwareCollectors.create(resourceGroupName, projectName, vmWareCollectorName, options);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=vMwareCollectorsCreateSample.js.map