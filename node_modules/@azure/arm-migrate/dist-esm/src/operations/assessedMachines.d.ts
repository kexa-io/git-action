...
import { AssessedMachine, AssessedMachinesListByAssessmentOptionalParams, AssessedMachinesGetOptionalParams, AssessedMachinesGetResponse } from "../models";
/** Class containing AssessedMachines operations. */
export declare class AssessedMachinesImpl implements AssessedMachines {
    ...
    private listByAssessmentPagingPage;
    private listByAssessmentPagingAll;
    /**
     * Get list of machines that assessed as part of the specified assessment. Returns a json array of
     * objects of type 'assessedMachine' as specified in the Models section.
     *
...
//# sourceMappingURL=assessedMachines.d.ts.map