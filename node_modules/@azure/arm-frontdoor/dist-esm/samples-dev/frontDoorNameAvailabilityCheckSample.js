...
function checkNameAvailability() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["FRONTDOOR_SUBSCRIPTION_ID"] ||
        ...
        const result = yield client.frontDoorNameAvailability.check(checkFrontDoorNameAvailabilityInput);
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=frontDoorNameAvailabilityCheckSample.js.map