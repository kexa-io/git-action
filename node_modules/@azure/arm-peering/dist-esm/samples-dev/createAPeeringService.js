...
function createAPeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.peeringServices.createOrUpdate(resourceGroupName, peeringServiceName, peeringService);
        console.log(result);
    });
}
createAPeeringService().catch(console.error);
//# sourceMappingURL=createAPeeringService.js.map