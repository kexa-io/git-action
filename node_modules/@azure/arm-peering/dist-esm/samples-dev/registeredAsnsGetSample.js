 ...
 */
function getARegisteredAsnAssociatedWithThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredAsns.get(resourceGroupName, peeringName, registeredAsnName);
        console.log(result);
    });
}
getARegisteredAsnAssociatedWithThePeering().catch(console.error);
//# sourceMappingURL=registeredAsnsGetSample.js.map