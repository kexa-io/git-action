 ...
 */
function deleteConnectionMonitorTest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectionMonitorTests.delete(resourceGroupName, peeringServiceName, connectionMonitorTestName);
        console.log(result);
    });
}
deleteConnectionMonitorTest().catch(console.error);
//# sourceMappingURL=connectionMonitorTestsDeleteSample.js.map