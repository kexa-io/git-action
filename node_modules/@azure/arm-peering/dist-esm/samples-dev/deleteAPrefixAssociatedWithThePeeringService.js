...
function deleteAPrefixAssociatedWithThePeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.prefixes.delete(resourceGroupName, peeringServiceName, prefixName);
        console.log(result);
    });
}
deleteAPrefixAssociatedWithThePeeringService().catch(console.error);
//# sourceMappingURL=deleteAPrefixAssociatedWithThePeeringService.js.map