 ...
 */
function createOrUpdateARegisteredAsnForThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredAsns.createOrUpdate(resourceGroupName, peeringName, registeredAsnName, registeredAsn);
        console.log(result);
    });
}
createOrUpdateARegisteredAsnForThePeering().catch(console.error);
//# sourceMappingURL=registeredAsnsCreateOrUpdateSample.js.map