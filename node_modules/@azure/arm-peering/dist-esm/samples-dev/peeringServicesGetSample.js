...
function getAPeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.peeringServices.get(resourceGroupName, peeringServiceName);
        console.log(result);
    });
}
getAPeeringService().catch(console.error);
//# sourceMappingURL=peeringServicesGetSample.js.map