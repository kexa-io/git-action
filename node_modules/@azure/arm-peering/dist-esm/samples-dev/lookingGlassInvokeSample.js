 ...
 */
function callLookingGlassToExecuteACommand() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.lookingGlass.invoke(command, sourceType, sourceLocation, destinationIP);
        console.log(result);
    });
}
callLookingGlassToExecuteACommand().catch(console.error);
//# sourceMappingURL=lookingGlassInvokeSample.js.map