 ...
 */
function initializePeeringServiceForConnectionMonitorFunctionality() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = "subId";
        const credential = new DefaultAzureCredential();
        const client = new PeeringManagementClient(credential, subscriptionId);
        const result = yield client.peeringServices.initializeConnectionMonitor();
        console.log(result);
    });
}
initializePeeringServiceForConnectionMonitorFunctionality().catch(console.error);
//# sourceMappingURL=peeringServicesInitializeConnectionMonitorSample.js.map