 ...
 */
function deletesARegisteredAsnAssociatedWithThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredAsns.delete(resourceGroupName, peeringName, registeredAsnName);
        console.log(result);
    });
}
deletesARegisteredAsnAssociatedWithThePeering().catch(console.error);
//# sourceMappingURL=registeredAsnsDeleteSample.js.map