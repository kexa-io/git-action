...
function deletesARegisteredPrefixAssociatedWithThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredPrefixes.delete(resourceGroupName, peeringName, registeredPrefixName);
        console.log(result);
    });
}
deletesARegisteredPrefixAssociatedWithThePeering().catch(console.error);
//# sourceMappingURL=deletesARegisteredPrefixAssociatedWithThePeering.js.map