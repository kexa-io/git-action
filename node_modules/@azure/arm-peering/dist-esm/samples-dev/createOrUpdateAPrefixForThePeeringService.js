...
function createOrUpdateAPrefixForThePeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.prefixes.createOrUpdate(resourceGroupName, peeringServiceName, prefixName, peeringServicePrefix);
        console.log(result);
    });
}
createOrUpdateAPrefixForThePeeringService().catch(console.error);
//# sourceMappingURL=createOrUpdateAPrefixForThePeeringService.js.map