...
function updatePeeringServiceTags() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.peeringServices.update(resourceGroupName, peeringServiceName, tags);
        console.log(result);
    });
}
updatePeeringServiceTags().catch(console.error);
//# sourceMappingURL=updatePeeringServiceTags.js.map