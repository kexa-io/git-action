...
function deleteAPeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.peeringServices.delete(resourceGroupName, peeringServiceName);
        console.log(result);
    });
}
deleteAPeeringService().catch(console.error);
//# sourceMappingURL=deleteAPeeringService.js.map