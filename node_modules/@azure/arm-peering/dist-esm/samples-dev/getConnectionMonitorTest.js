...
function getConnectionMonitorTest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectionMonitorTests.get(resourceGroupName, peeringServiceName, connectionMonitorTestName);
        console.log(result);
    });
}
getConnectionMonitorTest().catch(console.error);
//# sourceMappingURL=getConnectionMonitorTest.js.map