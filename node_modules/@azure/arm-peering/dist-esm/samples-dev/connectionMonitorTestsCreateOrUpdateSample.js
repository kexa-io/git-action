 ...
 */
function createOrUpdateConnectionMonitorTest() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.connectionMonitorTests.createOrUpdate(resourceGroupName, peeringServiceName, connectionMonitorTestName, connectionMonitorTest);
        console.log(result);
    });
}
createOrUpdateConnectionMonitorTest().catch(console.error);
//# sourceMappingURL=connectionMonitorTestsCreateOrUpdateSample.js.map