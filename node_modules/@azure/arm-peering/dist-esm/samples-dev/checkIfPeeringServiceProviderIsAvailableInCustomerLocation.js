...
function checkIfPeeringServiceProviderIsAvailableInCustomerLocation() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.checkServiceProviderAvailability(checkServiceProviderAvailabilityInput);
        console.log(result);
    });
}
checkIfPeeringServiceProviderIsAvailableInCustomerLocation().catch(console.error);
//# sourceMappingURL=checkIfPeeringServiceProviderIsAvailableInCustomerLocation.js.map