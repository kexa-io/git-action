...
function createOrUpdateARegisteredPrefixForThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredPrefixes.createOrUpdate(resourceGroupName, peeringName, registeredPrefixName, registeredPrefix);
        console.log(result);
    });
}
createOrUpdateARegisteredPrefixForThePeering().catch(console.error);
//# sourceMappingURL=createOrUpdateARegisteredPrefixForThePeering.js.map