 ...
 */
function getARegisteredPrefixAssociatedWithThePeering() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.registeredPrefixes.get(resourceGroupName, peeringName, registeredPrefixName);
        console.log(result);
    });
}
getARegisteredPrefixAssociatedWithThePeering().catch(console.error);
//# sourceMappingURL=registeredPrefixesGetSample.js.map