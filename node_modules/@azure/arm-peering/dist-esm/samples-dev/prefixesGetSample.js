 ...
 */
function getAPrefixAssociatedWithThePeeringService() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.prefixes.get(resourceGroupName, peeringServiceName, prefixName);
        console.log(result);
    });
}
getAPrefixAssociatedWithThePeeringService().catch(console.error);
//# sourceMappingURL=prefixesGetSample.js.map