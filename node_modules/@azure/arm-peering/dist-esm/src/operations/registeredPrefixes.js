...
export class RegisteredPrefixesImpl {
    /**
    ...
    listByPeeringPagingPage(resourceGroupName, peeringName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByPeeringPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByPeering(resourceGroupName, peeringName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByPeeringNext(resourceGroupName, peeringName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByPeeringPagingAll(resourceGroupName, peeringName, options) {
        return __asyncGenerator(this, arguments, function* listByPeeringPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByPeeringPagingPage(resourceGroupName, peeringName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    get(resourceGroupName, peeringName, registeredPrefixName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, peeringName, registeredPrefixName, options }, getOperationSpec);
    }
    /**
    ...
    delete(resourceGroupName, peeringName, registeredPrefixName, options) {
        return this.client.sendOperationRequest({ resourceGroupName, peeringName, registeredPrefixName, options }, deleteOperationSpec);
    }
    /**
     * Lists all registered prefixes under the given subscription, resource group and peering.
     * @param resourceGroupName The name of the resource group.
...
//# sourceMappingURL=registeredPrefixes.js.map