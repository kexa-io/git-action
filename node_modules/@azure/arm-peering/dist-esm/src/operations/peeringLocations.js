...
export class PeeringLocationsImpl {
    /**
    ...
    listPagingPage(kind, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(kind, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(kind, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(kind, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(kind, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    _listNext(kind, nextLink, options) {
        return this.client.sendOperationRequest({ kind, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=peeringLocations.js.map