...
export class CdnPeeringPrefixesImpl {
    /**
    ...
    listPagingPage(peeringLocation, options, settings) {
        return __asyncGenerator(this, arguments, function* listPagingPage_1() {
            ...
            if (!continuationToken) {
                result = yield __await(this._list(peeringLocation, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listNext(peeringLocation, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listPagingAll(peeringLocation, options) {
        return __asyncGenerator(this, arguments, function* listPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listPagingPage(peeringLocation, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
    ...
    _listNext(peeringLocation, nextLink, options) {
        return this.client.sendOperationRequest({ peeringLocation, nextLink, options }, listNextOperationSpec);
    }
}
...
//# sourceMappingURL=cdnPeeringPrefixes.js.map