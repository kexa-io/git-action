...
function deletesAPrivateEndpointConnectionWithAGivenName() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateEndpointConnections.beginDeleteAndWait(resourceGroupName, scopeName, privateEndpointConnectionName);
        console.log(result);
    });
}
deletesAPrivateEndpointConnectionWithAGivenName().catch(console.error);
//# sourceMappingURL=deletesAPrivateEndpointConnectionWithAGivenName.js.map