...
function privateLinkScopeUpdate() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.privateLinkScopes.createOrUpdate(resourceGroupName, scopeName, parameters);
        console.log(result);
    });
}
privateLinkScopeUpdate().catch(console.error);
//# sourceMappingURL=privateLinkScopeUpdate.js.map