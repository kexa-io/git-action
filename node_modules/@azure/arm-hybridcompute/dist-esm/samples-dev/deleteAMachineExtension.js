...
function deleteAMachineExtension() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.machineExtensions.beginDeleteAndWait(resourceGroupName, machineName, extensionName);
        console.log(result);
    });
}
deleteAMachineExtension().catch(console.error);
//# sourceMappingURL=deleteAMachineExtension.js.map