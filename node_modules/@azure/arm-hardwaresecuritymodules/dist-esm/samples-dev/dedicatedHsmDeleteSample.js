...
function deleteADedicatedHsm() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.dedicatedHsmOperations.beginDeleteAndWait(resourceGroupName, name);
        console.log(result);
    });
}
deleteADedicatedHsm().catch(console.error);
//# sourceMappingURL=dedicatedHsmDeleteSample.js.map