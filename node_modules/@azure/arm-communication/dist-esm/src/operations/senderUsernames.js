...
export class SenderUsernamesImpl {
    /**
    ...
    listByDomainsPagingPage(resourceGroupName, emailServiceName, domainName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByDomainsPagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByDomains(resourceGroupName, emailServiceName, domainName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByDomainsNext(resourceGroupName, emailServiceName, domainName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByDomainsPagingAll(resourceGroupName, emailServiceName, domainName, options) {
        return __asyncGenerator(this, arguments, function* listByDomainsPagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByDomainsPagingPage(resourceGroupName, emailServiceName, domainName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
