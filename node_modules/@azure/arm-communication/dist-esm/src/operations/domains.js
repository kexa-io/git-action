...
export class DomainsImpl {
    ...
    listByEmailServiceResourcePagingPage(resourceGroupName, emailServiceName, options, settings) {
        return __asyncGenerator(this, arguments, function* listByEmailServiceResourcePagingPage_1() {
            let result;
            let continuationToken = settings === null || settings === void 0 ? void 0 : settings.continuationToken;
            if (!continuationToken) {
                result = yield __await(this._listByEmailServiceResource(resourceGroupName, emailServiceName, options));
            ...
            while (continuationToken) {
                result = yield __await(this._listByEmailServiceResourceNext(resourceGroupName, emailServiceName, continuationToken, options));
                continuationToken = result.nextLink;
                let page = result.value || [];
                setContinuationToken(page, continuationToken);
                yield yield __await(page);
    ...
    listByEmailServiceResourcePagingAll(resourceGroupName, emailServiceName, options) {
        return __asyncGenerator(this, arguments, function* listByEmailServiceResourcePagingAll_1() {
            var e_1, _a;
            try {
                for (var _b = __asyncValues(this.listByEmailServiceResourcePagingPage(resourceGroupName, emailServiceName, options)), _c; _c = yield __await(_b.next()), !_c.done;) {
                    const page = _c.value;
