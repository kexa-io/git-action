 ...
 */
function getVerifiedExchangeOnlineDomains() {
    return __awaiter(this, void 0, void 0, function* () {
        const subscriptionId = process.env["COMMUNICATION_SUBSCRIPTION_ID"] ||
            "11112222-3333-4444-5555-666677778888";
        const credential = new DefaultAzureCredential();
        const client = new CommunicationServiceManagementClient(credential, subscriptionId);
        const result = yield client.emailServices.listVerifiedExchangeOnlineDomains();
        console.log(result);
    });
}
function main() {
...
//# sourceMappingURL=emailServicesListVerifiedExchangeOnlineDomainsSample.js.map