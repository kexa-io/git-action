...
function updateRemoteRenderingAccount() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const result = yield client.remoteRenderingAccounts.update(resourceGroupName, accountName, remoteRenderingAccount);
        console.log(result);
    });
}
updateRemoteRenderingAccount().catch(console.error);
//# sourceMappingURL=updateRemoteRenderingAccount.js.map