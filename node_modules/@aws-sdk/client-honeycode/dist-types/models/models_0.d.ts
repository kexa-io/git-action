 ...
 * @public
 */
export type ImportDataCharacterEncoding = (typeof ImportDataCharacterEncoding)[keyof typeof ImportDataCharacterEncoding];
/**
 * @public
 * <p>
 ...
 * @internal
 */
export declare const CreateRowDataFilterSensitiveLog: (obj: CreateRowData) => any;
/**
 * @internal
 */
export declare const BatchCreateTableRowsRequestFilterSensitiveLog: (obj: BatchCreateTableRowsRequest) => any;
/**
 * @internal
 */
export declare const UpdateRowDataFilterSensitiveLog: (obj: UpdateRowData) => any;
/**
 * @internal
 */
export declare const BatchUpdateTableRowsRequestFilterSensitiveLog: (obj: BatchUpdateTableRowsRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const UpsertRowDataFilterSensitiveLog: (obj: UpsertRowData) => any;
/**
 * @internal
 */
export declare const BatchUpsertTableRowsRequestFilterSensitiveLog: (obj: BatchUpsertTableRowsRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const ImportDataSourceConfigFilterSensitiveLog: (obj: ImportDataSourceConfig) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const ImportJobSubmitterFilterSensitiveLog: (obj: ImportJobSubmitter) => any;
/**
 * @internal
 */
export declare const TableDataImportJobMetadataFilterSensitiveLog: (obj: TableDataImportJobMetadata) => any;
/**
 * @internal
 */
export declare const DescribeTableDataImportJobResultFilterSensitiveLog: (obj: DescribeTableDataImportJobResult) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const GetScreenDataRequestFilterSensitiveLog: (obj: GetScreenDataRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const GetScreenDataResultFilterSensitiveLog: (obj: GetScreenDataResult) => any;
/**
 * @internal
 */
export declare const InvokeScreenAutomationRequestFilterSensitiveLog: (obj: InvokeScreenAutomationRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const ListTableRowsResultFilterSensitiveLog: (obj: ListTableRowsResult) => any;
/**
 * @internal
 */
export declare const QueryTableRowsRequestFilterSensitiveLog: (obj: QueryTableRowsRequest) => any;
/**
 * @internal
 */
export declare const QueryTableRowsResultFilterSensitiveLog: (obj: QueryTableRowsResult) => any;
/**
 * @internal
 */
export declare const StartTableDataImportJobRequestFilterSensitiveLog: (obj: StartTableDataImportJobRequest) => any;
