...
declare const BatchCreateTableRowsCommand_base: {
    new (input: BatchCreateTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateTableRowsCommandInput, BatchCreateTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchCreateTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateTableRowsCommandInput, BatchCreateTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchCreateTableRowsCommand extends BatchCreateTableRowsCommand_base {
}
