...
declare const DescribeTableDataImportJobCommand_base: {
    new (input: DescribeTableDataImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTableDataImportJobCommandInput, DescribeTableDataImportJobCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeTableDataImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTableDataImportJobCommandInput, DescribeTableDataImportJobCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeTableDataImportJobCommand extends DescribeTableDataImportJobCommand_base {
}
