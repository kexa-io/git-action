...
declare const GetScreenDataCommand_base: {
    new (input: GetScreenDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetScreenDataCommandInput, GetScreenDataCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetScreenDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetScreenDataCommandInput, GetScreenDataCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetScreenDataCommand extends GetScreenDataCommand_base {
}
