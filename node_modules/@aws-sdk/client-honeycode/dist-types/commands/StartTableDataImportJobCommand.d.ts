...
declare const StartTableDataImportJobCommand_base: {
    new (input: StartTableDataImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartTableDataImportJobCommandInput, StartTableDataImportJobCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartTableDataImportJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartTableDataImportJobCommandInput, StartTableDataImportJobCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartTableDataImportJobCommand extends StartTableDataImportJobCommand_base {
}
