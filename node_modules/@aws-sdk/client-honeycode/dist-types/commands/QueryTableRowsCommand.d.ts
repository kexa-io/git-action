...
declare const QueryTableRowsCommand_base: {
    new (input: QueryTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<QueryTableRowsCommandInput, QueryTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: QueryTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<QueryTableRowsCommandInput, QueryTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class QueryTableRowsCommand extends QueryTableRowsCommand_base {
}
