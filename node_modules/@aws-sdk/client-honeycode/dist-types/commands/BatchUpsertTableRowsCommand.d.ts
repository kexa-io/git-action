...
declare const BatchUpsertTableRowsCommand_base: {
    new (input: BatchUpsertTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpsertTableRowsCommandInput, BatchUpsertTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchUpsertTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpsertTableRowsCommandInput, BatchUpsertTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchUpsertTableRowsCommand extends BatchUpsertTableRowsCommand_base {
}
