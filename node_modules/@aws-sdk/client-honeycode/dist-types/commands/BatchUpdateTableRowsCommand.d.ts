...
declare const BatchUpdateTableRowsCommand_base: {
    new (input: BatchUpdateTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpdateTableRowsCommandInput, BatchUpdateTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchUpdateTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpdateTableRowsCommandInput, BatchUpdateTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchUpdateTableRowsCommand extends BatchUpdateTableRowsCommand_base {
}
