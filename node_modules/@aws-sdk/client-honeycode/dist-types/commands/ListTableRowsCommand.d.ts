...
declare const ListTableRowsCommand_base: {
    new (input: ListTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTableRowsCommandInput, ListTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListTableRowsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTableRowsCommandInput, ListTableRowsCommandOutput, HoneycodeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListTableRowsCommand extends ListTableRowsCommand_base {
}
