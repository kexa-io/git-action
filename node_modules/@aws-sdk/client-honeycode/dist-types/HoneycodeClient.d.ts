 ...
 * @public
 */
export type HoneycodeClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointInputConfig<EndpointParameters> & RetryInputConfig & HostHeaderInputConfig & UserAgentInputConfig & HttpAuthSchemeInputConfig & ClientInputEndpointParameters;
/**
 * @public
 *
...
export declare class HoneycodeClient extends __Client<__HttpHandlerOptions, ServiceInputTypes, ServiceOutputTypes, HoneycodeClientResolvedConfig> {
    ...
    constructor(...[configuration]: __CheckOptionalClientConfig<HoneycodeClientConfig>);
    /**
