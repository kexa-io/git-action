...
declare const DescribeUserCommand_base: {
    new (input: DescribeUserCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeUserCommandInput, DescribeUserCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeUserCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeUserCommandInput, DescribeUserCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
