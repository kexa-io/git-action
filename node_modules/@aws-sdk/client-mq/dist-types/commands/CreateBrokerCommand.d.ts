...
declare const CreateBrokerCommand_base: {
    new (input: CreateBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateBrokerCommandInput, CreateBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateBrokerCommandInput, CreateBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateBrokerCommand extends CreateBrokerCommand_base {
}
