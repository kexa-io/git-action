...
declare const ListConfigurationRevisionsCommand_base: {
    new (input: ListConfigurationRevisionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListConfigurationRevisionsCommandInput, ListConfigurationRevisionsCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListConfigurationRevisionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListConfigurationRevisionsCommandInput, ListConfigurationRevisionsCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
