...
declare const CreateTagsCommand_base: {
    new (input: CreateTagsCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTagsCommandInput, CreateTagsCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateTagsCommandInput): import("@smithy/smithy-client").CommandImpl<CreateTagsCommandInput, CreateTagsCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
