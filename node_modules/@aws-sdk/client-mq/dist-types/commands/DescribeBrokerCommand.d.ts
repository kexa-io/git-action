...
declare const DescribeBrokerCommand_base: {
    new (input: DescribeBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeBrokerCommandInput, DescribeBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeBrokerCommandInput, DescribeBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeBrokerCommand extends DescribeBrokerCommand_base {
}
