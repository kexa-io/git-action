...
declare const PromoteCommand_base: {
    new (input: PromoteCommandInput): import("@smithy/smithy-client").CommandImpl<PromoteCommandInput, PromoteCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class PromoteCommand extends PromoteCommand_base {
}
