...
declare const DeleteBrokerCommand_base: {
    new (input: DeleteBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBrokerCommandInput, DeleteBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBrokerCommandInput, DeleteBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteBrokerCommand extends DeleteBrokerCommand_base {
}
