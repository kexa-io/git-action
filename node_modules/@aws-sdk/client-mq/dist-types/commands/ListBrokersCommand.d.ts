...
declare const ListBrokersCommand_base: {
    new (input: ListBrokersCommandInput): import("@smithy/smithy-client").CommandImpl<ListBrokersCommandInput, ListBrokersCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListBrokersCommandInput]): import("@smithy/smithy-client").CommandImpl<ListBrokersCommandInput, ListBrokersCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListBrokersCommand extends ListBrokersCommand_base {
}
