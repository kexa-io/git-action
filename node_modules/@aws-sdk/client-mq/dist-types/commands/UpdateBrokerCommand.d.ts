...
declare const UpdateBrokerCommand_base: {
    new (input: UpdateBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBrokerCommandInput, UpdateBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBrokerCommandInput, UpdateBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateBrokerCommand extends UpdateBrokerCommand_base {
}
