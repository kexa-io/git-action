...
declare const CreateConfigurationCommand_base: {
    new (input: CreateConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateConfigurationCommandInput, CreateConfigurationCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateConfigurationCommandInput, CreateConfigurationCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
