...
declare const RebootBrokerCommand_base: {
    new (input: RebootBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<RebootBrokerCommandInput, RebootBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RebootBrokerCommandInput): import("@smithy/smithy-client").CommandImpl<RebootBrokerCommandInput, RebootBrokerCommandOutput, MqClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
