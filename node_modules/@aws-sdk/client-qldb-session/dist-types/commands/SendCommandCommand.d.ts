...
import { QLDBSessionClientResolvedConfig } from "../QLDBSessionClient";
/**
 * @public
 */
...
declare const SendCommandCommand_base: {
    new (input: SendCommandCommandInput): import("@smithy/smithy-client").CommandImpl<SendCommandCommandInput, SendCommandCommandOutput, QLDBSessionClientResolvedConfig, SendCommandCommandInput, SendCommandCommandOutput>;
    new (...[input]: [] | [SendCommandCommandInput]): import("@smithy/smithy-client").CommandImpl<SendCommandCommandInput, SendCommandCommandOutput, QLDBSessionClientResolvedConfig, SendCommandCommandInput, SendCommandCommandOutput>;
