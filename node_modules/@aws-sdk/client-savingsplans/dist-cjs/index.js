...
// src/SavingsplansClient.ts
var _SavingsplansClient = class _SavingsplansClient extends import_smithy_client.Client {
...
var _SavingsplansServiceException = class _SavingsplansServiceException extends import_smithy_client.ServiceException {
  /**
   * @internal
   */
  constructor(options) {
...
var _InternalServerException = class _InternalServerException extends SavingsplansServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ResourceNotFoundException = class _ResourceNotFoundException extends SavingsplansServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ServiceQuotaExceededException = class _ServiceQuotaExceededException extends SavingsplansServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ValidationException = class _ValidationException extends SavingsplansServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
// src/protocols/Aws_restJson1.ts
var se_CreateSavingsPlanCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify(
    (0, import_smithy_client.take)(input, {
      ...
      commitment: [],
      purchaseTime: (_) => Math.round(_.getTime() / 1e3),
...
var _Savingsplans = class _Savingsplans extends SavingsplansClient {
};
