...
declare const AssignVolumeCommand_base: {
    new (input: AssignVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<AssignVolumeCommandInput, AssignVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssignVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<AssignVolumeCommandInput, AssignVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssignVolumeCommand extends AssignVolumeCommand_base {
}
