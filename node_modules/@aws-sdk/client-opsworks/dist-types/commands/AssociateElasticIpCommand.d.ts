...
declare const AssociateElasticIpCommand_base: {
    new (input: AssociateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateElasticIpCommandInput, AssociateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateElasticIpCommandInput, AssociateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateElasticIpCommand extends AssociateElasticIpCommand_base {
}
