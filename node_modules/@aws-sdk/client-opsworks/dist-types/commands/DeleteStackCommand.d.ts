...
declare const DeleteStackCommand_base: {
    new (input: DeleteStackCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStackCommandInput, DeleteStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
