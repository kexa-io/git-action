...
declare const UpdateRdsDbInstanceCommand_base: {
    new (input: UpdateRdsDbInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRdsDbInstanceCommandInput, UpdateRdsDbInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRdsDbInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRdsDbInstanceCommandInput, UpdateRdsDbInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateRdsDbInstanceCommand extends UpdateRdsDbInstanceCommand_base {
}
