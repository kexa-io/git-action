...
declare const CreateStackCommand_base: {
    new (input: CreateStackCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateStackCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStackCommandInput, CreateStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
