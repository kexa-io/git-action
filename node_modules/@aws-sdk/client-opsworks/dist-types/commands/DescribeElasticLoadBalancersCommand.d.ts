...
declare const DescribeElasticLoadBalancersCommand_base: {
    new (input: DescribeElasticLoadBalancersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeElasticLoadBalancersCommandInput, DescribeElasticLoadBalancersCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeElasticLoadBalancersCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeElasticLoadBalancersCommandInput, DescribeElasticLoadBalancersCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeElasticLoadBalancersCommand extends DescribeElasticLoadBalancersCommand_base {
}
