...
declare const UnassignVolumeCommand_base: {
    new (input: UnassignVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<UnassignVolumeCommandInput, UnassignVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UnassignVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<UnassignVolumeCommandInput, UnassignVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UnassignVolumeCommand extends UnassignVolumeCommand_base {
}
