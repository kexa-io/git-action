...
declare const SetTimeBasedAutoScalingCommand_base: {
    new (input: SetTimeBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<SetTimeBasedAutoScalingCommandInput, SetTimeBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SetTimeBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<SetTimeBasedAutoScalingCommandInput, SetTimeBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SetTimeBasedAutoScalingCommand extends SetTimeBasedAutoScalingCommand_base {
}
