...
declare const DescribeVolumesCommand_base: {
    new (input: DescribeVolumesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeVolumesCommandInput, DescribeVolumesCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
