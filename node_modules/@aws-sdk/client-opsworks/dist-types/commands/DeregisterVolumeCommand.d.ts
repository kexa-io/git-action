...
declare const DeregisterVolumeCommand_base: {
    new (input: DeregisterVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterVolumeCommandInput, DeregisterVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeregisterVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterVolumeCommandInput, DeregisterVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeregisterVolumeCommand extends DeregisterVolumeCommand_base {
}
