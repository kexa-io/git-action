...
declare const RegisterRdsDbInstanceCommand_base: {
    new (input: RegisterRdsDbInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterRdsDbInstanceCommandInput, RegisterRdsDbInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterRdsDbInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterRdsDbInstanceCommandInput, RegisterRdsDbInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RegisterRdsDbInstanceCommand extends RegisterRdsDbInstanceCommand_base {
}
