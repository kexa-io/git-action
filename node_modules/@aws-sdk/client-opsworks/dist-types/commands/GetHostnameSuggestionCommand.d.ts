...
declare const GetHostnameSuggestionCommand_base: {
    new (input: GetHostnameSuggestionCommandInput): import("@smithy/smithy-client").CommandImpl<GetHostnameSuggestionCommandInput, GetHostnameSuggestionCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetHostnameSuggestionCommandInput): import("@smithy/smithy-client").CommandImpl<GetHostnameSuggestionCommandInput, GetHostnameSuggestionCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetHostnameSuggestionCommand extends GetHostnameSuggestionCommand_base {
}
