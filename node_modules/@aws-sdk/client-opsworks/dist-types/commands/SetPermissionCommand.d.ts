...
declare const SetPermissionCommand_base: {
    new (input: SetPermissionCommandInput): import("@smithy/smithy-client").CommandImpl<SetPermissionCommandInput, SetPermissionCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SetPermissionCommandInput): import("@smithy/smithy-client").CommandImpl<SetPermissionCommandInput, SetPermissionCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SetPermissionCommand extends SetPermissionCommand_base {
}
