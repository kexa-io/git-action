...
declare const CreateUserProfileCommand_base: {
    new (input: CreateUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUserProfileCommandInput, CreateUserProfileCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUserProfileCommandInput, CreateUserProfileCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
