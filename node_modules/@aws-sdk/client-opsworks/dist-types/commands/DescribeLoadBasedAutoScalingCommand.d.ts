...
declare const DescribeLoadBasedAutoScalingCommand_base: {
    new (input: DescribeLoadBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLoadBasedAutoScalingCommandInput, DescribeLoadBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeLoadBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLoadBasedAutoScalingCommandInput, DescribeLoadBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeLoadBasedAutoScalingCommand extends DescribeLoadBasedAutoScalingCommand_base {
}
