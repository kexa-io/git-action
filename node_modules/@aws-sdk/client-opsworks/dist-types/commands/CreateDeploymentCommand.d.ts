...
declare const CreateDeploymentCommand_base: {
    new (input: CreateDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeploymentCommandInput, CreateDeploymentCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeploymentCommandInput, CreateDeploymentCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
