...
declare const DisassociateElasticIpCommand_base: {
    new (input: DisassociateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateElasticIpCommandInput, DisassociateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateElasticIpCommandInput, DisassociateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateElasticIpCommand extends DisassociateElasticIpCommand_base {
}
