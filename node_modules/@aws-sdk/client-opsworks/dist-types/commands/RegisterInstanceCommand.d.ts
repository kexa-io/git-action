...
declare const RegisterInstanceCommand_base: {
    new (input: RegisterInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterInstanceCommandInput, RegisterInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterInstanceCommandInput, RegisterInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
