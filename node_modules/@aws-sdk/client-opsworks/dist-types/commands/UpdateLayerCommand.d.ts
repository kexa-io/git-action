...
declare const UpdateLayerCommand_base: {
    new (input: UpdateLayerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLayerCommandInput, UpdateLayerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLayerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLayerCommandInput, UpdateLayerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLayerCommand extends UpdateLayerCommand_base {
}
