...
declare const StopStackCommand_base: {
    new (input: StopStackCommandInput): import("@smithy/smithy-client").CommandImpl<StopStackCommandInput, StopStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopStackCommandInput): import("@smithy/smithy-client").CommandImpl<StopStackCommandInput, StopStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopStackCommand extends StopStackCommand_base {
}
