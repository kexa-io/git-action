...
declare const DescribePermissionsCommand_base: {
    new (input: DescribePermissionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribePermissionsCommandInput, DescribePermissionsCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribePermissionsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribePermissionsCommandInput, DescribePermissionsCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribePermissionsCommand extends DescribePermissionsCommand_base {
}
