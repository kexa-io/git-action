...
declare const DeregisterEcsClusterCommand_base: {
    new (input: DeregisterEcsClusterCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterEcsClusterCommandInput, DeregisterEcsClusterCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeregisterEcsClusterCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterEcsClusterCommandInput, DeregisterEcsClusterCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeregisterEcsClusterCommand extends DeregisterEcsClusterCommand_base {
}
