...
declare const RegisterElasticIpCommand_base: {
    new (input: RegisterElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterElasticIpCommandInput, RegisterElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class RegisterElasticIpCommand extends RegisterElasticIpCommand_base {
}
