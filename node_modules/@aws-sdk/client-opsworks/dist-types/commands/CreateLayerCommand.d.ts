...
declare const CreateLayerCommand_base: {
    new (input: CreateLayerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLayerCommandInput, CreateLayerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLayerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLayerCommandInput, CreateLayerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLayerCommand extends CreateLayerCommand_base {
}
