...
declare const DetachElasticLoadBalancerCommand_base: {
    new (input: DetachElasticLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<DetachElasticLoadBalancerCommandInput, DetachElasticLoadBalancerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DetachElasticLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<DetachElasticLoadBalancerCommandInput, DetachElasticLoadBalancerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DetachElasticLoadBalancerCommand extends DetachElasticLoadBalancerCommand_base {
}
