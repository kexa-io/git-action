...
declare const GrantAccessCommand_base: {
    new (input: GrantAccessCommandInput): import("@smithy/smithy-client").CommandImpl<GrantAccessCommandInput, GrantAccessCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class GrantAccessCommand extends GrantAccessCommand_base {
}
