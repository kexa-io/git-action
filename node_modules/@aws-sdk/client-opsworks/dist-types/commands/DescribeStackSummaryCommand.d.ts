...
declare const DescribeStackSummaryCommand_base: {
    new (input: DescribeStackSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeStackSummaryCommandInput, DescribeStackSummaryCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeStackSummaryCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeStackSummaryCommandInput, DescribeStackSummaryCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeStackSummaryCommand extends DescribeStackSummaryCommand_base {
}
