...
declare const DescribeTimeBasedAutoScalingCommand_base: {
    new (input: DescribeTimeBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTimeBasedAutoScalingCommandInput, DescribeTimeBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeTimeBasedAutoScalingCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeTimeBasedAutoScalingCommandInput, DescribeTimeBasedAutoScalingCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeTimeBasedAutoScalingCommand extends DescribeTimeBasedAutoScalingCommand_base {
}
