...
declare const AttachElasticLoadBalancerCommand_base: {
    new (input: AttachElasticLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<AttachElasticLoadBalancerCommandInput, AttachElasticLoadBalancerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AttachElasticLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<AttachElasticLoadBalancerCommandInput, AttachElasticLoadBalancerCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AttachElasticLoadBalancerCommand extends AttachElasticLoadBalancerCommand_base {
}
