...
declare const StartInstanceCommand_base: {
    new (input: StartInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartInstanceCommandInput, StartInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartInstanceCommandInput, StartInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
