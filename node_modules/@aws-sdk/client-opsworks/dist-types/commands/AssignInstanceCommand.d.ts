...
declare const AssignInstanceCommand_base: {
    new (input: AssignInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<AssignInstanceCommandInput, AssignInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssignInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<AssignInstanceCommandInput, AssignInstanceCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssignInstanceCommand extends AssignInstanceCommand_base {
}
