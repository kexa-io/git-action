...
declare const UpdateVolumeCommand_base: {
    new (input: UpdateVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVolumeCommandInput, UpdateVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateVolumeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVolumeCommandInput, UpdateVolumeCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
