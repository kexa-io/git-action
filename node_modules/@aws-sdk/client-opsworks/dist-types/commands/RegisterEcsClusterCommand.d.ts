...
declare const RegisterEcsClusterCommand_base: {
    new (input: RegisterEcsClusterCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterEcsClusterCommandInput, RegisterEcsClusterCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterEcsClusterCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterEcsClusterCommandInput, RegisterEcsClusterCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RegisterEcsClusterCommand extends RegisterEcsClusterCommand_base {
}
