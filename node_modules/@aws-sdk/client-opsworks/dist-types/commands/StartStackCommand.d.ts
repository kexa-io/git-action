...
declare const StartStackCommand_base: {
    new (input: StartStackCommandInput): import("@smithy/smithy-client").CommandImpl<StartStackCommandInput, StartStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartStackCommandInput): import("@smithy/smithy-client").CommandImpl<StartStackCommandInput, StartStackCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartStackCommand extends StartStackCommand_base {
}
