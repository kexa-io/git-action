...
declare const UpdateElasticIpCommand_base: {
    new (input: UpdateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateElasticIpCommandInput, UpdateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateElasticIpCommandInput, UpdateElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateElasticIpCommand extends UpdateElasticIpCommand_base {
}
