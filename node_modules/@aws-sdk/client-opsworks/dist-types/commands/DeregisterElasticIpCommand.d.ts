...
declare const DeregisterElasticIpCommand_base: {
    new (input: DeregisterElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterElasticIpCommandInput, DeregisterElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeregisterElasticIpCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterElasticIpCommandInput, DeregisterElasticIpCommandOutput, OpsWorksClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeregisterElasticIpCommand extends DeregisterElasticIpCommand_base {
}
