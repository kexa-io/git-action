...
const a = true, b = "isSet", c = "booleanEquals", d = "error", e = "endpoint", f = "tree", g = "PartitionResult", h = "stringEquals", i = "sigv4", j = { [x]: false, "type": "String" }, k = { [x]: true, "default": false, "type": "Boolean" }, l = { [A]: "Endpoint" }, m = { [y]: c, [z]: [{ [A]: "UseFIPS" }, true] }, n = { [y]: c, [z]: [{ [A]: "UseDualStack" }, true] }, o = {}, p = { [y]: "getAttr", [z]: [{ [A]: g }, "name"] }, q = { [y]: c, [z]: [{ [A]: "UseFIPS" }, false] }, r = { [y]: c, [z]: [{ [A]: "UseDualStack" }, false] }, s = { [y]: "getAttr", [z]: [{ [A]: g }, "supportsFIPS"] }, t = { [y]: c, [z]: [true, { [y]: "getAttr", [z]: [{ [A]: g }, "supportsDualStack"] }] }, u = [m], v = [n], w = [{ [A]: "Region" }];
