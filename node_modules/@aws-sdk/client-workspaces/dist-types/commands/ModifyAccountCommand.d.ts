...
declare const ModifyAccountCommand_base: {
    new (input: ModifyAccountCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyAccountCommandInput, ModifyAccountCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
