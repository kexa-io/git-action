...
declare const ModifyWorkspaceAccessPropertiesCommand_base: {
    new (input: ModifyWorkspaceAccessPropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyWorkspaceAccessPropertiesCommandInput, ModifyWorkspaceAccessPropertiesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyWorkspaceAccessPropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyWorkspaceAccessPropertiesCommandInput, ModifyWorkspaceAccessPropertiesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
