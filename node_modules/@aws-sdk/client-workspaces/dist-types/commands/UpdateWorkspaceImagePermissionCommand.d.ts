...
declare const UpdateWorkspaceImagePermissionCommand_base: {
    new (input: UpdateWorkspaceImagePermissionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceImagePermissionCommandInput, UpdateWorkspaceImagePermissionCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateWorkspaceImagePermissionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorkspaceImagePermissionCommandInput, UpdateWorkspaceImagePermissionCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
