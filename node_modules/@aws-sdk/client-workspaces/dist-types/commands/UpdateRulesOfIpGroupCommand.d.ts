...
declare const UpdateRulesOfIpGroupCommand_base: {
    new (input: UpdateRulesOfIpGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRulesOfIpGroupCommandInput, UpdateRulesOfIpGroupCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRulesOfIpGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRulesOfIpGroupCommandInput, UpdateRulesOfIpGroupCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
