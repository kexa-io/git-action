...
declare const ModifySelfservicePermissionsCommand_base: {
    new (input: ModifySelfservicePermissionsCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySelfservicePermissionsCommandInput, ModifySelfservicePermissionsCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifySelfservicePermissionsCommandInput): import("@smithy/smithy-client").CommandImpl<ModifySelfservicePermissionsCommandInput, ModifySelfservicePermissionsCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
