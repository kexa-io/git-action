...
declare const UpdateConnectionAliasPermissionCommand_base: {
    new (input: UpdateConnectionAliasPermissionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateConnectionAliasPermissionCommandInput, UpdateConnectionAliasPermissionCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateConnectionAliasPermissionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateConnectionAliasPermissionCommandInput, UpdateConnectionAliasPermissionCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
