...
declare const RebuildWorkspacesCommand_base: {
    new (input: RebuildWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<RebuildWorkspacesCommandInput, RebuildWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RebuildWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<RebuildWorkspacesCommandInput, RebuildWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
