...
declare const StartWorkspacesCommand_base: {
    new (input: StartWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<StartWorkspacesCommandInput, StartWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<StartWorkspacesCommandInput, StartWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
