...
declare const ModifyWorkspacePropertiesCommand_base: {
    new (input: ModifyWorkspacePropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyWorkspacePropertiesCommandInput, ModifyWorkspacePropertiesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ModifyWorkspacePropertiesCommandInput): import("@smithy/smithy-client").CommandImpl<ModifyWorkspacePropertiesCommandInput, ModifyWorkspacePropertiesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
