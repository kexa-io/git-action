...
declare const StopWorkspacesCommand_base: {
    new (input: StopWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<StopWorkspacesCommandInput, StopWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<StopWorkspacesCommandInput, StopWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
