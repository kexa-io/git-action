...
declare const TerminateWorkspacesCommand_base: {
    new (input: TerminateWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<TerminateWorkspacesCommandInput, TerminateWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TerminateWorkspacesCommandInput): import("@smithy/smithy-client").CommandImpl<TerminateWorkspacesCommandInput, TerminateWorkspacesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
