...
declare const RevokeIpRulesCommand_base: {
    new (input: RevokeIpRulesCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeIpRulesCommandInput, RevokeIpRulesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RevokeIpRulesCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeIpRulesCommandInput, RevokeIpRulesCommandOutput, WorkSpacesClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
