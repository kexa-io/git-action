...
export interface Panorama {
     ...
     */
    signalApplicationInstanceNodeInstances(args: SignalApplicationInstanceNodeInstancesCommandInput, options?: __HttpHandlerOptions): Promise<SignalApplicationInstanceNodeInstancesCommandOutput>;
    signalApplicationInstanceNodeInstances(args: SignalApplicationInstanceNodeInstancesCommandInput, cb: (err: any, data?: SignalApplicationInstanceNodeInstancesCommandOutput) => void): void;
    signalApplicationInstanceNodeInstances(args: SignalApplicationInstanceNodeInstancesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: SignalApplicationInstanceNodeInstancesCommandOutput) => void): void;
    /**
