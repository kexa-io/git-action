...
declare const ListPackagesCommand_base: {
    new (input: ListPackagesCommandInput): import("@smithy/smithy-client").CommandImpl<ListPackagesCommandInput, ListPackagesCommandOutput, PanoramaClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
