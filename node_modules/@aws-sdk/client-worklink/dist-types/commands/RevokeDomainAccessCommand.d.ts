...
declare const RevokeDomainAccessCommand_base: {
    new (input: RevokeDomainAccessCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeDomainAccessCommandInput, RevokeDomainAccessCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RevokeDomainAccessCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeDomainAccessCommandInput, RevokeDomainAccessCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RevokeDomainAccessCommand extends RevokeDomainAccessCommand_base {
}
