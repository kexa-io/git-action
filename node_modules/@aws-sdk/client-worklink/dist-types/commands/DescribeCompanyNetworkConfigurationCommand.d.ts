...
declare const DescribeCompanyNetworkConfigurationCommand_base: {
    new (input: DescribeCompanyNetworkConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeCompanyNetworkConfigurationCommandInput, DescribeCompanyNetworkConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeCompanyNetworkConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeCompanyNetworkConfigurationCommandInput, DescribeCompanyNetworkConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeCompanyNetworkConfigurationCommand extends DescribeCompanyNetworkConfigurationCommand_base {
}
