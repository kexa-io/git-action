...
declare const DisassociateWebsiteCertificateAuthorityCommand_base: {
    new (input: DisassociateWebsiteCertificateAuthorityCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateWebsiteCertificateAuthorityCommandInput, DisassociateWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateWebsiteCertificateAuthorityCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateWebsiteCertificateAuthorityCommandInput, DisassociateWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateWebsiteCertificateAuthorityCommand extends DisassociateWebsiteCertificateAuthorityCommand_base {
}
