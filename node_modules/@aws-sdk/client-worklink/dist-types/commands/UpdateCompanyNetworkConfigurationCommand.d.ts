...
declare const UpdateCompanyNetworkConfigurationCommand_base: {
    new (input: UpdateCompanyNetworkConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateCompanyNetworkConfigurationCommandInput, UpdateCompanyNetworkConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateCompanyNetworkConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateCompanyNetworkConfigurationCommandInput, UpdateCompanyNetworkConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateCompanyNetworkConfigurationCommand extends UpdateCompanyNetworkConfigurationCommand_base {
}
