...
declare const CreateFleetCommand_base: {
    new (input: CreateFleetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateFleetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
