...
declare const DescribeDevicePolicyConfigurationCommand_base: {
    new (input: DescribeDevicePolicyConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDevicePolicyConfigurationCommandInput, DescribeDevicePolicyConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeDevicePolicyConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDevicePolicyConfigurationCommandInput, DescribeDevicePolicyConfigurationCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeDevicePolicyConfigurationCommand extends DescribeDevicePolicyConfigurationCommand_base {
}
