...
declare const DisassociateWebsiteAuthorizationProviderCommand_base: {
    new (input: DisassociateWebsiteAuthorizationProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateWebsiteAuthorizationProviderCommandInput, DisassociateWebsiteAuthorizationProviderCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateWebsiteAuthorizationProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateWebsiteAuthorizationProviderCommandInput, DisassociateWebsiteAuthorizationProviderCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateWebsiteAuthorizationProviderCommand extends DisassociateWebsiteAuthorizationProviderCommand_base {
}
