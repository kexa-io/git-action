...
declare const ListWebsiteCertificateAuthoritiesCommand_base: {
    new (input: ListWebsiteCertificateAuthoritiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListWebsiteCertificateAuthoritiesCommandInput, ListWebsiteCertificateAuthoritiesCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListWebsiteCertificateAuthoritiesCommandInput): import("@smithy/smithy-client").CommandImpl<ListWebsiteCertificateAuthoritiesCommandInput, ListWebsiteCertificateAuthoritiesCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListWebsiteCertificateAuthoritiesCommand extends ListWebsiteCertificateAuthoritiesCommand_base {
}
