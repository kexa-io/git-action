...
declare const DescribeDomainCommand_base: {
    new (input: DescribeDomainCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDomainCommandInput, DescribeDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeDomainCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDomainCommandInput, DescribeDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
