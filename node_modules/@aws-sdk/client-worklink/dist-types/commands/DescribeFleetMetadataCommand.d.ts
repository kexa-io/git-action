...
declare const DescribeFleetMetadataCommand_base: {
    new (input: DescribeFleetMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFleetMetadataCommandInput, DescribeFleetMetadataCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeFleetMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFleetMetadataCommandInput, DescribeFleetMetadataCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeFleetMetadataCommand extends DescribeFleetMetadataCommand_base {
}
