...
declare const DisassociateDomainCommand_base: {
    new (input: DisassociateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateDomainCommandInput, DisassociateDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateDomainCommandInput, DisassociateDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateDomainCommand extends DisassociateDomainCommand_base {
}
