...
declare const AssociateDomainCommand_base: {
    new (input: AssociateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDomainCommandInput, AssociateDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDomainCommandInput, AssociateDomainCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateDomainCommand extends AssociateDomainCommand_base {
}
