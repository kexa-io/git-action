...
declare const UpdateDomainMetadataCommand_base: {
    new (input: UpdateDomainMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDomainMetadataCommandInput, UpdateDomainMetadataCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateDomainMetadataCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDomainMetadataCommandInput, UpdateDomainMetadataCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateDomainMetadataCommand extends UpdateDomainMetadataCommand_base {
}
