...
declare const AssociateWebsiteCertificateAuthorityCommand_base: {
    new (input: AssociateWebsiteCertificateAuthorityCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateWebsiteCertificateAuthorityCommandInput, AssociateWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateWebsiteCertificateAuthorityCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateWebsiteCertificateAuthorityCommandInput, AssociateWebsiteCertificateAuthorityCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateWebsiteCertificateAuthorityCommand extends AssociateWebsiteCertificateAuthorityCommand_base {
}
