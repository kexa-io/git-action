...
declare const RestoreDomainAccessCommand_base: {
    new (input: RestoreDomainAccessCommandInput): import("@smithy/smithy-client").CommandImpl<RestoreDomainAccessCommandInput, RestoreDomainAccessCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RestoreDomainAccessCommandInput): import("@smithy/smithy-client").CommandImpl<RestoreDomainAccessCommandInput, RestoreDomainAccessCommandOutput, WorkLinkClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RestoreDomainAccessCommand extends RestoreDomainAccessCommand_base {
}
