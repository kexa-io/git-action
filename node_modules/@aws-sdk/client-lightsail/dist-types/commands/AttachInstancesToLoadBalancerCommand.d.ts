...
declare const AttachInstancesToLoadBalancerCommand_base: {
    new (input: AttachInstancesToLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<AttachInstancesToLoadBalancerCommandInput, AttachInstancesToLoadBalancerCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AttachInstancesToLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<AttachInstancesToLoadBalancerCommandInput, AttachInstancesToLoadBalancerCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AttachInstancesToLoadBalancerCommand extends AttachInstancesToLoadBalancerCommand_base {
}
