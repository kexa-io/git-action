...
declare const AttachDiskCommand_base: {
    new (input: AttachDiskCommandInput): import("@smithy/smithy-client").CommandImpl<AttachDiskCommandInput, AttachDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AttachDiskCommandInput): import("@smithy/smithy-client").CommandImpl<AttachDiskCommandInput, AttachDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AttachDiskCommand extends AttachDiskCommand_base {
}
