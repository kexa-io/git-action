...
declare const CreateDistributionCommand_base: {
    new (input: CreateDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDistributionCommandInput, CreateDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDistributionCommandInput, CreateDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
