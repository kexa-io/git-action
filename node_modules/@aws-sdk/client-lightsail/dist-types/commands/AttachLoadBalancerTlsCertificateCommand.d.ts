...
declare const AttachLoadBalancerTlsCertificateCommand_base: {
    new (input: AttachLoadBalancerTlsCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<AttachLoadBalancerTlsCertificateCommandInput, AttachLoadBalancerTlsCertificateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AttachLoadBalancerTlsCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<AttachLoadBalancerTlsCertificateCommandInput, AttachLoadBalancerTlsCertificateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AttachLoadBalancerTlsCertificateCommand extends AttachLoadBalancerTlsCertificateCommand_base {
}
