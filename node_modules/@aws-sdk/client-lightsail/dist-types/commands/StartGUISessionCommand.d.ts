...
declare const StartGUISessionCommand_base: {
    new (input: StartGUISessionCommandInput): import("@smithy/smithy-client").CommandImpl<StartGUISessionCommandInput, StartGUISessionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartGUISessionCommandInput): import("@smithy/smithy-client").CommandImpl<StartGUISessionCommandInput, StartGUISessionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartGUISessionCommand extends StartGUISessionCommand_base {
}
