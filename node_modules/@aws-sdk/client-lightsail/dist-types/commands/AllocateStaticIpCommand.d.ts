...
declare const AllocateStaticIpCommand_base: {
    new (input: AllocateStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<AllocateStaticIpCommandInput, AllocateStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AllocateStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<AllocateStaticIpCommandInput, AllocateStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AllocateStaticIpCommand extends AllocateStaticIpCommand_base {
}
