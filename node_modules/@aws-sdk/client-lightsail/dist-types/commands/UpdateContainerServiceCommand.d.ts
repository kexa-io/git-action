...
declare const UpdateContainerServiceCommand_base: {
    new (input: UpdateContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateContainerServiceCommandInput, UpdateContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateContainerServiceCommandInput, UpdateContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateContainerServiceCommand extends UpdateContainerServiceCommand_base {
}
