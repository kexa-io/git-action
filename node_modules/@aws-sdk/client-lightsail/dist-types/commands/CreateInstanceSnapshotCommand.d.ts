...
declare const CreateInstanceSnapshotCommand_base: {
    new (input: CreateInstanceSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstanceSnapshotCommandInput, CreateInstanceSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateInstanceSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstanceSnapshotCommandInput, CreateInstanceSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateInstanceSnapshotCommand extends CreateInstanceSnapshotCommand_base {
}
