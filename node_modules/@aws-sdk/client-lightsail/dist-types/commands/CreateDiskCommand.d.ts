...
declare const CreateDiskCommand_base: {
    new (input: CreateDiskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskCommandInput, CreateDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDiskCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskCommandInput, CreateDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDiskCommand extends CreateDiskCommand_base {
}
