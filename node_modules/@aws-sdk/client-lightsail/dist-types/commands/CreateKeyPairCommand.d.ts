...
declare const CreateKeyPairCommand_base: {
    new (input: CreateKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<CreateKeyPairCommandInput, CreateKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<CreateKeyPairCommandInput, CreateKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
