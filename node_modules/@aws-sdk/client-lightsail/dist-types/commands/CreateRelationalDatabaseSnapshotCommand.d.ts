...
declare const CreateRelationalDatabaseSnapshotCommand_base: {
    new (input: CreateRelationalDatabaseSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseSnapshotCommandInput, CreateRelationalDatabaseSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRelationalDatabaseSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseSnapshotCommandInput, CreateRelationalDatabaseSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRelationalDatabaseSnapshotCommand extends CreateRelationalDatabaseSnapshotCommand_base {
}
