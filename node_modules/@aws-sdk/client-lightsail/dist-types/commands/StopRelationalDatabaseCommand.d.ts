...
declare const StopRelationalDatabaseCommand_base: {
    new (input: StopRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<StopRelationalDatabaseCommandInput, StopRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<StopRelationalDatabaseCommandInput, StopRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopRelationalDatabaseCommand extends StopRelationalDatabaseCommand_base {
}
