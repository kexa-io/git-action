...
declare const CreateDiskSnapshotCommand_base: {
    new (input: CreateDiskSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskSnapshotCommandInput, CreateDiskSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDiskSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskSnapshotCommandInput, CreateDiskSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDiskSnapshotCommand extends CreateDiskSnapshotCommand_base {
}
