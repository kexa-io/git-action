...
declare const GetContainerServiceMetricDataCommand_base: {
    new (input: GetContainerServiceMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerServiceMetricDataCommandInput, GetContainerServiceMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetContainerServiceMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerServiceMetricDataCommandInput, GetContainerServiceMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetContainerServiceMetricDataCommand extends GetContainerServiceMetricDataCommand_base {
}
