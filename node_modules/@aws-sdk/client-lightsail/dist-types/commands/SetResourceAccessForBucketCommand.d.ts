...
declare const SetResourceAccessForBucketCommand_base: {
    new (input: SetResourceAccessForBucketCommandInput): import("@smithy/smithy-client").CommandImpl<SetResourceAccessForBucketCommandInput, SetResourceAccessForBucketCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SetResourceAccessForBucketCommandInput): import("@smithy/smithy-client").CommandImpl<SetResourceAccessForBucketCommandInput, SetResourceAccessForBucketCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SetResourceAccessForBucketCommand extends SetResourceAccessForBucketCommand_base {
}
