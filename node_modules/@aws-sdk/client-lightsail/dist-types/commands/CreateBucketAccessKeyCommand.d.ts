...
declare const CreateBucketAccessKeyCommand_base: {
    new (input: CreateBucketAccessKeyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateBucketAccessKeyCommandInput, CreateBucketAccessKeyCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateBucketAccessKeyCommandInput): import("@smithy/smithy-client").CommandImpl<CreateBucketAccessKeyCommandInput, CreateBucketAccessKeyCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateBucketAccessKeyCommand extends CreateBucketAccessKeyCommand_base {
}
