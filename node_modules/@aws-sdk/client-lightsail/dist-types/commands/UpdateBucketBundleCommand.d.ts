...
declare const UpdateBucketBundleCommand_base: {
    new (input: UpdateBucketBundleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBucketBundleCommandInput, UpdateBucketBundleCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateBucketBundleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBucketBundleCommandInput, UpdateBucketBundleCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateBucketBundleCommand extends UpdateBucketBundleCommand_base {
}
