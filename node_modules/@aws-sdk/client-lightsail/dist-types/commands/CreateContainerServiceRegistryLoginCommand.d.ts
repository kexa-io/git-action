...
declare const CreateContainerServiceRegistryLoginCommand_base: {
    new (input: CreateContainerServiceRegistryLoginCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceRegistryLoginCommandInput, CreateContainerServiceRegistryLoginCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [CreateContainerServiceRegistryLoginCommandInput]): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceRegistryLoginCommandInput, CreateContainerServiceRegistryLoginCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateContainerServiceRegistryLoginCommand extends CreateContainerServiceRegistryLoginCommand_base {
}
