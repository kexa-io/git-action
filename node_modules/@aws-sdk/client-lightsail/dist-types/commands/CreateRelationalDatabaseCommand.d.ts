...
declare const CreateRelationalDatabaseCommand_base: {
    new (input: CreateRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseCommandInput, CreateRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseCommandInput, CreateRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRelationalDatabaseCommand extends CreateRelationalDatabaseCommand_base {
}
