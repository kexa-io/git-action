...
declare const OpenInstancePublicPortsCommand_base: {
    new (input: OpenInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<OpenInstancePublicPortsCommandInput, OpenInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: OpenInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<OpenInstancePublicPortsCommandInput, OpenInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
