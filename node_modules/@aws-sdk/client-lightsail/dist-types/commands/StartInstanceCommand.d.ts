...
declare const StartInstanceCommand_base: {
    new (input: StartInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartInstanceCommandInput, StartInstanceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartInstanceCommandInput, StartInstanceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartInstanceCommand extends StartInstanceCommand_base {
}
