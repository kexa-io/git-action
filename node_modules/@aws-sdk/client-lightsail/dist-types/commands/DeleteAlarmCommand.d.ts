...
declare const DeleteAlarmCommand_base: {
    new (input: DeleteAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAlarmCommandInput, DeleteAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAlarmCommandInput, DeleteAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAlarmCommand extends DeleteAlarmCommand_base {
}
