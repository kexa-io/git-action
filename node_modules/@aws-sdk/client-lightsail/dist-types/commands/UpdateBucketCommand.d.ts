...
declare const UpdateBucketCommand_base: {
    new (input: UpdateBucketCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBucketCommandInput, UpdateBucketCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateBucketCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBucketCommandInput, UpdateBucketCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateBucketCommand extends UpdateBucketCommand_base {
}
