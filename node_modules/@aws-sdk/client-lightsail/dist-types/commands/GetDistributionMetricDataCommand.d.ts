...
declare const GetDistributionMetricDataCommand_base: {
    new (input: GetDistributionMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetDistributionMetricDataCommandInput, GetDistributionMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDistributionMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetDistributionMetricDataCommandInput, GetDistributionMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDistributionMetricDataCommand extends GetDistributionMetricDataCommand_base {
}
