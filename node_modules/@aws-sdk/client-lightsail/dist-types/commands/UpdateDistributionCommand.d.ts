...
declare const UpdateDistributionCommand_base: {
    new (input: UpdateDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDistributionCommandInput, UpdateDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDistributionCommandInput, UpdateDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
