...
declare const CloseInstancePublicPortsCommand_base: {
    new (input: CloseInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<CloseInstancePublicPortsCommandInput, CloseInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CloseInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<CloseInstancePublicPortsCommandInput, CloseInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CloseInstancePublicPortsCommand extends CloseInstancePublicPortsCommand_base {
}
