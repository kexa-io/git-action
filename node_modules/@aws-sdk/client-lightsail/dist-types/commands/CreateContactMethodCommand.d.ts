...
declare const CreateContactMethodCommand_base: {
    new (input: CreateContactMethodCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContactMethodCommandInput, CreateContactMethodCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateContactMethodCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContactMethodCommandInput, CreateContactMethodCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateContactMethodCommand extends CreateContactMethodCommand_base {
}
