...
declare const CreateContainerServiceDeploymentCommand_base: {
    new (input: CreateContainerServiceDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceDeploymentCommandInput, CreateContainerServiceDeploymentCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateContainerServiceDeploymentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceDeploymentCommandInput, CreateContainerServiceDeploymentCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateContainerServiceDeploymentCommand extends CreateContainerServiceDeploymentCommand_base {
}
