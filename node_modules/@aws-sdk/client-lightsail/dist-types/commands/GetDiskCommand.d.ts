...
declare const GetDiskCommand_base: {
    new (input: GetDiskCommandInput): import("@smithy/smithy-client").CommandImpl<GetDiskCommandInput, GetDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDiskCommandInput): import("@smithy/smithy-client").CommandImpl<GetDiskCommandInput, GetDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDiskCommand extends GetDiskCommand_base {
}
