...
declare const CreateContainerServiceCommand_base: {
    new (input: CreateContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceCommandInput, CreateContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<CreateContainerServiceCommandInput, CreateContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateContainerServiceCommand extends CreateContainerServiceCommand_base {
}
