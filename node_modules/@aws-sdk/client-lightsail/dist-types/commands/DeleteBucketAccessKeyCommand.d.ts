...
declare const DeleteBucketAccessKeyCommand_base: {
    new (input: DeleteBucketAccessKeyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBucketAccessKeyCommandInput, DeleteBucketAccessKeyCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteBucketAccessKeyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteBucketAccessKeyCommandInput, DeleteBucketAccessKeyCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteBucketAccessKeyCommand extends DeleteBucketAccessKeyCommand_base {
}
