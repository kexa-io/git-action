...
declare const GetDiskSnapshotsCommand_base: {
    new (input: GetDiskSnapshotsCommandInput): import("@smithy/smithy-client").CommandImpl<GetDiskSnapshotsCommandInput, GetDiskSnapshotsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class GetDiskSnapshotsCommand extends GetDiskSnapshotsCommand_base {
}
