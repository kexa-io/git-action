...
declare const PutAlarmCommand_base: {
    new (input: PutAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<PutAlarmCommandInput, PutAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<PutAlarmCommandInput, PutAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
