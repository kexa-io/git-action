...
declare const GetKeyPairCommand_base: {
    new (input: GetKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<GetKeyPairCommandInput, GetKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<GetKeyPairCommandInput, GetKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetKeyPairCommand extends GetKeyPairCommand_base {
}
