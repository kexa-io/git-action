...
declare const GetCostEstimateCommand_base: {
    new (input: GetCostEstimateCommandInput): import("@smithy/smithy-client").CommandImpl<GetCostEstimateCommandInput, GetCostEstimateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetCostEstimateCommandInput): import("@smithy/smithy-client").CommandImpl<GetCostEstimateCommandInput, GetCostEstimateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetCostEstimateCommand extends GetCostEstimateCommand_base {
}
