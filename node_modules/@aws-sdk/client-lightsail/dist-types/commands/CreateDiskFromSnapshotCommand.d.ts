...
declare const CreateDiskFromSnapshotCommand_base: {
    new (input: CreateDiskFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskFromSnapshotCommandInput, CreateDiskFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDiskFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDiskFromSnapshotCommandInput, CreateDiskFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDiskFromSnapshotCommand extends CreateDiskFromSnapshotCommand_base {
}
