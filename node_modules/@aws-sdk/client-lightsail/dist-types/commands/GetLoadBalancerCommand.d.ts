...
declare const GetLoadBalancerCommand_base: {
    new (input: GetLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<GetLoadBalancerCommandInput, GetLoadBalancerCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLoadBalancerCommandInput): import("@smithy/smithy-client").CommandImpl<GetLoadBalancerCommandInput, GetLoadBalancerCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLoadBalancerCommand extends GetLoadBalancerCommand_base {
}
