...
declare const GetContainerLogCommand_base: {
    new (input: GetContainerLogCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerLogCommandInput, GetContainerLogCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetContainerLogCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerLogCommandInput, GetContainerLogCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetContainerLogCommand extends GetContainerLogCommand_base {
}
