...
declare const GetSetupHistoryCommand_base: {
    new (input: GetSetupHistoryCommandInput): import("@smithy/smithy-client").CommandImpl<GetSetupHistoryCommandInput, GetSetupHistoryCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetSetupHistoryCommandInput): import("@smithy/smithy-client").CommandImpl<GetSetupHistoryCommandInput, GetSetupHistoryCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
