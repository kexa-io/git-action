...
declare const GetStaticIpCommand_base: {
    new (input: GetStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<GetStaticIpCommandInput, GetStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<GetStaticIpCommandInput, GetStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
