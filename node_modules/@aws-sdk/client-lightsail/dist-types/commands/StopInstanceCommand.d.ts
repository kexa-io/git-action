...
declare const StopInstanceCommand_base: {
    new (input: StopInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StopInstanceCommandInput, StopInstanceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<StopInstanceCommandInput, StopInstanceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopInstanceCommand extends StopInstanceCommand_base {
}
