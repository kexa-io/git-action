...
declare const GetRelationalDatabaseSnapshotsCommand_base: {
    new (input: GetRelationalDatabaseSnapshotsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseSnapshotsCommandInput, GetRelationalDatabaseSnapshotsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
