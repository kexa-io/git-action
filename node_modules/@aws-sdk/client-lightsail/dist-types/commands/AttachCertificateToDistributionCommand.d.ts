...
declare const AttachCertificateToDistributionCommand_base: {
    new (input: AttachCertificateToDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<AttachCertificateToDistributionCommandInput, AttachCertificateToDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AttachCertificateToDistributionCommandInput): import("@smithy/smithy-client").CommandImpl<AttachCertificateToDistributionCommandInput, AttachCertificateToDistributionCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AttachCertificateToDistributionCommand extends AttachCertificateToDistributionCommand_base {
}
