...
declare const RebootRelationalDatabaseCommand_base: {
    new (input: RebootRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<RebootRelationalDatabaseCommandInput, RebootRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RebootRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<RebootRelationalDatabaseCommandInput, RebootRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
