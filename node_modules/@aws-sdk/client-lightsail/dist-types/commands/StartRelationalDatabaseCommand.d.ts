...
declare const StartRelationalDatabaseCommand_base: {
    new (input: StartRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<StartRelationalDatabaseCommandInput, StartRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<StartRelationalDatabaseCommandInput, StartRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartRelationalDatabaseCommand extends StartRelationalDatabaseCommand_base {
}
