...
declare const CreateRelationalDatabaseFromSnapshotCommand_base: {
    new (input: CreateRelationalDatabaseFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseFromSnapshotCommandInput, CreateRelationalDatabaseFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRelationalDatabaseFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRelationalDatabaseFromSnapshotCommandInput, CreateRelationalDatabaseFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRelationalDatabaseFromSnapshotCommand extends CreateRelationalDatabaseFromSnapshotCommand_base {
}
