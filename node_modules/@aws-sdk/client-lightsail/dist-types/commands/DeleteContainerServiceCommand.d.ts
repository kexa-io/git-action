...
declare const DeleteContainerServiceCommand_base: {
    new (input: DeleteContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContainerServiceCommandInput, DeleteContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteContainerServiceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContainerServiceCommandInput, DeleteContainerServiceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteContainerServiceCommand extends DeleteContainerServiceCommand_base {
}
