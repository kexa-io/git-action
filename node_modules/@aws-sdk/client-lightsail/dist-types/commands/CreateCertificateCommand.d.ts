...
declare const CreateCertificateCommand_base: {
    new (input: CreateCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCertificateCommandInput, CreateCertificateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCertificateCommandInput, CreateCertificateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateCertificateCommand extends CreateCertificateCommand_base {
}
