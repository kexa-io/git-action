...
declare const DeleteDiskSnapshotCommand_base: {
    new (input: DeleteDiskSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDiskSnapshotCommandInput, DeleteDiskSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDiskSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDiskSnapshotCommandInput, DeleteDiskSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDiskSnapshotCommand extends DeleteDiskSnapshotCommand_base {
}
