...
declare const ReleaseStaticIpCommand_base: {
    new (input: ReleaseStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<ReleaseStaticIpCommandInput, ReleaseStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ReleaseStaticIpCommandInput): import("@smithy/smithy-client").CommandImpl<ReleaseStaticIpCommandInput, ReleaseStaticIpCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
