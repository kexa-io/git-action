...
declare const DeleteContainerImageCommand_base: {
    new (input: DeleteContainerImageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContainerImageCommandInput, DeleteContainerImageCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteContainerImageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContainerImageCommandInput, DeleteContainerImageCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteContainerImageCommand extends DeleteContainerImageCommand_base {
}
