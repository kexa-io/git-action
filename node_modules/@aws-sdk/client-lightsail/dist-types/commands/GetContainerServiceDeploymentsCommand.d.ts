...
declare const GetContainerServiceDeploymentsCommand_base: {
    new (input: GetContainerServiceDeploymentsCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerServiceDeploymentsCommandInput, GetContainerServiceDeploymentsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetContainerServiceDeploymentsCommandInput): import("@smithy/smithy-client").CommandImpl<GetContainerServiceDeploymentsCommandInput, GetContainerServiceDeploymentsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetContainerServiceDeploymentsCommand extends GetContainerServiceDeploymentsCommand_base {
}
