...
declare const CreateDomainCommand_base: {
    new (input: CreateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDomainCommandInput, CreateDomainCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDomainCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDomainCommandInput, CreateDomainCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
