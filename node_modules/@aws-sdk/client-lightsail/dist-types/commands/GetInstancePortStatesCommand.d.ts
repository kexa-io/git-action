...
declare const GetInstancePortStatesCommand_base: {
    new (input: GetInstancePortStatesCommandInput): import("@smithy/smithy-client").CommandImpl<GetInstancePortStatesCommandInput, GetInstancePortStatesCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetInstancePortStatesCommandInput): import("@smithy/smithy-client").CommandImpl<GetInstancePortStatesCommandInput, GetInstancePortStatesCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetInstancePortStatesCommand extends GetInstancePortStatesCommand_base {
}
