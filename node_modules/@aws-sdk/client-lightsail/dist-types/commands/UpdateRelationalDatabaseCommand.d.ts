...
declare const UpdateRelationalDatabaseCommand_base: {
    new (input: UpdateRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRelationalDatabaseCommandInput, UpdateRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRelationalDatabaseCommandInput, UpdateRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateRelationalDatabaseCommand extends UpdateRelationalDatabaseCommand_base {
}
