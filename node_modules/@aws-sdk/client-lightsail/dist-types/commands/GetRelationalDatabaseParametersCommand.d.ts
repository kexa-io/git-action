...
declare const GetRelationalDatabaseParametersCommand_base: {
    new (input: GetRelationalDatabaseParametersCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseParametersCommandInput, GetRelationalDatabaseParametersCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseParametersCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseParametersCommandInput, GetRelationalDatabaseParametersCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
