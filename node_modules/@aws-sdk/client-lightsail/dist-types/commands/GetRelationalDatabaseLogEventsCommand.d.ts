...
declare const GetRelationalDatabaseLogEventsCommand_base: {
    new (input: GetRelationalDatabaseLogEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseLogEventsCommandInput, GetRelationalDatabaseLogEventsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseLogEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseLogEventsCommandInput, GetRelationalDatabaseLogEventsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseLogEventsCommand extends GetRelationalDatabaseLogEventsCommand_base {
}
