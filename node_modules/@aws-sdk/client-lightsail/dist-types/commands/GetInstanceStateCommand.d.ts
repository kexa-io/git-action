...
declare const GetInstanceStateCommand_base: {
    new (input: GetInstanceStateCommandInput): import("@smithy/smithy-client").CommandImpl<GetInstanceStateCommandInput, GetInstanceStateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetInstanceStateCommandInput): import("@smithy/smithy-client").CommandImpl<GetInstanceStateCommandInput, GetInstanceStateCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetInstanceStateCommand extends GetInstanceStateCommand_base {
}
