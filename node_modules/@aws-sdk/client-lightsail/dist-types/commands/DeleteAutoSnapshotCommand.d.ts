...
declare const DeleteAutoSnapshotCommand_base: {
    new (input: DeleteAutoSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAutoSnapshotCommandInput, DeleteAutoSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAutoSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAutoSnapshotCommandInput, DeleteAutoSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAutoSnapshotCommand extends DeleteAutoSnapshotCommand_base {
}
