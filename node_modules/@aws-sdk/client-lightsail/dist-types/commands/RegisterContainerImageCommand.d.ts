...
declare const RegisterContainerImageCommand_base: {
    new (input: RegisterContainerImageCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterContainerImageCommandInput, RegisterContainerImageCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterContainerImageCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterContainerImageCommandInput, RegisterContainerImageCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
