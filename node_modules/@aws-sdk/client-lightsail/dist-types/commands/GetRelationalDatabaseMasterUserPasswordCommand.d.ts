...
declare const GetRelationalDatabaseMasterUserPasswordCommand_base: {
    new (input: GetRelationalDatabaseMasterUserPasswordCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseMasterUserPasswordCommandInput, GetRelationalDatabaseMasterUserPasswordCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseMasterUserPasswordCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseMasterUserPasswordCommandInput, GetRelationalDatabaseMasterUserPasswordCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseMasterUserPasswordCommand extends GetRelationalDatabaseMasterUserPasswordCommand_base {
}
