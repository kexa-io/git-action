...
declare const SetupInstanceHttpsCommand_base: {
    new (input: SetupInstanceHttpsCommandInput): import("@smithy/smithy-client").CommandImpl<SetupInstanceHttpsCommandInput, SetupInstanceHttpsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SetupInstanceHttpsCommandInput): import("@smithy/smithy-client").CommandImpl<SetupInstanceHttpsCommandInput, SetupInstanceHttpsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
