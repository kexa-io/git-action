...
declare const GetRegionsCommand_base: {
    new (input: GetRegionsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRegionsCommandInput, GetRegionsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class GetRegionsCommand extends GetRegionsCommand_base {
}
