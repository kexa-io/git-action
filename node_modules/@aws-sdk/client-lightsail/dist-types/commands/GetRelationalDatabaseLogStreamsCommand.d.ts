...
declare const GetRelationalDatabaseLogStreamsCommand_base: {
    new (input: GetRelationalDatabaseLogStreamsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseLogStreamsCommandInput, GetRelationalDatabaseLogStreamsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseLogStreamsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseLogStreamsCommandInput, GetRelationalDatabaseLogStreamsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseLogStreamsCommand extends GetRelationalDatabaseLogStreamsCommand_base {
}
