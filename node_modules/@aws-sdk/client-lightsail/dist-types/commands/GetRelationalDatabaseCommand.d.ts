...
declare const GetRelationalDatabaseCommand_base: {
    new (input: GetRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseCommandInput, GetRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseCommandInput, GetRelationalDatabaseCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseCommand extends GetRelationalDatabaseCommand_base {
}
