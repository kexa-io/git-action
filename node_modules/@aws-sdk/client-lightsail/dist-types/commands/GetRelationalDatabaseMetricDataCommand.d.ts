...
declare const GetRelationalDatabaseMetricDataCommand_base: {
    new (input: GetRelationalDatabaseMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseMetricDataCommandInput, GetRelationalDatabaseMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseMetricDataCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseMetricDataCommandInput, GetRelationalDatabaseMetricDataCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseMetricDataCommand extends GetRelationalDatabaseMetricDataCommand_base {
}
