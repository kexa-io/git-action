...
declare const ImportKeyPairCommand_base: {
    new (input: ImportKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ImportKeyPairCommandInput): import("@smithy/smithy-client").CommandImpl<ImportKeyPairCommandInput, ImportKeyPairCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
