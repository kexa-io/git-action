...
declare const TestAlarmCommand_base: {
    new (input: TestAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<TestAlarmCommandInput, TestAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TestAlarmCommandInput): import("@smithy/smithy-client").CommandImpl<TestAlarmCommandInput, TestAlarmCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TestAlarmCommand extends TestAlarmCommand_base {
}
