...
declare const SendContactMethodVerificationCommand_base: {
    new (input: SendContactMethodVerificationCommandInput): import("@smithy/smithy-client").CommandImpl<SendContactMethodVerificationCommandInput, SendContactMethodVerificationCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SendContactMethodVerificationCommandInput): import("@smithy/smithy-client").CommandImpl<SendContactMethodVerificationCommandInput, SendContactMethodVerificationCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
