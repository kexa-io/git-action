...
declare const DeleteDiskCommand_base: {
    new (input: DeleteDiskCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDiskCommandInput, DeleteDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDiskCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDiskCommandInput, DeleteDiskCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteDiskCommand extends DeleteDiskCommand_base {
}
