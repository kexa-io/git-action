...
declare const GetRelationalDatabaseEventsCommand_base: {
    new (input: GetRelationalDatabaseEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseEventsCommandInput, GetRelationalDatabaseEventsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRelationalDatabaseEventsCommandInput): import("@smithy/smithy-client").CommandImpl<GetRelationalDatabaseEventsCommandInput, GetRelationalDatabaseEventsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRelationalDatabaseEventsCommand extends GetRelationalDatabaseEventsCommand_base {
}
