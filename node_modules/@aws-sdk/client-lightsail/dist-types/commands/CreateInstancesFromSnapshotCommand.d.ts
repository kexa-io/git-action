...
declare const CreateInstancesFromSnapshotCommand_base: {
    new (input: CreateInstancesFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstancesFromSnapshotCommandInput, CreateInstancesFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateInstancesFromSnapshotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateInstancesFromSnapshotCommandInput, CreateInstancesFromSnapshotCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateInstancesFromSnapshotCommand extends CreateInstancesFromSnapshotCommand_base {
}
