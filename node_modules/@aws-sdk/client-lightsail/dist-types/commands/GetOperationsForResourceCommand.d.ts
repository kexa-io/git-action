...
declare const GetOperationsForResourceCommand_base: {
    new (input: GetOperationsForResourceCommandInput): import("@smithy/smithy-client").CommandImpl<GetOperationsForResourceCommandInput, GetOperationsForResourceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetOperationsForResourceCommandInput): import("@smithy/smithy-client").CommandImpl<GetOperationsForResourceCommandInput, GetOperationsForResourceCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetOperationsForResourceCommand extends GetOperationsForResourceCommand_base {
}
