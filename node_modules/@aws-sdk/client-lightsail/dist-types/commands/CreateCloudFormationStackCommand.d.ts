...
declare const CreateCloudFormationStackCommand_base: {
    new (input: CreateCloudFormationStackCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCloudFormationStackCommandInput, CreateCloudFormationStackCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateCloudFormationStackCommandInput): import("@smithy/smithy-client").CommandImpl<CreateCloudFormationStackCommandInput, CreateCloudFormationStackCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateCloudFormationStackCommand extends CreateCloudFormationStackCommand_base {
}
