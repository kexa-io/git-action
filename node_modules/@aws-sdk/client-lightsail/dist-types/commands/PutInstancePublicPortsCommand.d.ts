...
declare const PutInstancePublicPortsCommand_base: {
    new (input: PutInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<PutInstancePublicPortsCommandInput, PutInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutInstancePublicPortsCommandInput): import("@smithy/smithy-client").CommandImpl<PutInstancePublicPortsCommandInput, PutInstancePublicPortsCommandOutput, LightsailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
