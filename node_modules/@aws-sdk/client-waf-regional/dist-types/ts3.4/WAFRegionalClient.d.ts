...
export type WAFRegionalClientConfigType = Partial<
...
export type WAFRegionalClientResolvedConfigType =
  __SmithyResolvedConfiguration<__HttpHandlerOptions> &
    ...
    HttpAuthSchemeResolvedConfig &
    ClientResolvedEndpointParameters;
export interface WAFRegionalClientResolvedConfig
  extends WAFRegionalClientResolvedConfigType {}
export declare class WAFRegionalClient extends __Client<
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<WAFRegionalClientConfig>
  );
  destroy(): void;
