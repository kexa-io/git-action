...
declare const PutPermissionPolicyCommand_base: {
    new (input: PutPermissionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutPermissionPolicyCommandInput, PutPermissionPolicyCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutPermissionPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutPermissionPolicyCommandInput, PutPermissionPolicyCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
