...
declare const ListSubscribedRuleGroupsCommand_base: {
    new (input: ListSubscribedRuleGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSubscribedRuleGroupsCommandInput, ListSubscribedRuleGroupsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListSubscribedRuleGroupsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListSubscribedRuleGroupsCommandInput, ListSubscribedRuleGroupsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
