...
declare const ListRegexMatchSetsCommand_base: {
    new (input: ListRegexMatchSetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRegexMatchSetsCommandInput, ListRegexMatchSetsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
