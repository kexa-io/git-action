...
declare const ListXssMatchSetsCommand_base: {
    new (input: ListXssMatchSetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListXssMatchSetsCommandInput, ListXssMatchSetsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
