...
declare const ListRateBasedRulesCommand_base: {
    new (input: ListRateBasedRulesCommandInput): import("@smithy/smithy-client").CommandImpl<ListRateBasedRulesCommandInput, ListRateBasedRulesCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
