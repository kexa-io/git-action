...
declare const GetChangeTokenCommand_base: {
    new (input: GetChangeTokenCommandInput): import("@smithy/smithy-client").CommandImpl<GetChangeTokenCommandInput, GetChangeTokenCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
