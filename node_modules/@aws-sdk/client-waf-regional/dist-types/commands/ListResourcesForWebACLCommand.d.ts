...
declare const ListResourcesForWebACLCommand_base: {
    new (input: ListResourcesForWebACLCommandInput): import("@smithy/smithy-client").CommandImpl<ListResourcesForWebACLCommandInput, ListResourcesForWebACLCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListResourcesForWebACLCommandInput): import("@smithy/smithy-client").CommandImpl<ListResourcesForWebACLCommandInput, ListResourcesForWebACLCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
