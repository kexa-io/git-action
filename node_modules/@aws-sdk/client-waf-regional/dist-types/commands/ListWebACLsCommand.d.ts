...
declare const ListWebACLsCommand_base: {
    new (input: ListWebACLsCommandInput): import("@smithy/smithy-client").CommandImpl<ListWebACLsCommandInput, ListWebACLsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
