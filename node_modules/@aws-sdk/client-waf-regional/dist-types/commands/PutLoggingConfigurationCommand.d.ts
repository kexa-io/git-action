...
declare const PutLoggingConfigurationCommand_base: {
    new (input: PutLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutLoggingConfigurationCommandInput, PutLoggingConfigurationCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutLoggingConfigurationCommandInput, PutLoggingConfigurationCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
