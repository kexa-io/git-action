...
declare const UpdateRuleCommand_base: {
    ...
    new (__0_0: UpdateRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRuleCommandInput, UpdateRuleCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
