...
declare const UpdateByteMatchSetCommand_base: {
    new (input: UpdateByteMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateByteMatchSetCommandInput, UpdateByteMatchSetCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateByteMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateByteMatchSetCommandInput, UpdateByteMatchSetCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
