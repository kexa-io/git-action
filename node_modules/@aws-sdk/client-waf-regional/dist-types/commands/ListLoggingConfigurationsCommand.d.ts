...
declare const ListLoggingConfigurationsCommand_base: {
    new (input: ListLoggingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListLoggingConfigurationsCommandInput, ListLoggingConfigurationsCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
