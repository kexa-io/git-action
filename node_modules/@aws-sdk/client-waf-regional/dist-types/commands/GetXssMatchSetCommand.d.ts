...
declare const GetXssMatchSetCommand_base: {
    new (input: GetXssMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<GetXssMatchSetCommandInput, GetXssMatchSetCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetXssMatchSetCommandInput): import("@smithy/smithy-client").CommandImpl<GetXssMatchSetCommandInput, GetXssMatchSetCommandOutput, WAFRegionalClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
