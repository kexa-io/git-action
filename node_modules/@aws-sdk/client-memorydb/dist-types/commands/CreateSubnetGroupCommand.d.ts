...
declare const CreateSubnetGroupCommand_base: {
    new (input: CreateSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSubnetGroupCommandInput, CreateSubnetGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSubnetGroupCommandInput, CreateSubnetGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
