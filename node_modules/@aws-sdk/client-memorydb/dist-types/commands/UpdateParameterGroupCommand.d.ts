...
declare const UpdateParameterGroupCommand_base: {
    new (input: UpdateParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateParameterGroupCommandInput, UpdateParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateParameterGroupCommandInput, UpdateParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
