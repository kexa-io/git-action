...
declare const DeleteParameterGroupCommand_base: {
    new (input: DeleteParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteParameterGroupCommandInput, DeleteParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteParameterGroupCommandInput, DeleteParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
