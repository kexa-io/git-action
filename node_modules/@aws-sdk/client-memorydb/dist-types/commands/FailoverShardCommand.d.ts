...
declare const FailoverShardCommand_base: {
    new (input: FailoverShardCommandInput): import("@smithy/smithy-client").CommandImpl<FailoverShardCommandInput, FailoverShardCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: FailoverShardCommandInput): import("@smithy/smithy-client").CommandImpl<FailoverShardCommandInput, FailoverShardCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class FailoverShardCommand extends FailoverShardCommand_base {
}
