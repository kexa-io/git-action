...
declare const ListAllowedNodeTypeUpdatesCommand_base: {
    new (input: ListAllowedNodeTypeUpdatesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAllowedNodeTypeUpdatesCommandInput, ListAllowedNodeTypeUpdatesCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAllowedNodeTypeUpdatesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAllowedNodeTypeUpdatesCommandInput, ListAllowedNodeTypeUpdatesCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAllowedNodeTypeUpdatesCommand extends ListAllowedNodeTypeUpdatesCommand_base {
}
