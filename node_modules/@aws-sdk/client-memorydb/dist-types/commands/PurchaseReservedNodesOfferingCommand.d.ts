...
declare const PurchaseReservedNodesOfferingCommand_base: {
    new (input: PurchaseReservedNodesOfferingCommandInput): import("@smithy/smithy-client").CommandImpl<PurchaseReservedNodesOfferingCommandInput, PurchaseReservedNodesOfferingCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PurchaseReservedNodesOfferingCommandInput): import("@smithy/smithy-client").CommandImpl<PurchaseReservedNodesOfferingCommandInput, PurchaseReservedNodesOfferingCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PurchaseReservedNodesOfferingCommand extends PurchaseReservedNodesOfferingCommand_base {
}
