...
declare const DeleteACLCommand_base: {
    new (input: DeleteACLCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteACLCommandInput, DeleteACLCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteACLCommand extends DeleteACLCommand_base {
}
