...
declare const BatchUpdateClusterCommand_base: {
    new (input: BatchUpdateClusterCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpdateClusterCommandInput, BatchUpdateClusterCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchUpdateClusterCommandInput): import("@smithy/smithy-client").CommandImpl<BatchUpdateClusterCommandInput, BatchUpdateClusterCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchUpdateClusterCommand extends BatchUpdateClusterCommand_base {
}
