...
declare const DescribeEventsCommand_base: {
    new (input: DescribeEventsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeEventsCommandInput, DescribeEventsCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
