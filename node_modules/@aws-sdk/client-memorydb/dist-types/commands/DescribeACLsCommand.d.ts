...
declare const DescribeACLsCommand_base: {
    new (input: DescribeACLsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeACLsCommandInput, DescribeACLsCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeACLsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeACLsCommandInput, DescribeACLsCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeACLsCommand extends DescribeACLsCommand_base {
}
