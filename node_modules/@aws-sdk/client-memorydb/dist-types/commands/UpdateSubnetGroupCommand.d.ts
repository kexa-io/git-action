...
declare const UpdateSubnetGroupCommand_base: {
    new (input: UpdateSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSubnetGroupCommandInput, UpdateSubnetGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSubnetGroupCommandInput, UpdateSubnetGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
