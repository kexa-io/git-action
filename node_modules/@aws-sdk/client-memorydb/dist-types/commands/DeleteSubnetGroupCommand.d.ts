...
declare const DeleteSubnetGroupCommand_base: {
    new (input: DeleteSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSubnetGroupCommandInput, DeleteSubnetGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
