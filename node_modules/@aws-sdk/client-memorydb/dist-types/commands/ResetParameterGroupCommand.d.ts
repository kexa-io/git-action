...
declare const ResetParameterGroupCommand_base: {
    new (input: ResetParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ResetParameterGroupCommandInput, ResetParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ResetParameterGroupCommandInput): import("@smithy/smithy-client").CommandImpl<ResetParameterGroupCommandInput, ResetParameterGroupCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ResetParameterGroupCommand extends ResetParameterGroupCommand_base {
}
