...
declare const UpdateACLCommand_base: {
    new (input: UpdateACLCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateACLCommandInput, UpdateACLCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateACLCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateACLCommandInput, UpdateACLCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateACLCommand extends UpdateACLCommand_base {
}
