...
declare const DescribeSubnetGroupsCommand_base: {
    new (input: DescribeSubnetGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSubnetGroupsCommandInput, DescribeSubnetGroupsCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeSubnetGroupsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeSubnetGroupsCommandInput, DescribeSubnetGroupsCommandOutput, MemoryDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
