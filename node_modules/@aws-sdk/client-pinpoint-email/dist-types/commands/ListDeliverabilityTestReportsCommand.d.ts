...
declare const ListDeliverabilityTestReportsCommand_base: {
    new (input: ListDeliverabilityTestReportsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDeliverabilityTestReportsCommandInput, ListDeliverabilityTestReportsCommandOutput, PinpointEmailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListDeliverabilityTestReportsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListDeliverabilityTestReportsCommandInput, ListDeliverabilityTestReportsCommandOutput, PinpointEmailClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
