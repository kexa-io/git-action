 ...
 * @public
 */
export type ServiceInputTypes = ArchiveApplicationCommandInput | ArchiveWaveCommandInput | AssociateApplicationsCommandInput | AssociateSourceServersCommandInput | ChangeServerLifeCycleStateCommandInput | CreateApplicationCommandInput | CreateConnectorCommandInput | CreateLaunchConfigurationTemplateCommandInput | CreateReplicationConfigurationTemplateCommandInput | CreateWaveCommandInput | DeleteApplicationCommandInput | DeleteConnectorCommandInput | DeleteJobCommandInput | DeleteLaunchConfigurationTemplateCommandInput | DeleteReplicationConfigurationTemplateCommandInput | DeleteSourceServerCommandInput | DeleteVcenterClientCommandInput | DeleteWaveCommandInput | DescribeJobLogItemsCommandInput | DescribeJobsCommandInput | DescribeLaunchConfigurationTemplatesCommandInput | DescribeReplicationConfigurationTemplatesCommandInput | DescribeSourceServersCommandInput | DescribeVcenterClientsCommandInput | DisassociateApplicationsCommandInput | DisassociateSourceServersCommandInput | DisconnectFromServiceCommandInput | FinalizeCutoverCommandInput | GetLaunchConfigurationCommandInput | GetReplicationConfigurationCommandInput | InitializeServiceCommandInput | ListApplicationsCommandInput | ListConnectorsCommandInput | ListExportErrorsCommandInput | ListExportsCommandInput | ListImportErrorsCommandInput | ListImportsCommandInput | ListManagedAccountsCommandInput | ListSourceServerActionsCommandInput | ListTagsForResourceCommandInput | ListTemplateActionsCommandInput | ListWavesCommandInput | MarkAsArchivedCommandInput | PauseReplicationCommandInput | PutSourceServerActionCommandInput | PutTemplateActionCommandInput | RemoveSourceServerActionCommandInput | RemoveTemplateActionCommandInput | ResumeReplicationCommandInput | RetryDataReplicationCommandInput | StartCutoverCommandInput | StartExportCommandInput | StartImportCommandInput | StartReplicationCommandInput | StartTestCommandInput | StopReplicationCommandInput | TagResourceCommandInput | TerminateTargetInstancesCommandInput | UnarchiveApplicationCommandInput | UnarchiveWaveCommandInput | UntagResourceCommandInput | UpdateApplicationCommandInput | UpdateConnectorCommandInput | UpdateLaunchConfigurationCommandInput | UpdateLaunchConfigurationTemplateCommandInput | UpdateReplicationConfigurationCommandInput | UpdateReplicationConfigurationTemplateCommandInput | UpdateSourceServerCommandInput | UpdateSourceServerReplicationTypeCommandInput | UpdateWaveCommandInput;
/**
 * @public
 */
export type ServiceOutputTypes = ArchiveApplicationCommandOutput | ArchiveWaveCommandOutput | AssociateApplicationsCommandOutput | AssociateSourceServersCommandOutput | ChangeServerLifeCycleStateCommandOutput | CreateApplicationCommandOutput | CreateConnectorCommandOutput | CreateLaunchConfigurationTemplateCommandOutput | CreateReplicationConfigurationTemplateCommandOutput | CreateWaveCommandOutput | DeleteApplicationCommandOutput | DeleteConnectorCommandOutput | DeleteJobCommandOutput | DeleteLaunchConfigurationTemplateCommandOutput | DeleteReplicationConfigurationTemplateCommandOutput | DeleteSourceServerCommandOutput | DeleteVcenterClientCommandOutput | DeleteWaveCommandOutput | DescribeJobLogItemsCommandOutput | DescribeJobsCommandOutput | DescribeLaunchConfigurationTemplatesCommandOutput | DescribeReplicationConfigurationTemplatesCommandOutput | DescribeSourceServersCommandOutput | DescribeVcenterClientsCommandOutput | DisassociateApplicationsCommandOutput | DisassociateSourceServersCommandOutput | DisconnectFromServiceCommandOutput | FinalizeCutoverCommandOutput | GetLaunchConfigurationCommandOutput | GetReplicationConfigurationCommandOutput | InitializeServiceCommandOutput | ListApplicationsCommandOutput | ListConnectorsCommandOutput | ListExportErrorsCommandOutput | ListExportsCommandOutput | ListImportErrorsCommandOutput | ListImportsCommandOutput | ListManagedAccountsCommandOutput | ListSourceServerActionsCommandOutput | ListTagsForResourceCommandOutput | ListTemplateActionsCommandOutput | ListWavesCommandOutput | MarkAsArchivedCommandOutput | PauseReplicationCommandOutput | PutSourceServerActionCommandOutput | PutTemplateActionCommandOutput | RemoveSourceServerActionCommandOutput | RemoveTemplateActionCommandOutput | ResumeReplicationCommandOutput | RetryDataReplicationCommandOutput | StartCutoverCommandOutput | StartExportCommandOutput | StartImportCommandOutput | StartReplicationCommandOutput | StartTestCommandOutput | StopReplicationCommandOutput | TagResourceCommandOutput | TerminateTargetInstancesCommandOutput | UnarchiveApplicationCommandOutput | UnarchiveWaveCommandOutput | UntagResourceCommandOutput | UpdateApplicationCommandOutput | UpdateConnectorCommandOutput | UpdateLaunchConfigurationCommandOutput | UpdateLaunchConfigurationTemplateCommandOutput | UpdateReplicationConfigurationCommandOutput | UpdateReplicationConfigurationTemplateCommandOutput | UpdateSourceServerCommandOutput | UpdateSourceServerReplicationTypeCommandOutput | UpdateWaveCommandOutput;
/**
 * @public
 */
 ...
 * @public
 */
export type MgnClientConfigType = Partial<__SmithyConfiguration<__HttpHandlerOptions>> & ClientDefaults & RegionInputConfig & EndpointInputConfig<EndpointParameters> & RetryInputConfig & HostHeaderInputConfig & UserAgentInputConfig & HttpAuthSchemeInputConfig & ClientInputEndpointParameters;
/**
 * @public
 *
 ...
 * @public
 */
export type MgnClientResolvedConfigType = __SmithyResolvedConfiguration<__HttpHandlerOptions> & Required<ClientDefaults> & RuntimeExtensionsConfig & RegionResolvedConfig & EndpointResolvedConfig<EndpointParameters> & RetryResolvedConfig & HostHeaderResolvedConfig & UserAgentResolvedConfig & HttpAuthSchemeResolvedConfig & ClientResolvedEndpointParameters;
/**
 * @public
 *
