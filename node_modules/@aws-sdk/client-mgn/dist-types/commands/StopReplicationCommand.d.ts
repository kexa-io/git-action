...
declare const StopReplicationCommand_base: {
    new (input: StopReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<StopReplicationCommandInput, StopReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<StopReplicationCommandInput, StopReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
