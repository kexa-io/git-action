...
declare const ArchiveWaveCommand_base: {
    new (input: ArchiveWaveCommandInput): import("@smithy/smithy-client").CommandImpl<ArchiveWaveCommandInput, ArchiveWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ArchiveWaveCommandInput): import("@smithy/smithy-client").CommandImpl<ArchiveWaveCommandInput, ArchiveWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ArchiveWaveCommand extends ArchiveWaveCommand_base {
}
