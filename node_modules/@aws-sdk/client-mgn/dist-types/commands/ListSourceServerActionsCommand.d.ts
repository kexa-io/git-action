...
declare const ListSourceServerActionsCommand_base: {
    new (input: ListSourceServerActionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSourceServerActionsCommandInput, ListSourceServerActionsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListSourceServerActionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSourceServerActionsCommandInput, ListSourceServerActionsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSourceServerActionsCommand extends ListSourceServerActionsCommand_base {
}
