...
declare const DisconnectFromServiceCommand_base: {
    new (input: DisconnectFromServiceCommandInput): import("@smithy/smithy-client").CommandImpl<DisconnectFromServiceCommandInput, DisconnectFromServiceCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisconnectFromServiceCommandInput): import("@smithy/smithy-client").CommandImpl<DisconnectFromServiceCommandInput, DisconnectFromServiceCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisconnectFromServiceCommand extends DisconnectFromServiceCommand_base {
}
