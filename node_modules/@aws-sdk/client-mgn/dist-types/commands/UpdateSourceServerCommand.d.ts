...
import { SourceServer, UpdateSourceServerRequest } from "../models/models_0";
/**
 * @public
 */
...
declare const UpdateSourceServerCommand_base: {
    new (input: UpdateSourceServerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSourceServerCommandInput, UpdateSourceServerCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSourceServerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSourceServerCommandInput, UpdateSourceServerCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateSourceServerCommand extends UpdateSourceServerCommand_base {
}
