...
declare const DeleteJobCommand_base: {
    new (input: DeleteJobCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteJobCommandInput, DeleteJobCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteJobCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteJobCommandInput, DeleteJobCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
