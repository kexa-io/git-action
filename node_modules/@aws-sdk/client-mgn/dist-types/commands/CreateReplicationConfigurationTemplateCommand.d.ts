...
declare const CreateReplicationConfigurationTemplateCommand_base: {
    new (input: CreateReplicationConfigurationTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateReplicationConfigurationTemplateCommandInput, CreateReplicationConfigurationTemplateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateReplicationConfigurationTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateReplicationConfigurationTemplateCommandInput, CreateReplicationConfigurationTemplateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
