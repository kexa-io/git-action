...
declare const RemoveTemplateActionCommand_base: {
    new (input: RemoveTemplateActionCommandInput): import("@smithy/smithy-client").CommandImpl<RemoveTemplateActionCommandInput, RemoveTemplateActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RemoveTemplateActionCommandInput): import("@smithy/smithy-client").CommandImpl<RemoveTemplateActionCommandInput, RemoveTemplateActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RemoveTemplateActionCommand extends RemoveTemplateActionCommand_base {
}
