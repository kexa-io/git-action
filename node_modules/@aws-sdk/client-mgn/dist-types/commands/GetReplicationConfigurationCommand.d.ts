...
declare const GetReplicationConfigurationCommand_base: {
    new (input: GetReplicationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetReplicationConfigurationCommandInput, GetReplicationConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetReplicationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetReplicationConfigurationCommandInput, GetReplicationConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
