...
declare const StartTestCommand_base: {
    new (input: StartTestCommandInput): import("@smithy/smithy-client").CommandImpl<StartTestCommandInput, StartTestCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartTestCommandInput): import("@smithy/smithy-client").CommandImpl<StartTestCommandInput, StartTestCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartTestCommand extends StartTestCommand_base {
}
