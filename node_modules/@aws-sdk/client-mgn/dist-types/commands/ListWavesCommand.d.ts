...
declare const ListWavesCommand_base: {
    new (input: ListWavesCommandInput): import("@smithy/smithy-client").CommandImpl<ListWavesCommandInput, ListWavesCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListWavesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListWavesCommandInput, ListWavesCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListWavesCommand extends ListWavesCommand_base {
}
