...
declare const PutSourceServerActionCommand_base: {
    new (input: PutSourceServerActionCommandInput): import("@smithy/smithy-client").CommandImpl<PutSourceServerActionCommandInput, PutSourceServerActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutSourceServerActionCommandInput): import("@smithy/smithy-client").CommandImpl<PutSourceServerActionCommandInput, PutSourceServerActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutSourceServerActionCommand extends PutSourceServerActionCommand_base {
}
