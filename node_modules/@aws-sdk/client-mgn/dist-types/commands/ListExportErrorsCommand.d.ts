...
declare const ListExportErrorsCommand_base: {
    new (input: ListExportErrorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListExportErrorsCommandInput, ListExportErrorsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListExportErrorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListExportErrorsCommandInput, ListExportErrorsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListExportErrorsCommand extends ListExportErrorsCommand_base {
}
