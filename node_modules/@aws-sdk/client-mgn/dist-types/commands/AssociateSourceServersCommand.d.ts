...
declare const AssociateSourceServersCommand_base: {
    new (input: AssociateSourceServersCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSourceServersCommandInput, AssociateSourceServersCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateSourceServersCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSourceServersCommandInput, AssociateSourceServersCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateSourceServersCommand extends AssociateSourceServersCommand_base {
}
