...
declare const DeleteWaveCommand_base: {
    new (input: DeleteWaveCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteWaveCommandInput, DeleteWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteWaveCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteWaveCommandInput, DeleteWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteWaveCommand extends DeleteWaveCommand_base {
}
