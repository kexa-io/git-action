...
declare const TerminateTargetInstancesCommand_base: {
    new (input: TerminateTargetInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<TerminateTargetInstancesCommandInput, TerminateTargetInstancesCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TerminateTargetInstancesCommandInput): import("@smithy/smithy-client").CommandImpl<TerminateTargetInstancesCommandInput, TerminateTargetInstancesCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TerminateTargetInstancesCommand extends TerminateTargetInstancesCommand_base {
}
