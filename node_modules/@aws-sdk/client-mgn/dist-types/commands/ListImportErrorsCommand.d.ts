...
declare const ListImportErrorsCommand_base: {
    new (input: ListImportErrorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListImportErrorsCommandInput, ListImportErrorsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListImportErrorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListImportErrorsCommandInput, ListImportErrorsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListImportErrorsCommand extends ListImportErrorsCommand_base {
}
