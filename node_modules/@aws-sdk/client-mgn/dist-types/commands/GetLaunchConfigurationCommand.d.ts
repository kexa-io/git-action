...
declare const GetLaunchConfigurationCommand_base: {
    new (input: GetLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchConfigurationCommandInput, GetLaunchConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchConfigurationCommandInput, GetLaunchConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
