...
declare const RemoveSourceServerActionCommand_base: {
    new (input: RemoveSourceServerActionCommandInput): import("@smithy/smithy-client").CommandImpl<RemoveSourceServerActionCommandInput, RemoveSourceServerActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RemoveSourceServerActionCommandInput): import("@smithy/smithy-client").CommandImpl<RemoveSourceServerActionCommandInput, RemoveSourceServerActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RemoveSourceServerActionCommand extends RemoveSourceServerActionCommand_base {
}
