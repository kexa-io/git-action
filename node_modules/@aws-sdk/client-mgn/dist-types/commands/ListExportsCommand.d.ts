...
declare const ListExportsCommand_base: {
    new (input: ListExportsCommandInput): import("@smithy/smithy-client").CommandImpl<ListExportsCommandInput, ListExportsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
