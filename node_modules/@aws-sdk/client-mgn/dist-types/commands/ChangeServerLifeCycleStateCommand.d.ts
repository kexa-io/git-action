...
declare const ChangeServerLifeCycleStateCommand_base: {
    new (input: ChangeServerLifeCycleStateCommandInput): import("@smithy/smithy-client").CommandImpl<ChangeServerLifeCycleStateCommandInput, ChangeServerLifeCycleStateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ChangeServerLifeCycleStateCommandInput): import("@smithy/smithy-client").CommandImpl<ChangeServerLifeCycleStateCommandInput, ChangeServerLifeCycleStateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ChangeServerLifeCycleStateCommand extends ChangeServerLifeCycleStateCommand_base {
}
