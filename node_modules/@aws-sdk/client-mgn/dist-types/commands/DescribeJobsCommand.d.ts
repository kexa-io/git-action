...
declare const DescribeJobsCommand_base: {
    new (input: DescribeJobsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeJobsCommandInput, DescribeJobsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
