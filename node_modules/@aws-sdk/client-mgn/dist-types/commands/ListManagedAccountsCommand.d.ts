...
declare const ListManagedAccountsCommand_base: {
    new (input: ListManagedAccountsCommandInput): import("@smithy/smithy-client").CommandImpl<ListManagedAccountsCommandInput, ListManagedAccountsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListManagedAccountsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListManagedAccountsCommandInput, ListManagedAccountsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListManagedAccountsCommand extends ListManagedAccountsCommand_base {
}
