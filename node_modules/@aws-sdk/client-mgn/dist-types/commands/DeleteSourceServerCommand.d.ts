...
declare const DeleteSourceServerCommand_base: {
    new (input: DeleteSourceServerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSourceServerCommandInput, DeleteSourceServerCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteSourceServerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSourceServerCommandInput, DeleteSourceServerCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
