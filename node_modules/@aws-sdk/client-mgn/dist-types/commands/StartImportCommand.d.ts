...
declare const StartImportCommand_base: {
    new (input: StartImportCommandInput): import("@smithy/smithy-client").CommandImpl<StartImportCommandInput, StartImportCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartImportCommandInput): import("@smithy/smithy-client").CommandImpl<StartImportCommandInput, StartImportCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
