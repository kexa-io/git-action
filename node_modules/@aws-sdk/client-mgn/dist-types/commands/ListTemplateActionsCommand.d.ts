...
declare const ListTemplateActionsCommand_base: {
    new (input: ListTemplateActionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTemplateActionsCommandInput, ListTemplateActionsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListTemplateActionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListTemplateActionsCommandInput, ListTemplateActionsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListTemplateActionsCommand extends ListTemplateActionsCommand_base {
}
