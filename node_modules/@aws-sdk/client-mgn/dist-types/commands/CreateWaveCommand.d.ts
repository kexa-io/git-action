...
declare const CreateWaveCommand_base: {
    new (input: CreateWaveCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWaveCommandInput, CreateWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateWaveCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWaveCommandInput, CreateWaveCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateWaveCommand extends CreateWaveCommand_base {
}
