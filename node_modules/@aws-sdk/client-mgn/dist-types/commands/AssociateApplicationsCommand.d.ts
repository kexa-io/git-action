...
declare const AssociateApplicationsCommand_base: {
    new (input: AssociateApplicationsCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateApplicationsCommandInput, AssociateApplicationsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateApplicationsCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateApplicationsCommandInput, AssociateApplicationsCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
