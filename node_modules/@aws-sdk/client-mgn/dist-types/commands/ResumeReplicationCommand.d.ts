...
declare const ResumeReplicationCommand_base: {
    new (input: ResumeReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<ResumeReplicationCommandInput, ResumeReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ResumeReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<ResumeReplicationCommandInput, ResumeReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ResumeReplicationCommand extends ResumeReplicationCommand_base {
}
