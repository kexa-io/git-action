...
declare const ArchiveApplicationCommand_base: {
    new (input: ArchiveApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<ArchiveApplicationCommandInput, ArchiveApplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ArchiveApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<ArchiveApplicationCommandInput, ArchiveApplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ArchiveApplicationCommand extends ArchiveApplicationCommand_base {
}
