...
declare const PutTemplateActionCommand_base: {
    new (input: PutTemplateActionCommandInput): import("@smithy/smithy-client").CommandImpl<PutTemplateActionCommandInput, PutTemplateActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutTemplateActionCommandInput): import("@smithy/smithy-client").CommandImpl<PutTemplateActionCommandInput, PutTemplateActionCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutTemplateActionCommand extends PutTemplateActionCommand_base {
}
