...
declare const FinalizeCutoverCommand_base: {
    new (input: FinalizeCutoverCommandInput): import("@smithy/smithy-client").CommandImpl<FinalizeCutoverCommandInput, FinalizeCutoverCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: FinalizeCutoverCommandInput): import("@smithy/smithy-client").CommandImpl<FinalizeCutoverCommandInput, FinalizeCutoverCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class FinalizeCutoverCommand extends FinalizeCutoverCommand_base {
}
