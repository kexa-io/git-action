...
declare const RetryDataReplicationCommand_base: {
    new (input: RetryDataReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<RetryDataReplicationCommandInput, RetryDataReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RetryDataReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<RetryDataReplicationCommandInput, RetryDataReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
