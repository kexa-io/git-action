...
declare const StartReplicationCommand_base: {
    new (input: StartReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<StartReplicationCommandInput, StartReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<StartReplicationCommandInput, StartReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
