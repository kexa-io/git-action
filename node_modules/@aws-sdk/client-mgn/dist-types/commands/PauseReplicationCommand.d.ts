...
declare const PauseReplicationCommand_base: {
    new (input: PauseReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<PauseReplicationCommandInput, PauseReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PauseReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<PauseReplicationCommandInput, PauseReplicationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PauseReplicationCommand extends PauseReplicationCommand_base {
}
