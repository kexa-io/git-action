...
declare const StartExportCommand_base: {
    new (input: StartExportCommandInput): import("@smithy/smithy-client").CommandImpl<StartExportCommandInput, StartExportCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartExportCommandInput): import("@smithy/smithy-client").CommandImpl<StartExportCommandInput, StartExportCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartExportCommand extends StartExportCommand_base {
}
