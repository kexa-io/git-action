...
declare const UpdateLaunchConfigurationTemplateCommand_base: {
    new (input: UpdateLaunchConfigurationTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchConfigurationTemplateCommandInput, UpdateLaunchConfigurationTemplateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLaunchConfigurationTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchConfigurationTemplateCommandInput, UpdateLaunchConfigurationTemplateCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
