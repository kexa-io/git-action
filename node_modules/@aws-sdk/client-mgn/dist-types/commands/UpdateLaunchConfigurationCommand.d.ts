...
declare const UpdateLaunchConfigurationCommand_base: {
    new (input: UpdateLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchConfigurationCommandInput, UpdateLaunchConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchConfigurationCommandInput, UpdateLaunchConfigurationCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
