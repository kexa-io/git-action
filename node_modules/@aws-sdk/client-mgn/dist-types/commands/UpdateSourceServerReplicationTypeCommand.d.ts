...
declare const UpdateSourceServerReplicationTypeCommand_base: {
    new (input: UpdateSourceServerReplicationTypeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSourceServerReplicationTypeCommandInput, UpdateSourceServerReplicationTypeCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSourceServerReplicationTypeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSourceServerReplicationTypeCommandInput, UpdateSourceServerReplicationTypeCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateSourceServerReplicationTypeCommand extends UpdateSourceServerReplicationTypeCommand_base {
}
