...
declare const MarkAsArchivedCommand_base: {
    new (input: MarkAsArchivedCommandInput): import("@smithy/smithy-client").CommandImpl<MarkAsArchivedCommandInput, MarkAsArchivedCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: MarkAsArchivedCommandInput): import("@smithy/smithy-client").CommandImpl<MarkAsArchivedCommandInput, MarkAsArchivedCommandOutput, MgnClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class MarkAsArchivedCommand extends MarkAsArchivedCommand_base {
}
