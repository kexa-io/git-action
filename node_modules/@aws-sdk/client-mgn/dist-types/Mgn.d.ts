...
import { AssociateSourceServersCommandInput, AssociateSourceServersCommandOutput } from "./commands/AssociateSourceServersCommand";
...
import { DeleteVcenterClientCommandInput, DeleteVcenterClientCommandOutput } from "./commands/DeleteVcenterClientCommand";
...
import { DescribeVcenterClientsCommandInput, DescribeVcenterClientsCommandOutput } from "./commands/DescribeVcenterClientsCommand";
...
import { DisassociateSourceServersCommandInput, DisassociateSourceServersCommandOutput } from "./commands/DisassociateSourceServersCommand";
...
import { ListManagedAccountsCommandInput, ListManagedAccountsCommandOutput } from "./commands/ListManagedAccountsCommand";
import { ListSourceServerActionsCommandInput, ListSourceServerActionsCommandOutput } from "./commands/ListSourceServerActionsCommand";
import { ListTagsForResourceCommandInput, ListTagsForResourceCommandOutput } from "./commands/ListTagsForResourceCommand";
import { ListTemplateActionsCommandInput, ListTemplateActionsCommandOutput } from "./commands/ListTemplateActionsCommand";
...
import { PutSourceServerActionCommandInput, PutSourceServerActionCommandOutput } from "./commands/PutSourceServerActionCommand";
import { PutTemplateActionCommandInput, PutTemplateActionCommandOutput } from "./commands/PutTemplateActionCommand";
import { RemoveSourceServerActionCommandInput, RemoveSourceServerActionCommandOutput } from "./commands/RemoveSourceServerActionCommand";
import { RemoveTemplateActionCommandInput, RemoveTemplateActionCommandOutput } from "./commands/RemoveTemplateActionCommand";
...
import { UnarchiveApplicationCommandInput, UnarchiveApplicationCommandOutput } from "./commands/UnarchiveApplicationCommand";
...
import { UpdateSourceServerReplicationTypeCommandInput, UpdateSourceServerReplicationTypeCommandOutput } from "./commands/UpdateSourceServerReplicationTypeCommand";
...
export interface Mgn {
     ...
     */
    archiveApplication(args: ArchiveApplicationCommandInput, options?: __HttpHandlerOptions): Promise<ArchiveApplicationCommandOutput>;
    archiveApplication(args: ArchiveApplicationCommandInput, cb: (err: any, data?: ArchiveApplicationCommandOutput) => void): void;
    archiveApplication(args: ArchiveApplicationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ArchiveApplicationCommandOutput) => void): void;
    /**
    ...
    archiveWave(args: ArchiveWaveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ArchiveWaveCommandOutput) => void): void;
    /**
     * @see {@link AssociateApplicationsCommand}
     */
    associateApplications(args: AssociateApplicationsCommandInput, options?: __HttpHandlerOptions): Promise<AssociateApplicationsCommandOutput>;
    associateApplications(args: AssociateApplicationsCommandInput, cb: (err: any, data?: AssociateApplicationsCommandOutput) => void): void;
    associateApplications(args: AssociateApplicationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateApplicationsCommandOutput) => void): void;
    /**
     * @see {@link AssociateSourceServersCommand}
     */
    associateSourceServers(args: AssociateSourceServersCommandInput, options?: __HttpHandlerOptions): Promise<AssociateSourceServersCommandOutput>;
    associateSourceServers(args: AssociateSourceServersCommandInput, cb: (err: any, data?: AssociateSourceServersCommandOutput) => void): void;
    associateSourceServers(args: AssociateSourceServersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: AssociateSourceServersCommandOutput) => void): void;
    /**
    ...
    createWave(args: CreateWaveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateWaveCommandOutput) => void): void;
    /**
    ...
    deleteWave(args: DeleteWaveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteWaveCommandOutput) => void): void;
    /**
     ...
     */
    disassociateApplications(args: DisassociateApplicationsCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateApplicationsCommandOutput>;
    disassociateApplications(args: DisassociateApplicationsCommandInput, cb: (err: any, data?: DisassociateApplicationsCommandOutput) => void): void;
    disassociateApplications(args: DisassociateApplicationsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateApplicationsCommandOutput) => void): void;
    /**
     * @see {@link DisassociateSourceServersCommand}
     */
    disassociateSourceServers(args: DisassociateSourceServersCommandInput, options?: __HttpHandlerOptions): Promise<DisassociateSourceServersCommandOutput>;
    disassociateSourceServers(args: DisassociateSourceServersCommandInput, cb: (err: any, data?: DisassociateSourceServersCommandOutput) => void): void;
    disassociateSourceServers(args: DisassociateSourceServersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisassociateSourceServersCommandOutput) => void): void;
    /**
     ...
     */
    listExportErrors(args: ListExportErrorsCommandInput, options?: __HttpHandlerOptions): Promise<ListExportErrorsCommandOutput>;
    listExportErrors(args: ListExportErrorsCommandInput, cb: (err: any, data?: ListExportErrorsCommandOutput) => void): void;
    listExportErrors(args: ListExportErrorsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListExportErrorsCommandOutput) => void): void;
    /**
     ...
     */
    listImportErrors(args: ListImportErrorsCommandInput, options?: __HttpHandlerOptions): Promise<ListImportErrorsCommandOutput>;
    listImportErrors(args: ListImportErrorsCommandInput, cb: (err: any, data?: ListImportErrorsCommandOutput) => void): void;
    listImportErrors(args: ListImportErrorsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListImportErrorsCommandOutput) => void): void;
    /**
     ...
     */
    listManagedAccounts(args: ListManagedAccountsCommandInput, options?: __HttpHandlerOptions): Promise<ListManagedAccountsCommandOutput>;
    listManagedAccounts(args: ListManagedAccountsCommandInput, cb: (err: any, data?: ListManagedAccountsCommandOutput) => void): void;
    listManagedAccounts(args: ListManagedAccountsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListManagedAccountsCommandOutput) => void): void;
    /**
     * @see {@link ListSourceServerActionsCommand}
     */
    listSourceServerActions(args: ListSourceServerActionsCommandInput, options?: __HttpHandlerOptions): Promise<ListSourceServerActionsCommandOutput>;
    listSourceServerActions(args: ListSourceServerActionsCommandInput, cb: (err: any, data?: ListSourceServerActionsCommandOutput) => void): void;
    listSourceServerActions(args: ListSourceServerActionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListSourceServerActionsCommandOutput) => void): void;
    /**
     ...
     */
    listTemplateActions(args: ListTemplateActionsCommandInput, options?: __HttpHandlerOptions): Promise<ListTemplateActionsCommandOutput>;
    listTemplateActions(args: ListTemplateActionsCommandInput, cb: (err: any, data?: ListTemplateActionsCommandOutput) => void): void;
    listTemplateActions(args: ListTemplateActionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListTemplateActionsCommandOutput) => void): void;
    /**
    ...
    listWaves(args: ListWavesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListWavesCommandOutput) => void): void;
    /**
     ...
     */
    pauseReplication(args: PauseReplicationCommandInput, options?: __HttpHandlerOptions): Promise<PauseReplicationCommandOutput>;
    pauseReplication(args: PauseReplicationCommandInput, cb: (err: any, data?: PauseReplicationCommandOutput) => void): void;
    pauseReplication(args: PauseReplicationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PauseReplicationCommandOutput) => void): void;
    /**
     * @see {@link PutSourceServerActionCommand}
     */
    putSourceServerAction(args: PutSourceServerActionCommandInput, options?: __HttpHandlerOptions): Promise<PutSourceServerActionCommandOutput>;
    putSourceServerAction(args: PutSourceServerActionCommandInput, cb: (err: any, data?: PutSourceServerActionCommandOutput) => void): void;
    putSourceServerAction(args: PutSourceServerActionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutSourceServerActionCommandOutput) => void): void;
    /**
     * @see {@link PutTemplateActionCommand}
     */
    putTemplateAction(args: PutTemplateActionCommandInput, options?: __HttpHandlerOptions): Promise<PutTemplateActionCommandOutput>;
    putTemplateAction(args: PutTemplateActionCommandInput, cb: (err: any, data?: PutTemplateActionCommandOutput) => void): void;
    putTemplateAction(args: PutTemplateActionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: PutTemplateActionCommandOutput) => void): void;
    /**
     * @see {@link RemoveSourceServerActionCommand}
     */
    removeSourceServerAction(args: RemoveSourceServerActionCommandInput, options?: __HttpHandlerOptions): Promise<RemoveSourceServerActionCommandOutput>;
    removeSourceServerAction(args: RemoveSourceServerActionCommandInput, cb: (err: any, data?: RemoveSourceServerActionCommandOutput) => void): void;
    removeSourceServerAction(args: RemoveSourceServerActionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: RemoveSourceServerActionCommandOutput) => void): void;
    /**
     * @see {@link RemoveTemplateActionCommand}
     */
    removeTemplateAction(args: RemoveTemplateActionCommandInput, options?: __HttpHandlerOptions): Promise<RemoveTemplateActionCommandOutput>;
    removeTemplateAction(args: RemoveTemplateActionCommandInput, cb: (err: any, data?: RemoveTemplateActionCommandOutput) => void): void;
    removeTemplateAction(args: RemoveTemplateActionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: RemoveTemplateActionCommandOutput) => void): void;
    /**
     * @see {@link ResumeReplicationCommand}
     */
    resumeReplication(args: ResumeReplicationCommandInput, options?: __HttpHandlerOptions): Promise<ResumeReplicationCommandOutput>;
    resumeReplication(args: ResumeReplicationCommandInput, cb: (err: any, data?: ResumeReplicationCommandOutput) => void): void;
    resumeReplication(args: ResumeReplicationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ResumeReplicationCommandOutput) => void): void;
    /**
    ...
    startExport(args: StartExportCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartExportCommandOutput) => void): void;
    /**
     ...
     */
    unarchiveApplication(args: UnarchiveApplicationCommandInput, options?: __HttpHandlerOptions): Promise<UnarchiveApplicationCommandOutput>;
    unarchiveApplication(args: UnarchiveApplicationCommandInput, cb: (err: any, data?: UnarchiveApplicationCommandOutput) => void): void;
    unarchiveApplication(args: UnarchiveApplicationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UnarchiveApplicationCommandOutput) => void): void;
    /**
    ...
    unarchiveWave(args: UnarchiveWaveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UnarchiveWaveCommandOutput) => void): void;
    /**
     ...
     */
    updateSourceServer(args: UpdateSourceServerCommandInput, options?: __HttpHandlerOptions): Promise<UpdateSourceServerCommandOutput>;
    updateSourceServer(args: UpdateSourceServerCommandInput, cb: (err: any, data?: UpdateSourceServerCommandOutput) => void): void;
    updateSourceServer(args: UpdateSourceServerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateSourceServerCommandOutput) => void): void;
    /**
    ...
    updateWave(args: UpdateWaveCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateWaveCommandOutput) => void): void;
}
/**
 * @public
 * <p>The Application Migration Service service.</p>
 */
export declare class Mgn extends MgnClient implements Mgn {
}
