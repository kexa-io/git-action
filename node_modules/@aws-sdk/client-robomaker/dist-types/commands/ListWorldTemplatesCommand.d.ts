...
declare const ListWorldTemplatesCommand_base: {
    new (input: ListWorldTemplatesCommandInput): import("@smithy/smithy-client").CommandImpl<ListWorldTemplatesCommandInput, ListWorldTemplatesCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListWorldTemplatesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListWorldTemplatesCommandInput, ListWorldTemplatesCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListWorldTemplatesCommand extends ListWorldTemplatesCommand_base {
}
