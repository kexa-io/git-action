...
declare const CancelDeploymentJobCommand_base: {
    new (input: CancelDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelDeploymentJobCommandInput, CancelDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelDeploymentJobCommandInput, CancelDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelDeploymentJobCommand extends CancelDeploymentJobCommand_base {
}
