...
declare const DescribeSimulationJobBatchCommand_base: {
    new (input: DescribeSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationJobBatchCommandInput, DescribeSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationJobBatchCommandInput, DescribeSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeSimulationJobBatchCommand extends DescribeSimulationJobBatchCommand_base {
}
