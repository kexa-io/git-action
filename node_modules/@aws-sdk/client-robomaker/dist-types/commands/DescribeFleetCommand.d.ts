...
declare const DescribeFleetCommand_base: {
    new (input: DescribeFleetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFleetCommandInput, DescribeFleetCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeFleetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeFleetCommandInput, DescribeFleetCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeFleetCommand extends DescribeFleetCommand_base {
}
