...
declare const UpdateSimulationApplicationCommand_base: {
    new (input: UpdateSimulationApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSimulationApplicationCommandInput, UpdateSimulationApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSimulationApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSimulationApplicationCommandInput, UpdateSimulationApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateSimulationApplicationCommand extends UpdateSimulationApplicationCommand_base {
}
