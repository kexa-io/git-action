...
declare const DescribeWorldGenerationJobCommand_base: {
    new (input: DescribeWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldGenerationJobCommandInput, DescribeWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldGenerationJobCommandInput, DescribeWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeWorldGenerationJobCommand extends DescribeWorldGenerationJobCommand_base {
}
