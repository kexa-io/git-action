...
declare const DescribeWorldCommand_base: {
    new (input: DescribeWorldCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldCommandInput, DescribeWorldCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeWorldCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldCommandInput, DescribeWorldCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeWorldCommand extends DescribeWorldCommand_base {
}
