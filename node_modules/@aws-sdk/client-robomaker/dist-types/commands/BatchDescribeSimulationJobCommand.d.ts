...
declare const BatchDescribeSimulationJobCommand_base: {
    new (input: BatchDescribeSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDescribeSimulationJobCommandInput, BatchDescribeSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchDescribeSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDescribeSimulationJobCommandInput, BatchDescribeSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchDescribeSimulationJobCommand extends BatchDescribeSimulationJobCommand_base {
}
