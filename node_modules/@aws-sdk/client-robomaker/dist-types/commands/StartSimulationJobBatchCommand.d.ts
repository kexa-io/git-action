...
declare const StartSimulationJobBatchCommand_base: {
    new (input: StartSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<StartSimulationJobBatchCommandInput, StartSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<StartSimulationJobBatchCommandInput, StartSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartSimulationJobBatchCommand extends StartSimulationJobBatchCommand_base {
}
