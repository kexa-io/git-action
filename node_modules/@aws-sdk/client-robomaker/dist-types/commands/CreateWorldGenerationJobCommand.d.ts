...
declare const CreateWorldGenerationJobCommand_base: {
    new (input: CreateWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorldGenerationJobCommandInput, CreateWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorldGenerationJobCommandInput, CreateWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateWorldGenerationJobCommand extends CreateWorldGenerationJobCommand_base {
}
