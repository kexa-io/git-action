...
declare const ListSimulationJobBatchesCommand_base: {
    new (input: ListSimulationJobBatchesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSimulationJobBatchesCommandInput, ListSimulationJobBatchesCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListSimulationJobBatchesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListSimulationJobBatchesCommandInput, ListSimulationJobBatchesCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSimulationJobBatchesCommand extends ListSimulationJobBatchesCommand_base {
}
