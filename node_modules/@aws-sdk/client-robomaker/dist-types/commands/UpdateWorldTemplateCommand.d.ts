...
declare const UpdateWorldTemplateCommand_base: {
    new (input: UpdateWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorldTemplateCommandInput, UpdateWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWorldTemplateCommandInput, UpdateWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateWorldTemplateCommand extends UpdateWorldTemplateCommand_base {
}
