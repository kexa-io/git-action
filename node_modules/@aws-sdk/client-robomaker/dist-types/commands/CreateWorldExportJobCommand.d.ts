...
declare const CreateWorldExportJobCommand_base: {
    new (input: CreateWorldExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorldExportJobCommandInput, CreateWorldExportJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateWorldExportJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateWorldExportJobCommandInput, CreateWorldExportJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateWorldExportJobCommand extends CreateWorldExportJobCommand_base {
}
