...
declare const RestartSimulationJobCommand_base: {
    new (input: RestartSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<RestartSimulationJobCommandInput, RestartSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RestartSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<RestartSimulationJobCommandInput, RestartSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RestartSimulationJobCommand extends RestartSimulationJobCommand_base {
}
