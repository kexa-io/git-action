...
declare const DeleteRobotCommand_base: {
    new (input: DeleteRobotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRobotCommandInput, DeleteRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRobotCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRobotCommandInput, DeleteRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteRobotCommand extends DeleteRobotCommand_base {
}
