...
declare const DescribeDeploymentJobCommand_base: {
    new (input: DescribeDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDeploymentJobCommandInput, DescribeDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDeploymentJobCommandInput, DescribeDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeDeploymentJobCommand extends DescribeDeploymentJobCommand_base {
}
