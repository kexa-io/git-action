...
declare const CreateFleetCommand_base: {
    new (input: CreateFleetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateFleetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFleetCommandInput, CreateFleetCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
