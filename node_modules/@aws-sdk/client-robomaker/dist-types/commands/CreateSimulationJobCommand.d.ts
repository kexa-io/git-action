...
declare const CreateSimulationJobCommand_base: {
    new (input: CreateSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSimulationJobCommandInput, CreateSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSimulationJobCommandInput, CreateSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateSimulationJobCommand extends CreateSimulationJobCommand_base {
}
