...
declare const DescribeWorldTemplateCommand_base: {
    new (input: DescribeWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldTemplateCommandInput, DescribeWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeWorldTemplateCommandInput, DescribeWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeWorldTemplateCommand extends DescribeWorldTemplateCommand_base {
}
