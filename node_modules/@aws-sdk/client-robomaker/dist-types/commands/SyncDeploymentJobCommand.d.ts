...
declare const SyncDeploymentJobCommand_base: {
    new (input: SyncDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<SyncDeploymentJobCommandInput, SyncDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SyncDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<SyncDeploymentJobCommandInput, SyncDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SyncDeploymentJobCommand extends SyncDeploymentJobCommand_base {
}
