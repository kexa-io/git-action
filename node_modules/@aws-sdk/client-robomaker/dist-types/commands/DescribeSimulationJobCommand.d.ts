...
declare const DescribeSimulationJobCommand_base: {
    new (input: DescribeSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationJobCommandInput, DescribeSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationJobCommandInput, DescribeSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeSimulationJobCommand extends DescribeSimulationJobCommand_base {
}
