...
declare const BatchDeleteWorldsCommand_base: {
    new (input: BatchDeleteWorldsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDeleteWorldsCommandInput, BatchDeleteWorldsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchDeleteWorldsCommandInput): import("@smithy/smithy-client").CommandImpl<BatchDeleteWorldsCommandInput, BatchDeleteWorldsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchDeleteWorldsCommand extends BatchDeleteWorldsCommand_base {
}
