...
declare const DescribeRobotApplicationCommand_base: {
    new (input: DescribeRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRobotApplicationCommandInput, DescribeRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeRobotApplicationCommandInput, DescribeRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeRobotApplicationCommand extends DescribeRobotApplicationCommand_base {
}
