...
declare const CancelSimulationJobCommand_base: {
    new (input: CancelSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelSimulationJobCommandInput, CancelSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelSimulationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelSimulationJobCommandInput, CancelSimulationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelSimulationJobCommand extends CancelSimulationJobCommand_base {
}
