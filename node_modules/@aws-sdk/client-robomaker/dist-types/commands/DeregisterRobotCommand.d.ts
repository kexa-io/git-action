...
declare const DeregisterRobotCommand_base: {
    new (input: DeregisterRobotCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterRobotCommandInput, DeregisterRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeregisterRobotCommandInput): import("@smithy/smithy-client").CommandImpl<DeregisterRobotCommandInput, DeregisterRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeregisterRobotCommand extends DeregisterRobotCommand_base {
}
