...
declare const CreateRobotApplicationCommand_base: {
    new (input: CreateRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotApplicationCommandInput, CreateRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotApplicationCommandInput, CreateRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRobotApplicationCommand extends CreateRobotApplicationCommand_base {
}
