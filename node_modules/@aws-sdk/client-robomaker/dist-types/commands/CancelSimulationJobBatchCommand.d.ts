...
declare const CancelSimulationJobBatchCommand_base: {
    new (input: CancelSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<CancelSimulationJobBatchCommandInput, CancelSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelSimulationJobBatchCommandInput): import("@smithy/smithy-client").CommandImpl<CancelSimulationJobBatchCommandInput, CancelSimulationJobBatchCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelSimulationJobBatchCommand extends CancelSimulationJobBatchCommand_base {
}
