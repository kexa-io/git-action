...
declare const CreateRobotApplicationVersionCommand_base: {
    new (input: CreateRobotApplicationVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotApplicationVersionCommandInput, CreateRobotApplicationVersionCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRobotApplicationVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotApplicationVersionCommandInput, CreateRobotApplicationVersionCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRobotApplicationVersionCommand extends CreateRobotApplicationVersionCommand_base {
}
