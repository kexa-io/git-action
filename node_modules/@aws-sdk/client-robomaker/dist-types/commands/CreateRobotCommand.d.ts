...
declare const CreateRobotCommand_base: {
    new (input: CreateRobotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotCommandInput, CreateRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateRobotCommandInput): import("@smithy/smithy-client").CommandImpl<CreateRobotCommandInput, CreateRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateRobotCommand extends CreateRobotCommand_base {
}
