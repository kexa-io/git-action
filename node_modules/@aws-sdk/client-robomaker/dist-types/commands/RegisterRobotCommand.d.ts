...
declare const RegisterRobotCommand_base: {
    new (input: RegisterRobotCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterRobotCommandInput, RegisterRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterRobotCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterRobotCommandInput, RegisterRobotCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RegisterRobotCommand extends RegisterRobotCommand_base {
}
