...
declare const DescribeSimulationApplicationCommand_base: {
    new (input: DescribeSimulationApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationApplicationCommandInput, DescribeSimulationApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeSimulationApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeSimulationApplicationCommandInput, DescribeSimulationApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeSimulationApplicationCommand extends DescribeSimulationApplicationCommand_base {
}
