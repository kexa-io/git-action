...
declare const CancelWorldGenerationJobCommand_base: {
    new (input: CancelWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelWorldGenerationJobCommandInput, CancelWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelWorldGenerationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelWorldGenerationJobCommandInput, CancelWorldGenerationJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelWorldGenerationJobCommand extends CancelWorldGenerationJobCommand_base {
}
