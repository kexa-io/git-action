...
declare const DeleteRobotApplicationCommand_base: {
    new (input: DeleteRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRobotApplicationCommandInput, DeleteRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRobotApplicationCommandInput, DeleteRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteRobotApplicationCommand extends DeleteRobotApplicationCommand_base {
}
