...
declare const CreateDeploymentJobCommand_base: {
    new (input: CreateDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeploymentJobCommandInput, CreateDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDeploymentJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDeploymentJobCommandInput, CreateDeploymentJobCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDeploymentJobCommand extends CreateDeploymentJobCommand_base {
}
