...
declare const ListDeploymentJobsCommand_base: {
    new (input: ListDeploymentJobsCommandInput): import("@smithy/smithy-client").CommandImpl<ListDeploymentJobsCommandInput, ListDeploymentJobsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListDeploymentJobsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListDeploymentJobsCommandInput, ListDeploymentJobsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListDeploymentJobsCommand extends ListDeploymentJobsCommand_base {
}
