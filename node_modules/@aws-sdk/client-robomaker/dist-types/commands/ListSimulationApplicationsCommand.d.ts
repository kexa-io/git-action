...
declare const ListSimulationApplicationsCommand_base: {
    new (input: ListSimulationApplicationsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSimulationApplicationsCommandInput, ListSimulationApplicationsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListSimulationApplicationsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListSimulationApplicationsCommandInput, ListSimulationApplicationsCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSimulationApplicationsCommand extends ListSimulationApplicationsCommand_base {
}
