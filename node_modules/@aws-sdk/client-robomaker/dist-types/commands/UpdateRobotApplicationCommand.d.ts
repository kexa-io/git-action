...
declare const UpdateRobotApplicationCommand_base: {
    new (input: UpdateRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRobotApplicationCommandInput, UpdateRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRobotApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRobotApplicationCommandInput, UpdateRobotApplicationCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateRobotApplicationCommand extends UpdateRobotApplicationCommand_base {
}
