...
declare const CreateSimulationApplicationVersionCommand_base: {
    new (input: CreateSimulationApplicationVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSimulationApplicationVersionCommandInput, CreateSimulationApplicationVersionCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSimulationApplicationVersionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSimulationApplicationVersionCommandInput, CreateSimulationApplicationVersionCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateSimulationApplicationVersionCommand extends CreateSimulationApplicationVersionCommand_base {
}
