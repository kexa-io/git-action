...
declare const DeleteWorldTemplateCommand_base: {
    new (input: DeleteWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteWorldTemplateCommandInput, DeleteWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteWorldTemplateCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteWorldTemplateCommandInput, DeleteWorldTemplateCommandOutput, RoboMakerClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteWorldTemplateCommand extends DeleteWorldTemplateCommand_base {
}
