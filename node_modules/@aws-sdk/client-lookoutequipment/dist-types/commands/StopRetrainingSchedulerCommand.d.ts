...
declare const StopRetrainingSchedulerCommand_base: {
    new (input: StopRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StopRetrainingSchedulerCommandInput, StopRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StopRetrainingSchedulerCommandInput, StopRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
