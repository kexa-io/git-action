...
declare const ListSensorStatisticsCommand_base: {
    new (input: ListSensorStatisticsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSensorStatisticsCommandInput, ListSensorStatisticsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListSensorStatisticsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSensorStatisticsCommandInput, ListSensorStatisticsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
