...
declare const ListModelVersionsCommand_base: {
    new (input: ListModelVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelVersionsCommandInput, ListModelVersionsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListModelVersionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelVersionsCommandInput, ListModelVersionsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
