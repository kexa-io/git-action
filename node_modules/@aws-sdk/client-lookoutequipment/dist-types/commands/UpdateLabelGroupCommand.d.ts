...
declare const UpdateLabelGroupCommand_base: {
    new (input: UpdateLabelGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLabelGroupCommandInput, UpdateLabelGroupCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLabelGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLabelGroupCommandInput, UpdateLabelGroupCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
