...
declare const StartDataIngestionJobCommand_base: {
    new (input: StartDataIngestionJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartDataIngestionJobCommandInput, StartDataIngestionJobCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartDataIngestionJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartDataIngestionJobCommandInput, StartDataIngestionJobCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
