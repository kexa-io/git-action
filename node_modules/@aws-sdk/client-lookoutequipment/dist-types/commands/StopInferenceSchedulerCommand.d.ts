...
declare const StopInferenceSchedulerCommand_base: {
    new (input: StopInferenceSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StopInferenceSchedulerCommandInput, StopInferenceSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopInferenceSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StopInferenceSchedulerCommandInput, StopInferenceSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
