...
declare const UpdateActiveModelVersionCommand_base: {
    new (input: UpdateActiveModelVersionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateActiveModelVersionCommandInput, UpdateActiveModelVersionCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateActiveModelVersionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateActiveModelVersionCommandInput, UpdateActiveModelVersionCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
