...
declare const StartInferenceSchedulerCommand_base: {
    new (input: StartInferenceSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StartInferenceSchedulerCommandInput, StartInferenceSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartInferenceSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StartInferenceSchedulerCommandInput, StartInferenceSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
