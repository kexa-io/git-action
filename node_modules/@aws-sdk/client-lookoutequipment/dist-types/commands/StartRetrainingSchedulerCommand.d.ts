...
declare const StartRetrainingSchedulerCommand_base: {
    new (input: StartRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StartRetrainingSchedulerCommandInput, StartRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<StartRetrainingSchedulerCommandInput, StartRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
