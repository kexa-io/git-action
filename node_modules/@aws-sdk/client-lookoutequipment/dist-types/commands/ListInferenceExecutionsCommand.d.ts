...
declare const ListInferenceExecutionsCommand_base: {
    new (input: ListInferenceExecutionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListInferenceExecutionsCommandInput, ListInferenceExecutionsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListInferenceExecutionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListInferenceExecutionsCommandInput, ListInferenceExecutionsCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
