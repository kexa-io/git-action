...
declare const UpdateRetrainingSchedulerCommand_base: {
    new (input: UpdateRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRetrainingSchedulerCommandInput, UpdateRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRetrainingSchedulerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRetrainingSchedulerCommandInput, UpdateRetrainingSchedulerCommandOutput, LookoutEquipmentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
