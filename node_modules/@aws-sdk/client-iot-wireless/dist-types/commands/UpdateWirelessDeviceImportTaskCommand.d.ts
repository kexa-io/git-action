...
declare const UpdateWirelessDeviceImportTaskCommand_base: {
    new (input: UpdateWirelessDeviceImportTaskCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWirelessDeviceImportTaskCommandInput, UpdateWirelessDeviceImportTaskCommandOutput, IoTWirelessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateWirelessDeviceImportTaskCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateWirelessDeviceImportTaskCommandInput, UpdateWirelessDeviceImportTaskCommandOutput, IoTWirelessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateWirelessDeviceImportTaskCommand extends UpdateWirelessDeviceImportTaskCommand_base {
}
