...
export interface UpdateWirelessDeviceCommandInput
  extends UpdateWirelessDeviceRequest {}
export interface UpdateWirelessDeviceCommandOutput
  extends UpdateWirelessDeviceResponse,
    __MetadataBearer {}
declare const UpdateWirelessDeviceCommand_base: {
  ...
  >;
  new (
    __0_0: UpdateWirelessDeviceCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    UpdateWirelessDeviceCommandInput,
    UpdateWirelessDeviceCommandOutput,
    IoTWirelessClientResolvedConfig,
