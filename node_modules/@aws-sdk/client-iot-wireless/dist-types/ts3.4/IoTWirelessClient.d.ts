...
export type IoTWirelessClientConfigType = Partial<
...
export type IoTWirelessClientResolvedConfigType =
...
> {
  ...
  constructor(
    ...[configuration]: __CheckOptionalClientConfig<IoTWirelessClientConfig>
  );
  destroy(): void;
