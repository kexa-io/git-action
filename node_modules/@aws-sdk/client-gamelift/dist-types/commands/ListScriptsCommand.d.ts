...
declare const ListScriptsCommand_base: {
    new (input: ListScriptsCommandInput): import("@smithy/smithy-client").CommandImpl<ListScriptsCommandInput, ListScriptsCommandOutput, GameLiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
