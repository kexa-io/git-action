...
export interface GameLift {
     ...
     */
    createContainerGroupDefinition(args: CreateContainerGroupDefinitionCommandInput, options?: __HttpHandlerOptions): Promise<CreateContainerGroupDefinitionCommandOutput>;
    createContainerGroupDefinition(args: CreateContainerGroupDefinitionCommandInput, cb: (err: any, data?: CreateContainerGroupDefinitionCommandOutput) => void): void;
    createContainerGroupDefinition(args: CreateContainerGroupDefinitionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateContainerGroupDefinitionCommandOutput) => void): void;
    /**
     ...
     */
    deleteContainerGroupDefinition(args: DeleteContainerGroupDefinitionCommandInput, options?: __HttpHandlerOptions): Promise<DeleteContainerGroupDefinitionCommandOutput>;
    deleteContainerGroupDefinition(args: DeleteContainerGroupDefinitionCommandInput, cb: (err: any, data?: DeleteContainerGroupDefinitionCommandOutput) => void): void;
    deleteContainerGroupDefinition(args: DeleteContainerGroupDefinitionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteContainerGroupDefinitionCommandOutput) => void): void;
    /**
