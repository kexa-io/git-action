...
declare const UpdateNFSFileShareCommand_base: {
    new (input: UpdateNFSFileShareCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateNFSFileShareCommandInput, UpdateNFSFileShareCommandOutput, StorageGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateNFSFileShareCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateNFSFileShareCommandInput, UpdateNFSFileShareCommandOutput, StorageGatewayClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
