...
__export(src_exports, {
  ...
  AzureBlobSasConfigurationFilterSensitiveLog: () => AzureBlobSasConfigurationFilterSensitiveLog,
  AzureBlobType: () => AzureBlobType,
  CancelTaskExecutionCommand: () => CancelTaskExecutionCommand,
  CreateAgentCommand: () => CreateAgentCommand,
  CreateLocationAzureBlobCommand: () => CreateLocationAzureBlobCommand,
  CreateLocationAzureBlobRequestFilterSensitiveLog: () => CreateLocationAzureBlobRequestFilterSensitiveLog,
  CreateLocationEfsCommand: () => CreateLocationEfsCommand,
  CreateLocationFsxLustreCommand: () => CreateLocationFsxLustreCommand,
  CreateLocationFsxOntapCommand: () => CreateLocationFsxOntapCommand,
  CreateLocationFsxOntapRequestFilterSensitiveLog: () => CreateLocationFsxOntapRequestFilterSensitiveLog,
  CreateLocationFsxOpenZfsCommand: () => CreateLocationFsxOpenZfsCommand,
  CreateLocationFsxOpenZfsRequestFilterSensitiveLog: () => CreateLocationFsxOpenZfsRequestFilterSensitiveLog,
  CreateLocationFsxWindowsCommand: () => CreateLocationFsxWindowsCommand,
  CreateLocationFsxWindowsRequestFilterSensitiveLog: () => CreateLocationFsxWindowsRequestFilterSensitiveLog,
  CreateLocationHdfsCommand: () => CreateLocationHdfsCommand,
  CreateLocationNfsCommand: () => CreateLocationNfsCommand,
  CreateLocationObjectStorageCommand: () => CreateLocationObjectStorageCommand,
  CreateLocationObjectStorageRequestFilterSensitiveLog: () => CreateLocationObjectStorageRequestFilterSensitiveLog,
  CreateLocationS3Command: () => CreateLocationS3Command,
  ...
  DescribeLocationFsxOntapCommand: () => DescribeLocationFsxOntapCommand,
  DescribeLocationFsxOntapResponseFilterSensitiveLog: () => DescribeLocationFsxOntapResponseFilterSensitiveLog,
  DescribeLocationFsxOpenZfsCommand: () => DescribeLocationFsxOpenZfsCommand,
  DescribeLocationFsxOpenZfsResponseFilterSensitiveLog: () => DescribeLocationFsxOpenZfsResponseFilterSensitiveLog,
  DescribeLocationFsxWindowsCommand: () => DescribeLocationFsxWindowsCommand,
  DescribeLocationHdfsCommand: () => DescribeLocationHdfsCommand,
  DescribeLocationNfsCommand: () => DescribeLocationNfsCommand,
...
// src/DataSyncClient.ts
var _DataSyncClient = class _DataSyncClient extends import_smithy_client.Client {
  ...
  getDefaultHttpAuthSchemeParametersProvider() {
    return import_httpAuthSchemeProvider.defaultDataSyncHttpAuthSchemeParametersProvider;
  }
...
var _DataSyncServiceException = class _DataSyncServiceException extends import_smithy_client.ServiceException {
  /**
   * @internal
   */
  constructor(options) {
...
var _InternalException = class _InternalException extends DataSyncServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _InvalidRequestException = class _InvalidRequestException extends DataSyncServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var CreateLocationAzureBlobRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
...
var FsxProtocolSmbFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Password && { Password: import_smithy_client.SENSITIVE_STRING }
}), "FsxProtocolSmbFilterSensitiveLog");
var FsxProtocolFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.SMB && { SMB: FsxProtocolSmbFilterSensitiveLog(obj.SMB) }
}), "FsxProtocolFilterSensitiveLog");
var CreateLocationFsxOntapRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Protocol && { Protocol: FsxProtocolFilterSensitiveLog(obj.Protocol) }
}), "CreateLocationFsxOntapRequestFilterSensitiveLog");
var CreateLocationFsxOpenZfsRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Protocol && { Protocol: FsxProtocolFilterSensitiveLog(obj.Protocol) }
}), "CreateLocationFsxOpenZfsRequestFilterSensitiveLog");
var CreateLocationFsxWindowsRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Password && { Password: import_smithy_client.SENSITIVE_STRING }
}), "CreateLocationFsxWindowsRequestFilterSensitiveLog");
var CreateLocationObjectStorageRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.SecretKey && { SecretKey: import_smithy_client.SENSITIVE_STRING }
}), "CreateLocationObjectStorageRequestFilterSensitiveLog");
var CreateLocationSmbRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Password && { Password: import_smithy_client.SENSITIVE_STRING }
}), "CreateLocationSmbRequestFilterSensitiveLog");
var DescribeLocationFsxOntapResponseFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Protocol && { Protocol: FsxProtocolFilterSensitiveLog(obj.Protocol) }
}), "DescribeLocationFsxOntapResponseFilterSensitiveLog");
var DescribeLocationFsxOpenZfsResponseFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Protocol && { Protocol: FsxProtocolFilterSensitiveLog(obj.Protocol) }
}), "DescribeLocationFsxOpenZfsResponseFilterSensitiveLog");
var UpdateLocationAzureBlobRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.SasConfiguration && { SasConfiguration: AzureBlobSasConfigurationFilterSensitiveLog(obj.SasConfiguration) }
...
var UpdateLocationSmbRequestFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Password && { Password: import_smithy_client.SENSITIVE_STRING }
...
var se_CreateLocationAzureBlobCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationAzureBlob");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationAzureBlobCommand");
var se_CreateLocationEfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationEfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationEfsCommand");
var se_CreateLocationFsxLustreCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationFsxLustre");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationFsxLustreCommand");
var se_CreateLocationFsxOntapCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationFsxOntap");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationFsxOntapCommand");
var se_CreateLocationFsxOpenZfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationFsxOpenZfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationFsxOpenZfsCommand");
var se_CreateLocationFsxWindowsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationFsxWindows");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationFsxWindowsCommand");
var se_CreateLocationHdfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationHdfs");
  let body;
  body = JSON.stringify(se_CreateLocationHdfsRequest(input, context));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationHdfsCommand");
var se_CreateLocationNfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationNfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationNfsCommand");
var se_CreateLocationObjectStorageCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationObjectStorageCommand");
var se_CreateLocationS3Command = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("CreateLocationS3");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_CreateLocationS3Command");
...
var se_DeleteTaskCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DeleteTask");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DeleteTaskCommand");
var se_DescribeAgentCommand = /* @__PURE__ */ __name(async (input, context) => {
...
var se_DescribeLocationAzureBlobCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationAzureBlobCommand");
var se_DescribeLocationEfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationEfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationEfsCommand");
var se_DescribeLocationFsxLustreCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationFsxLustre");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationFsxLustreCommand");
var se_DescribeLocationFsxOntapCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationFsxOntap");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationFsxOntapCommand");
var se_DescribeLocationFsxOpenZfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationFsxOpenZfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationFsxOpenZfsCommand");
var se_DescribeLocationFsxWindowsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationFsxWindows");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationFsxWindowsCommand");
var se_DescribeLocationHdfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationHdfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationHdfsCommand");
var se_DescribeLocationNfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationNfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationNfsCommand");
var se_DescribeLocationObjectStorageCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationObjectStorage");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationObjectStorageCommand");
var se_DescribeLocationS3Command = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("DescribeLocationS3");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_DescribeLocationS3Command");
var se_DescribeLocationSmbCommand = /* @__PURE__ */ __name(async (input, context) => {
...
var se_DescribeTaskExecutionCommand = /* @__PURE__ */ __name(async (input, context) => {
...
var se_ListTaskExecutionsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("ListTaskExecutions");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_ListTaskExecutionsCommand");
...
var se_UpdateLocationNfsCommand = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("UpdateLocationNfs");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_UpdateLocationNfsCommand");
var se_UpdateLocationObjectStorageCommand = /* @__PURE__ */ __name(async (input, context) => {
...
var se_UpdateTaskCommand = /* @__PURE__ */ __name(async (input, context) => {
  ...
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_UpdateTaskCommand");
var se_UpdateTaskExecutionCommand = /* @__PURE__ */ __name(async (input, context) => {
...
var se_CreateLocationHdfsRequest = /* @__PURE__ */ __name((input, context) => {
  return (0, import_smithy_client.take)(input, {
    ...
    KerberosPrincipal: [],
    KmsKeyProviderUri: [],
    NameNodes: import_smithy_client._json,
    QopConfiguration: import_smithy_client._json,
    ReplicationFactor: [],
    SimpleUser: [],
    Subdirectory: [],
    Tags: import_smithy_client._json
  });
}, "se_CreateLocationHdfsRequest");
var se_CreateLocationObjectStorageRequest = /* @__PURE__ */ __name((input, context) => {
  return (0, import_smithy_client.take)(input, {
    AccessKey: [],
    AgentArns: import_smithy_client._json,
    BucketName: [],
...
}, "se_UpdateLocationHdfsRequest");
var se_UpdateLocationObjectStorageRequest = /* @__PURE__ */ __name((input, context) => {
  return (0, import_smithy_client.take)(input, {
    AccessKey: [],
    AgentArns: import_smithy_client._json,
    LocationArn: [],
...
var de_DescribeLocationFsxOntapResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    ...
    SecurityGroupArns: import_smithy_client._json,
    StorageVirtualMachineArn: import_smithy_client.expectString
  });
...
}, "de_DescribeLocationFsxWindowsResponse");
var de_DescribeLocationHdfsResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    AgentArns: import_smithy_client._json,
    AuthenticationType: import_smithy_client.expectString,
    ...
    NameNodes: import_smithy_client._json,
    QopConfiguration: import_smithy_client._json,
    ReplicationFactor: import_smithy_client.expectInt32,
    SimpleUser: import_smithy_client.expectString
  });
...
var de_DescribeLocationNfsResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    ...
    OnPremConfig: import_smithy_client._json
  });
}, "de_DescribeLocationNfsResponse");
var de_DescribeLocationObjectStorageResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
...
}, "de_DescribeLocationObjectStorageResponse");
var de_DescribeLocationS3Response = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    ...
    S3StorageClass: import_smithy_client.expectString
  });
}, "de_DescribeLocationS3Response");
...
var de_DescribeTaskResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    ...
    ErrorDetail: import_smithy_client.expectString,
    Excludes: import_smithy_client._json,
    Includes: import_smithy_client._json,
    ManifestConfig: import_smithy_client._json,
    Name: import_smithy_client.expectString,
...
var throwDefaultError = (0, import_smithy_client.withBaseException)(DataSyncServiceException);
...
var _DataSync = class _DataSync extends DataSyncClient {
};
...
// src/pagination/ListTaskExecutionsPaginator.ts

var paginateListTaskExecutions = (0, import_core.createPaginator)(DataSyncClient, ListTaskExecutionsCommand, "NextToken", "NextToken", "MaxResults");

// src/pagination/ListTasksPaginator.ts

var paginateListTasks = (0, import_core.createPaginator)(DataSyncClient, ListTasksCommand, "NextToken", "NextToken", "MaxResults");
