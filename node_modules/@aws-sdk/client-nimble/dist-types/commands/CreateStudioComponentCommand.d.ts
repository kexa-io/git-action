...
declare const CreateStudioComponentCommand_base: {
    new (input: CreateStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStudioComponentCommandInput, CreateStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStudioComponentCommandInput, CreateStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateStudioComponentCommand extends CreateStudioComponentCommand_base {
}
