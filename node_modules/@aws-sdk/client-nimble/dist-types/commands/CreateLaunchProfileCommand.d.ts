...
declare const CreateLaunchProfileCommand_base: {
    new (input: CreateLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLaunchProfileCommandInput, CreateLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLaunchProfileCommandInput, CreateLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLaunchProfileCommand extends CreateLaunchProfileCommand_base {
}
