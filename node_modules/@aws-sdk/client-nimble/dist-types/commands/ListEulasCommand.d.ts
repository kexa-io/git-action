...
declare const ListEulasCommand_base: {
    new (input: ListEulasCommandInput): import("@smithy/smithy-client").CommandImpl<ListEulasCommandInput, ListEulasCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListEulasCommandInput]): import("@smithy/smithy-client").CommandImpl<ListEulasCommandInput, ListEulasCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListEulasCommand extends ListEulasCommand_base {
}
