...
declare const ListEulaAcceptancesCommand_base: {
    new (input: ListEulaAcceptancesCommandInput): import("@smithy/smithy-client").CommandImpl<ListEulaAcceptancesCommandInput, ListEulaAcceptancesCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListEulaAcceptancesCommandInput): import("@smithy/smithy-client").CommandImpl<ListEulaAcceptancesCommandInput, ListEulaAcceptancesCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListEulaAcceptancesCommand extends ListEulaAcceptancesCommand_base {
}
