 ...
 */
export interface ListStreamingSessionBackupsCommandOutput extends ListStreamingSessionBackupsResponse, __MetadataBearer {
}
declare const ListStreamingSessionBackupsCommand_base: {
    new (input: ListStreamingSessionBackupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingSessionBackupsCommandInput, ListStreamingSessionBackupsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListStreamingSessionBackupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingSessionBackupsCommandInput, ListStreamingSessionBackupsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListStreamingSessionBackupsCommand extends ListStreamingSessionBackupsCommand_base {
}
