...
declare const ListStreamingImagesCommand_base: {
    new (input: ListStreamingImagesCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingImagesCommandInput, ListStreamingImagesCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListStreamingImagesCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingImagesCommandInput, ListStreamingImagesCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListStreamingImagesCommand extends ListStreamingImagesCommand_base {
}
