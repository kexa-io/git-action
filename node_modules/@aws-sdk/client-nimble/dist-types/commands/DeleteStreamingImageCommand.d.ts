...
declare const DeleteStreamingImageCommand_base: {
    new (input: DeleteStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStreamingImageCommandInput, DeleteStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStreamingImageCommandInput, DeleteStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteStreamingImageCommand extends DeleteStreamingImageCommand_base {
}
