...
declare const GetStreamingImageCommand_base: {
    new (input: GetStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingImageCommandInput, GetStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingImageCommandInput, GetStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetStreamingImageCommand extends GetStreamingImageCommand_base {
}
