...
declare const DeleteStudioComponentCommand_base: {
    new (input: DeleteStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStudioComponentCommandInput, DeleteStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStudioComponentCommandInput, DeleteStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteStudioComponentCommand extends DeleteStudioComponentCommand_base {
}
