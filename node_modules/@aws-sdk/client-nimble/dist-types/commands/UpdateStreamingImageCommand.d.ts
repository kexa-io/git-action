...
declare const UpdateStreamingImageCommand_base: {
    new (input: UpdateStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStreamingImageCommandInput, UpdateStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStreamingImageCommandInput, UpdateStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateStreamingImageCommand extends UpdateStreamingImageCommand_base {
}
