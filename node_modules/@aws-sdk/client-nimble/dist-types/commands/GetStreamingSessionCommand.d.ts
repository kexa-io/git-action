...
declare const GetStreamingSessionCommand_base: {
    new (input: GetStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingSessionCommandInput, GetStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingSessionCommandInput, GetStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetStreamingSessionCommand extends GetStreamingSessionCommand_base {
}
