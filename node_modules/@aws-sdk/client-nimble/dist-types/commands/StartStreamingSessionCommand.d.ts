...
declare const StartStreamingSessionCommand_base: {
    new (input: StartStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<StartStreamingSessionCommandInput, StartStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<StartStreamingSessionCommandInput, StartStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartStreamingSessionCommand extends StartStreamingSessionCommand_base {
}
