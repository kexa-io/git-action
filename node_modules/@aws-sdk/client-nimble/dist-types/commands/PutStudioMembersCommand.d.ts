...
declare const PutStudioMembersCommand_base: {
    new (input: PutStudioMembersCommandInput): import("@smithy/smithy-client").CommandImpl<PutStudioMembersCommandInput, PutStudioMembersCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutStudioMembersCommandInput): import("@smithy/smithy-client").CommandImpl<PutStudioMembersCommandInput, PutStudioMembersCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutStudioMembersCommand extends PutStudioMembersCommand_base {
}
