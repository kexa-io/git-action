...
declare const GetStudioCommand_base: {
    new (input: GetStudioCommandInput): import("@smithy/smithy-client").CommandImpl<GetStudioCommandInput, GetStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStudioCommandInput): import("@smithy/smithy-client").CommandImpl<GetStudioCommandInput, GetStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetStudioCommand extends GetStudioCommand_base {
}
