...
declare const GetLaunchProfileDetailsCommand_base: {
    new (input: GetLaunchProfileDetailsCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileDetailsCommandInput, GetLaunchProfileDetailsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLaunchProfileDetailsCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileDetailsCommandInput, GetLaunchProfileDetailsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLaunchProfileDetailsCommand extends GetLaunchProfileDetailsCommand_base {
}
