...
declare const ListStreamingSessionsCommand_base: {
    new (input: ListStreamingSessionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingSessionsCommandInput, ListStreamingSessionsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListStreamingSessionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStreamingSessionsCommandInput, ListStreamingSessionsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListStreamingSessionsCommand extends ListStreamingSessionsCommand_base {
}
