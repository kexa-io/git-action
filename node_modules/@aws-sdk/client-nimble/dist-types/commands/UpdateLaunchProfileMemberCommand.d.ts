...
declare const UpdateLaunchProfileMemberCommand_base: {
    new (input: UpdateLaunchProfileMemberCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchProfileMemberCommandInput, UpdateLaunchProfileMemberCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLaunchProfileMemberCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchProfileMemberCommandInput, UpdateLaunchProfileMemberCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLaunchProfileMemberCommand extends UpdateLaunchProfileMemberCommand_base {
}
