...
declare const ListLaunchProfileMembersCommand_base: {
    new (input: ListLaunchProfileMembersCommandInput): import("@smithy/smithy-client").CommandImpl<ListLaunchProfileMembersCommandInput, ListLaunchProfileMembersCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListLaunchProfileMembersCommandInput): import("@smithy/smithy-client").CommandImpl<ListLaunchProfileMembersCommandInput, ListLaunchProfileMembersCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListLaunchProfileMembersCommand extends ListLaunchProfileMembersCommand_base {
}
