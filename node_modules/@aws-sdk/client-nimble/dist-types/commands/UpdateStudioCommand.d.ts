...
declare const UpdateStudioCommand_base: {
    new (input: UpdateStudioCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStudioCommandInput, UpdateStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateStudioCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStudioCommandInput, UpdateStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
