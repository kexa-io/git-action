...
declare const StartStudioSSOConfigurationRepairCommand_base: {
    new (input: StartStudioSSOConfigurationRepairCommandInput): import("@smithy/smithy-client").CommandImpl<StartStudioSSOConfigurationRepairCommandInput, StartStudioSSOConfigurationRepairCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartStudioSSOConfigurationRepairCommandInput): import("@smithy/smithy-client").CommandImpl<StartStudioSSOConfigurationRepairCommandInput, StartStudioSSOConfigurationRepairCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartStudioSSOConfigurationRepairCommand extends StartStudioSSOConfigurationRepairCommand_base {
}
