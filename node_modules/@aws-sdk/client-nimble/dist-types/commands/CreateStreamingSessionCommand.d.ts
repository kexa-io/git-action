...
declare const CreateStreamingSessionCommand_base: {
    new (input: CreateStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStreamingSessionCommandInput, CreateStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStreamingSessionCommandInput, CreateStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateStreamingSessionCommand extends CreateStreamingSessionCommand_base {
}
