...
declare const CreateStreamingImageCommand_base: {
    new (input: CreateStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStreamingImageCommandInput, CreateStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateStreamingImageCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStreamingImageCommandInput, CreateStreamingImageCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateStreamingImageCommand extends CreateStreamingImageCommand_base {
}
