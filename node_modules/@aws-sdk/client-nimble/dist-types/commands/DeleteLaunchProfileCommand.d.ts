...
declare const DeleteLaunchProfileCommand_base: {
    new (input: DeleteLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLaunchProfileCommandInput, DeleteLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLaunchProfileCommandInput, DeleteLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteLaunchProfileCommand extends DeleteLaunchProfileCommand_base {
}
