...
declare const StopStreamingSessionCommand_base: {
    new (input: StopStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<StopStreamingSessionCommandInput, StopStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopStreamingSessionCommandInput): import("@smithy/smithy-client").CommandImpl<StopStreamingSessionCommandInput, StopStreamingSessionCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopStreamingSessionCommand extends StopStreamingSessionCommand_base {
}
