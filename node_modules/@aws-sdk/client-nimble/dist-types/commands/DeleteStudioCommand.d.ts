...
declare const DeleteStudioCommand_base: {
    new (input: DeleteStudioCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStudioCommandInput, DeleteStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteStudioCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteStudioCommandInput, DeleteStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
