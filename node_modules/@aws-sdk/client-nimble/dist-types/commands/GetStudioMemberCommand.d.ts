...
declare const GetStudioMemberCommand_base: {
    new (input: GetStudioMemberCommandInput): import("@smithy/smithy-client").CommandImpl<GetStudioMemberCommandInput, GetStudioMemberCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStudioMemberCommandInput): import("@smithy/smithy-client").CommandImpl<GetStudioMemberCommandInput, GetStudioMemberCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetStudioMemberCommand extends GetStudioMemberCommand_base {
}
