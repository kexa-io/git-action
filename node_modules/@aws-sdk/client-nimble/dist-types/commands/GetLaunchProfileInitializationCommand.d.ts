...
declare const GetLaunchProfileInitializationCommand_base: {
    new (input: GetLaunchProfileInitializationCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileInitializationCommandInput, GetLaunchProfileInitializationCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLaunchProfileInitializationCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileInitializationCommandInput, GetLaunchProfileInitializationCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLaunchProfileInitializationCommand extends GetLaunchProfileInitializationCommand_base {
}
