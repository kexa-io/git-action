...
declare const ListStudioComponentsCommand_base: {
    new (input: ListStudioComponentsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStudioComponentsCommandInput, ListStudioComponentsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListStudioComponentsCommandInput): import("@smithy/smithy-client").CommandImpl<ListStudioComponentsCommandInput, ListStudioComponentsCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListStudioComponentsCommand extends ListStudioComponentsCommand_base {
}
