...
declare const CreateStudioCommand_base: {
    new (input: CreateStudioCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStudioCommandInput, CreateStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateStudioCommandInput): import("@smithy/smithy-client").CommandImpl<CreateStudioCommandInput, CreateStudioCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
