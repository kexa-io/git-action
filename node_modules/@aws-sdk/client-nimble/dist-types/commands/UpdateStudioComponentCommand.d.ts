...
declare const UpdateStudioComponentCommand_base: {
    new (input: UpdateStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStudioComponentCommandInput, UpdateStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateStudioComponentCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateStudioComponentCommandInput, UpdateStudioComponentCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateStudioComponentCommand extends UpdateStudioComponentCommand_base {
}
