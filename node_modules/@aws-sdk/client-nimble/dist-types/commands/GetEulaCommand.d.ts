...
declare const GetEulaCommand_base: {
    new (input: GetEulaCommandInput): import("@smithy/smithy-client").CommandImpl<GetEulaCommandInput, GetEulaCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetEulaCommandInput): import("@smithy/smithy-client").CommandImpl<GetEulaCommandInput, GetEulaCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetEulaCommand extends GetEulaCommand_base {
}
