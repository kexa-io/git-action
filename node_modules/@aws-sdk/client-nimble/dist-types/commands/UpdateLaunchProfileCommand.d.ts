...
declare const UpdateLaunchProfileCommand_base: {
    new (input: UpdateLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchProfileCommandInput, UpdateLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchProfileCommandInput, UpdateLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLaunchProfileCommand extends UpdateLaunchProfileCommand_base {
}
