...
declare const GetStreamingSessionStreamCommand_base: {
    new (input: GetStreamingSessionStreamCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingSessionStreamCommandInput, GetStreamingSessionStreamCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetStreamingSessionStreamCommandInput): import("@smithy/smithy-client").CommandImpl<GetStreamingSessionStreamCommandInput, GetStreamingSessionStreamCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetStreamingSessionStreamCommand extends GetStreamingSessionStreamCommand_base {
}
