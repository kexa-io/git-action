...
declare const GetLaunchProfileCommand_base: {
    new (input: GetLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileCommandInput, GetLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLaunchProfileCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchProfileCommandInput, GetLaunchProfileCommandOutput, NimbleClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLaunchProfileCommand extends GetLaunchProfileCommand_base {
}
