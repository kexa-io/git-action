...
import { GetStreamingSessionBackupCommandInput, GetStreamingSessionBackupCommandOutput } from "./commands/GetStreamingSessionBackupCommand";
...
import { ListStreamingSessionBackupsCommandInput, ListStreamingSessionBackupsCommandOutput } from "./commands/ListStreamingSessionBackupsCommand";
...
import { StartStreamingSessionCommandInput, StartStreamingSessionCommandOutput } from "./commands/StartStreamingSessionCommand";
...
import { StopStreamingSessionCommandInput, StopStreamingSessionCommandOutput } from "./commands/StopStreamingSessionCommand";
...
export interface Nimble {
     ...
     */
    getStreamingSessionBackup(args: GetStreamingSessionBackupCommandInput, options?: __HttpHandlerOptions): Promise<GetStreamingSessionBackupCommandOutput>;
    getStreamingSessionBackup(args: GetStreamingSessionBackupCommandInput, cb: (err: any, data?: GetStreamingSessionBackupCommandOutput) => void): void;
    getStreamingSessionBackup(args: GetStreamingSessionBackupCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetStreamingSessionBackupCommandOutput) => void): void;
    /**
     ...
     */
    listStreamingSessionBackups(args: ListStreamingSessionBackupsCommandInput, options?: __HttpHandlerOptions): Promise<ListStreamingSessionBackupsCommandOutput>;
    listStreamingSessionBackups(args: ListStreamingSessionBackupsCommandInput, cb: (err: any, data?: ListStreamingSessionBackupsCommandOutput) => void): void;
    listStreamingSessionBackups(args: ListStreamingSessionBackupsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListStreamingSessionBackupsCommandOutput) => void): void;
    /**
 ...
 *             service.</p>
 */
export declare class Nimble extends NimbleClient implements Nimble {
}
