 ...
 * @internal
 */
export interface CloudHSMHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<CloudHSMClientResolvedConfig, HandlerExecutionContext, CloudHSMHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultCloudHSMHttpAuthSchemeParametersProvider: (config: CloudHSMClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<CloudHSMHttpAuthSchemeParameters>;
/**
 * @internal
 */
