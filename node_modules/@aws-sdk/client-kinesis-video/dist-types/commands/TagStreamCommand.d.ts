...
declare const TagStreamCommand_base: {
    ...
    new (__0_0: TagStreamCommandInput): import("@smithy/smithy-client").CommandImpl<TagStreamCommandInput, TagStreamCommandOutput, KinesisVideoClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
