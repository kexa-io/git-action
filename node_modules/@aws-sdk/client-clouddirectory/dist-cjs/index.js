...
__export(src_exports, {
  ...
  AttachObjectCommand: () => AttachObjectCommand,
  AttachPolicyCommand: () => AttachPolicyCommand,
  AttachToIndexCommand: () => AttachToIndexCommand,
  AttachTypedLinkCommand: () => AttachTypedLinkCommand,
  BatchReadCommand: () => BatchReadCommand,
  ...
  CloudDirectoryServiceException: () => CloudDirectoryServiceException,
  ConsistencyLevel: () => ConsistencyLevel,
  CreateDirectoryCommand: () => CreateDirectoryCommand,
  CreateFacetCommand: () => CreateFacetCommand,
  CreateIndexCommand: () => CreateIndexCommand,
  CreateObjectCommand: () => CreateObjectCommand,
  CreateSchemaCommand: () => CreateSchemaCommand,
  CreateTypedLinkFacetCommand: () => CreateTypedLinkFacetCommand,
  DeleteDirectoryCommand: () => DeleteDirectoryCommand,
  DeleteFacetCommand: () => DeleteFacetCommand,
  DeleteObjectCommand: () => DeleteObjectCommand,
  DeleteSchemaCommand: () => DeleteSchemaCommand,
  DeleteTypedLinkFacetCommand: () => DeleteTypedLinkFacetCommand,
  DetachFromIndexCommand: () => DetachFromIndexCommand,
  DetachObjectCommand: () => DetachObjectCommand,
  DetachPolicyCommand: () => DetachPolicyCommand,
  DetachTypedLinkCommand: () => DetachTypedLinkCommand,
  ...
  DisableDirectoryCommand: () => DisableDirectoryCommand,
  EnableDirectoryCommand: () => EnableDirectoryCommand,
  ...
  GetAppliedSchemaVersionCommand: () => GetAppliedSchemaVersionCommand,
  GetDirectoryCommand: () => GetDirectoryCommand,
  GetFacetCommand: () => GetFacetCommand,
  GetLinkAttributesCommand: () => GetLinkAttributesCommand,
  GetObjectAttributesCommand: () => GetObjectAttributesCommand,
  GetObjectInformationCommand: () => GetObjectInformationCommand,
  GetSchemaAsJsonCommand: () => GetSchemaAsJsonCommand,
  GetTypedLinkFacetInformationCommand: () => GetTypedLinkFacetInformationCommand,
  ...
  ListAppliedSchemaArnsCommand: () => ListAppliedSchemaArnsCommand,
  ListAttachedIndicesCommand: () => ListAttachedIndicesCommand,
  ListDevelopmentSchemaArnsCommand: () => ListDevelopmentSchemaArnsCommand,
  ListDirectoriesCommand: () => ListDirectoriesCommand,
  ListFacetAttributesCommand: () => ListFacetAttributesCommand,
  ListFacetNamesCommand: () => ListFacetNamesCommand,
  ListIncomingTypedLinksCommand: () => ListIncomingTypedLinksCommand,
  ListIndexCommand: () => ListIndexCommand,
  ListManagedSchemaArnsCommand: () => ListManagedSchemaArnsCommand,
  ListObjectAttributesCommand: () => ListObjectAttributesCommand,
  ListObjectChildrenCommand: () => ListObjectChildrenCommand,
  ListObjectParentPathsCommand: () => ListObjectParentPathsCommand,
  ListObjectParentsCommand: () => ListObjectParentsCommand,
  ListObjectPoliciesCommand: () => ListObjectPoliciesCommand,
  ListOutgoingTypedLinksCommand: () => ListOutgoingTypedLinksCommand,
  ListPolicyAttachmentsCommand: () => ListPolicyAttachmentsCommand,
  ListPublishedSchemaArnsCommand: () => ListPublishedSchemaArnsCommand,
  ListTagsForResourceCommand: () => ListTagsForResourceCommand,
  ListTypedLinkFacetAttributesCommand: () => ListTypedLinkFacetAttributesCommand,
  ListTypedLinkFacetNamesCommand: () => ListTypedLinkFacetNamesCommand,
  LookupPolicyCommand: () => LookupPolicyCommand,
  ...
  PutSchemaFromJsonCommand: () => PutSchemaFromJsonCommand,
  RangeMode: () => RangeMode,
  RemoveFacetFromObjectCommand: () => RemoveFacetFromObjectCommand,
  ...
  UpdateFacetCommand: () => UpdateFacetCommand,
  UpdateLinkAttributesCommand: () => UpdateLinkAttributesCommand,
  UpdateObjectAttributesCommand: () => UpdateObjectAttributesCommand,
  UpdateSchemaCommand: () => UpdateSchemaCommand,
  UpdateTypedLinkFacetCommand: () => UpdateTypedLinkFacetCommand,
  UpgradeAppliedSchemaCommand: () => UpgradeAppliedSchemaCommand,
  UpgradePublishedSchemaCommand: () => UpgradePublishedSchemaCommand,
  ValidationException: () => ValidationException,
  __Client: () => import_smithy_client.Client,
  paginateListAppliedSchemaArns: () => paginateListAppliedSchemaArns,
  paginateListAttachedIndices: () => paginateListAttachedIndices,
  paginateListDevelopmentSchemaArns: () => paginateListDevelopmentSchemaArns,
  paginateListDirectories: () => paginateListDirectories,
  paginateListFacetAttributes: () => paginateListFacetAttributes,
  paginateListFacetNames: () => paginateListFacetNames,
  paginateListIndex: () => paginateListIndex,
  paginateListManagedSchemaArns: () => paginateListManagedSchemaArns,
  paginateListObjectAttributes: () => paginateListObjectAttributes,
  paginateListObjectChildren: () => paginateListObjectChildren,
  paginateListObjectParentPaths: () => paginateListObjectParentPaths,
  paginateListObjectParents: () => paginateListObjectParents,
  paginateListObjectPolicies: () => paginateListObjectPolicies,
  paginateListPolicyAttachments: () => paginateListPolicyAttachments,
  paginateListPublishedSchemaArns: () => paginateListPublishedSchemaArns,
  paginateListTagsForResource: () => paginateListTagsForResource,
  paginateListTypedLinkFacetAttributes: () => paginateListTypedLinkFacetAttributes,
...
var de_BatchWriteExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_BatchWriteExceptionRes");
var de_CannotListParentOfRootExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_CannotListParentOfRootExceptionRes");
var de_DirectoryAlreadyExistsExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_DirectoryAlreadyExistsExceptionRes");
var de_DirectoryDeletedExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_DirectoryDeletedExceptionRes");
var de_DirectoryNotDisabledExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_DirectoryNotDisabledExceptionRes");
var de_DirectoryNotEnabledExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_DirectoryNotEnabledExceptionRes");
var de_FacetAlreadyExistsExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_FacetAlreadyExistsExceptionRes");
var de_FacetInUseExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_FacetInUseExceptionRes");
var de_FacetNotFoundExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_FacetNotFoundExceptionRes");
var de_FacetValidationExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_FacetValidationExceptionRes");
var de_IncompatibleSchemaExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_IncompatibleSchemaExceptionRes");
var de_IndexedAttributeMissingExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_IndexedAttributeMissingExceptionRes");
...
var de_InvalidAttachmentExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_InvalidAttachmentExceptionRes");
var de_InvalidFacetUpdateExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_InvalidFacetUpdateExceptionRes");
...
var de_InvalidRuleExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_InvalidRuleExceptionRes");
var de_InvalidSchemaDocExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_InvalidSchemaDocExceptionRes");
var de_InvalidTaggingRequestExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_InvalidTaggingRequestExceptionRes");
...
var de_LinkNameAlreadyInUseExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_LinkNameAlreadyInUseExceptionRes");
var de_NotIndexExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_NotIndexExceptionRes");
var de_NotNodeExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_NotNodeExceptionRes");
var de_NotPolicyExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_NotPolicyExceptionRes");
var de_ObjectAlreadyDetachedExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_ObjectAlreadyDetachedExceptionRes");
var de_ObjectNotDetachedExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_ObjectNotDetachedExceptionRes");
...
var de_RetryableConflictExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_RetryableConflictExceptionRes");
var de_SchemaAlreadyExistsExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_SchemaAlreadyExistsExceptionRes");
var de_SchemaAlreadyPublishedExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_SchemaAlreadyPublishedExceptionRes");
var de_StillContainsLinksExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_StillContainsLinksExceptionRes");
var de_UnsupportedIndexTypeExceptionRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const contents = (0, import_smithy_client.map)({});
  const data = parsedOutput.body;
  const doc = (0, import_smithy_client.take)(data, {
    Message: import_smithy_client.expectString
  ...
  return (0, import_smithy_client.decorateServiceException)(exception, parsedOutput.body);
}, "de_UnsupportedIndexTypeExceptionRes");
...
}, "se_BatchAttachTypedLink");
var se_BatchCreateObject = /* @__PURE__ */ __name((input, context) => {
  return (0, import_smithy_client.take)(input, {
    BatchReferenceName: [],
    LinkName: [],
    ObjectAttributeList: (_) => se_AttributeKeyAndValueList(_, context),
...
}, "se_BatchListIncomingTypedLinks");
var se_BatchListIndex = /* @__PURE__ */ __name((input, context) => {
  return (0, import_smithy_client.take)(input, {
...
}, "se_BatchReadOperation");
var se_BatchReadOperationList = /* @__PURE__ */ __name((input, context) => {
  return input.filter((e) => e != null).map((entry) => {
...
}, "se_FacetAttributeDefinition");
var se_FacetAttributeList = /* @__PURE__ */ __name((input, context) => {
  return input.filter((e) => e != null).map((entry) => {
    return se_FacetAttribute(entry, context);
  });
}, "se_FacetAttributeList");
...
var se_LinkAttributeUpdateList = /* @__PURE__ */ __name((input, context) => {
  return input.filter((e) => e != null).map((entry) => {
    return se_LinkAttributeUpdate(entry, context);
  });
}, "se_LinkAttributeUpdateList");
...
var se_ObjectAttributeUpdateList = /* @__PURE__ */ __name((input, context) => {
  return input.filter((e) => e != null).map((entry) => {
...
var se_TypedAttributeValue = /* @__PURE__ */ __name((input, context) => {
  return TypedAttributeValue.visit(input, {
    ...
    DatetimeValue: (value) => ({ DatetimeValue: Math.round(value.getTime() / 1e3) }),
...
}, "se_TypedLinkAttributeDefinition");
var se_TypedLinkAttributeDefinitionList = /* @__PURE__ */ __name((input, context) => {
  return input.filter((e) => e != null).map((entry) => {
    return se_TypedLinkAttributeDefinition(entry, context);
  });
}, "se_TypedLinkAttributeDefinitionList");
...
}, "de_BatchReadSuccessfulResponse");
var de_BatchWriteOperationResponse = /* @__PURE__ */ __name((output, context) => {
  return (0, import_smithy_client.take)(output, {
    AddFacetToObject: import_smithy_client._json,
    AttachObject: import_smithy_client._json,
    AttachPolicy: import_smithy_client._json,
    AttachToIndex: import_smithy_client._json,
    ...
    DetachObject: import_smithy_client._json,
    DetachPolicy: import_smithy_client._json,
    DetachTypedLink: import_smithy_client._json,
    RemoveFacetFromObject: import_smithy_client._json,
    UpdateLinkAttributes: import_smithy_client._json,
    UpdateObjectAttributes: import_smithy_client._json
  });
}, "de_BatchWriteOperationResponse");
var de_BatchWriteOperationResponseList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
...
var de_DirectoryList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
...
}, "de_FacetAttributeDefinition");
var de_FacetAttributeList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
...
var de_IndexAttachmentList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
    return de_IndexAttachment(entry, context);
  });
  return retVal;
}, "de_IndexAttachmentList");
var de_TypedAttributeValue = /* @__PURE__ */ __name((output, context) => {
  ...
  if (output.DatetimeValue != null) {
    return {
      DatetimeValue: (0, import_smithy_client.expectNonNull)((0, import_smithy_client.parseEpochTimestamp)((0, import_smithy_client.expectNumber)(output.DatetimeValue)))
    };
  }
  if ((0, import_smithy_client.expectString)(output.NumberValue) !== void 0) {
    return { NumberValue: (0, import_smithy_client.expectString)(output.NumberValue) };
  }
...
}, "de_TypedLinkAttributeDefinition");
var de_TypedLinkAttributeDefinitionList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
...
}, "de_TypedLinkSpecifier");
var de_TypedLinkSpecifierList = /* @__PURE__ */ __name((output, context) => {
  const retVal = (output || []).filter((e) => e != null).map((entry) => {
    return de_TypedLinkSpecifier(entry, context);
  });
  return retVal;
}, "de_TypedLinkSpecifierList");
