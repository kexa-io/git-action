...
export type MarketplaceMeteringClientResolvedConfigType =
  __SmithyResolvedConfiguration<__HttpHandlerOptions> &
    ...
    HttpAuthSchemeResolvedConfig &
    ClientResolvedEndpointParameters;
export interface MarketplaceMeteringClientResolvedConfig
  extends MarketplaceMeteringClientResolvedConfigType {}
export declare class MarketplaceMeteringClient extends __Client<
...
> {
  ...
  constructor(
    ...[
      configuration,
    ]: __CheckOptionalClientConfig<MarketplaceMeteringClientConfig>
  );
  destroy(): void;
