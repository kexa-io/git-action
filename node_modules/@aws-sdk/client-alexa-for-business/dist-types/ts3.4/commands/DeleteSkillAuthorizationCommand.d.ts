...
export interface DeleteSkillAuthorizationCommandInput
  extends DeleteSkillAuthorizationRequest {}
export interface DeleteSkillAuthorizationCommandOutput
...
declare const DeleteSkillAuthorizationCommand_base: {
  ...
  >;
  new (
    __0_0: DeleteSkillAuthorizationCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    DeleteSkillAuthorizationCommandInput,
    DeleteSkillAuthorizationCommandOutput,
    AlexaForBusinessClientResolvedConfig,
