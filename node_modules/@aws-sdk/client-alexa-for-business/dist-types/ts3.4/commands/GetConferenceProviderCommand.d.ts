...
export interface GetConferenceProviderCommandInput
  extends GetConferenceProviderRequest {}
export interface GetConferenceProviderCommandOutput
  extends GetConferenceProviderResponse,
    __MetadataBearer {}
declare const GetConferenceProviderCommand_base: {
  ...
  >;
  new (
    __0_0: GetConferenceProviderCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    GetConferenceProviderCommandInput,
    GetConferenceProviderCommandOutput,
    AlexaForBusinessClientResolvedConfig,
