...
declare const SearchAddressBooksCommand_base: {
    new (input: SearchAddressBooksCommandInput): import("@smithy/smithy-client").CommandImpl<SearchAddressBooksCommandInput, SearchAddressBooksCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class SearchAddressBooksCommand extends SearchAddressBooksCommand_base {
}
