...
declare const SearchRoomsCommand_base: {
    new (input: SearchRoomsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchRoomsCommandInput, SearchRoomsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [SearchRoomsCommandInput]): import("@smithy/smithy-client").CommandImpl<SearchRoomsCommandInput, SearchRoomsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchRoomsCommand extends SearchRoomsCommand_base {
}
