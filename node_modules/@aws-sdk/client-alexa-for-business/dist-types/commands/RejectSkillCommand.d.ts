...
declare const RejectSkillCommand_base: {
    new (input: RejectSkillCommandInput): import("@smithy/smithy-client").CommandImpl<RejectSkillCommandInput, RejectSkillCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RejectSkillCommandInput): import("@smithy/smithy-client").CommandImpl<RejectSkillCommandInput, RejectSkillCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RejectSkillCommand extends RejectSkillCommand_base {
}
