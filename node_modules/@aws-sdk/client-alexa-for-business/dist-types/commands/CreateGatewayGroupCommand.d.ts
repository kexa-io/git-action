...
declare const CreateGatewayGroupCommand_base: {
    new (input: CreateGatewayGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateGatewayGroupCommandInput, CreateGatewayGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class CreateGatewayGroupCommand extends CreateGatewayGroupCommand_base {
}
