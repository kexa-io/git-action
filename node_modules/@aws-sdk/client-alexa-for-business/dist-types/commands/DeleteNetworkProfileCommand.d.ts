...
declare const DeleteNetworkProfileCommand_base: {
    new (input: DeleteNetworkProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteNetworkProfileCommandInput, DeleteNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
