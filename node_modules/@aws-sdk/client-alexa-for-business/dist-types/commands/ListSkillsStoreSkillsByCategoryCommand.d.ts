 ...
 */
export interface ListSkillsStoreSkillsByCategoryCommandOutput extends ListSkillsStoreSkillsByCategoryResponse, __MetadataBearer {
}
declare const ListSkillsStoreSkillsByCategoryCommand_base: {
    new (input: ListSkillsStoreSkillsByCategoryCommandInput): import("@smithy/smithy-client").CommandImpl<ListSkillsStoreSkillsByCategoryCommandInput, ListSkillsStoreSkillsByCategoryCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListSkillsStoreSkillsByCategoryCommandInput): import("@smithy/smithy-client").CommandImpl<ListSkillsStoreSkillsByCategoryCommandInput, ListSkillsStoreSkillsByCategoryCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSkillsStoreSkillsByCategoryCommand extends ListSkillsStoreSkillsByCategoryCommand_base {
}
