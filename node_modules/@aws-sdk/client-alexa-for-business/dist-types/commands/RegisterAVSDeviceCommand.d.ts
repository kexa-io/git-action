...
declare const RegisterAVSDeviceCommand_base: {
    new (input: RegisterAVSDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterAVSDeviceCommandInput, RegisterAVSDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RegisterAVSDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<RegisterAVSDeviceCommandInput, RegisterAVSDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RegisterAVSDeviceCommand extends RegisterAVSDeviceCommand_base {
}
