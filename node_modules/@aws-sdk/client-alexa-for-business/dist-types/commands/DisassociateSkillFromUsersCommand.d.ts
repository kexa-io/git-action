...
declare const DisassociateSkillFromUsersCommand_base: {
    new (input: DisassociateSkillFromUsersCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateSkillFromUsersCommandInput, DisassociateSkillFromUsersCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateSkillFromUsersCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateSkillFromUsersCommandInput, DisassociateSkillFromUsersCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateSkillFromUsersCommand extends DisassociateSkillFromUsersCommand_base {
}
