...
declare const UpdateConferenceProviderCommand_base: {
    new (input: UpdateConferenceProviderCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateConferenceProviderCommandInput, UpdateConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class UpdateConferenceProviderCommand extends UpdateConferenceProviderCommand_base {
}
