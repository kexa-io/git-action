...
declare const DeleteGatewayGroupCommand_base: {
    new (input: DeleteGatewayGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteGatewayGroupCommandInput, DeleteGatewayGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteGatewayGroupCommand extends DeleteGatewayGroupCommand_base {
}
