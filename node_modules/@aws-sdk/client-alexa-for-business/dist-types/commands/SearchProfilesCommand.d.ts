...
declare const SearchProfilesCommand_base: {
    new (input: SearchProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchProfilesCommandInput, SearchProfilesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
