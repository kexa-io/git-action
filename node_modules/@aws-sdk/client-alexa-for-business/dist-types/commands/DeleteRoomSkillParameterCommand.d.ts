...
declare const DeleteRoomSkillParameterCommand_base: {
    new (input: DeleteRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRoomSkillParameterCommandInput, DeleteRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRoomSkillParameterCommandInput, DeleteRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteRoomSkillParameterCommand extends DeleteRoomSkillParameterCommand_base {
}
