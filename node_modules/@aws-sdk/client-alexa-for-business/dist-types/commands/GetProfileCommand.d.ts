...
declare const GetProfileCommand_base: {
    new (input: GetProfileCommandInput): import("@smithy/smithy-client").CommandImpl<GetProfileCommandInput, GetProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetProfileCommandInput]): import("@smithy/smithy-client").CommandImpl<GetProfileCommandInput, GetProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
