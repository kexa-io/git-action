...
declare const UpdateAddressBookCommand_base: {
    new (input: UpdateAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAddressBookCommandInput, UpdateAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAddressBookCommandInput, UpdateAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateAddressBookCommand extends UpdateAddressBookCommand_base {
}
