...
declare const GetRoomCommand_base: {
    new (input: GetRoomCommandInput): import("@smithy/smithy-client").CommandImpl<GetRoomCommandInput, GetRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetRoomCommandInput]): import("@smithy/smithy-client").CommandImpl<GetRoomCommandInput, GetRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
