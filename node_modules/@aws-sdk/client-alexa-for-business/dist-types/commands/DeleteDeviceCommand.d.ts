...
declare const DeleteDeviceCommand_base: {
    new (input: DeleteDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeviceCommandInput, DeleteDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeviceCommandInput, DeleteDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
