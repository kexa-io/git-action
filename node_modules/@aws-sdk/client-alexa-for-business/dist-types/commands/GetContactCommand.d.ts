...
declare const GetContactCommand_base: {
    new (input: GetContactCommandInput): import("@smithy/smithy-client").CommandImpl<GetContactCommandInput, GetContactCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetContactCommandInput): import("@smithy/smithy-client").CommandImpl<GetContactCommandInput, GetContactCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
