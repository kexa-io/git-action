...
declare const ListSkillsStoreCategoriesCommand_base: {
    new (input: ListSkillsStoreCategoriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSkillsStoreCategoriesCommandInput, ListSkillsStoreCategoriesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListSkillsStoreCategoriesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListSkillsStoreCategoriesCommandInput, ListSkillsStoreCategoriesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSkillsStoreCategoriesCommand extends ListSkillsStoreCategoriesCommand_base {
}
