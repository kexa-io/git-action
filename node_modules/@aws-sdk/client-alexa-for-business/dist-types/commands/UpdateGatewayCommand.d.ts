...
declare const UpdateGatewayCommand_base: {
    new (input: UpdateGatewayCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayCommandInput, UpdateGatewayCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateGatewayCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayCommandInput, UpdateGatewayCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
