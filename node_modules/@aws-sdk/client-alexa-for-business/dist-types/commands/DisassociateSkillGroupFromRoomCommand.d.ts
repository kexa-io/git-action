 ...
 */
export interface DisassociateSkillGroupFromRoomCommandOutput extends DisassociateSkillGroupFromRoomResponse, __MetadataBearer {
}
declare const DisassociateSkillGroupFromRoomCommand_base: {
    new (input: DisassociateSkillGroupFromRoomCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateSkillGroupFromRoomCommandInput, DisassociateSkillGroupFromRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DisassociateSkillGroupFromRoomCommand extends DisassociateSkillGroupFromRoomCommand_base {
}
