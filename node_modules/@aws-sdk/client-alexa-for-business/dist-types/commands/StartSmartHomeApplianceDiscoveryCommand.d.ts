 ...
 */
export interface StartSmartHomeApplianceDiscoveryCommandOutput extends StartSmartHomeApplianceDiscoveryResponse, __MetadataBearer {
}
declare const StartSmartHomeApplianceDiscoveryCommand_base: {
    new (input: StartSmartHomeApplianceDiscoveryCommandInput): import("@smithy/smithy-client").CommandImpl<StartSmartHomeApplianceDiscoveryCommandInput, StartSmartHomeApplianceDiscoveryCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class StartSmartHomeApplianceDiscoveryCommand extends StartSmartHomeApplianceDiscoveryCommand_base {
}
