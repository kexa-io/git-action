...
declare const GetConferencePreferenceCommand_base: {
    new (input: GetConferencePreferenceCommandInput): import("@smithy/smithy-client").CommandImpl<GetConferencePreferenceCommandInput, GetConferencePreferenceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetConferencePreferenceCommandInput]): import("@smithy/smithy-client").CommandImpl<GetConferencePreferenceCommandInput, GetConferencePreferenceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetConferencePreferenceCommand extends GetConferencePreferenceCommand_base {
}
