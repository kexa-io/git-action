...
declare const DeleteRoomCommand_base: {
    new (input: DeleteRoomCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteRoomCommandInput, DeleteRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
