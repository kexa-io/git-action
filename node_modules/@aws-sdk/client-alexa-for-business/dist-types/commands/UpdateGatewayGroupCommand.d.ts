...
declare const UpdateGatewayGroupCommand_base: {
    new (input: UpdateGatewayGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayGroupCommandInput, UpdateGatewayGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateGatewayGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateGatewayGroupCommandInput, UpdateGatewayGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateGatewayGroupCommand extends UpdateGatewayGroupCommand_base {
}
