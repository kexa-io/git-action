 ...
 */
export interface AssociateSkillWithSkillGroupCommandOutput extends AssociateSkillWithSkillGroupResponse, __MetadataBearer {
}
declare const AssociateSkillWithSkillGroupCommand_base: {
    new (input: AssociateSkillWithSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSkillWithSkillGroupCommandInput, AssociateSkillWithSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class AssociateSkillWithSkillGroupCommand extends AssociateSkillWithSkillGroupCommand_base {
}
