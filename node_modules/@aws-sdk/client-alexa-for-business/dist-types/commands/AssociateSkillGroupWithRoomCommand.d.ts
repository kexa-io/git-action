 ...
 */
export interface AssociateSkillGroupWithRoomCommandOutput extends AssociateSkillGroupWithRoomResponse, __MetadataBearer {
}
declare const AssociateSkillGroupWithRoomCommand_base: {
    new (input: AssociateSkillGroupWithRoomCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSkillGroupWithRoomCommandInput, AssociateSkillGroupWithRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class AssociateSkillGroupWithRoomCommand extends AssociateSkillGroupWithRoomCommand_base {
}
