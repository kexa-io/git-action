...
declare const GetRoomSkillParameterCommand_base: {
    new (input: GetRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<GetRoomSkillParameterCommandInput, GetRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<GetRoomSkillParameterCommandInput, GetRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetRoomSkillParameterCommand extends GetRoomSkillParameterCommand_base {
}
