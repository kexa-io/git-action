...
declare const ForgetSmartHomeAppliancesCommand_base: {
    new (input: ForgetSmartHomeAppliancesCommandInput): import("@smithy/smithy-client").CommandImpl<ForgetSmartHomeAppliancesCommandInput, ForgetSmartHomeAppliancesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class ForgetSmartHomeAppliancesCommand extends ForgetSmartHomeAppliancesCommand_base {
}
