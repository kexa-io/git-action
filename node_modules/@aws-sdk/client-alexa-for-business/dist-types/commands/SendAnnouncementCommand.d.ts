...
declare const SendAnnouncementCommand_base: {
    new (input: SendAnnouncementCommandInput): import("@smithy/smithy-client").CommandImpl<SendAnnouncementCommandInput, SendAnnouncementCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SendAnnouncementCommandInput): import("@smithy/smithy-client").CommandImpl<SendAnnouncementCommandInput, SendAnnouncementCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SendAnnouncementCommand extends SendAnnouncementCommand_base {
}
