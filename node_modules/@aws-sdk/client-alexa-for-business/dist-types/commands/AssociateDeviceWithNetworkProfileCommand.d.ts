...
import { AssociateDeviceWithNetworkProfileRequest, AssociateDeviceWithNetworkProfileResponse } from "../models/models_0";
/**
 * @public
 */
 ...
 */
export interface AssociateDeviceWithNetworkProfileCommandOutput extends AssociateDeviceWithNetworkProfileResponse, __MetadataBearer {
}
declare const AssociateDeviceWithNetworkProfileCommand_base: {
    new (input: AssociateDeviceWithNetworkProfileCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDeviceWithNetworkProfileCommandInput, AssociateDeviceWithNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateDeviceWithNetworkProfileCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDeviceWithNetworkProfileCommandInput, AssociateDeviceWithNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateDeviceWithNetworkProfileCommand extends AssociateDeviceWithNetworkProfileCommand_base {
}
