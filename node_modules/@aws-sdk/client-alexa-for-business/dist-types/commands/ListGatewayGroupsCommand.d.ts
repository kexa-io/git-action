...
declare const ListGatewayGroupsCommand_base: {
    new (input: ListGatewayGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<ListGatewayGroupsCommandInput, ListGatewayGroupsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListGatewayGroupsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListGatewayGroupsCommandInput, ListGatewayGroupsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListGatewayGroupsCommand extends ListGatewayGroupsCommand_base {
}
