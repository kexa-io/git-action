...
declare const ResolveRoomCommand_base: {
    new (input: ResolveRoomCommandInput): import("@smithy/smithy-client").CommandImpl<ResolveRoomCommandInput, ResolveRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ResolveRoomCommandInput): import("@smithy/smithy-client").CommandImpl<ResolveRoomCommandInput, ResolveRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ResolveRoomCommand extends ResolveRoomCommand_base {
}
