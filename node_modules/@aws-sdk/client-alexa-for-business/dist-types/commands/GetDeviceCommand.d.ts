...
declare const GetDeviceCommand_base: {
    new (input: GetDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<GetDeviceCommandInput, GetDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
