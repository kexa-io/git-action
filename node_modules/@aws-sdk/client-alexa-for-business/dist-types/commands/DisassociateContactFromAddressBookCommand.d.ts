...
import { DisassociateContactFromAddressBookRequest, DisassociateContactFromAddressBookResponse } from "../models/models_0";
/**
 * @public
 */
 ...
 */
export interface DisassociateContactFromAddressBookCommandOutput extends DisassociateContactFromAddressBookResponse, __MetadataBearer {
}
declare const DisassociateContactFromAddressBookCommand_base: {
    new (input: DisassociateContactFromAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateContactFromAddressBookCommandInput, DisassociateContactFromAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DisassociateContactFromAddressBookCommand extends DisassociateContactFromAddressBookCommand_base {
}
