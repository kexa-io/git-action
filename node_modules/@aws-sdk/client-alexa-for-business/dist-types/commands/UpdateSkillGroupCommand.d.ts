...
declare const UpdateSkillGroupCommand_base: {
    new (input: UpdateSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSkillGroupCommandInput, UpdateSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class UpdateSkillGroupCommand extends UpdateSkillGroupCommand_base {
}
