...
declare const DeleteSkillGroupCommand_base: {
    new (input: DeleteSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSkillGroupCommandInput, DeleteSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DeleteSkillGroupCommandInput]): import("@smithy/smithy-client").CommandImpl<DeleteSkillGroupCommandInput, DeleteSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteSkillGroupCommand extends DeleteSkillGroupCommand_base {
}
