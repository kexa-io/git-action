...
declare const ListSmartHomeAppliancesCommand_base: {
    new (input: ListSmartHomeAppliancesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSmartHomeAppliancesCommandInput, ListSmartHomeAppliancesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListSmartHomeAppliancesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSmartHomeAppliancesCommandInput, ListSmartHomeAppliancesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSmartHomeAppliancesCommand extends ListSmartHomeAppliancesCommand_base {
}
