...
declare const DisassociateDeviceFromRoomCommand_base: {
    new (input: DisassociateDeviceFromRoomCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateDeviceFromRoomCommandInput, DisassociateDeviceFromRoomCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DisassociateDeviceFromRoomCommand extends DisassociateDeviceFromRoomCommand_base {
}
