...
declare const SearchContactsCommand_base: {
    new (input: SearchContactsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchContactsCommandInput, SearchContactsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
