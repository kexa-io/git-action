 ...
 */
export interface DisassociateSkillFromSkillGroupCommandOutput extends DisassociateSkillFromSkillGroupResponse, __MetadataBearer {
}
declare const DisassociateSkillFromSkillGroupCommand_base: {
    new (input: DisassociateSkillFromSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateSkillFromSkillGroupCommandInput, DisassociateSkillFromSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateSkillFromSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateSkillFromSkillGroupCommandInput, DisassociateSkillFromSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateSkillFromSkillGroupCommand extends DisassociateSkillFromSkillGroupCommand_base {
}
