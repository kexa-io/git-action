...
declare const SearchSkillGroupsCommand_base: {
    new (input: SearchSkillGroupsCommandInput): import("@smithy/smithy-client").CommandImpl<SearchSkillGroupsCommandInput, SearchSkillGroupsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [SearchSkillGroupsCommandInput]): import("@smithy/smithy-client").CommandImpl<SearchSkillGroupsCommandInput, SearchSkillGroupsCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchSkillGroupsCommand extends SearchSkillGroupsCommand_base {
}
