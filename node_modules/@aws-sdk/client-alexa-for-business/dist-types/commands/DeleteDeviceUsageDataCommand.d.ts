...
declare const DeleteDeviceUsageDataCommand_base: {
    new (input: DeleteDeviceUsageDataCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDeviceUsageDataCommandInput, DeleteDeviceUsageDataCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteDeviceUsageDataCommand extends DeleteDeviceUsageDataCommand_base {
}
