...
declare const SearchNetworkProfilesCommand_base: {
    new (input: SearchNetworkProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchNetworkProfilesCommandInput, SearchNetworkProfilesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class SearchNetworkProfilesCommand extends SearchNetworkProfilesCommand_base {
}
