...
declare const RevokeInvitationCommand_base: {
    new (input: RevokeInvitationCommandInput): import("@smithy/smithy-client").CommandImpl<RevokeInvitationCommandInput, RevokeInvitationCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [RevokeInvitationCommandInput]): import("@smithy/smithy-client").CommandImpl<RevokeInvitationCommandInput, RevokeInvitationCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RevokeInvitationCommand extends RevokeInvitationCommand_base {
}
