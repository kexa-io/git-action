...
declare const GetGatewayCommand_base: {
    new (input: GetGatewayCommandInput): import("@smithy/smithy-client").CommandImpl<GetGatewayCommandInput, GetGatewayCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
