...
declare const PutConferencePreferenceCommand_base: {
    new (input: PutConferencePreferenceCommandInput): import("@smithy/smithy-client").CommandImpl<PutConferencePreferenceCommandInput, PutConferencePreferenceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutConferencePreferenceCommandInput): import("@smithy/smithy-client").CommandImpl<PutConferencePreferenceCommandInput, PutConferencePreferenceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutConferencePreferenceCommand extends PutConferencePreferenceCommand_base {
}
