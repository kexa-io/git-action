...
declare const PutRoomSkillParameterCommand_base: {
    new (input: PutRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<PutRoomSkillParameterCommandInput, PutRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutRoomSkillParameterCommandInput): import("@smithy/smithy-client").CommandImpl<PutRoomSkillParameterCommandInput, PutRoomSkillParameterCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutRoomSkillParameterCommand extends PutRoomSkillParameterCommand_base {
}
