...
declare const GetSkillGroupCommand_base: {
    new (input: GetSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetSkillGroupCommandInput, GetSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetSkillGroupCommandInput]): import("@smithy/smithy-client").CommandImpl<GetSkillGroupCommandInput, GetSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetSkillGroupCommand extends GetSkillGroupCommand_base {
}
