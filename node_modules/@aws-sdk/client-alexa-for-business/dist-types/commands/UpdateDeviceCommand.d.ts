...
declare const UpdateDeviceCommand_base: {
    new (input: UpdateDeviceCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDeviceCommandInput, UpdateDeviceCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
