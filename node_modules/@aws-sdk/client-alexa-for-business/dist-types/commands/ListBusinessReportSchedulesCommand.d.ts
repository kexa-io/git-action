 ...
 */
export interface ListBusinessReportSchedulesCommandOutput extends ListBusinessReportSchedulesResponse, __MetadataBearer {
}
declare const ListBusinessReportSchedulesCommand_base: {
    new (input: ListBusinessReportSchedulesCommandInput): import("@smithy/smithy-client").CommandImpl<ListBusinessReportSchedulesCommandInput, ListBusinessReportSchedulesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListBusinessReportSchedulesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListBusinessReportSchedulesCommandInput, ListBusinessReportSchedulesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListBusinessReportSchedulesCommand extends ListBusinessReportSchedulesCommand_base {
}
