...
declare const DeleteConferenceProviderCommand_base: {
    new (input: DeleteConferenceProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConferenceProviderCommandInput, DeleteConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteConferenceProviderCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteConferenceProviderCommandInput, DeleteConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteConferenceProviderCommand extends DeleteConferenceProviderCommand_base {
}
