 ...
 */
export interface UpdateBusinessReportScheduleCommandOutput extends UpdateBusinessReportScheduleResponse, __MetadataBearer {
}
declare const UpdateBusinessReportScheduleCommand_base: {
    new (input: UpdateBusinessReportScheduleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBusinessReportScheduleCommandInput, UpdateBusinessReportScheduleCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateBusinessReportScheduleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateBusinessReportScheduleCommandInput, UpdateBusinessReportScheduleCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateBusinessReportScheduleCommand extends UpdateBusinessReportScheduleCommand_base {
}
