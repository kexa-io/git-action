...
declare const AssociateSkillWithUsersCommand_base: {
    new (input: AssociateSkillWithUsersCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSkillWithUsersCommandInput, AssociateSkillWithUsersCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateSkillWithUsersCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateSkillWithUsersCommandInput, AssociateSkillWithUsersCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateSkillWithUsersCommand extends AssociateSkillWithUsersCommand_base {
}
