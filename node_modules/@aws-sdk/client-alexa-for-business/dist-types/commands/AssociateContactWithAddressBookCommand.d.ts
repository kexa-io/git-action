...
declare const AssociateContactWithAddressBookCommand_base: {
    new (input: AssociateContactWithAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateContactWithAddressBookCommandInput, AssociateContactWithAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class AssociateContactWithAddressBookCommand extends AssociateContactWithAddressBookCommand_base {
}
