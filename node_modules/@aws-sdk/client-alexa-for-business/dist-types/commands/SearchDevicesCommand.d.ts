...
declare const SearchDevicesCommand_base: {
    new (input: SearchDevicesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchDevicesCommandInput, SearchDevicesCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
