...
declare const UpdateNetworkProfileCommand_base: {
    new (input: UpdateNetworkProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateNetworkProfileCommandInput, UpdateNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateNetworkProfileCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateNetworkProfileCommandInput, UpdateNetworkProfileCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
