...
declare const CreateConferenceProviderCommand_base: {
    new (input: CreateConferenceProviderCommandInput): import("@smithy/smithy-client").CommandImpl<CreateConferenceProviderCommandInput, CreateConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateConferenceProviderCommandInput): import("@smithy/smithy-client").CommandImpl<CreateConferenceProviderCommandInput, CreateConferenceProviderCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateConferenceProviderCommand extends CreateConferenceProviderCommand_base {
}
