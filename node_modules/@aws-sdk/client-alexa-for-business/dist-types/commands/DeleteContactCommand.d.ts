...
declare const DeleteContactCommand_base: {
    new (input: DeleteContactCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteContactCommandInput, DeleteContactCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
