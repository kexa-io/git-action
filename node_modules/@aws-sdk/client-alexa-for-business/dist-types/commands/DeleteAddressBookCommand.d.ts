...
declare const DeleteAddressBookCommand_base: {
    new (input: DeleteAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAddressBookCommandInput, DeleteAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAddressBookCommandInput, DeleteAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAddressBookCommand extends DeleteAddressBookCommand_base {
}
