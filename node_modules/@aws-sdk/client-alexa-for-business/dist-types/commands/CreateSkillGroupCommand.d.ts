...
declare const CreateSkillGroupCommand_base: {
    new (input: CreateSkillGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSkillGroupCommandInput, CreateSkillGroupCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class CreateSkillGroupCommand extends CreateSkillGroupCommand_base {
}
