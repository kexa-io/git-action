...
declare const CreateAddressBookCommand_base: {
    new (input: CreateAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAddressBookCommandInput, CreateAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateAddressBookCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAddressBookCommandInput, CreateAddressBookCommandOutput, AlexaForBusinessClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateAddressBookCommand extends CreateAddressBookCommand_base {
}
