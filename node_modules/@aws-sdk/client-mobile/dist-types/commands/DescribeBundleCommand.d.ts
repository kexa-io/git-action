...
declare const DescribeBundleCommand_base: {
    new (input: DescribeBundleCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeBundleCommandInput, DescribeBundleCommandOutput, MobileClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeBundleCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeBundleCommandInput, DescribeBundleCommandOutput, MobileClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeBundleCommand extends DescribeBundleCommand_base {
}
