...
declare const ListBundlesCommand_base: {
    new (input: ListBundlesCommandInput): import("@smithy/smithy-client").CommandImpl<ListBundlesCommandInput, ListBundlesCommandOutput, MobileClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListBundlesCommandInput]): import("@smithy/smithy-client").CommandImpl<ListBundlesCommandInput, ListBundlesCommandOutput, MobileClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListBundlesCommand extends ListBundlesCommand_base {
}
