...
declare const ListProjectsCommand_base: {
    new (input: ListProjectsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProjectsCommandInput, ListProjectsCommandOutput, MobileClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
