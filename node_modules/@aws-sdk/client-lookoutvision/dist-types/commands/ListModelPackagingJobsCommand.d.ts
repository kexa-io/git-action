...
declare const ListModelPackagingJobsCommand_base: {
    new (input: ListModelPackagingJobsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelPackagingJobsCommandInput, ListModelPackagingJobsCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListModelPackagingJobsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelPackagingJobsCommandInput, ListModelPackagingJobsCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListModelPackagingJobsCommand extends ListModelPackagingJobsCommand_base {
}
