...
declare const DescribeModelCommand_base: {
    new (input: DescribeModelCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeModelCommandInput, DescribeModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeModelCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeModelCommandInput, DescribeModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
