...
declare const StartModelPackagingJobCommand_base: {
    new (input: StartModelPackagingJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartModelPackagingJobCommandInput, StartModelPackagingJobCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartModelPackagingJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartModelPackagingJobCommandInput, StartModelPackagingJobCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartModelPackagingJobCommand extends StartModelPackagingJobCommand_base {
}
