...
declare const ListDatasetEntriesCommand_base: {
    new (input: ListDatasetEntriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDatasetEntriesCommandInput, ListDatasetEntriesCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListDatasetEntriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDatasetEntriesCommandInput, ListDatasetEntriesCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
