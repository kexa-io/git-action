...
declare const CreateModelCommand_base: {
    new (input: CreateModelCommandInput): import("@smithy/smithy-client").CommandImpl<CreateModelCommandInput, CreateModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateModelCommandInput): import("@smithy/smithy-client").CommandImpl<CreateModelCommandInput, CreateModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
