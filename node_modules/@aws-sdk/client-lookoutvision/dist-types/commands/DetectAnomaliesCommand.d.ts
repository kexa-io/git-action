...
declare const DetectAnomaliesCommand_base: {
    new (input: DetectAnomaliesCommandInput): import("@smithy/smithy-client").CommandImpl<DetectAnomaliesCommandInput, DetectAnomaliesCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DetectAnomaliesCommandInput): import("@smithy/smithy-client").CommandImpl<DetectAnomaliesCommandInput, DetectAnomaliesCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DetectAnomaliesCommand extends DetectAnomaliesCommand_base {
}
