...
declare const ListModelsCommand_base: {
    new (input: ListModelsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelsCommandInput, ListModelsCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListModelsCommandInput): import("@smithy/smithy-client").CommandImpl<ListModelsCommandInput, ListModelsCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
