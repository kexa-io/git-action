...
declare const StartModelCommand_base: {
    new (input: StartModelCommandInput): import("@smithy/smithy-client").CommandImpl<StartModelCommandInput, StartModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartModelCommandInput): import("@smithy/smithy-client").CommandImpl<StartModelCommandInput, StartModelCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartModelCommand extends StartModelCommand_base {
}
