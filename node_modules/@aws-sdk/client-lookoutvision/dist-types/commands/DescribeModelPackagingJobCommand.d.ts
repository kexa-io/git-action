...
declare const DescribeModelPackagingJobCommand_base: {
    new (input: DescribeModelPackagingJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeModelPackagingJobCommandInput, DescribeModelPackagingJobCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeModelPackagingJobCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeModelPackagingJobCommandInput, DescribeModelPackagingJobCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeModelPackagingJobCommand extends DescribeModelPackagingJobCommand_base {
}
