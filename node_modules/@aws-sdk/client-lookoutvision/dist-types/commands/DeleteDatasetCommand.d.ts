...
declare const DeleteDatasetCommand_base: {
    new (input: DeleteDatasetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDatasetCommandInput, DeleteDatasetCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDatasetCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDatasetCommandInput, DeleteDatasetCommandOutput, LookoutVisionClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
