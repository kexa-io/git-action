...
const a = true, b = "isSet", c = "booleanEquals", d = "error", e = "endpoint", f = "tree", g = "PartitionResult", h = "stringEquals", i = "us-gov-east-1", j = "us-gov-west-1", k = "sigv4", l = "greengrass", m = { [y]: false, "type": "String" }, n = { [y]: true, "default": false, "type": "Boolean" }, o = { [B]: "Endpoint" }, p = { [z]: c, [A]: [{ [B]: "UseFIPS" }, true] }, q = { [z]: c, [A]: [{ [B]: "UseDualStack" }, true] }, r = {}, s = { [B]: "Region" }, t = { [z]: "getAttr", [A]: [{ [B]: g }, "supportsFIPS"] }, u = { [z]: c, [A]: [true, { [z]: "getAttr", [A]: [{ [B]: g }, "supportsDualStack"] }] }, v = [p], w = [q], x = [s];
