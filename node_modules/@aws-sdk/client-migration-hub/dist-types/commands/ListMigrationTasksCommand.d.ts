...
declare const ListMigrationTasksCommand_base: {
    new (input: ListMigrationTasksCommandInput): import("@smithy/smithy-client").CommandImpl<ListMigrationTasksCommandInput, ListMigrationTasksCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
