...
declare const ListCreatedArtifactsCommand_base: {
    new (input: ListCreatedArtifactsCommandInput): import("@smithy/smithy-client").CommandImpl<ListCreatedArtifactsCommandInput, ListCreatedArtifactsCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListCreatedArtifactsCommandInput): import("@smithy/smithy-client").CommandImpl<ListCreatedArtifactsCommandInput, ListCreatedArtifactsCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
