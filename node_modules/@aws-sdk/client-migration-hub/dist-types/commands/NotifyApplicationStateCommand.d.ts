...
declare const NotifyApplicationStateCommand_base: {
    new (input: NotifyApplicationStateCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyApplicationStateCommandInput, NotifyApplicationStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: NotifyApplicationStateCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyApplicationStateCommandInput, NotifyApplicationStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
