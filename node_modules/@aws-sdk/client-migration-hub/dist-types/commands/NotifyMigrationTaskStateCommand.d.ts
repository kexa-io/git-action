...
declare const NotifyMigrationTaskStateCommand_base: {
    new (input: NotifyMigrationTaskStateCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyMigrationTaskStateCommandInput, NotifyMigrationTaskStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: NotifyMigrationTaskStateCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyMigrationTaskStateCommandInput, NotifyMigrationTaskStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
