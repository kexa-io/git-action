...
declare const ListProgressUpdateStreamsCommand_base: {
    new (input: ListProgressUpdateStreamsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProgressUpdateStreamsCommandInput, ListProgressUpdateStreamsCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
