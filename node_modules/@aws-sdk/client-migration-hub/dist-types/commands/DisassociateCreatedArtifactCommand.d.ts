...
declare const DisassociateCreatedArtifactCommand_base: {
    new (input: DisassociateCreatedArtifactCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateCreatedArtifactCommandInput, DisassociateCreatedArtifactCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateCreatedArtifactCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateCreatedArtifactCommandInput, DisassociateCreatedArtifactCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
