...
declare const CreateProgressUpdateStreamCommand_base: {
    new (input: CreateProgressUpdateStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CreateProgressUpdateStreamCommandInput, CreateProgressUpdateStreamCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateProgressUpdateStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CreateProgressUpdateStreamCommandInput, CreateProgressUpdateStreamCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
