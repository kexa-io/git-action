...
declare const ListDiscoveredResourcesCommand_base: {
    new (input: ListDiscoveredResourcesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDiscoveredResourcesCommandInput, ListDiscoveredResourcesCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListDiscoveredResourcesCommandInput): import("@smithy/smithy-client").CommandImpl<ListDiscoveredResourcesCommandInput, ListDiscoveredResourcesCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
