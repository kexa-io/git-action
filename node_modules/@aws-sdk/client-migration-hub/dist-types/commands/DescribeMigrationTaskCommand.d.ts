...
declare const DescribeMigrationTaskCommand_base: {
    new (input: DescribeMigrationTaskCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeMigrationTaskCommandInput, DescribeMigrationTaskCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeMigrationTaskCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeMigrationTaskCommandInput, DescribeMigrationTaskCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
