...
declare const ImportMigrationTaskCommand_base: {
    new (input: ImportMigrationTaskCommandInput): import("@smithy/smithy-client").CommandImpl<ImportMigrationTaskCommandInput, ImportMigrationTaskCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ImportMigrationTaskCommandInput): import("@smithy/smithy-client").CommandImpl<ImportMigrationTaskCommandInput, ImportMigrationTaskCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
