...
declare const DescribeApplicationStateCommand_base: {
    new (input: DescribeApplicationStateCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeApplicationStateCommandInput, DescribeApplicationStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeApplicationStateCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeApplicationStateCommandInput, DescribeApplicationStateCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
