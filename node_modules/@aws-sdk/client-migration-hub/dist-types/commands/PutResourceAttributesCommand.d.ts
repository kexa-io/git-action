...
declare const PutResourceAttributesCommand_base: {
    new (input: PutResourceAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<PutResourceAttributesCommandInput, PutResourceAttributesCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutResourceAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<PutResourceAttributesCommandInput, PutResourceAttributesCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
