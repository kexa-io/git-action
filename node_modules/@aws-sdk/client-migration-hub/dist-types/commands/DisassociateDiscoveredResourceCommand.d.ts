...
declare const DisassociateDiscoveredResourceCommand_base: {
    new (input: DisassociateDiscoveredResourceCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateDiscoveredResourceCommandInput, DisassociateDiscoveredResourceCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateDiscoveredResourceCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateDiscoveredResourceCommandInput, DisassociateDiscoveredResourceCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
