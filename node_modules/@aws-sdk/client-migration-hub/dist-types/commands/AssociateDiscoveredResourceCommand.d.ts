...
declare const AssociateDiscoveredResourceCommand_base: {
    new (input: AssociateDiscoveredResourceCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDiscoveredResourceCommandInput, AssociateDiscoveredResourceCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateDiscoveredResourceCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateDiscoveredResourceCommandInput, AssociateDiscoveredResourceCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
