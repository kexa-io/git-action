...
declare const AssociateCreatedArtifactCommand_base: {
    new (input: AssociateCreatedArtifactCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateCreatedArtifactCommandInput, AssociateCreatedArtifactCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateCreatedArtifactCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateCreatedArtifactCommandInput, AssociateCreatedArtifactCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
