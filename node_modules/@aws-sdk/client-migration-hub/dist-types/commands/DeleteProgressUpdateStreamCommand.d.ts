...
declare const DeleteProgressUpdateStreamCommand_base: {
    new (input: DeleteProgressUpdateStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProgressUpdateStreamCommandInput, DeleteProgressUpdateStreamCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteProgressUpdateStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProgressUpdateStreamCommandInput, DeleteProgressUpdateStreamCommandOutput, MigrationHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
