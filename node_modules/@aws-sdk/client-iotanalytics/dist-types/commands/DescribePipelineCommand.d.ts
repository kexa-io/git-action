...
declare const DescribePipelineCommand_base: {
    new (input: DescribePipelineCommandInput): import("@smithy/smithy-client").CommandImpl<DescribePipelineCommandInput, DescribePipelineCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribePipelineCommandInput): import("@smithy/smithy-client").CommandImpl<DescribePipelineCommandInput, DescribePipelineCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
