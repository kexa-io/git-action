...
declare const RunPipelineActivityCommand_base: {
    new (input: RunPipelineActivityCommandInput): import("@smithy/smithy-client").CommandImpl<RunPipelineActivityCommandInput, RunPipelineActivityCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RunPipelineActivityCommandInput): import("@smithy/smithy-client").CommandImpl<RunPipelineActivityCommandInput, RunPipelineActivityCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RunPipelineActivityCommand extends RunPipelineActivityCommand_base {
}
