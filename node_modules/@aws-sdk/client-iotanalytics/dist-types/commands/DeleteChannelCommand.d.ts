...
declare const DeleteChannelCommand_base: {
    new (input: DeleteChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelCommandInput, DeleteChannelCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelCommandInput, DeleteChannelCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
