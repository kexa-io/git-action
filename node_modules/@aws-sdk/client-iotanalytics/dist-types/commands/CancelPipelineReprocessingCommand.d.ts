...
declare const CancelPipelineReprocessingCommand_base: {
    new (input: CancelPipelineReprocessingCommandInput): import("@smithy/smithy-client").CommandImpl<CancelPipelineReprocessingCommandInput, CancelPipelineReprocessingCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelPipelineReprocessingCommandInput): import("@smithy/smithy-client").CommandImpl<CancelPipelineReprocessingCommandInput, CancelPipelineReprocessingCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelPipelineReprocessingCommand extends CancelPipelineReprocessingCommand_base {
}
