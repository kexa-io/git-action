...
declare const UpdateDatastoreCommand_base: {
    new (input: UpdateDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDatastoreCommandInput, UpdateDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDatastoreCommandInput, UpdateDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateDatastoreCommand extends UpdateDatastoreCommand_base {
}
