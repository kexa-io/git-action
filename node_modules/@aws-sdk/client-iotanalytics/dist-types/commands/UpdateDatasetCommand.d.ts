...
declare const UpdateDatasetCommand_base: {
    new (input: UpdateDatasetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDatasetCommandInput, UpdateDatasetCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateDatasetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateDatasetCommandInput, UpdateDatasetCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
