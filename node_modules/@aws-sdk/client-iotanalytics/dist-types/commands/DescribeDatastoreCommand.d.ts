...
declare const DescribeDatastoreCommand_base: {
    new (input: DescribeDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDatastoreCommandInput, DescribeDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeDatastoreCommandInput, DescribeDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeDatastoreCommand extends DescribeDatastoreCommand_base {
}
