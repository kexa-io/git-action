...
declare const CreateDatasetContentCommand_base: {
    new (input: CreateDatasetContentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDatasetContentCommandInput, CreateDatasetContentCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDatasetContentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDatasetContentCommandInput, CreateDatasetContentCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateDatasetContentCommand extends CreateDatasetContentCommand_base {
}
