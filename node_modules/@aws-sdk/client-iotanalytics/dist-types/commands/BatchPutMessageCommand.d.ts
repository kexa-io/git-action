...
declare const BatchPutMessageCommand_base: {
    new (input: BatchPutMessageCommandInput): import("@smithy/smithy-client").CommandImpl<BatchPutMessageCommandInput, BatchPutMessageCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchPutMessageCommandInput): import("@smithy/smithy-client").CommandImpl<BatchPutMessageCommandInput, BatchPutMessageCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
