...
declare const CreateDatastoreCommand_base: {
    new (input: CreateDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDatastoreCommandInput, CreateDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<CreateDatastoreCommandInput, CreateDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
