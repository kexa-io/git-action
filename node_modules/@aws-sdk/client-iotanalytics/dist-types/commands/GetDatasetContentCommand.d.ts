...
declare const GetDatasetContentCommand_base: {
    new (input: GetDatasetContentCommandInput): import("@smithy/smithy-client").CommandImpl<GetDatasetContentCommandInput, GetDatasetContentCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDatasetContentCommandInput): import("@smithy/smithy-client").CommandImpl<GetDatasetContentCommandInput, GetDatasetContentCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDatasetContentCommand extends GetDatasetContentCommand_base {
}
