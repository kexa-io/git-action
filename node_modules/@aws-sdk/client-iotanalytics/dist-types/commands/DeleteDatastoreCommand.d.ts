...
declare const DeleteDatastoreCommand_base: {
    new (input: DeleteDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDatastoreCommandInput, DeleteDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteDatastoreCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteDatastoreCommandInput, DeleteDatastoreCommandOutput, IoTAnalyticsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
