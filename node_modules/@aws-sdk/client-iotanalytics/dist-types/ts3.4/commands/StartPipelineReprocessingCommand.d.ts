...
export interface StartPipelineReprocessingCommandInput
  extends StartPipelineReprocessingRequest {}
export interface StartPipelineReprocessingCommandOutput
  extends StartPipelineReprocessingResponse,
    __MetadataBearer {}
declare const StartPipelineReprocessingCommand_base: {
  ...
  >;
  new (
    __0_0: StartPipelineReprocessingCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    StartPipelineReprocessingCommandInput,
    StartPipelineReprocessingCommandOutput,
    IoTAnalyticsClientResolvedConfig,
