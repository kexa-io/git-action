...
const a = false, b = true, c = "isSet", d = "booleanEquals", e = "error", f = "endpoint", g = "tree", h = "PartitionResult", i = { [x]: false, "type": "String" }, j = { [x]: true, "default": false, "type": "Boolean" }, k = { [A]: "Endpoint" }, l = { [y]: d, [z]: [{ [A]: "UseFIPS" }, true] }, m = { [A]: "UseFIPS" }, n = { [y]: d, [z]: [{ [A]: "UseDualStack" }, true] }, o = {}, p = { [y]: "stringEquals", [z]: [{ [y]: "getAttr", [z]: [{ [A]: h }, "name"] }, "aws"] }, q = { [y]: d, [z]: [{ [A]: "UseDualStack" }, false] }, r = { "authSchemes": [{ "name": "sigv4", "signingName": "waf", "signingRegion": "us-east-1" }] }, s = { [y]: "getAttr", [z]: [{ [A]: h }, "supportsFIPS"] }, t = { [y]: d, [z]: [true, { [y]: "getAttr", [z]: [{ [A]: h }, "supportsDualStack"] }] }, u = [l], v = [n], w = [{ [A]: "Region" }];
