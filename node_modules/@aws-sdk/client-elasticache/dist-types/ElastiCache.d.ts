...
export interface ElastiCache {
     ...
     */
    copyServerlessCacheSnapshot(args: CopyServerlessCacheSnapshotCommandInput, options?: __HttpHandlerOptions): Promise<CopyServerlessCacheSnapshotCommandOutput>;
    copyServerlessCacheSnapshot(args: CopyServerlessCacheSnapshotCommandInput, cb: (err: any, data?: CopyServerlessCacheSnapshotCommandOutput) => void): void;
    copyServerlessCacheSnapshot(args: CopyServerlessCacheSnapshotCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CopyServerlessCacheSnapshotCommandOutput) => void): void;
    /**
     ...
     */
    createServerlessCache(args: CreateServerlessCacheCommandInput, options?: __HttpHandlerOptions): Promise<CreateServerlessCacheCommandOutput>;
    createServerlessCache(args: CreateServerlessCacheCommandInput, cb: (err: any, data?: CreateServerlessCacheCommandOutput) => void): void;
    createServerlessCache(args: CreateServerlessCacheCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateServerlessCacheCommandOutput) => void): void;
    /**
     * @see {@link CreateServerlessCacheSnapshotCommand}
     */
    createServerlessCacheSnapshot(args: CreateServerlessCacheSnapshotCommandInput, options?: __HttpHandlerOptions): Promise<CreateServerlessCacheSnapshotCommandOutput>;
    createServerlessCacheSnapshot(args: CreateServerlessCacheSnapshotCommandInput, cb: (err: any, data?: CreateServerlessCacheSnapshotCommandOutput) => void): void;
    createServerlessCacheSnapshot(args: CreateServerlessCacheSnapshotCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateServerlessCacheSnapshotCommandOutput) => void): void;
    /**
     ...
     */
    deleteServerlessCache(args: DeleteServerlessCacheCommandInput, options?: __HttpHandlerOptions): Promise<DeleteServerlessCacheCommandOutput>;
    deleteServerlessCache(args: DeleteServerlessCacheCommandInput, cb: (err: any, data?: DeleteServerlessCacheCommandOutput) => void): void;
    deleteServerlessCache(args: DeleteServerlessCacheCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteServerlessCacheCommandOutput) => void): void;
    /**
     * @see {@link DeleteServerlessCacheSnapshotCommand}
     */
    deleteServerlessCacheSnapshot(args: DeleteServerlessCacheSnapshotCommandInput, options?: __HttpHandlerOptions): Promise<DeleteServerlessCacheSnapshotCommandOutput>;
    deleteServerlessCacheSnapshot(args: DeleteServerlessCacheSnapshotCommandInput, cb: (err: any, data?: DeleteServerlessCacheSnapshotCommandOutput) => void): void;
    deleteServerlessCacheSnapshot(args: DeleteServerlessCacheSnapshotCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteServerlessCacheSnapshotCommandOutput) => void): void;
    /**
     ...
     */
    exportServerlessCacheSnapshot(args: ExportServerlessCacheSnapshotCommandInput, options?: __HttpHandlerOptions): Promise<ExportServerlessCacheSnapshotCommandOutput>;
    exportServerlessCacheSnapshot(args: ExportServerlessCacheSnapshotCommandInput, cb: (err: any, data?: ExportServerlessCacheSnapshotCommandOutput) => void): void;
    exportServerlessCacheSnapshot(args: ExportServerlessCacheSnapshotCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ExportServerlessCacheSnapshotCommandOutput) => void): void;
    /**
     ...
     */
    modifyServerlessCache(args: ModifyServerlessCacheCommandInput, options?: __HttpHandlerOptions): Promise<ModifyServerlessCacheCommandOutput>;
    modifyServerlessCache(args: ModifyServerlessCacheCommandInput, cb: (err: any, data?: ModifyServerlessCacheCommandOutput) => void): void;
    modifyServerlessCache(args: ModifyServerlessCacheCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ModifyServerlessCacheCommandOutput) => void): void;
    /**
