...
declare const ListVirtualRoutersCommand_base: {
    new (input: ListVirtualRoutersCommandInput): import("@smithy/smithy-client").CommandImpl<ListVirtualRoutersCommandInput, ListVirtualRoutersCommandOutput, AppMeshClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
