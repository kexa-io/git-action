...
declare const ListVirtualNodesCommand_base: {
    new (input: ListVirtualNodesCommandInput): import("@smithy/smithy-client").CommandImpl<ListVirtualNodesCommandInput, ListVirtualNodesCommandOutput, AppMeshClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListVirtualNodesCommandInput): import("@smithy/smithy-client").CommandImpl<ListVirtualNodesCommandInput, ListVirtualNodesCommandOutput, AppMeshClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
