...
declare const DescribeAcceleratorsCommand_base: {
    new (input: DescribeAcceleratorsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAcceleratorsCommandInput, DescribeAcceleratorsCommandOutput, ElasticInferenceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeAcceleratorsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeAcceleratorsCommandInput, DescribeAcceleratorsCommandOutput, ElasticInferenceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeAcceleratorsCommand extends DescribeAcceleratorsCommand_base {
}
