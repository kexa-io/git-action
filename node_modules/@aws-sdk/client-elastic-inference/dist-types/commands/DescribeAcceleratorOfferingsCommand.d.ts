...
declare const DescribeAcceleratorOfferingsCommand_base: {
    new (input: DescribeAcceleratorOfferingsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAcceleratorOfferingsCommandInput, DescribeAcceleratorOfferingsCommandOutput, ElasticInferenceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DescribeAcceleratorOfferingsCommand extends DescribeAcceleratorOfferingsCommand_base {
}
