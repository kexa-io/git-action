...
declare const DescribeAcceleratorTypesCommand_base: {
    new (input: DescribeAcceleratorTypesCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAcceleratorTypesCommandInput, DescribeAcceleratorTypesCommandOutput, ElasticInferenceClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DescribeAcceleratorTypesCommand extends DescribeAcceleratorTypesCommand_base {
}
