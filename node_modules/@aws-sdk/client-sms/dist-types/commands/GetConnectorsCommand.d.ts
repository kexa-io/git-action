...
declare const GetConnectorsCommand_base: {
    new (input: GetConnectorsCommandInput): import("@smithy/smithy-client").CommandImpl<GetConnectorsCommandInput, GetConnectorsCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetConnectorsCommandInput]): import("@smithy/smithy-client").CommandImpl<GetConnectorsCommandInput, GetConnectorsCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetConnectorsCommand extends GetConnectorsCommand_base {
}
