...
declare const UpdateAppCommand_base: {
    new (input: UpdateAppCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAppCommandInput, UpdateAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
