...
declare const GetServersCommand_base: {
    new (input: GetServersCommandInput): import("@smithy/smithy-client").CommandImpl<GetServersCommandInput, GetServersCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetServersCommandInput]): import("@smithy/smithy-client").CommandImpl<GetServersCommandInput, GetServersCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetServersCommand extends GetServersCommand_base {
}
