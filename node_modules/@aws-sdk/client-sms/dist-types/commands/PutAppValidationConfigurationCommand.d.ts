...
declare const PutAppValidationConfigurationCommand_base: {
    new (input: PutAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppValidationConfigurationCommandInput, PutAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppValidationConfigurationCommandInput, PutAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutAppValidationConfigurationCommand extends PutAppValidationConfigurationCommand_base {
}
