...
declare const DeleteAppCommand_base: {
    new (input: DeleteAppCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppCommandInput, DeleteAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
