...
declare const PutAppLaunchConfigurationCommand_base: {
    new (input: PutAppLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppLaunchConfigurationCommandInput, PutAppLaunchConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [PutAppLaunchConfigurationCommandInput]): import("@smithy/smithy-client").CommandImpl<PutAppLaunchConfigurationCommandInput, PutAppLaunchConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutAppLaunchConfigurationCommand extends PutAppLaunchConfigurationCommand_base {
}
