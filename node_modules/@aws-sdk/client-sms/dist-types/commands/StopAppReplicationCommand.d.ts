...
declare const StopAppReplicationCommand_base: {
    new (input: StopAppReplicationCommandInput): import("@smithy/smithy-client").CommandImpl<StopAppReplicationCommandInput, StopAppReplicationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [StopAppReplicationCommandInput]): import("@smithy/smithy-client").CommandImpl<StopAppReplicationCommandInput, StopAppReplicationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopAppReplicationCommand extends StopAppReplicationCommand_base {
}
