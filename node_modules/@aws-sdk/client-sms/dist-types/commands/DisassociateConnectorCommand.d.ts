...
declare const DisassociateConnectorCommand_base: {
    new (input: DisassociateConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateConnectorCommandInput, DisassociateConnectorCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateConnectorCommandInput, DisassociateConnectorCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateConnectorCommand extends DisassociateConnectorCommand_base {
}
