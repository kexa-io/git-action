...
declare const UpdateReplicationJobCommand_base: {
    new (input: UpdateReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateReplicationJobCommandInput, UpdateReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateReplicationJobCommandInput, UpdateReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateReplicationJobCommand extends UpdateReplicationJobCommand_base {
}
