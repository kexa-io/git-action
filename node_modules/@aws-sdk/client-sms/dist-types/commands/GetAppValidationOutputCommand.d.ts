...
declare const GetAppValidationOutputCommand_base: {
    new (input: GetAppValidationOutputCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppValidationOutputCommandInput, GetAppValidationOutputCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAppValidationOutputCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppValidationOutputCommandInput, GetAppValidationOutputCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetAppValidationOutputCommand extends GetAppValidationOutputCommand_base {
}
