...
declare const DeleteAppValidationConfigurationCommand_base: {
    new (input: DeleteAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppValidationConfigurationCommandInput, DeleteAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppValidationConfigurationCommandInput, DeleteAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAppValidationConfigurationCommand extends DeleteAppValidationConfigurationCommand_base {
}
