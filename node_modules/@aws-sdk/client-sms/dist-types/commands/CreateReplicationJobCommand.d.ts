...
declare const CreateReplicationJobCommand_base: {
    new (input: CreateReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateReplicationJobCommandInput, CreateReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateReplicationJobCommandInput, CreateReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateReplicationJobCommand extends CreateReplicationJobCommand_base {
}
