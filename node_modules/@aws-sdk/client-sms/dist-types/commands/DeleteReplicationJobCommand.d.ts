...
declare const DeleteReplicationJobCommand_base: {
    new (input: DeleteReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteReplicationJobCommandInput, DeleteReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteReplicationJobCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteReplicationJobCommandInput, DeleteReplicationJobCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteReplicationJobCommand extends DeleteReplicationJobCommand_base {
}
