...
declare const NotifyAppValidationOutputCommand_base: {
    new (input: NotifyAppValidationOutputCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyAppValidationOutputCommandInput, NotifyAppValidationOutputCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: NotifyAppValidationOutputCommandInput): import("@smithy/smithy-client").CommandImpl<NotifyAppValidationOutputCommandInput, NotifyAppValidationOutputCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class NotifyAppValidationOutputCommand extends NotifyAppValidationOutputCommand_base {
}
