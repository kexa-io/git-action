...
declare const CreateAppCommand_base: {
    new (input: CreateAppCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAppCommandInput, CreateAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
