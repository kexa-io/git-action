...
declare const GetAppLaunchConfigurationCommand_base: {
    new (input: GetAppLaunchConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppLaunchConfigurationCommandInput, GetAppLaunchConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetAppLaunchConfigurationCommandInput]): import("@smithy/smithy-client").CommandImpl<GetAppLaunchConfigurationCommandInput, GetAppLaunchConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetAppLaunchConfigurationCommand extends GetAppLaunchConfigurationCommand_base {
}
