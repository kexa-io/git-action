...
declare const LaunchAppCommand_base: {
    new (input: LaunchAppCommandInput): import("@smithy/smithy-client").CommandImpl<LaunchAppCommandInput, LaunchAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [LaunchAppCommandInput]): import("@smithy/smithy-client").CommandImpl<LaunchAppCommandInput, LaunchAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class LaunchAppCommand extends LaunchAppCommand_base {
}
