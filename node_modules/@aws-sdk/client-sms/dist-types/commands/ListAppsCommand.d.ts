...
declare const ListAppsCommand_base: {
    new (input: ListAppsCommandInput): import("@smithy/smithy-client").CommandImpl<ListAppsCommandInput, ListAppsCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
