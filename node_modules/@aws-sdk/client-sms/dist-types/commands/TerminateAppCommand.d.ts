...
declare const TerminateAppCommand_base: {
    new (input: TerminateAppCommandInput): import("@smithy/smithy-client").CommandImpl<TerminateAppCommandInput, TerminateAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [TerminateAppCommandInput]): import("@smithy/smithy-client").CommandImpl<TerminateAppCommandInput, TerminateAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TerminateAppCommand extends TerminateAppCommand_base {
}
