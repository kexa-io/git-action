...
declare const GetReplicationRunsCommand_base: {
    new (input: GetReplicationRunsCommandInput): import("@smithy/smithy-client").CommandImpl<GetReplicationRunsCommandInput, GetReplicationRunsCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetReplicationRunsCommandInput): import("@smithy/smithy-client").CommandImpl<GetReplicationRunsCommandInput, GetReplicationRunsCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetReplicationRunsCommand extends GetReplicationRunsCommand_base {
}
