...
declare const GetAppCommand_base: {
    new (input: GetAppCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppCommandInput, GetAppCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
