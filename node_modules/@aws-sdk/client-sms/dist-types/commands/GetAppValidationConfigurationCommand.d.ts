...
declare const GetAppValidationConfigurationCommand_base: {
    new (input: GetAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppValidationConfigurationCommandInput, GetAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAppValidationConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppValidationConfigurationCommandInput, GetAppValidationConfigurationCommandOutput, SMSClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetAppValidationConfigurationCommand extends GetAppValidationConfigurationCommand_base {
}
