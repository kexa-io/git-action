...
export interface FSx {
     ...
     */
    startMisconfiguredStateRecovery(args: StartMisconfiguredStateRecoveryCommandInput, options?: __HttpHandlerOptions): Promise<StartMisconfiguredStateRecoveryCommandOutput>;
    startMisconfiguredStateRecovery(args: StartMisconfiguredStateRecoveryCommandInput, cb: (err: any, data?: StartMisconfiguredStateRecoveryCommandOutput) => void): void;
    startMisconfiguredStateRecovery(args: StartMisconfiguredStateRecoveryCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartMisconfiguredStateRecoveryCommandOutput) => void): void;
    /**
