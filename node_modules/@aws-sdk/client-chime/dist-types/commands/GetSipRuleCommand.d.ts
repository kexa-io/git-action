...
declare const GetSipRuleCommand_base: {
    new (input: GetSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<GetSipRuleCommandInput, GetSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<GetSipRuleCommandInput, GetSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
