...
declare const CreateSipMediaApplicationCommand_base: {
    new (input: CreateSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipMediaApplicationCommandInput, CreateSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipMediaApplicationCommandInput, CreateSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
