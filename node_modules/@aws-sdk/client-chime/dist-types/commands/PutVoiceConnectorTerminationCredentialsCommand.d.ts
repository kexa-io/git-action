...
declare const PutVoiceConnectorTerminationCredentialsCommand_base: {
    new (input: PutVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorTerminationCredentialsCommandInput, PutVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorTerminationCredentialsCommandInput, PutVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
