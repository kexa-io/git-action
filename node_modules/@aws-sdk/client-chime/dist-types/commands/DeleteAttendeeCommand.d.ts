...
declare const DeleteAttendeeCommand_base: {
    new (input: DeleteAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAttendeeCommandInput, DeleteAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAttendeeCommandInput, DeleteAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
