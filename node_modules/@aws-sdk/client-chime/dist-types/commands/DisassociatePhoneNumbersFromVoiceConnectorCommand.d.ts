...
declare const DisassociatePhoneNumbersFromVoiceConnectorCommand_base: {
    new (input: DisassociatePhoneNumbersFromVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociatePhoneNumbersFromVoiceConnectorCommandInput, DisassociatePhoneNumbersFromVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociatePhoneNumbersFromVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociatePhoneNumbersFromVoiceConnectorCommandInput, DisassociatePhoneNumbersFromVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
