...
declare const UpdateSipMediaApplicationCommand_base: {
    new (input: UpdateSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipMediaApplicationCommandInput, UpdateSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipMediaApplicationCommandInput, UpdateSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
