...
declare const PutVoiceConnectorTerminationCommand_base: {
    new (input: PutVoiceConnectorTerminationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorTerminationCommandInput, PutVoiceConnectorTerminationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorTerminationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorTerminationCommandInput, PutVoiceConnectorTerminationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
