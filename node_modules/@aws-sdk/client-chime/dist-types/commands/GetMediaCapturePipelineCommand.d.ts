...
declare const GetMediaCapturePipelineCommand_base: {
    new (input: GetMediaCapturePipelineCommandInput): import("@smithy/smithy-client").CommandImpl<GetMediaCapturePipelineCommandInput, GetMediaCapturePipelineCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
