...
declare const UntagAttendeeCommand_base: {
    new (input: UntagAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<UntagAttendeeCommandInput, UntagAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UntagAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<UntagAttendeeCommandInput, UntagAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UntagAttendeeCommand extends UntagAttendeeCommand_base {
}
