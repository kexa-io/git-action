...
declare const CreateAppInstanceAdminCommand_base: {
    new (input: CreateAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAppInstanceAdminCommandInput, CreateAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAppInstanceAdminCommandInput, CreateAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
