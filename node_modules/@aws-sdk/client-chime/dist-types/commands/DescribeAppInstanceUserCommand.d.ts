...
declare const DescribeAppInstanceUserCommand_base: {
    new (input: DescribeAppInstanceUserCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppInstanceUserCommandInput, DescribeAppInstanceUserCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
