...
declare const UpdateAccountCommand_base: {
    new (input: UpdateAccountCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccountCommandInput, UpdateAccountCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAccountCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAccountCommandInput, UpdateAccountCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
