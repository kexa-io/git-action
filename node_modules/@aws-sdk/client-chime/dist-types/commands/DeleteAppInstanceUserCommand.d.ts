...
declare const DeleteAppInstanceUserCommand_base: {
    new (input: DeleteAppInstanceUserCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceUserCommandInput, DeleteAppInstanceUserCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAppInstanceUserCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceUserCommandInput, DeleteAppInstanceUserCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
