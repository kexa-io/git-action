...
declare const RedactChannelMessageCommand_base: {
    new (input: RedactChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<RedactChannelMessageCommandInput, RedactChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RedactChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<RedactChannelMessageCommandInput, RedactChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
