...
declare const DeleteVoiceConnectorProxyCommand_base: {
    new (input: DeleteVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorProxyCommandInput, DeleteVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorProxyCommandInput, DeleteVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
