...
declare const CreateVoiceConnectorCommand_base: {
    new (input: CreateVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceConnectorCommandInput, CreateVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceConnectorCommandInput, CreateVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
