...
declare const DeleteChannelBanCommand_base: {
    new (input: DeleteChannelBanCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelBanCommandInput, DeleteChannelBanCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteChannelBanCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelBanCommandInput, DeleteChannelBanCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
