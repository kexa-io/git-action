...
declare const PutVoiceConnectorLoggingConfigurationCommand_base: {
    new (input: PutVoiceConnectorLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorLoggingConfigurationCommandInput, PutVoiceConnectorLoggingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorLoggingConfigurationCommandInput, PutVoiceConnectorLoggingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
