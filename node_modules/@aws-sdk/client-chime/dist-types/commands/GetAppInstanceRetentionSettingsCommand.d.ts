...
declare const GetAppInstanceRetentionSettingsCommand_base: {
    new (input: GetAppInstanceRetentionSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppInstanceRetentionSettingsCommandInput, GetAppInstanceRetentionSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAppInstanceRetentionSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppInstanceRetentionSettingsCommandInput, GetAppInstanceRetentionSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
