...
declare const UpdateChannelReadMarkerCommand_base: {
    new (input: UpdateChannelReadMarkerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateChannelReadMarkerCommandInput, UpdateChannelReadMarkerCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateChannelReadMarkerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateChannelReadMarkerCommandInput, UpdateChannelReadMarkerCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
