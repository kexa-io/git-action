...
declare const PutVoiceConnectorOriginationCommand_base: {
    new (input: PutVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorOriginationCommandInput, PutVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorOriginationCommandInput, PutVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
