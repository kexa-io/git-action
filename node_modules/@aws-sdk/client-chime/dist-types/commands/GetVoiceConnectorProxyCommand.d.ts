...
declare const GetVoiceConnectorProxyCommand_base: {
    new (input: GetVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorProxyCommandInput, GetVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorProxyCommandInput, GetVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
