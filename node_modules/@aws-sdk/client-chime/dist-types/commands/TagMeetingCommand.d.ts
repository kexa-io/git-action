...
declare const TagMeetingCommand_base: {
    new (input: TagMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<TagMeetingCommandInput, TagMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TagMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<TagMeetingCommandInput, TagMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TagMeetingCommand extends TagMeetingCommand_base {
}
