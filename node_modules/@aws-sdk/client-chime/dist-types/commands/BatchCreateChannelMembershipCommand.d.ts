...
declare const BatchCreateChannelMembershipCommand_base: {
    new (input: BatchCreateChannelMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateChannelMembershipCommandInput, BatchCreateChannelMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchCreateChannelMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateChannelMembershipCommandInput, BatchCreateChannelMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
