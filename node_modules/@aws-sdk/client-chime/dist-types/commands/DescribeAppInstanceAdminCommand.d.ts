...
declare const DescribeAppInstanceAdminCommand_base: {
    new (input: DescribeAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppInstanceAdminCommandInput, DescribeAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppInstanceAdminCommandInput, DescribeAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
