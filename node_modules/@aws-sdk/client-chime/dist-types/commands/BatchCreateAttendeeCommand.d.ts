...
declare const BatchCreateAttendeeCommand_base: {
    new (input: BatchCreateAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateAttendeeCommandInput, BatchCreateAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchCreateAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<BatchCreateAttendeeCommandInput, BatchCreateAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
