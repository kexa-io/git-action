...
declare const PutAppInstanceRetentionSettingsCommand_base: {
    new (input: PutAppInstanceRetentionSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppInstanceRetentionSettingsCommandInput, PutAppInstanceRetentionSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAppInstanceRetentionSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppInstanceRetentionSettingsCommandInput, PutAppInstanceRetentionSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
