...
declare const DeleteProxySessionCommand_base: {
    new (input: DeleteProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProxySessionCommandInput, DeleteProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteProxySessionCommandInput, DeleteProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
