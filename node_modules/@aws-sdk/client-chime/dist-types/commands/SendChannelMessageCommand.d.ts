...
declare const SendChannelMessageCommand_base: {
    new (input: SendChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendChannelMessageCommandInput, SendChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SendChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<SendChannelMessageCommandInput, SendChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
