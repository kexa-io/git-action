...
declare const UntagMeetingCommand_base: {
    new (input: UntagMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<UntagMeetingCommandInput, UntagMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UntagMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<UntagMeetingCommandInput, UntagMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UntagMeetingCommand extends UntagMeetingCommand_base {
}
