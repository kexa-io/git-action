...
declare const GetVoiceConnectorGroupCommand_base: {
    new (input: GetVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorGroupCommandInput, GetVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorGroupCommandInput, GetVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
