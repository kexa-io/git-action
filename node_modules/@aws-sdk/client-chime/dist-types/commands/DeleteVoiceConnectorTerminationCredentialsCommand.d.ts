...
declare const DeleteVoiceConnectorTerminationCredentialsCommand_base: {
    new (input: DeleteVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorTerminationCredentialsCommandInput, DeleteVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorTerminationCredentialsCommandInput, DeleteVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
