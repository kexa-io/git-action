...
declare const AssociatePhoneNumbersWithVoiceConnectorCommand_base: {
    new (input: AssociatePhoneNumbersWithVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<AssociatePhoneNumbersWithVoiceConnectorCommandInput, AssociatePhoneNumbersWithVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociatePhoneNumbersWithVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<AssociatePhoneNumbersWithVoiceConnectorCommandInput, AssociatePhoneNumbersWithVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
