...
declare const UpdateUserSettingsCommand_base: {
    new (input: UpdateUserSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserSettingsCommandInput, UpdateUserSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateUserSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateUserSettingsCommandInput, UpdateUserSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
