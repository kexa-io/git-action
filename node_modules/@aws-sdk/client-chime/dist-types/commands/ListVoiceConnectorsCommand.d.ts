...
declare const ListVoiceConnectorsCommand_base: {
    new (input: ListVoiceConnectorsCommandInput): import("@smithy/smithy-client").CommandImpl<ListVoiceConnectorsCommandInput, ListVoiceConnectorsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
