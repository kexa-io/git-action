...
declare const DeleteSipRuleCommand_base: {
    new (input: DeleteSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSipRuleCommandInput, DeleteSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSipRuleCommandInput, DeleteSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
