...
import { GetVoiceConnectorLoggingConfigurationRequest, GetVoiceConnectorLoggingConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetVoiceConnectorLoggingConfigurationCommand_base: {
    new (input: GetVoiceConnectorLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorLoggingConfigurationCommandInput, GetVoiceConnectorLoggingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceConnectorLoggingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorLoggingConfigurationCommandInput, GetVoiceConnectorLoggingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
