...
declare const PutVoiceConnectorEmergencyCallingConfigurationCommand_base: {
    new (input: PutVoiceConnectorEmergencyCallingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorEmergencyCallingConfigurationCommandInput, PutVoiceConnectorEmergencyCallingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorEmergencyCallingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorEmergencyCallingConfigurationCommandInput, PutVoiceConnectorEmergencyCallingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
