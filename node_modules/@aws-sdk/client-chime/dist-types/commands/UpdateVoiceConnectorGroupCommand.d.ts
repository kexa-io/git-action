...
declare const UpdateVoiceConnectorGroupCommand_base: {
    new (input: UpdateVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceConnectorGroupCommandInput, UpdateVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateVoiceConnectorGroupCommandInput, UpdateVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
