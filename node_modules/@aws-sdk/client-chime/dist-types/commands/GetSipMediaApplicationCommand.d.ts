...
declare const GetSipMediaApplicationCommand_base: {
    new (input: GetSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<GetSipMediaApplicationCommandInput, GetSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<GetSipMediaApplicationCommandInput, GetSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
