...
declare const DeleteVoiceConnectorGroupCommand_base: {
    new (input: DeleteVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorGroupCommandInput, DeleteVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorGroupCommandInput, DeleteVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
