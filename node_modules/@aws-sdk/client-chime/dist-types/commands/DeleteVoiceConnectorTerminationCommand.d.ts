...
declare const DeleteVoiceConnectorTerminationCommand_base: {
    new (input: DeleteVoiceConnectorTerminationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorTerminationCommandInput, DeleteVoiceConnectorTerminationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorTerminationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorTerminationCommandInput, DeleteVoiceConnectorTerminationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
