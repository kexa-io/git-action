...
declare const DeleteSipMediaApplicationCommand_base: {
    new (input: DeleteSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSipMediaApplicationCommandInput, DeleteSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteSipMediaApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSipMediaApplicationCommandInput, DeleteSipMediaApplicationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
