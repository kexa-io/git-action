...
declare const UpdateSipRuleCommand_base: {
    new (input: UpdateSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipRuleCommandInput, UpdateSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipRuleCommandInput, UpdateSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
