...
declare const UpdateChannelCommand_base: {
    new (input: UpdateChannelCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateChannelCommandInput, UpdateChannelCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
