...
declare const StartMeetingTranscriptionCommand_base: {
    new (input: StartMeetingTranscriptionCommandInput): import("@smithy/smithy-client").CommandImpl<StartMeetingTranscriptionCommandInput, StartMeetingTranscriptionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartMeetingTranscriptionCommandInput): import("@smithy/smithy-client").CommandImpl<StartMeetingTranscriptionCommandInput, StartMeetingTranscriptionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
