...
declare const CreateSipRuleCommand_base: {
    new (input: CreateSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipRuleCommandInput, CreateSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSipRuleCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipRuleCommandInput, CreateSipRuleCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
