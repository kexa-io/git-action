...
declare const GetVoiceConnectorOriginationCommand_base: {
    new (input: GetVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorOriginationCommandInput, GetVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorOriginationCommandInput, GetVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
