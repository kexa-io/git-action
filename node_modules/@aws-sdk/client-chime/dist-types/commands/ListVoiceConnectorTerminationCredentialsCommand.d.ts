...
declare const ListVoiceConnectorTerminationCredentialsCommand_base: {
    new (input: ListVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<ListVoiceConnectorTerminationCredentialsCommandInput, ListVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListVoiceConnectorTerminationCredentialsCommandInput): import("@smithy/smithy-client").CommandImpl<ListVoiceConnectorTerminationCredentialsCommandInput, ListVoiceConnectorTerminationCredentialsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
