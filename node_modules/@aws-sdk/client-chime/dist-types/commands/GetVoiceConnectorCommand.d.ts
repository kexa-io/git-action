...
declare const GetVoiceConnectorCommand_base: {
    new (input: GetVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorCommandInput, GetVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
