...
declare const PutAppInstanceStreamingConfigurationsCommand_base: {
    new (input: PutAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppInstanceStreamingConfigurationsCommandInput, PutAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutAppInstanceStreamingConfigurationsCommandInput, PutAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
