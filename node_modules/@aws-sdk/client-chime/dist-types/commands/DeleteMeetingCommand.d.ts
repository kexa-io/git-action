...
declare const DeleteMeetingCommand_base: {
    new (input: DeleteMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteMeetingCommandInput, DeleteMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteMeetingCommandInput, DeleteMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
