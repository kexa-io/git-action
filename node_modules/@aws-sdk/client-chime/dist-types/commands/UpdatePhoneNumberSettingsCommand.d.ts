...
declare const UpdatePhoneNumberSettingsCommand_base: {
    new (input: UpdatePhoneNumberSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePhoneNumberSettingsCommandInput, UpdatePhoneNumberSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdatePhoneNumberSettingsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePhoneNumberSettingsCommandInput, UpdatePhoneNumberSettingsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
