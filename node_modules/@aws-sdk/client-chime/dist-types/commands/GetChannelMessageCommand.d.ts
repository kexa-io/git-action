...
declare const GetChannelMessageCommand_base: {
    new (input: GetChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<GetChannelMessageCommandInput, GetChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<GetChannelMessageCommandInput, GetChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
