...
declare const DeleteAppInstanceAdminCommand_base: {
    new (input: DeleteAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceAdminCommandInput, DeleteAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAppInstanceAdminCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceAdminCommandInput, DeleteAppInstanceAdminCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
