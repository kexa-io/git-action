...
declare const GetProxySessionCommand_base: {
    new (input: GetProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<GetProxySessionCommandInput, GetProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<GetProxySessionCommandInput, GetProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
