...
declare const UpdateRoomCommand_base: {
    new (input: UpdateRoomCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRoomCommandInput, UpdateRoomCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRoomCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRoomCommandInput, UpdateRoomCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
