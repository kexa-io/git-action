...
declare const DeleteAppInstanceCommand_base: {
    new (input: DeleteAppInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceCommandInput, DeleteAppInstanceCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
