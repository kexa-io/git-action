...
declare const UpdateProxySessionCommand_base: {
    new (input: UpdateProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProxySessionCommandInput, UpdateProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateProxySessionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProxySessionCommandInput, UpdateProxySessionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *          <important>
 *             <p>
 *                <b>This API is is no longer supported and will not be updated.</b> We recommend using the latest version, <a href="https://docs.aws.amazon.com/chime-sdk/latest/APIReference/API_voice-chime_UpdateProxySession.html">UpdateProxySession</a>, in the Amazon Chime SDK.</p>
