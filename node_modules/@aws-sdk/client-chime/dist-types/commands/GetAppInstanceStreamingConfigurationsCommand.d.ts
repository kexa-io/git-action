...
import { GetAppInstanceStreamingConfigurationsRequest, GetAppInstanceStreamingConfigurationsResponse } from "../models/models_0";
/**
 * @public
 */
...
declare const GetAppInstanceStreamingConfigurationsCommand_base: {
    new (input: GetAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppInstanceStreamingConfigurationsCommandInput, GetAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<GetAppInstanceStreamingConfigurationsCommandInput, GetAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
