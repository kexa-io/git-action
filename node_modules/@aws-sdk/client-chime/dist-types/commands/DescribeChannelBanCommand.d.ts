...
declare const DescribeChannelBanCommand_base: {
    new (input: DescribeChannelBanCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeChannelBanCommandInput, DescribeChannelBanCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeChannelBanCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeChannelBanCommandInput, DescribeChannelBanCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
