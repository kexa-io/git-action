...
declare const UpdateSipMediaApplicationCallCommand_base: {
    new (input: UpdateSipMediaApplicationCallCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipMediaApplicationCallCommandInput, UpdateSipMediaApplicationCallCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateSipMediaApplicationCallCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateSipMediaApplicationCallCommandInput, UpdateSipMediaApplicationCallCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
