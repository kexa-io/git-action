...
declare const DeleteAppInstanceStreamingConfigurationsCommand_base: {
    new (input: DeleteAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceStreamingConfigurationsCommandInput, DeleteAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAppInstanceStreamingConfigurationsCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAppInstanceStreamingConfigurationsCommandInput, DeleteAppInstanceStreamingConfigurationsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAppInstanceStreamingConfigurationsCommand extends DeleteAppInstanceStreamingConfigurationsCommand_base {
}
