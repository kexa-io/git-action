...
declare const DeleteVoiceConnectorOriginationCommand_base: {
    new (input: DeleteVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorOriginationCommandInput, DeleteVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorOriginationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorOriginationCommandInput, DeleteVoiceConnectorOriginationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
