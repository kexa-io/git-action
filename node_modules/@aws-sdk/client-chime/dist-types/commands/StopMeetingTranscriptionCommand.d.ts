...
declare const StopMeetingTranscriptionCommand_base: {
    new (input: StopMeetingTranscriptionCommandInput): import("@smithy/smithy-client").CommandImpl<StopMeetingTranscriptionCommandInput, StopMeetingTranscriptionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopMeetingTranscriptionCommandInput): import("@smithy/smithy-client").CommandImpl<StopMeetingTranscriptionCommandInput, StopMeetingTranscriptionCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
