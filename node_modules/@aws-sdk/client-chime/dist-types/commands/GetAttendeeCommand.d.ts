...
declare const GetAttendeeCommand_base: {
    new (input: GetAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<GetAttendeeCommandInput, GetAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<GetAttendeeCommandInput, GetAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
