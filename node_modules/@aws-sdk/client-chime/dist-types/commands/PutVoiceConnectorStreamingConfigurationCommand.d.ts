...
declare const PutVoiceConnectorStreamingConfigurationCommand_base: {
    new (input: PutVoiceConnectorStreamingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorStreamingConfigurationCommandInput, PutVoiceConnectorStreamingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorStreamingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorStreamingConfigurationCommandInput, PutVoiceConnectorStreamingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
