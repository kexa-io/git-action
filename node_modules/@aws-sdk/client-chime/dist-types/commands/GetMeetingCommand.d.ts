...
declare const GetMeetingCommand_base: {
    new (input: GetMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<GetMeetingCommandInput, GetMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetMeetingCommandInput): import("@smithy/smithy-client").CommandImpl<GetMeetingCommandInput, GetMeetingCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
