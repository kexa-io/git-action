...
declare const DeleteVoiceConnectorStreamingConfigurationCommand_base: {
    new (input: DeleteVoiceConnectorStreamingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorStreamingConfigurationCommandInput, DeleteVoiceConnectorStreamingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorStreamingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorStreamingConfigurationCommandInput, DeleteVoiceConnectorStreamingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
