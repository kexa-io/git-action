...
declare const CreateSipMediaApplicationCallCommand_base: {
    new (input: CreateSipMediaApplicationCallCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipMediaApplicationCallCommandInput, CreateSipMediaApplicationCallCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSipMediaApplicationCallCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSipMediaApplicationCallCommandInput, CreateSipMediaApplicationCallCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
