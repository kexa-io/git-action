...
declare const UpdateAppInstanceUserCommand_base: {
    new (input: UpdateAppInstanceUserCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAppInstanceUserCommandInput, UpdateAppInstanceUserCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAppInstanceUserCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAppInstanceUserCommandInput, UpdateAppInstanceUserCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
