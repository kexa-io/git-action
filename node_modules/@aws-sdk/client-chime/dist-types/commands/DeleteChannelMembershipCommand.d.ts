...
declare const DeleteChannelMembershipCommand_base: {
    new (input: DeleteChannelMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelMembershipCommandInput, DeleteChannelMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteChannelMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelMembershipCommandInput, DeleteChannelMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
