...
declare const DeleteChannelMessageCommand_base: {
    new (input: DeleteChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelMessageCommandInput, DeleteChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteChannelMessageCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteChannelMessageCommandInput, DeleteChannelMessageCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
