...
import { GetVoiceConnectorEmergencyCallingConfigurationRequest, GetVoiceConnectorEmergencyCallingConfigurationResponse } from "../models/models_1";
/**
 * @public
 */
...
declare const GetVoiceConnectorEmergencyCallingConfigurationCommand_base: {
    new (input: GetVoiceConnectorEmergencyCallingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorEmergencyCallingConfigurationCommandInput, GetVoiceConnectorEmergencyCallingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetVoiceConnectorEmergencyCallingConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<GetVoiceConnectorEmergencyCallingConfigurationCommandInput, GetVoiceConnectorEmergencyCallingConfigurationCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
