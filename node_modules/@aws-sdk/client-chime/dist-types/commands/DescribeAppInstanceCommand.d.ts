...
declare const DescribeAppInstanceCommand_base: {
    new (input: DescribeAppInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppInstanceCommandInput, DescribeAppInstanceCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAppInstanceCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAppInstanceCommandInput, DescribeAppInstanceCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
