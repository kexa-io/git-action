...
declare const ListProxySessionsCommand_base: {
    new (input: ListProxySessionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProxySessionsCommandInput, ListProxySessionsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListProxySessionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListProxySessionsCommandInput, ListProxySessionsCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
