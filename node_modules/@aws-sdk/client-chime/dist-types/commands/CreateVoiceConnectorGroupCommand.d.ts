...
declare const CreateVoiceConnectorGroupCommand_base: {
    new (input: CreateVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceConnectorGroupCommandInput, CreateVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateVoiceConnectorGroupCommandInput, CreateVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
