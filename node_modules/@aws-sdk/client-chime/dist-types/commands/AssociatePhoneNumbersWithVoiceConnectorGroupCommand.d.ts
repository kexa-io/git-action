...
declare const AssociatePhoneNumbersWithVoiceConnectorGroupCommand_base: {
    new (input: AssociatePhoneNumbersWithVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<AssociatePhoneNumbersWithVoiceConnectorGroupCommandInput, AssociatePhoneNumbersWithVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociatePhoneNumbersWithVoiceConnectorGroupCommandInput): import("@smithy/smithy-client").CommandImpl<AssociatePhoneNumbersWithVoiceConnectorGroupCommandInput, AssociatePhoneNumbersWithVoiceConnectorGroupCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
