...
declare const DeleteVoiceConnectorCommand_base: {
    new (input: DeleteVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorCommandInput, DeleteVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteVoiceConnectorCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteVoiceConnectorCommandInput, DeleteVoiceConnectorCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
