...
declare const DescribeChannelCommand_base: {
    new (input: DescribeChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeChannelCommandInput, DescribeChannelCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeChannelCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeChannelCommandInput, DescribeChannelCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
