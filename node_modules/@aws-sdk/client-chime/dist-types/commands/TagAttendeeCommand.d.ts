...
declare const TagAttendeeCommand_base: {
    new (input: TagAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<TagAttendeeCommandInput, TagAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TagAttendeeCommandInput): import("@smithy/smithy-client").CommandImpl<TagAttendeeCommandInput, TagAttendeeCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TagAttendeeCommand extends TagAttendeeCommand_base {
}
