...
declare const PutVoiceConnectorProxyCommand_base: {
    new (input: PutVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorProxyCommandInput, PutVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutVoiceConnectorProxyCommandInput): import("@smithy/smithy-client").CommandImpl<PutVoiceConnectorProxyCommandInput, PutVoiceConnectorProxyCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
