...
declare const UpdateRoomMembershipCommand_base: {
    new (input: UpdateRoomMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRoomMembershipCommandInput, UpdateRoomMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRoomMembershipCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRoomMembershipCommandInput, UpdateRoomMembershipCommandOutput, ChimeClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
