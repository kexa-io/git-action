...
export interface UpdateRoomMembershipCommandInput
  extends UpdateRoomMembershipRequest {}
export interface UpdateRoomMembershipCommandOutput
  extends UpdateRoomMembershipResponse,
    __MetadataBearer {}
