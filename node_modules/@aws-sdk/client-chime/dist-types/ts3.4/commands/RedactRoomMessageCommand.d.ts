...
export interface RedactRoomMessageCommandInput
  extends RedactRoomMessageRequest {}
export interface RedactRoomMessageCommandOutput
  extends RedactRoomMessageResponse,
    __MetadataBearer {}
declare const RedactRoomMessageCommand_base: {
  ...
  >;
  new (
    __0_0: RedactRoomMessageCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    RedactRoomMessageCommandInput,
    RedactRoomMessageCommandOutput,
    ChimeClientResolvedConfig,
