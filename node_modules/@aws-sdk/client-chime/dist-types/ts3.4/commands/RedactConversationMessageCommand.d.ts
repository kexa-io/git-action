...
export interface RedactConversationMessageCommandInput
  extends RedactConversationMessageRequest {}
export interface RedactConversationMessageCommandOutput
  extends RedactConversationMessageResponse,
    __MetadataBearer {}
declare const RedactConversationMessageCommand_base: {
  ...
  >;
  new (
    __0_0: RedactConversationMessageCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    RedactConversationMessageCommandInput,
    RedactConversationMessageCommandOutput,
    ChimeClientResolvedConfig,
