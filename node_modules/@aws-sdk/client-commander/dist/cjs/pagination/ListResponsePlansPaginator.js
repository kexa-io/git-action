...
const CommanderClient_1 = require("../CommanderClient");
...
async function* paginateListResponsePlans(config, input, ...additionalArguments) {
    ...
    while (hasNext) {
        ...
        if (config.client instanceof Commander_1.Commander) {
            page = await makePagedRequest(config.client, input, ...additionalArguments);
        }
        else if (config.client instanceof CommanderClient_1.CommanderClient) {
