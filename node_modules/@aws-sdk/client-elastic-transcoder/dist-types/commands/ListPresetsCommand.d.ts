...
declare const ListPresetsCommand_base: {
    new (input: ListPresetsCommandInput): import("@smithy/smithy-client").CommandImpl<ListPresetsCommandInput, ListPresetsCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
