...
declare const CancelJobCommand_base: {
    new (input: CancelJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelJobCommandInput, CancelJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelJobCommandInput): import("@smithy/smithy-client").CommandImpl<CancelJobCommandInput, CancelJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
