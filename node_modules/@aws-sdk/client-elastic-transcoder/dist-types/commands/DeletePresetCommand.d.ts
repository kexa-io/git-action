...
declare const DeletePresetCommand_base: {
    new (input: DeletePresetCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePresetCommandInput, DeletePresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeletePresetCommandInput): import("@smithy/smithy-client").CommandImpl<DeletePresetCommandInput, DeletePresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
