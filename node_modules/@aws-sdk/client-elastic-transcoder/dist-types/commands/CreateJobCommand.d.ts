...
declare const CreateJobCommand_base: {
    new (input: CreateJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateJobCommandInput, CreateJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateJobCommandInput): import("@smithy/smithy-client").CommandImpl<CreateJobCommandInput, CreateJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
