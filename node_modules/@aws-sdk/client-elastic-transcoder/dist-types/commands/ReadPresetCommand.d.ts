...
declare const ReadPresetCommand_base: {
    new (input: ReadPresetCommandInput): import("@smithy/smithy-client").CommandImpl<ReadPresetCommandInput, ReadPresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ReadPresetCommandInput): import("@smithy/smithy-client").CommandImpl<ReadPresetCommandInput, ReadPresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ReadPresetCommand extends ReadPresetCommand_base {
}
