...
declare const ListJobsByPipelineCommand_base: {
    new (input: ListJobsByPipelineCommandInput): import("@smithy/smithy-client").CommandImpl<ListJobsByPipelineCommandInput, ListJobsByPipelineCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListJobsByPipelineCommandInput): import("@smithy/smithy-client").CommandImpl<ListJobsByPipelineCommandInput, ListJobsByPipelineCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListJobsByPipelineCommand extends ListJobsByPipelineCommand_base {
}
