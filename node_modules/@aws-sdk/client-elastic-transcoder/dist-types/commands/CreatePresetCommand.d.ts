...
declare const CreatePresetCommand_base: {
    new (input: CreatePresetCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePresetCommandInput, CreatePresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreatePresetCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePresetCommandInput, CreatePresetCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
