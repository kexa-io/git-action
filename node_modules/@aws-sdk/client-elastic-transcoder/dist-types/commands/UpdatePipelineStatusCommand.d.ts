...
declare const UpdatePipelineStatusCommand_base: {
    new (input: UpdatePipelineStatusCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePipelineStatusCommandInput, UpdatePipelineStatusCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdatePipelineStatusCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePipelineStatusCommandInput, UpdatePipelineStatusCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdatePipelineStatusCommand extends UpdatePipelineStatusCommand_base {
}
