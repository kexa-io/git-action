...
declare const UpdatePipelineNotificationsCommand_base: {
    new (input: UpdatePipelineNotificationsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePipelineNotificationsCommandInput, UpdatePipelineNotificationsCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdatePipelineNotificationsCommandInput): import("@smithy/smithy-client").CommandImpl<UpdatePipelineNotificationsCommandInput, UpdatePipelineNotificationsCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdatePipelineNotificationsCommand extends UpdatePipelineNotificationsCommand_base {
}
