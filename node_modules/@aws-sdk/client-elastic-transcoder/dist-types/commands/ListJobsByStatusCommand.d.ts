...
declare const ListJobsByStatusCommand_base: {
    new (input: ListJobsByStatusCommandInput): import("@smithy/smithy-client").CommandImpl<ListJobsByStatusCommandInput, ListJobsByStatusCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListJobsByStatusCommandInput): import("@smithy/smithy-client").CommandImpl<ListJobsByStatusCommandInput, ListJobsByStatusCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListJobsByStatusCommand extends ListJobsByStatusCommand_base {
}
