...
declare const ReadPipelineCommand_base: {
    new (input: ReadPipelineCommandInput): import("@smithy/smithy-client").CommandImpl<ReadPipelineCommandInput, ReadPipelineCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ReadPipelineCommandInput): import("@smithy/smithy-client").CommandImpl<ReadPipelineCommandInput, ReadPipelineCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ReadPipelineCommand extends ReadPipelineCommand_base {
}
