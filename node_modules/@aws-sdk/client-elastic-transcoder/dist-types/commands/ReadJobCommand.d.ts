...
declare const ReadJobCommand_base: {
    new (input: ReadJobCommandInput): import("@smithy/smithy-client").CommandImpl<ReadJobCommandInput, ReadJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ReadJobCommandInput): import("@smithy/smithy-client").CommandImpl<ReadJobCommandInput, ReadJobCommandOutput, ElasticTranscoderClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ReadJobCommand extends ReadJobCommand_base {
}
