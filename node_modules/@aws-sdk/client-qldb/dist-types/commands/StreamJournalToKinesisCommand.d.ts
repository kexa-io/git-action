...
declare const StreamJournalToKinesisCommand_base: {
    new (input: StreamJournalToKinesisCommandInput): import("@smithy/smithy-client").CommandImpl<StreamJournalToKinesisCommandInput, StreamJournalToKinesisCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StreamJournalToKinesisCommandInput): import("@smithy/smithy-client").CommandImpl<StreamJournalToKinesisCommandInput, StreamJournalToKinesisCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StreamJournalToKinesisCommand extends StreamJournalToKinesisCommand_base {
}
