...
declare const DescribeJournalS3ExportCommand_base: {
    new (input: DescribeJournalS3ExportCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeJournalS3ExportCommandInput, DescribeJournalS3ExportCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeJournalS3ExportCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeJournalS3ExportCommandInput, DescribeJournalS3ExportCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeJournalS3ExportCommand extends DescribeJournalS3ExportCommand_base {
}
