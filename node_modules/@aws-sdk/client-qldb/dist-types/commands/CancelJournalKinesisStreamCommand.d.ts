...
declare const CancelJournalKinesisStreamCommand_base: {
    new (input: CancelJournalKinesisStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CancelJournalKinesisStreamCommandInput, CancelJournalKinesisStreamCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CancelJournalKinesisStreamCommandInput): import("@smithy/smithy-client").CommandImpl<CancelJournalKinesisStreamCommandInput, CancelJournalKinesisStreamCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CancelJournalKinesisStreamCommand extends CancelJournalKinesisStreamCommand_base {
}
