...
declare const GetBlockCommand_base: {
    new (input: GetBlockCommandInput): import("@smithy/smithy-client").CommandImpl<GetBlockCommandInput, GetBlockCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class GetBlockCommand extends GetBlockCommand_base {
}
