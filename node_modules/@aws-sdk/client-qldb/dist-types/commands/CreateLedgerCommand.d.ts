...
declare const CreateLedgerCommand_base: {
    new (input: CreateLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLedgerCommandInput, CreateLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLedgerCommandInput, CreateLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLedgerCommand extends CreateLedgerCommand_base {
}
