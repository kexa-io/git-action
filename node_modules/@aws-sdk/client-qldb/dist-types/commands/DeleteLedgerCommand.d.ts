...
declare const DeleteLedgerCommand_base: {
    new (input: DeleteLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLedgerCommandInput, DeleteLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteLedgerCommandInput, DeleteLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteLedgerCommand extends DeleteLedgerCommand_base {
}
