...
declare const DescribeLedgerCommand_base: {
    new (input: DescribeLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLedgerCommandInput, DescribeLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLedgerCommandInput, DescribeLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeLedgerCommand extends DescribeLedgerCommand_base {
}
