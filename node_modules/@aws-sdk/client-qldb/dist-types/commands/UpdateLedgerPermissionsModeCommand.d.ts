...
declare const UpdateLedgerPermissionsModeCommand_base: {
    new (input: UpdateLedgerPermissionsModeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLedgerPermissionsModeCommandInput, UpdateLedgerPermissionsModeCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLedgerPermissionsModeCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLedgerPermissionsModeCommandInput, UpdateLedgerPermissionsModeCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
