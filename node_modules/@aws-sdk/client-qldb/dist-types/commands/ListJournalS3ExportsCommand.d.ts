...
declare const ListJournalS3ExportsCommand_base: {
    new (input: ListJournalS3ExportsCommandInput): import("@smithy/smithy-client").CommandImpl<ListJournalS3ExportsCommandInput, ListJournalS3ExportsCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListJournalS3ExportsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListJournalS3ExportsCommandInput, ListJournalS3ExportsCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListJournalS3ExportsCommand extends ListJournalS3ExportsCommand_base {
}
