...
declare const GetDigestCommand_base: {
    new (input: GetDigestCommandInput): import("@smithy/smithy-client").CommandImpl<GetDigestCommandInput, GetDigestCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDigestCommandInput): import("@smithy/smithy-client").CommandImpl<GetDigestCommandInput, GetDigestCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDigestCommand extends GetDigestCommand_base {
}
