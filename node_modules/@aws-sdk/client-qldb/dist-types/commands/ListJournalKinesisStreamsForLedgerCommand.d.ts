...
declare const ListJournalKinesisStreamsForLedgerCommand_base: {
    new (input: ListJournalKinesisStreamsForLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<ListJournalKinesisStreamsForLedgerCommandInput, ListJournalKinesisStreamsForLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListJournalKinesisStreamsForLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<ListJournalKinesisStreamsForLedgerCommandInput, ListJournalKinesisStreamsForLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListJournalKinesisStreamsForLedgerCommand extends ListJournalKinesisStreamsForLedgerCommand_base {
}
