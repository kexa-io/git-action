...
declare const DescribeJournalKinesisStreamCommand_base: {
    new (input: DescribeJournalKinesisStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeJournalKinesisStreamCommandInput, DescribeJournalKinesisStreamCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeJournalKinesisStreamCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeJournalKinesisStreamCommandInput, DescribeJournalKinesisStreamCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeJournalKinesisStreamCommand extends DescribeJournalKinesisStreamCommand_base {
}
