...
declare const UpdateLedgerCommand_base: {
    new (input: UpdateLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLedgerCommandInput, UpdateLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLedgerCommandInput, UpdateLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLedgerCommand extends UpdateLedgerCommand_base {
}
