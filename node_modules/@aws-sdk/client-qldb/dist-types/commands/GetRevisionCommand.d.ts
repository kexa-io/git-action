...
declare const GetRevisionCommand_base: {
    new (input: GetRevisionCommandInput): import("@smithy/smithy-client").CommandImpl<GetRevisionCommandInput, GetRevisionCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
