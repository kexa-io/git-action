...
declare const ListJournalS3ExportsForLedgerCommand_base: {
    new (input: ListJournalS3ExportsForLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<ListJournalS3ExportsForLedgerCommandInput, ListJournalS3ExportsForLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListJournalS3ExportsForLedgerCommandInput): import("@smithy/smithy-client").CommandImpl<ListJournalS3ExportsForLedgerCommandInput, ListJournalS3ExportsForLedgerCommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListJournalS3ExportsForLedgerCommand extends ListJournalS3ExportsForLedgerCommand_base {
}
