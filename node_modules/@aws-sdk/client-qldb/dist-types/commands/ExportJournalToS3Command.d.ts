...
declare const ExportJournalToS3Command_base: {
    new (input: ExportJournalToS3CommandInput): import("@smithy/smithy-client").CommandImpl<ExportJournalToS3CommandInput, ExportJournalToS3CommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ExportJournalToS3CommandInput): import("@smithy/smithy-client").CommandImpl<ExportJournalToS3CommandInput, ExportJournalToS3CommandOutput, QLDBClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ExportJournalToS3Command extends ExportJournalToS3Command_base {
}
