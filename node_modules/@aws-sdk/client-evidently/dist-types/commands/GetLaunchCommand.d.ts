...
declare const GetLaunchCommand_base: {
    new (input: GetLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchCommandInput, GetLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<GetLaunchCommandInput, GetLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetLaunchCommand extends GetLaunchCommand_base {
}
