...
declare const DeleteFeatureCommand_base: {
    new (input: DeleteFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteFeatureCommandInput, DeleteFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class DeleteFeatureCommand extends DeleteFeatureCommand_base {
}
