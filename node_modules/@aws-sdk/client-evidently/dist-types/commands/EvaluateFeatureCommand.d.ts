...
declare const EvaluateFeatureCommand_base: {
    new (input: EvaluateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<EvaluateFeatureCommandInput, EvaluateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: EvaluateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<EvaluateFeatureCommandInput, EvaluateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class EvaluateFeatureCommand extends EvaluateFeatureCommand_base {
}
