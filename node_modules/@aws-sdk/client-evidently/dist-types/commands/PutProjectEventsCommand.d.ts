...
declare const PutProjectEventsCommand_base: {
    new (input: PutProjectEventsCommandInput): import("@smithy/smithy-client").CommandImpl<PutProjectEventsCommandInput, PutProjectEventsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutProjectEventsCommandInput): import("@smithy/smithy-client").CommandImpl<PutProjectEventsCommandInput, PutProjectEventsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class PutProjectEventsCommand extends PutProjectEventsCommand_base {
}
