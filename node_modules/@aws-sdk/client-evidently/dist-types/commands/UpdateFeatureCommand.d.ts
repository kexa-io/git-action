...
declare const UpdateFeatureCommand_base: {
    new (input: UpdateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFeatureCommandInput, UpdateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFeatureCommandInput, UpdateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateFeatureCommand extends UpdateFeatureCommand_base {
}
