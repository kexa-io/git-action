...
declare const GetExperimentResultsCommand_base: {
    new (input: GetExperimentResultsCommandInput): import("@smithy/smithy-client").CommandImpl<GetExperimentResultsCommandInput, GetExperimentResultsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetExperimentResultsCommandInput): import("@smithy/smithy-client").CommandImpl<GetExperimentResultsCommandInput, GetExperimentResultsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetExperimentResultsCommand extends GetExperimentResultsCommand_base {
}
