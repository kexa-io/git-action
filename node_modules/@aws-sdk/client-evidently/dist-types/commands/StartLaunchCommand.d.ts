...
declare const StartLaunchCommand_base: {
    new (input: StartLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<StartLaunchCommandInput, StartLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<StartLaunchCommandInput, StartLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartLaunchCommand extends StartLaunchCommand_base {
}
