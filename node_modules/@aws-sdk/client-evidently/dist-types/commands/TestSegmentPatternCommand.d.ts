...
declare const TestSegmentPatternCommand_base: {
    new (input: TestSegmentPatternCommandInput): import("@smithy/smithy-client").CommandImpl<TestSegmentPatternCommandInput, TestSegmentPatternCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: TestSegmentPatternCommandInput): import("@smithy/smithy-client").CommandImpl<TestSegmentPatternCommandInput, TestSegmentPatternCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class TestSegmentPatternCommand extends TestSegmentPatternCommand_base {
}
