...
declare const CreateFeatureCommand_base: {
    new (input: CreateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFeatureCommandInput, CreateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<CreateFeatureCommandInput, CreateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateFeatureCommand extends CreateFeatureCommand_base {
}
