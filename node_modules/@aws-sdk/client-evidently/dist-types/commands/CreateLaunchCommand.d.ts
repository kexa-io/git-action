...
declare const CreateLaunchCommand_base: {
    new (input: CreateLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLaunchCommandInput, CreateLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<CreateLaunchCommandInput, CreateLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateLaunchCommand extends CreateLaunchCommand_base {
}
