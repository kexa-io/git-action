...
declare const ListSegmentsCommand_base: {
    new (input: ListSegmentsCommandInput): import("@smithy/smithy-client").CommandImpl<ListSegmentsCommandInput, ListSegmentsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListSegmentsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListSegmentsCommandInput, ListSegmentsCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSegmentsCommand extends ListSegmentsCommand_base {
}
