...
declare const GetProjectCommand_base: {
    new (input: GetProjectCommandInput): import("@smithy/smithy-client").CommandImpl<GetProjectCommandInput, GetProjectCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetProjectCommandInput): import("@smithy/smithy-client").CommandImpl<GetProjectCommandInput, GetProjectCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
