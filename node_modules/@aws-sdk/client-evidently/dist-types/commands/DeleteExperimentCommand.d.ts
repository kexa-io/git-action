...
declare const DeleteExperimentCommand_base: {
    new (input: DeleteExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteExperimentCommandInput, DeleteExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteExperimentCommandInput, DeleteExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
