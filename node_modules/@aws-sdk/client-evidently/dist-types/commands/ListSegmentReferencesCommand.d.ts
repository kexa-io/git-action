...
declare const ListSegmentReferencesCommand_base: {
    new (input: ListSegmentReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSegmentReferencesCommandInput, ListSegmentReferencesCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListSegmentReferencesCommandInput): import("@smithy/smithy-client").CommandImpl<ListSegmentReferencesCommandInput, ListSegmentReferencesCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListSegmentReferencesCommand extends ListSegmentReferencesCommand_base {
}
