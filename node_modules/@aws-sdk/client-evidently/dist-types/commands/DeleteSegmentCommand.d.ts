...
declare const DeleteSegmentCommand_base: {
    new (input: DeleteSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSegmentCommandInput, DeleteSegmentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteSegmentCommandInput, DeleteSegmentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
