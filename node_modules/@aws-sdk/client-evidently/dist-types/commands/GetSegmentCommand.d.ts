...
declare const GetSegmentCommand_base: {
    new (input: GetSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<GetSegmentCommandInput, GetSegmentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetSegmentCommandInput): import("@smithy/smithy-client").CommandImpl<GetSegmentCommandInput, GetSegmentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
