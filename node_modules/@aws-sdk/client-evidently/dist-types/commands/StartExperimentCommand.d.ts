...
declare const StartExperimentCommand_base: {
    new (input: StartExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<StartExperimentCommandInput, StartExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<StartExperimentCommandInput, StartExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
