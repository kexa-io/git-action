...
declare const ListLaunchesCommand_base: {
    new (input: ListLaunchesCommandInput): import("@smithy/smithy-client").CommandImpl<ListLaunchesCommandInput, ListLaunchesCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListLaunchesCommandInput): import("@smithy/smithy-client").CommandImpl<ListLaunchesCommandInput, ListLaunchesCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListLaunchesCommand extends ListLaunchesCommand_base {
}
