...
declare const BatchEvaluateFeatureCommand_base: {
    new (input: BatchEvaluateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<BatchEvaluateFeatureCommandInput, BatchEvaluateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: BatchEvaluateFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<BatchEvaluateFeatureCommandInput, BatchEvaluateFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class BatchEvaluateFeatureCommand extends BatchEvaluateFeatureCommand_base {
}
