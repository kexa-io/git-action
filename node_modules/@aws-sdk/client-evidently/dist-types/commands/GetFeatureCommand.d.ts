...
declare const GetFeatureCommand_base: {
    new (input: GetFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<GetFeatureCommandInput, GetFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetFeatureCommandInput): import("@smithy/smithy-client").CommandImpl<GetFeatureCommandInput, GetFeatureCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetFeatureCommand extends GetFeatureCommand_base {
}
