...
declare const UpdateProjectDataDeliveryCommand_base: {
    new (input: UpdateProjectDataDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProjectDataDeliveryCommandInput, UpdateProjectDataDeliveryCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateProjectDataDeliveryCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateProjectDataDeliveryCommandInput, UpdateProjectDataDeliveryCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateProjectDataDeliveryCommand extends UpdateProjectDataDeliveryCommand_base {
}
