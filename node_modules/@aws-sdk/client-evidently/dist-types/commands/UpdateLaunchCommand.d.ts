...
declare const UpdateLaunchCommand_base: {
    new (input: UpdateLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchCommandInput, UpdateLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateLaunchCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateLaunchCommandInput, UpdateLaunchCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateLaunchCommand extends UpdateLaunchCommand_base {
}
