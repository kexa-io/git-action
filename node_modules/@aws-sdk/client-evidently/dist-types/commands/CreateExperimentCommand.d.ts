...
declare const CreateExperimentCommand_base: {
    new (input: CreateExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExperimentCommandInput, CreateExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateExperimentCommandInput): import("@smithy/smithy-client").CommandImpl<CreateExperimentCommandInput, CreateExperimentCommandOutput, EvidentlyClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
