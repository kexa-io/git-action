 ...
 * @internal
 */
export interface SSMIncidentsHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<SSMIncidentsClientResolvedConfig, HandlerExecutionContext, SSMIncidentsHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultSSMIncidentsHttpAuthSchemeParametersProvider: (config: SSMIncidentsClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<SSMIncidentsHttpAuthSchemeParameters>;
/**
 * @internal
 */
