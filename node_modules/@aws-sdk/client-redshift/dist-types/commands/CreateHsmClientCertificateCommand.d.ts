...
declare const CreateHsmClientCertificateCommand_base: {
    new (input: CreateHsmClientCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHsmClientCertificateCommandInput, CreateHsmClientCertificateCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateHsmClientCertificateCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHsmClientCertificateCommandInput, CreateHsmClientCertificateCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
