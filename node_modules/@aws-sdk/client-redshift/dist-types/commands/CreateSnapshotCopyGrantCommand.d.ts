...
declare const CreateSnapshotCopyGrantCommand_base: {
    new (input: CreateSnapshotCopyGrantCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSnapshotCopyGrantCommandInput, CreateSnapshotCopyGrantCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateSnapshotCopyGrantCommandInput): import("@smithy/smithy-client").CommandImpl<CreateSnapshotCopyGrantCommandInput, CreateSnapshotCopyGrantCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
