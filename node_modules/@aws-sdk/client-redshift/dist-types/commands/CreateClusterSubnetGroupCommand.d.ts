...
declare const CreateClusterSubnetGroupCommand_base: {
    new (input: CreateClusterSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateClusterSubnetGroupCommandInput, CreateClusterSubnetGroupCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateClusterSubnetGroupCommandInput): import("@smithy/smithy-client").CommandImpl<CreateClusterSubnetGroupCommandInput, CreateClusterSubnetGroupCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
