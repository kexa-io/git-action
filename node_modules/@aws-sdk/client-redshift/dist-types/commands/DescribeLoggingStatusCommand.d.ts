...
declare const DescribeLoggingStatusCommand_base: {
    new (input: DescribeLoggingStatusCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLoggingStatusCommandInput, DescribeLoggingStatusCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeLoggingStatusCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeLoggingStatusCommandInput, DescribeLoggingStatusCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
