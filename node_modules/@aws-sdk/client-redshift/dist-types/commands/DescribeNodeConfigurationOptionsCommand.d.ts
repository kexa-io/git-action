...
declare const DescribeNodeConfigurationOptionsCommand_base: {
    new (input: DescribeNodeConfigurationOptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeNodeConfigurationOptionsCommandInput, DescribeNodeConfigurationOptionsCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeNodeConfigurationOptionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeNodeConfigurationOptionsCommandInput, DescribeNodeConfigurationOptionsCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
