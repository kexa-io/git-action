...
declare const DescribeClusterSnapshotsCommand_base: {
    new (input: DescribeClusterSnapshotsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeClusterSnapshotsCommandInput, DescribeClusterSnapshotsCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeClusterSnapshotsCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeClusterSnapshotsCommandInput, DescribeClusterSnapshotsCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
