...
declare const CreateEndpointAccessCommand_base: {
    new (input: CreateEndpointAccessCommandInput): import("@smithy/smithy-client").CommandImpl<CreateEndpointAccessCommandInput, CreateEndpointAccessCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateEndpointAccessCommandInput): import("@smithy/smithy-client").CommandImpl<CreateEndpointAccessCommandInput, CreateEndpointAccessCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
