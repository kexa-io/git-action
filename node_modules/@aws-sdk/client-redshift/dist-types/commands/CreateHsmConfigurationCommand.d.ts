...
declare const CreateHsmConfigurationCommand_base: {
    new (input: CreateHsmConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHsmConfigurationCommandInput, CreateHsmConfigurationCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateHsmConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateHsmConfigurationCommandInput, CreateHsmConfigurationCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
