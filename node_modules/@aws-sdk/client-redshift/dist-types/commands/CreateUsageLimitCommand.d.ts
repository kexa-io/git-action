...
declare const CreateUsageLimitCommand_base: {
    new (input: CreateUsageLimitCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUsageLimitCommandInput, CreateUsageLimitCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateUsageLimitCommandInput): import("@smithy/smithy-client").CommandImpl<CreateUsageLimitCommandInput, CreateUsageLimitCommandOutput, RedshiftClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
