...
declare const UpdateReportPlanCommand_base: {
    new (input: UpdateReportPlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateReportPlanCommandInput, UpdateReportPlanCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateReportPlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateReportPlanCommandInput, UpdateReportPlanCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
