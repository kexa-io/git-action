...
declare const ListRestoreTestingSelectionsCommand_base: {
    new (input: ListRestoreTestingSelectionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRestoreTestingSelectionsCommandInput, ListRestoreTestingSelectionsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListRestoreTestingSelectionsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRestoreTestingSelectionsCommandInput, ListRestoreTestingSelectionsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
