...
declare const UpdateRestoreTestingPlanCommand_base: {
    new (input: UpdateRestoreTestingPlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRestoreTestingPlanCommandInput, UpdateRestoreTestingPlanCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRestoreTestingPlanCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRestoreTestingPlanCommandInput, UpdateRestoreTestingPlanCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
