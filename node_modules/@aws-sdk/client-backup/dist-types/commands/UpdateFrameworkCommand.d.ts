...
declare const UpdateFrameworkCommand_base: {
    new (input: UpdateFrameworkCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFrameworkCommandInput, UpdateFrameworkCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateFrameworkCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateFrameworkCommandInput, UpdateFrameworkCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
