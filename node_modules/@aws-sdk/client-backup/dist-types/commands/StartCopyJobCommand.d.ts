...
declare const StartCopyJobCommand_base: {
    new (input: StartCopyJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartCopyJobCommandInput, StartCopyJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartCopyJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartCopyJobCommandInput, StartCopyJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
