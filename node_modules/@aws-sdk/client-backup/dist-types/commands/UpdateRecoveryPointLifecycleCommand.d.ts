...
declare const UpdateRecoveryPointLifecycleCommand_base: {
    new (input: UpdateRecoveryPointLifecycleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRecoveryPointLifecycleCommandInput, UpdateRecoveryPointLifecycleCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRecoveryPointLifecycleCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRecoveryPointLifecycleCommandInput, UpdateRecoveryPointLifecycleCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
