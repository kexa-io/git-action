...
declare const StartRestoreJobCommand_base: {
    new (input: StartRestoreJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartRestoreJobCommandInput, StartRestoreJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartRestoreJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartRestoreJobCommandInput, StartRestoreJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
