...
declare const PutBackupVaultNotificationsCommand_base: {
    new (input: PutBackupVaultNotificationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultNotificationsCommandInput, PutBackupVaultNotificationsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutBackupVaultNotificationsCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultNotificationsCommandInput, PutBackupVaultNotificationsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
