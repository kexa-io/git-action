...
declare const UpdateRestoreTestingSelectionCommand_base: {
    new (input: UpdateRestoreTestingSelectionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRestoreTestingSelectionCommandInput, UpdateRestoreTestingSelectionCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateRestoreTestingSelectionCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateRestoreTestingSelectionCommandInput, UpdateRestoreTestingSelectionCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
