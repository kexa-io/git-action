...
declare const ListRestoreJobsCommand_base: {
    new (input: ListRestoreJobsCommandInput): import("@smithy/smithy-client").CommandImpl<ListRestoreJobsCommandInput, ListRestoreJobsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [ListRestoreJobsCommandInput]): import("@smithy/smithy-client").CommandImpl<ListRestoreJobsCommandInput, ListRestoreJobsCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
