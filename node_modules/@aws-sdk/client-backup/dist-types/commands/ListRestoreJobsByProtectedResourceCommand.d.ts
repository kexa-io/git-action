...
declare const ListRestoreJobsByProtectedResourceCommand_base: {
    new (input: ListRestoreJobsByProtectedResourceCommandInput): import("@smithy/smithy-client").CommandImpl<ListRestoreJobsByProtectedResourceCommandInput, ListRestoreJobsByProtectedResourceCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListRestoreJobsByProtectedResourceCommandInput): import("@smithy/smithy-client").CommandImpl<ListRestoreJobsByProtectedResourceCommandInput, ListRestoreJobsByProtectedResourceCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
