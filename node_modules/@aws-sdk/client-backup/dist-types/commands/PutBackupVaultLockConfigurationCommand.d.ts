...
declare const PutBackupVaultLockConfigurationCommand_base: {
    new (input: PutBackupVaultLockConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultLockConfigurationCommandInput, PutBackupVaultLockConfigurationCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutBackupVaultLockConfigurationCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultLockConfigurationCommandInput, PutBackupVaultLockConfigurationCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
