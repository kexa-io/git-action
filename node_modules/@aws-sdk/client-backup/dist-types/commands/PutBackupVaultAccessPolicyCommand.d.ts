...
declare const PutBackupVaultAccessPolicyCommand_base: {
    new (input: PutBackupVaultAccessPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultAccessPolicyCommandInput, PutBackupVaultAccessPolicyCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutBackupVaultAccessPolicyCommandInput): import("@smithy/smithy-client").CommandImpl<PutBackupVaultAccessPolicyCommandInput, PutBackupVaultAccessPolicyCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
