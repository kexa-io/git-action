...
declare const StartReportJobCommand_base: {
    new (input: StartReportJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartReportJobCommandInput, StartReportJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartReportJobCommandInput): import("@smithy/smithy-client").CommandImpl<StartReportJobCommandInput, StartReportJobCommandOutput, BackupClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
