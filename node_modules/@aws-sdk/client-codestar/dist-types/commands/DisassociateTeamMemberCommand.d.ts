...
declare const DisassociateTeamMemberCommand_base: {
    new (input: DisassociateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateTeamMemberCommandInput, DisassociateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateTeamMemberCommandInput, DisassociateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateTeamMemberCommand extends DisassociateTeamMemberCommand_base {
}
