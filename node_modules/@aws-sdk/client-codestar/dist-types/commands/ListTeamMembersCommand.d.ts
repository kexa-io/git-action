...
declare const ListTeamMembersCommand_base: {
    new (input: ListTeamMembersCommandInput): import("@smithy/smithy-client").CommandImpl<ListTeamMembersCommandInput, ListTeamMembersCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 *
 */
export declare class ListTeamMembersCommand extends ListTeamMembersCommand_base {
}
