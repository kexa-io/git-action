...
declare const AssociateTeamMemberCommand_base: {
    new (input: AssociateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateTeamMemberCommandInput, AssociateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateTeamMemberCommandInput, AssociateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateTeamMemberCommand extends AssociateTeamMemberCommand_base {
}
