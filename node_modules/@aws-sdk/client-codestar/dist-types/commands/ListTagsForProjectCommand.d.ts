...
declare const ListTagsForProjectCommand_base: {
    new (input: ListTagsForProjectCommandInput): import("@smithy/smithy-client").CommandImpl<ListTagsForProjectCommandInput, ListTagsForProjectCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListTagsForProjectCommandInput): import("@smithy/smithy-client").CommandImpl<ListTagsForProjectCommandInput, ListTagsForProjectCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListTagsForProjectCommand extends ListTagsForProjectCommand_base {
}
