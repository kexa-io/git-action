...
declare const UpdateTeamMemberCommand_base: {
    new (input: UpdateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTeamMemberCommandInput, UpdateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateTeamMemberCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateTeamMemberCommandInput, UpdateTeamMemberCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateTeamMemberCommand extends UpdateTeamMemberCommand_base {
}
