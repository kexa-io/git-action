...
declare const DescribeUserProfileCommand_base: {
    new (input: DescribeUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeUserProfileCommandInput, DescribeUserProfileCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeUserProfileCommandInput, DescribeUserProfileCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
