...
declare const DeleteUserProfileCommand_base: {
    new (input: DeleteUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUserProfileCommandInput, DeleteUserProfileCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteUserProfileCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteUserProfileCommandInput, DeleteUserProfileCommandOutput, CodeStarClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
