 ...
 * @internal
 */
export interface WellArchitectedHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<WellArchitectedClientResolvedConfig, HandlerExecutionContext, WellArchitectedHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultWellArchitectedHttpAuthSchemeParametersProvider: (config: WellArchitectedClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<WellArchitectedHttpAuthSchemeParameters>;
/**
 * @internal
 */
