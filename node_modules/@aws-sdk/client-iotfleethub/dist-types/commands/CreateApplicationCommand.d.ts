...
declare const CreateApplicationCommand_base: {
    new (input: CreateApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateApplicationCommandInput, CreateApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<CreateApplicationCommandInput, CreateApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
