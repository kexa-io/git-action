...
declare const DescribeApplicationCommand_base: {
    new (input: DescribeApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeApplicationCommandInput, DescribeApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeApplicationCommandInput, DescribeApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
