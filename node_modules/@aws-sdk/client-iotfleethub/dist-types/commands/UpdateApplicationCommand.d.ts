...
declare const UpdateApplicationCommand_base: {
    new (input: UpdateApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateApplicationCommandInput, UpdateApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateApplicationCommandInput, UpdateApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
