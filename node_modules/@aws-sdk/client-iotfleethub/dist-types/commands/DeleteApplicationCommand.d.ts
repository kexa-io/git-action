...
declare const DeleteApplicationCommand_base: {
    new (input: DeleteApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApplicationCommandInput, DeleteApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteApplicationCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteApplicationCommandInput, DeleteApplicationCommandOutput, IoTFleetHubClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
