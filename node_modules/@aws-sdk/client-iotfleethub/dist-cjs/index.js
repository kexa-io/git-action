...
__export(src_exports, {
  ...
  IoTFleetHubServiceException: () => IoTFleetHubServiceException,
...
// src/IoTFleetHubClient.ts
var _IoTFleetHubClient = class _IoTFleetHubClient extends import_smithy_client.Client {
  ...
  getDefaultHttpAuthSchemeParametersProvider() {
    return import_httpAuthSchemeProvider.defaultIoTFleetHubHttpAuthSchemeParametersProvider;
  }
...
__name(_IoTFleetHubClient, "IoTFleetHubClient");
var IoTFleetHubClient = _IoTFleetHubClient;
...
// src/models/IoTFleetHubServiceException.ts

var _IoTFleetHubServiceException = class _IoTFleetHubServiceException extends import_smithy_client.ServiceException {
  /**
   * @internal
   */
  constructor(options) {
    super(options);
    Object.setPrototypeOf(this, _IoTFleetHubServiceException.prototype);
  }
};
__name(_IoTFleetHubServiceException, "IoTFleetHubServiceException");
var IoTFleetHubServiceException = _IoTFleetHubServiceException;
...
var _InternalFailureException = class _InternalFailureException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _InvalidRequestException = class _InvalidRequestException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _LimitExceededException = class _LimitExceededException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ThrottlingException = class _ThrottlingException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ResourceNotFoundException = class _ResourceNotFoundException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var _ConflictException = class _ConflictException extends IoTFleetHubServiceException {
  /**
   * @internal
   */
  constructor(opts) {
...
var de_DescribeApplicationCommand = /* @__PURE__ */ __name(async (output, context) => {
  ...
  const doc = (0, import_smithy_client.take)(data, {
    applicationArn: import_smithy_client.expectString,
    applicationCreationDate: import_smithy_client.expectLong,
    applicationDescription: import_smithy_client.expectString,
    applicationId: import_smithy_client.expectString,
    applicationLastUpdateDate: import_smithy_client.expectLong,
    applicationName: import_smithy_client.expectString,
    applicationState: import_smithy_client.expectString,
    applicationUrl: import_smithy_client.expectString,
...
var de_ListApplicationsCommand = /* @__PURE__ */ __name(async (output, context) => {
  ...
  const data = (0, import_smithy_client.expectNonNull)((0, import_smithy_client.expectObject)(await (0, import_core2.parseJsonBody)(output.body, context)), "body");
  const doc = (0, import_smithy_client.take)(data, {
    applicationSummaries: import_smithy_client._json,
...
var throwDefaultError = (0, import_smithy_client.withBaseException)(IoTFleetHubServiceException);
...
}).s("AWSIoTFleetHub", "CreateApplication", {}).n("IoTFleetHubClient", "CreateApplicationCommand").f(void 0, void 0).ser(se_CreateApplicationCommand).de(de_CreateApplicationCommand).build() {
};
...
}).s("AWSIoTFleetHub", "DescribeApplication", {}).n("IoTFleetHubClient", "DescribeApplicationCommand").f(void 0, void 0).ser(se_DescribeApplicationCommand).de(de_DescribeApplicationCommand).build() {
};
...
}).s("AWSIoTFleetHub", "ListApplications", {}).n("IoTFleetHubClient", "ListApplicationsCommand").f(void 0, void 0).ser(se_ListApplicationsCommand).de(de_ListApplicationsCommand).build() {
};
...
}).s("AWSIoTFleetHub", "ListTagsForResource", {}).n("IoTFleetHubClient", "ListTagsForResourceCommand").f(void 0, void 0).ser(se_ListTagsForResourceCommand).de(de_ListTagsForResourceCommand).build() {
};
...
}).s("AWSIoTFleetHub", "TagResource", {}).n("IoTFleetHubClient", "TagResourceCommand").f(void 0, void 0).ser(se_TagResourceCommand).de(de_TagResourceCommand).build() {
};
...
}).s("AWSIoTFleetHub", "UntagResource", {}).n("IoTFleetHubClient", "UntagResourceCommand").f(void 0, void 0).ser(se_UntagResourceCommand).de(de_UntagResourceCommand).build() {
};
...
}).s("AWSIoTFleetHub", "UpdateApplication", {}).n("IoTFleetHubClient", "UpdateApplicationCommand").f(void 0, void 0).ser(se_UpdateApplicationCommand).de(de_UpdateApplicationCommand).build() {
};
...
var _IoTFleetHub = class _IoTFleetHub extends IoTFleetHubClient {
};
__name(_IoTFleetHub, "IoTFleetHub");
var IoTFleetHub = _IoTFleetHub;
(0, import_smithy_client.createAggregatedClient)(commands, IoTFleetHub);

// src/pagination/ListApplicationsPaginator.ts

var paginateListApplications = (0, import_core.createPaginator)(IoTFleetHubClient, ListApplicationsCommand, "nextToken", "nextToken", "");
