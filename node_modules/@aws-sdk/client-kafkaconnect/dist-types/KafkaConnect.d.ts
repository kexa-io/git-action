...
export interface KafkaConnect {
     ...
     */
    deleteWorkerConfiguration(args: DeleteWorkerConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<DeleteWorkerConfigurationCommandOutput>;
    deleteWorkerConfiguration(args: DeleteWorkerConfigurationCommandInput, cb: (err: any, data?: DeleteWorkerConfigurationCommandOutput) => void): void;
    deleteWorkerConfiguration(args: DeleteWorkerConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteWorkerConfigurationCommandOutput) => void): void;
    /**
