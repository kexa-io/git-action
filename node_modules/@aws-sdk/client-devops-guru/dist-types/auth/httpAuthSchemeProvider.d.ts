 ...
 * @internal
 */
export interface DevOpsGuruHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<DevOpsGuruClientResolvedConfig, HandlerExecutionContext, DevOpsGuruHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultDevOpsGuruHttpAuthSchemeParametersProvider: (config: DevOpsGuruClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<DevOpsGuruHttpAuthSchemeParameters>;
/**
 * @internal
 */
