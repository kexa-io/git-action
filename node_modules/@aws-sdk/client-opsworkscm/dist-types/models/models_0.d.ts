 ...
 * @internal
 */
export declare const EngineAttributeFilterSensitiveLog: (obj: EngineAttribute) => any;
/**
 * @internal
 */
export declare const AssociateNodeRequestFilterSensitiveLog: (obj: AssociateNodeRequest) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const DescribeNodeAssociationStatusResponseFilterSensitiveLog: (obj: DescribeNodeAssociationStatusResponse) => any;
/**
 * @internal
 */
export declare const DescribeServersResponseFilterSensitiveLog: (obj: DescribeServersResponse) => any;
/**
 * @internal
 */
export declare const DisassociateNodeRequestFilterSensitiveLog: (obj: DisassociateNodeRequest) => any;
/**
 * @internal
 */
export declare const ExportServerEngineAttributeRequestFilterSensitiveLog: (obj: ExportServerEngineAttributeRequest) => any;
/**
 * @internal
 */
export declare const ExportServerEngineAttributeResponseFilterSensitiveLog: (obj: ExportServerEngineAttributeResponse) => any;
/**
 * @internal
 */
export declare const RestoreServerResponseFilterSensitiveLog: (obj: RestoreServerResponse) => any;
/**
 * @internal
 */
export declare const StartMaintenanceRequestFilterSensitiveLog: (obj: StartMaintenanceRequest) => any;
/**
 * @internal
 */
export declare const StartMaintenanceResponseFilterSensitiveLog: (obj: StartMaintenanceResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const UpdateServerEngineAttributesResponseFilterSensitiveLog: (obj: UpdateServerEngineAttributesResponse) => any;
