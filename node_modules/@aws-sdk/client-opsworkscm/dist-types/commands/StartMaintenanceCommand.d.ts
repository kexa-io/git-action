...
declare const StartMaintenanceCommand_base: {
    new (input: StartMaintenanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartMaintenanceCommandInput, StartMaintenanceCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StartMaintenanceCommandInput): import("@smithy/smithy-client").CommandImpl<StartMaintenanceCommandInput, StartMaintenanceCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StartMaintenanceCommand extends StartMaintenanceCommand_base {
}
