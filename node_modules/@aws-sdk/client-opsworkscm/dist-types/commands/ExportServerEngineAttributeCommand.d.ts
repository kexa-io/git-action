...
declare const ExportServerEngineAttributeCommand_base: {
    new (input: ExportServerEngineAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ExportServerEngineAttributeCommandInput, ExportServerEngineAttributeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ExportServerEngineAttributeCommandInput): import("@smithy/smithy-client").CommandImpl<ExportServerEngineAttributeCommandInput, ExportServerEngineAttributeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ExportServerEngineAttributeCommand extends ExportServerEngineAttributeCommand_base {
}
