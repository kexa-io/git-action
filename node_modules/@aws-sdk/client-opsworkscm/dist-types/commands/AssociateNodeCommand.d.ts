...
declare const AssociateNodeCommand_base: {
    new (input: AssociateNodeCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateNodeCommandInput, AssociateNodeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: AssociateNodeCommandInput): import("@smithy/smithy-client").CommandImpl<AssociateNodeCommandInput, AssociateNodeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class AssociateNodeCommand extends AssociateNodeCommand_base {
}
