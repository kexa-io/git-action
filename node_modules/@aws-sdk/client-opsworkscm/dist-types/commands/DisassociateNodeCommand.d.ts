...
declare const DisassociateNodeCommand_base: {
    new (input: DisassociateNodeCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateNodeCommandInput, DisassociateNodeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DisassociateNodeCommandInput): import("@smithy/smithy-client").CommandImpl<DisassociateNodeCommandInput, DisassociateNodeCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DisassociateNodeCommand extends DisassociateNodeCommand_base {
}
