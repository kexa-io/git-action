...
declare const UpdateServerEngineAttributesCommand_base: {
    new (input: UpdateServerEngineAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerEngineAttributesCommandInput, UpdateServerEngineAttributesCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateServerEngineAttributesCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerEngineAttributesCommandInput, UpdateServerEngineAttributesCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateServerEngineAttributesCommand extends UpdateServerEngineAttributesCommand_base {
}
