...
declare const DescribeServersCommand_base: {
    new (input: DescribeServersCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeServersCommandInput, DescribeServersCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [DescribeServersCommandInput]): import("@smithy/smithy-client").CommandImpl<DescribeServersCommandInput, DescribeServersCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeServersCommand extends DescribeServersCommand_base {
}
