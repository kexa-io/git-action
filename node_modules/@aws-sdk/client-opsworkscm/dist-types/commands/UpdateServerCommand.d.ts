...
declare const UpdateServerCommand_base: {
    new (input: UpdateServerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerCommandInput, UpdateServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateServerCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateServerCommandInput, UpdateServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
