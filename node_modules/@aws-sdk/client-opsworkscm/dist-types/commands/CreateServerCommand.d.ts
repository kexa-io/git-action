...
declare const CreateServerCommand_base: {
    new (input: CreateServerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateServerCommandInput, CreateServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateServerCommandInput): import("@smithy/smithy-client").CommandImpl<CreateServerCommandInput, CreateServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
