...
declare const RestoreServerCommand_base: {
    new (input: RestoreServerCommandInput): import("@smithy/smithy-client").CommandImpl<RestoreServerCommandInput, RestoreServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: RestoreServerCommandInput): import("@smithy/smithy-client").CommandImpl<RestoreServerCommandInput, RestoreServerCommandOutput, OpsWorksCMClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class RestoreServerCommand extends RestoreServerCommand_base {
}
