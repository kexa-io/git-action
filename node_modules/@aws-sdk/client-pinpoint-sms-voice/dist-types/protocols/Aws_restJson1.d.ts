 ...
 */
export declare const se_SendVoiceMessageCommand: (input: SendVoiceMessageCommandInput, context: __SerdeContext) => Promise<__HttpRequest>;
/**
 ...
 */
export declare const de_SendVoiceMessageCommand: (output: __HttpResponse, context: __SerdeContext) => Promise<SendVoiceMessageCommandOutput>;
/**
