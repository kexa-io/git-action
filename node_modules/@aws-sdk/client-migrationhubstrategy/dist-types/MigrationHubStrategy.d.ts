...
export interface MigrationHubStrategy {
     ...
     */
    getApplicationComponentDetails(args: GetApplicationComponentDetailsCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationComponentDetailsCommandOutput>;
    getApplicationComponentDetails(args: GetApplicationComponentDetailsCommandInput, cb: (err: any, data?: GetApplicationComponentDetailsCommandOutput) => void): void;
    getApplicationComponentDetails(args: GetApplicationComponentDetailsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationComponentDetailsCommandOutput) => void): void;
    /**
     * @see {@link GetApplicationComponentStrategiesCommand}
     */
    getApplicationComponentStrategies(args: GetApplicationComponentStrategiesCommandInput, options?: __HttpHandlerOptions): Promise<GetApplicationComponentStrategiesCommandOutput>;
    getApplicationComponentStrategies(args: GetApplicationComponentStrategiesCommandInput, cb: (err: any, data?: GetApplicationComponentStrategiesCommandOutput) => void): void;
    getApplicationComponentStrategies(args: GetApplicationComponentStrategiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetApplicationComponentStrategiesCommandOutput) => void): void;
    /**
     ...
     */
    getImportFileTask(args: GetImportFileTaskCommandInput, options?: __HttpHandlerOptions): Promise<GetImportFileTaskCommandOutput>;
    getImportFileTask(args: GetImportFileTaskCommandInput, cb: (err: any, data?: GetImportFileTaskCommandOutput) => void): void;
    getImportFileTask(args: GetImportFileTaskCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetImportFileTaskCommandOutput) => void): void;
    /**
     ...
     */
    getRecommendationReportDetails(args: GetRecommendationReportDetailsCommandInput, options?: __HttpHandlerOptions): Promise<GetRecommendationReportDetailsCommandOutput>;
    getRecommendationReportDetails(args: GetRecommendationReportDetailsCommandInput, cb: (err: any, data?: GetRecommendationReportDetailsCommandOutput) => void): void;
    getRecommendationReportDetails(args: GetRecommendationReportDetailsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetRecommendationReportDetailsCommandOutput) => void): void;
    /**
     * @see {@link GetServerDetailsCommand}
     */
    getServerDetails(args: GetServerDetailsCommandInput, options?: __HttpHandlerOptions): Promise<GetServerDetailsCommandOutput>;
    getServerDetails(args: GetServerDetailsCommandInput, cb: (err: any, data?: GetServerDetailsCommandOutput) => void): void;
    getServerDetails(args: GetServerDetailsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetServerDetailsCommandOutput) => void): void;
    /**
     * @see {@link GetServerStrategiesCommand}
     */
    getServerStrategies(args: GetServerStrategiesCommandInput, options?: __HttpHandlerOptions): Promise<GetServerStrategiesCommandOutput>;
    getServerStrategies(args: GetServerStrategiesCommandInput, cb: (err: any, data?: GetServerStrategiesCommandOutput) => void): void;
    getServerStrategies(args: GetServerStrategiesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetServerStrategiesCommandOutput) => void): void;
    /**
     ...
     */
    startImportFileTask(args: StartImportFileTaskCommandInput, options?: __HttpHandlerOptions): Promise<StartImportFileTaskCommandOutput>;
    startImportFileTask(args: StartImportFileTaskCommandInput, cb: (err: any, data?: StartImportFileTaskCommandOutput) => void): void;
    startImportFileTask(args: StartImportFileTaskCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartImportFileTaskCommandOutput) => void): void;
    /**
     ...
     */
    stopAssessment(args: StopAssessmentCommandInput, options?: __HttpHandlerOptions): Promise<StopAssessmentCommandOutput>;
    stopAssessment(args: StopAssessmentCommandInput, cb: (err: any, data?: StopAssessmentCommandOutput) => void): void;
    stopAssessment(args: StopAssessmentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StopAssessmentCommandOutput) => void): void;
    /**
     * @see {@link UpdateApplicationComponentConfigCommand}
     */
    updateApplicationComponentConfig(args: UpdateApplicationComponentConfigCommandInput, options?: __HttpHandlerOptions): Promise<UpdateApplicationComponentConfigCommandOutput>;
    updateApplicationComponentConfig(args: UpdateApplicationComponentConfigCommandInput, cb: (err: any, data?: UpdateApplicationComponentConfigCommandOutput) => void): void;
    updateApplicationComponentConfig(args: UpdateApplicationComponentConfigCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateApplicationComponentConfigCommandOutput) => void): void;
    /**
