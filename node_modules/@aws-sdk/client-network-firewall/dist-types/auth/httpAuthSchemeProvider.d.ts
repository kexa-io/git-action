 ...
 * @internal
 */
export interface NetworkFirewallHttpAuthSchemeParametersProvider extends HttpAuthSchemeParametersProvider<NetworkFirewallClientResolvedConfig, HandlerExecutionContext, NetworkFirewallHttpAuthSchemeParameters, object> {
}
/**
 * @internal
 */
export declare const defaultNetworkFirewallHttpAuthSchemeParametersProvider: (config: NetworkFirewallClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<NetworkFirewallHttpAuthSchemeParameters>;
/**
 * @internal
 */
