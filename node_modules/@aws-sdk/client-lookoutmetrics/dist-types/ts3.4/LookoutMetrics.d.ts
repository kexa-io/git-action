...
} from "./commands/GetFeedbackCommand";
import {
...
export interface LookoutMetrics {
  ...
  describeAnomalyDetectionExecutions(
    ...
    cb: (
      err: any,
      data?: DescribeAnomalyDetectionExecutionsCommandOutput
    ) => void
  ): void;
  describeAnomalyDetectionExecutions(
    args: DescribeAnomalyDetectionExecutionsCommandInput,
...
export declare class LookoutMetrics
  extends LookoutMetricsClient
  implements LookoutMetrics {}
