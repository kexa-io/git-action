...
export interface BackTestAnomalyDetectorCommandInput
  extends BackTestAnomalyDetectorRequest {}
export interface BackTestAnomalyDetectorCommandOutput
  extends BackTestAnomalyDetectorResponse,
    __MetadataBearer {}
declare const BackTestAnomalyDetectorCommand_base: {
  ...
  >;
  new (
    __0_0: BackTestAnomalyDetectorCommandInput
  ): import("@smithy/smithy-client").CommandImpl<
    BackTestAnomalyDetectorCommandInput,
    BackTestAnomalyDetectorCommandOutput,
    LookoutMetricsClientResolvedConfig,
