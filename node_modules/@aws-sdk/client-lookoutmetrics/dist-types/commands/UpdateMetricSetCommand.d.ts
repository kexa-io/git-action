...
declare const UpdateMetricSetCommand_base: {
    new (input: UpdateMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateMetricSetCommandInput, UpdateMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateMetricSetCommandInput, UpdateMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateMetricSetCommand extends UpdateMetricSetCommand_base {
}
