...
declare const UpdateAnomalyDetectorCommand_base: {
    new (input: UpdateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAnomalyDetectorCommandInput, UpdateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAnomalyDetectorCommandInput, UpdateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateAnomalyDetectorCommand extends UpdateAnomalyDetectorCommand_base {
}
