...
declare const ListAnomalyGroupSummariesCommand_base: {
    new (input: ListAnomalyGroupSummariesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnomalyGroupSummariesCommandInput, ListAnomalyGroupSummariesCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAnomalyGroupSummariesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnomalyGroupSummariesCommandInput, ListAnomalyGroupSummariesCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAnomalyGroupSummariesCommand extends ListAnomalyGroupSummariesCommand_base {
}
