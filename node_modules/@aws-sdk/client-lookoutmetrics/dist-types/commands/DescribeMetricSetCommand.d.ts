...
declare const DescribeMetricSetCommand_base: {
    new (input: DescribeMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeMetricSetCommandInput, DescribeMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeMetricSetCommandInput, DescribeMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeMetricSetCommand extends DescribeMetricSetCommand_base {
}
