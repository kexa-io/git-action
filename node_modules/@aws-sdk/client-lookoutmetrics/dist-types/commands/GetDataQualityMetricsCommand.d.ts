...
declare const GetDataQualityMetricsCommand_base: {
    new (input: GetDataQualityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetDataQualityMetricsCommandInput, GetDataQualityMetricsCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetDataQualityMetricsCommandInput): import("@smithy/smithy-client").CommandImpl<GetDataQualityMetricsCommandInput, GetDataQualityMetricsCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetDataQualityMetricsCommand extends GetDataQualityMetricsCommand_base {
}
