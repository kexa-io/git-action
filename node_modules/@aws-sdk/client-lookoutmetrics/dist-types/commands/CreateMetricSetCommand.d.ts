...
declare const CreateMetricSetCommand_base: {
    new (input: CreateMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateMetricSetCommandInput, CreateMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateMetricSetCommandInput): import("@smithy/smithy-client").CommandImpl<CreateMetricSetCommandInput, CreateMetricSetCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateMetricSetCommand extends CreateMetricSetCommand_base {
}
