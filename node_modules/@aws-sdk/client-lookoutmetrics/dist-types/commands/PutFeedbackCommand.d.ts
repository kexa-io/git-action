...
declare const PutFeedbackCommand_base: {
    new (input: PutFeedbackCommandInput): import("@smithy/smithy-client").CommandImpl<PutFeedbackCommandInput, PutFeedbackCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: PutFeedbackCommandInput): import("@smithy/smithy-client").CommandImpl<PutFeedbackCommandInput, PutFeedbackCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
