...
declare const GetFeedbackCommand_base: {
    new (input: GetFeedbackCommandInput): import("@smithy/smithy-client").CommandImpl<GetFeedbackCommandInput, GetFeedbackCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetFeedbackCommandInput): import("@smithy/smithy-client").CommandImpl<GetFeedbackCommandInput, GetFeedbackCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetFeedbackCommand extends GetFeedbackCommand_base {
}
