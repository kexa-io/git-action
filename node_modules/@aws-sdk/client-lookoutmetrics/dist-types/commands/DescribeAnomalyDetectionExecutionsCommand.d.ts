...
declare const DescribeAnomalyDetectionExecutionsCommand_base: {
    new (input: DescribeAnomalyDetectionExecutionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAnomalyDetectionExecutionsCommandInput, DescribeAnomalyDetectionExecutionsCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAnomalyDetectionExecutionsCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAnomalyDetectionExecutionsCommandInput, DescribeAnomalyDetectionExecutionsCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DescribeAnomalyDetectionExecutionsCommand extends DescribeAnomalyDetectionExecutionsCommand_base {
}
