...
declare const CreateAnomalyDetectorCommand_base: {
    new (input: CreateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAnomalyDetectorCommandInput, CreateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAnomalyDetectorCommandInput, CreateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
