...
declare const DetectMetricSetConfigCommand_base: {
    new (input: DetectMetricSetConfigCommandInput): import("@smithy/smithy-client").CommandImpl<DetectMetricSetConfigCommandInput, DetectMetricSetConfigCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DetectMetricSetConfigCommandInput): import("@smithy/smithy-client").CommandImpl<DetectMetricSetConfigCommandInput, DetectMetricSetConfigCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DetectMetricSetConfigCommand extends DetectMetricSetConfigCommand_base {
}
