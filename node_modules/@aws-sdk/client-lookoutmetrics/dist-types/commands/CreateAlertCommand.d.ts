...
declare const CreateAlertCommand_base: {
    new (input: CreateAlertCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAlertCommandInput, CreateAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreateAlertCommandInput): import("@smithy/smithy-client").CommandImpl<CreateAlertCommandInput, CreateAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class CreateAlertCommand extends CreateAlertCommand_base {
}
