...
declare const ActivateAnomalyDetectorCommand_base: {
    new (input: ActivateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<ActivateAnomalyDetectorCommandInput, ActivateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ActivateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<ActivateAnomalyDetectorCommandInput, ActivateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ActivateAnomalyDetectorCommand extends ActivateAnomalyDetectorCommand_base {
}
