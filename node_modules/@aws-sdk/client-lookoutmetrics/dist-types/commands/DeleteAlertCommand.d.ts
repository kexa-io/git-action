...
declare const DeleteAlertCommand_base: {
    new (input: DeleteAlertCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAlertCommandInput, DeleteAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeleteAlertCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAlertCommandInput, DeleteAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeleteAlertCommand extends DeleteAlertCommand_base {
}
