...
declare const GetAnomalyGroupCommand_base: {
    new (input: GetAnomalyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetAnomalyGroupCommandInput, GetAnomalyGroupCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetAnomalyGroupCommandInput): import("@smithy/smithy-client").CommandImpl<GetAnomalyGroupCommandInput, GetAnomalyGroupCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetAnomalyGroupCommand extends GetAnomalyGroupCommand_base {
}
