...
declare const ListAnomalyGroupTimeSeriesCommand_base: {
    new (input: ListAnomalyGroupTimeSeriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnomalyGroupTimeSeriesCommandInput, ListAnomalyGroupTimeSeriesCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: ListAnomalyGroupTimeSeriesCommandInput): import("@smithy/smithy-client").CommandImpl<ListAnomalyGroupTimeSeriesCommandInput, ListAnomalyGroupTimeSeriesCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class ListAnomalyGroupTimeSeriesCommand extends ListAnomalyGroupTimeSeriesCommand_base {
}
