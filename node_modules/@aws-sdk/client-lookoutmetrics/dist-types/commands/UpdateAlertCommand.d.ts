...
declare const UpdateAlertCommand_base: {
    new (input: UpdateAlertCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAlertCommandInput, UpdateAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: UpdateAlertCommandInput): import("@smithy/smithy-client").CommandImpl<UpdateAlertCommandInput, UpdateAlertCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class UpdateAlertCommand extends UpdateAlertCommand_base {
}
