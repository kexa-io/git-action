...
declare const DescribeAnomalyDetectorCommand_base: {
    new (input: DescribeAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAnomalyDetectorCommandInput, DescribeAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeAnomalyDetectorCommandInput, DescribeAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
