...
declare const DeactivateAnomalyDetectorCommand_base: {
    new (input: DeactivateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<DeactivateAnomalyDetectorCommandInput, DeactivateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DeactivateAnomalyDetectorCommandInput): import("@smithy/smithy-client").CommandImpl<DeactivateAnomalyDetectorCommandInput, DeactivateAnomalyDetectorCommandOutput, LookoutMetricsClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class DeactivateAnomalyDetectorCommand extends DeactivateAnomalyDetectorCommand_base {
}
