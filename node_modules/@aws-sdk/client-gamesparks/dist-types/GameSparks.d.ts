...
import { GetExtensionVersionCommandInput, GetExtensionVersionCommandOutput } from "./commands/GetExtensionVersionCommand";
import { GetGameCommandInput, GetGameCommandOutput } from "./commands/GetGameCommand";
import { GetGameConfigurationCommandInput, GetGameConfigurationCommandOutput } from "./commands/GetGameConfigurationCommand";
import { GetGeneratedCodeJobCommandInput, GetGeneratedCodeJobCommandOutput } from "./commands/GetGeneratedCodeJobCommand";
import { GetPlayerConnectionStatusCommandInput, GetPlayerConnectionStatusCommandOutput } from "./commands/GetPlayerConnectionStatusCommand";
...
import { ImportGameConfigurationCommandInput, ImportGameConfigurationCommandOutput } from "./commands/ImportGameConfigurationCommand";
...
import { StartGeneratedCodeJobCommandInput, StartGeneratedCodeJobCommandOutput } from "./commands/StartGeneratedCodeJobCommand";
import { StartStageDeploymentCommandInput, StartStageDeploymentCommandOutput } from "./commands/StartStageDeploymentCommand";
import { TagResourceCommandInput, TagResourceCommandOutput } from "./commands/TagResourceCommand";
import { UntagResourceCommandInput, UntagResourceCommandOutput } from "./commands/UntagResourceCommand";
import { UpdateGameCommandInput, UpdateGameCommandOutput } from "./commands/UpdateGameCommand";
import { UpdateGameConfigurationCommandInput, UpdateGameConfigurationCommandOutput } from "./commands/UpdateGameConfigurationCommand";
...
export interface GameSparks {
    ...
    deleteGame(args: DeleteGameCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteGameCommandOutput) => void): void;
    /**
     ...
     */
    disconnectPlayer(args: DisconnectPlayerCommandInput, options?: __HttpHandlerOptions): Promise<DisconnectPlayerCommandOutput>;
    disconnectPlayer(args: DisconnectPlayerCommandInput, cb: (err: any, data?: DisconnectPlayerCommandOutput) => void): void;
    disconnectPlayer(args: DisconnectPlayerCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DisconnectPlayerCommandOutput) => void): void;
    /**
     ...
     */
    getExtensionVersion(args: GetExtensionVersionCommandInput, options?: __HttpHandlerOptions): Promise<GetExtensionVersionCommandOutput>;
    getExtensionVersion(args: GetExtensionVersionCommandInput, cb: (err: any, data?: GetExtensionVersionCommandOutput) => void): void;
    getExtensionVersion(args: GetExtensionVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetExtensionVersionCommandOutput) => void): void;
    /**
    ...
    getGame(args: GetGameCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetGameCommandOutput) => void): void;
    /**
     * @see {@link GetGameConfigurationCommand}
     */
    getGameConfiguration(args: GetGameConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<GetGameConfigurationCommandOutput>;
    getGameConfiguration(args: GetGameConfigurationCommandInput, cb: (err: any, data?: GetGameConfigurationCommandOutput) => void): void;
    getGameConfiguration(args: GetGameConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetGameConfigurationCommandOutput) => void): void;
    /**
     * @see {@link GetGeneratedCodeJobCommand}
     */
    getGeneratedCodeJob(args: GetGeneratedCodeJobCommandInput, options?: __HttpHandlerOptions): Promise<GetGeneratedCodeJobCommandOutput>;
    getGeneratedCodeJob(args: GetGeneratedCodeJobCommandInput, cb: (err: any, data?: GetGeneratedCodeJobCommandOutput) => void): void;
    getGeneratedCodeJob(args: GetGeneratedCodeJobCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetGeneratedCodeJobCommandOutput) => void): void;
    /**
     * @see {@link GetPlayerConnectionStatusCommand}
     */
    getPlayerConnectionStatus(args: GetPlayerConnectionStatusCommandInput, options?: __HttpHandlerOptions): Promise<GetPlayerConnectionStatusCommandOutput>;
    getPlayerConnectionStatus(args: GetPlayerConnectionStatusCommandInput, cb: (err: any, data?: GetPlayerConnectionStatusCommandOutput) => void): void;
    getPlayerConnectionStatus(args: GetPlayerConnectionStatusCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetPlayerConnectionStatusCommandOutput) => void): void;
    /**
     ...
     */
    getStageDeployment(args: GetStageDeploymentCommandInput, options?: __HttpHandlerOptions): Promise<GetStageDeploymentCommandOutput>;
    getStageDeployment(args: GetStageDeploymentCommandInput, cb: (err: any, data?: GetStageDeploymentCommandOutput) => void): void;
    getStageDeployment(args: GetStageDeploymentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: GetStageDeploymentCommandOutput) => void): void;
    /**
     * @see {@link ImportGameConfigurationCommand}
     */
    importGameConfiguration(args: ImportGameConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<ImportGameConfigurationCommandOutput>;
    importGameConfiguration(args: ImportGameConfigurationCommandInput, cb: (err: any, data?: ImportGameConfigurationCommandOutput) => void): void;
    importGameConfiguration(args: ImportGameConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ImportGameConfigurationCommandOutput) => void): void;
    /**
     ...
     */
    listExtensionVersions(args: ListExtensionVersionsCommandInput, options?: __HttpHandlerOptions): Promise<ListExtensionVersionsCommandOutput>;
    listExtensionVersions(args: ListExtensionVersionsCommandInput, cb: (err: any, data?: ListExtensionVersionsCommandOutput) => void): void;
    listExtensionVersions(args: ListExtensionVersionsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListExtensionVersionsCommandOutput) => void): void;
    /**
    ...
    listGames(args: ListGamesCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListGamesCommandOutput) => void): void;
    /**
     * @see {@link ListGeneratedCodeJobsCommand}
     */
    listGeneratedCodeJobs(args: ListGeneratedCodeJobsCommandInput, options?: __HttpHandlerOptions): Promise<ListGeneratedCodeJobsCommandOutput>;
    listGeneratedCodeJobs(args: ListGeneratedCodeJobsCommandInput, cb: (err: any, data?: ListGeneratedCodeJobsCommandOutput) => void): void;
    listGeneratedCodeJobs(args: ListGeneratedCodeJobsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListGeneratedCodeJobsCommandOutput) => void): void;
    /**
     ...
     */
    listStageDeployments(args: ListStageDeploymentsCommandInput, options?: __HttpHandlerOptions): Promise<ListStageDeploymentsCommandOutput>;
    listStageDeployments(args: ListStageDeploymentsCommandInput, cb: (err: any, data?: ListStageDeploymentsCommandOutput) => void): void;
    listStageDeployments(args: ListStageDeploymentsCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListStageDeploymentsCommandOutput) => void): void;
    /**
     ...
     */
    startGeneratedCodeJob(args: StartGeneratedCodeJobCommandInput, options?: __HttpHandlerOptions): Promise<StartGeneratedCodeJobCommandOutput>;
    startGeneratedCodeJob(args: StartGeneratedCodeJobCommandInput, cb: (err: any, data?: StartGeneratedCodeJobCommandOutput) => void): void;
    startGeneratedCodeJob(args: StartGeneratedCodeJobCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartGeneratedCodeJobCommandOutput) => void): void;
    /**
     * @see {@link StartStageDeploymentCommand}
     */
    startStageDeployment(args: StartStageDeploymentCommandInput, options?: __HttpHandlerOptions): Promise<StartStageDeploymentCommandOutput>;
    startStageDeployment(args: StartStageDeploymentCommandInput, cb: (err: any, data?: StartStageDeploymentCommandOutput) => void): void;
    startStageDeployment(args: StartStageDeploymentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: StartStageDeploymentCommandOutput) => void): void;
    /**
    ...
    updateGame(args: UpdateGameCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateGameCommandOutput) => void): void;
    /**
     * @see {@link UpdateGameConfigurationCommand}
     */
    updateGameConfiguration(args: UpdateGameConfigurationCommandInput, options?: __HttpHandlerOptions): Promise<UpdateGameConfigurationCommandOutput>;
    updateGameConfiguration(args: UpdateGameConfigurationCommandInput, cb: (err: any, data?: UpdateGameConfigurationCommandOutput) => void): void;
    updateGameConfiguration(args: UpdateGameConfigurationCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateGameConfigurationCommandOutput) => void): void;
    /**
