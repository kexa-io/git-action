...
exports.paginateGetNetworkInsightsAccessScopeAnalysisFindings = void 0;
...
const makePagedClientRequest = async (client, input, ...args) => {
    return await client.send(new GetNetworkInsightsAccessScopeAnalysisFindingsCommand_1.GetNetworkInsightsAccessScopeAnalysisFindingsCommand(input), ...args);
};
async function* paginateGetNetworkInsightsAccessScopeAnalysisFindings(config, input, ...additionalArguments) {
