 ...
 *
 */
export declare class DisassociateIpamByoasnCommand extends $Command<DisassociateIpamByoasnCommandInput, DisassociateIpamByoasnCommandOutput, EC2ClientResolvedConfig> {
    readonly input: DisassociateIpamByoasnCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DisassociateIpamByoasnCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: EC2ClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DisassociateIpamByoasnCommandInput, DisassociateIpamByoasnCommandOutput>;
    /**
     * @internal
     */
    private serialize;
