 ...
 *
 */
export declare class LockSnapshotCommand extends $Command<LockSnapshotCommandInput, LockSnapshotCommandOutput, EC2ClientResolvedConfig> {
     ...
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: EC2ClientResolvedConfig, options?: __HttpHandlerOptions): Handler<LockSnapshotCommandInput, LockSnapshotCommandOutput>;
    /**
     * @internal
     */
    private serialize;
