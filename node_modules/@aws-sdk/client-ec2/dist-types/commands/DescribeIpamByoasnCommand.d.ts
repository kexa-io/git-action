 ...
 *
 */
export declare class DescribeIpamByoasnCommand extends $Command<DescribeIpamByoasnCommandInput, DescribeIpamByoasnCommandOutput, EC2ClientResolvedConfig> {
    readonly input: DescribeIpamByoasnCommandInput;
    static getEndpointParameterInstructions(): EndpointParameterInstructions;
    /**
     * @public
     */
    constructor(input: DescribeIpamByoasnCommandInput);
    /**
     * @internal
     */
    resolveMiddleware(clientStack: MiddlewareStack<ServiceInputTypes, ServiceOutputTypes>, configuration: EC2ClientResolvedConfig, options?: __HttpHandlerOptions): Handler<DescribeIpamByoasnCommandInput, DescribeIpamByoasnCommandOutput>;
    /**
     * @internal
     */
    private serialize;
