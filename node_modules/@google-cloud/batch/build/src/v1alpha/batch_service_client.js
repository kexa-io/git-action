...
exports.BatchServiceClient = void 0;
 ...
 */
const gapicConfig = require("./batch_service_client_config.json");
...
class BatchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            taskPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}/tasks/{task}'),
            taskGroupPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/jobs/{job}/taskGroups/{task_group}'),
        };
        ...
        const deleteJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteJobMetadata = protoFilesRoot.lookup('.google.cloud.batch.v1alpha.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.batch.v1alpha.BatchService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.batch.v1alpha.BatchService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.batch.v1alpha.BatchService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of batchServiceStubMethods) {
            const callPromise = this.batchServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
//# sourceMappingURL=batch_service_client.js.map