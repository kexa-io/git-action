...
class BatchServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const deleteJobMetadata = protoFilesRoot.lookup('.google.cloud.batch.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.batch.v1.BatchService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.batchServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.batch.v1.BatchService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.batch.v1.BatchService, this._opts, this._providedCustomServicePath);
