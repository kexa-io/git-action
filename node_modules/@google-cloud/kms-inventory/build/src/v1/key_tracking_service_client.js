...
exports.KeyTrackingServiceClient = void 0;
 ...
 */
const gapicConfig = require("./key_tracking_service_client_config.json");
...
class KeyTrackingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            projectLocationKeyRingCryptoKeyCryptoKeyVersionProtectedResourcesSummaryPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/protectedResourcesSummary'),
            projectLocationKeyRingCryptoKeyProtectedResourcesSummaryPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/protectedResourcesSummary'),
        ...
        this.descriptors.page = {
            searchProtectedResources: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'protectedResources'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.kms.inventory.v1.KeyTrackingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keyTrackingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.kms.inventory.v1.KeyTrackingService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.kms.inventory.v1
                    .KeyTrackingService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of keyTrackingServiceStubMethods) {
            const callPromise = this.keyTrackingServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getProtectedResourcesSummary(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    searchProtectedResources(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                scope: (_a = request.scope) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    searchProtectedResourcesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.searchProtectedResources.createStream(this.innerApiCalls.searchProtectedResources, request, callSettings);
    }
    /**
    ...
    searchProtectedResourcesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchProtectedResources.asyncIterate(this.innerApiCalls['searchProtectedResources'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.KeyTrackingServiceClient = KeyTrackingServiceClient;
//# sourceMappingURL=key_tracking_service_client.js.map