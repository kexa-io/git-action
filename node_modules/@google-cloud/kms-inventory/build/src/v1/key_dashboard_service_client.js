...
exports.KeyDashboardServiceClient = void 0;
 ...
 */
const gapicConfig = require("./key_dashboard_service_client_config.json");
...
class KeyDashboardServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.kms.inventory.v1.KeyDashboardService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.keyDashboardServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.kms.inventory.v1.KeyDashboardService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.kms.inventory.v1
                    .KeyDashboardService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of keyDashboardServiceStubMethods) {
            const callPromise = this.keyDashboardServiceStub.then(stub => (...args) => {
                if (this._terminated) {
...
exports.KeyDashboardServiceClient = KeyDashboardServiceClient;
//# sourceMappingURL=key_dashboard_service_client.js.map