 ...
 */
const gapicConfig = require("./lineage_client_config.json");
...
class LineageClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            lineageEventPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/processes/{process}/runs/{run}/lineageEvents/{lineage_event}'),
            locationPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}'),
            processPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/processes/{process}'),
            projectPathTemplate: new this._gaxModule.PathTemplate('projects/{project}'),
            runPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/processes/{process}/runs/{run}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listProcesses: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'processes'),
            listRuns: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'runs'),
            listLineageEvents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'lineageEvents'),
            searchLinks: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'links'),
            batchSearchLinkProcesses: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'processLinks'),
        };
        ...
        const deleteProcessResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteProcessMetadata = protoFilesRoot.lookup('.google.cloud.datacatalog.lineage.v1.OperationMetadata');
        const deleteRunResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRunMetadata = protoFilesRoot.lookup('.google.cloud.datacatalog.lineage.v1.OperationMetadata');
        this.descriptors.longrunning = {
            deleteProcess: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteProcessResponse.decode.bind(deleteProcessResponse), deleteProcessMetadata.decode.bind(deleteProcessMetadata)),
            deleteRun: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteRunResponse.decode.bind(deleteRunResponse), deleteRunMetadata.decode.bind(deleteRunMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.datacatalog.lineage.v1.Lineage', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.lineageStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.datacatalog.lineage.v1.Lineage')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.datacatalog.lineage.v1.Lineage, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of lineageStubMethods) {
            const callPromise = this.lineageStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    processOpenLineageRunEvent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createProcess(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateProcess(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'process.name': (_a = request.process.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateProcess(request, options, callback);
    }
    getProcess(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'run.name': (_a = request.run.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateRun(request, options, callback);
    }
    getRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createLineageEvent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getLineageEvent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteLineageEvent(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteProcess(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteProcessProgress(name) {
    ...
    deleteRun(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteRunProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listProcesses(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listProcessesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listProcesses.createStream(this.innerApiCalls.listProcesses, request, callSettings);
    }
    /**
    ...
    listProcessesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listProcesses.asyncIterate(this.innerApiCalls['listProcesses'], request, callSettings);
    }
    listRuns(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listRunsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listRuns.createStream(this.innerApiCalls.listRuns, request, callSettings);
    }
    /**
    ...
    listRunsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listRuns.asyncIterate(this.innerApiCalls['listRuns'], request, callSettings);
    }
    listLineageEvents(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listLineageEventsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listLineageEvents.createStream(this.innerApiCalls.listLineageEvents, request, callSettings);
    }
    /**
    ...
    listLineageEventsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listLineageEvents.asyncIterate(this.innerApiCalls['listLineageEvents'], request, callSettings);
    }
    searchLinks(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    searchLinksStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchLinks.createStream(this.innerApiCalls.searchLinks, request, callSettings);
    }
    /**
    ...
    searchLinksAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchLinks.asyncIterate(this.innerApiCalls['searchLinks'], request, callSettings);
    }
    batchSearchLinkProcesses(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    batchSearchLinkProcessesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.batchSearchLinkProcesses.createStream(this.innerApiCalls.batchSearchLinkProcesses, request, callSettings);
    }
    /**
    ...
    batchSearchLinkProcessesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.batchSearchLinkProcesses.asyncIterate(this.innerApiCalls['batchSearchLinkProcesses'], request, callSettings);
    }
    /**
...
exports.LineageClient = LineageClient;
//# sourceMappingURL=lineage_client.js.map