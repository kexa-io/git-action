...
class WorkflowsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            cryptoKeyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}'),
    ...
    updateWorkflow(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'workflow.name': (_a = request.workflow.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
