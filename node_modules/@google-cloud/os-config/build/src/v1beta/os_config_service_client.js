...
class OsConfigServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            guestPolicyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/guestPolicies/{guest_policy}'),
        ...
        this.descriptors.page = {
            ...
            listGuestPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'guestPolicies'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.osconfig.v1beta.OsConfigService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.osConfigServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.osconfig.v1beta.OsConfigService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.osconfig.v1beta.OsConfigService, this._opts, this._providedCustomServicePath);
    ...
    createGuestPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getGuestPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateGuestPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'guest_policy.name': (_a = request.guestPolicy.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateGuestPolicy(request, options, callback);
    }
    deleteGuestPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    lookupEffectiveGuestPolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listGuestPolicies(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listGuestPoliciesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listGuestPolicies.createStream(this.innerApiCalls.listGuestPolicies, request, callSettings);
    }
    /**
    ...
    listGuestPoliciesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listGuestPolicies.asyncIterate(this.innerApiCalls['listGuestPolicies'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
