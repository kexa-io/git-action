...
exports.OsConfigZonalServiceClient = void 0;
 ...
 */
const gapicConfig = require("./os_config_zonal_service_client_config.json");
...
class OsConfigZonalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            instanceOSPoliciesCompliancePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/instanceOSPoliciesCompliances/{instance}'),
        ...
        this.descriptors.page = {
            listOSPolicyAssignments: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'osPolicyAssignments'),
            listOSPolicyAssignmentRevisions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'osPolicyAssignments'),
            listInstanceOSPoliciesCompliances: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'instanceOsPoliciesCompliances'),
            listOSPolicyAssignmentReports: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'osPolicyAssignmentReports'),
            listInventories: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'inventories'),
            listVulnerabilityReports: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'vulnerabilityReports'),
        };
        ...
        const createOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.cloud.osconfig.v1alpha.OSPolicyAssignment');
        const createOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata');
        const updateOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.cloud.osconfig.v1alpha.OSPolicyAssignment');
        const updateOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata');
        const deleteOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata');
        this.descriptors.longrunning = {
            createOSPolicyAssignment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createOSPolicyAssignmentResponse.decode.bind(createOSPolicyAssignmentResponse), createOSPolicyAssignmentMetadata.decode.bind(createOSPolicyAssignmentMetadata)),
            updateOSPolicyAssignment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateOSPolicyAssignmentResponse.decode.bind(updateOSPolicyAssignmentResponse), updateOSPolicyAssignmentMetadata.decode.bind(updateOSPolicyAssignmentMetadata)),
            deleteOSPolicyAssignment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteOSPolicyAssignmentResponse.decode.bind(deleteOSPolicyAssignmentResponse), deleteOSPolicyAssignmentMetadata.decode.bind(deleteOSPolicyAssignmentMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.osconfig.v1alpha.OsConfigZonalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.osConfigZonalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.osconfig.v1alpha.OsConfigZonalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.osconfig.v1alpha
                    .OsConfigZonalService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of osConfigZonalServiceStubMethods) {
            const callPromise = this.osConfigZonalServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getOSPolicyAssignment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getInstanceOSPoliciesCompliance(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getOSPolicyAssignmentReport(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getInventory(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getVulnerabilityReport(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createOSPolicyAssignment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateOSPolicyAssignmentProgress(name) {
    ...
    updateOSPolicyAssignment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'os_policy_assignment.name': (_a = request.osPolicyAssignment.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateOSPolicyAssignmentProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteOSPolicyAssignment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteOSPolicyAssignmentProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listOSPolicyAssignments(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listOSPolicyAssignmentsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignments.createStream(this.innerApiCalls.listOsPolicyAssignments, request, callSettings);
    }
    /**
    ...
    listOSPolicyAssignmentsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignments.asyncIterate(this.innerApiCalls['listOsPolicyAssignments'], request, callSettings);
    }
    listOSPolicyAssignmentRevisions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listOSPolicyAssignmentRevisionsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignmentRevisions.createStream(this.innerApiCalls.listOsPolicyAssignmentRevisions, request, callSettings);
    }
    /**
    ...
    listOSPolicyAssignmentRevisionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignmentRevisions.asyncIterate(this.innerApiCalls['listOsPolicyAssignmentRevisions'], request, callSettings);
    }
    listInstanceOSPoliciesCompliances(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listInstanceOSPoliciesCompliancesStream(request, options) {
        ...
        this.initialize();
        this.warn('DEP$OsConfigZonalService-$ListInstanceOSPoliciesCompliances', 'ListInstanceOSPoliciesCompliances is deprecated and may be removed in a future version.', 'DeprecationWarning');
        return this.descriptors.page.listInstanceOSPoliciesCompliances.createStream(this.innerApiCalls.listInstanceOsPoliciesCompliances, request, callSettings);
    }
    /**
    ...
    listInstanceOSPoliciesCompliancesAsync(request, options) {
        ...
        this.initialize();
        this.warn('DEP$OsConfigZonalService-$ListInstanceOSPoliciesCompliances', 'ListInstanceOSPoliciesCompliances is deprecated and may be removed in a future version.', 'DeprecationWarning');
        return this.descriptors.page.listInstanceOSPoliciesCompliances.asyncIterate(this.innerApiCalls['listInstanceOsPoliciesCompliances'], request, callSettings);
    }
    listOSPolicyAssignmentReports(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listOSPolicyAssignmentReportsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignmentReports.createStream(this.innerApiCalls.listOsPolicyAssignmentReports, request, callSettings);
    }
    /**
    ...
    listOSPolicyAssignmentReportsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listOSPolicyAssignmentReports.asyncIterate(this.innerApiCalls['listOsPolicyAssignmentReports'], request, callSettings);
    }
    listInventories(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listInventoriesStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listInventories.createStream(this.innerApiCalls.listInventories, request, callSettings);
    }
    /**
    ...
    listInventoriesAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listInventories.asyncIterate(this.innerApiCalls['listInventories'], request, callSettings);
    }
    listVulnerabilityReports(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listVulnerabilityReportsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listVulnerabilityReports.createStream(this.innerApiCalls.listVulnerabilityReports, request, callSettings);
    }
    /**
    ...
    listVulnerabilityReportsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listVulnerabilityReports.asyncIterate(this.innerApiCalls['listVulnerabilityReports'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.OsConfigZonalServiceClient = OsConfigZonalServiceClient;
//# sourceMappingURL=os_config_zonal_service_client.js.map