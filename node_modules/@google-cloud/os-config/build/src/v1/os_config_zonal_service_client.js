...
class OsConfigZonalServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.cloud.osconfig.v1.OSPolicyAssignment');
        const createOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata');
        const updateOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.cloud.osconfig.v1.OSPolicyAssignment');
        const updateOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata');
        const deleteOSPolicyAssignmentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteOSPolicyAssignmentMetadata = protoFilesRoot.lookup('.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.osconfig.v1.OsConfigZonalService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.osConfigZonalServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.osconfig.v1.OsConfigZonalService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.osconfig.v1.OsConfigZonalService, this._opts, this._providedCustomServicePath);
