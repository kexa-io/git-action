...
class WorkstationsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createWorkstationClusterResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationCluster');
        const createWorkstationClusterMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const updateWorkstationClusterResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationCluster');
        const updateWorkstationClusterMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const deleteWorkstationClusterResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationCluster');
        const deleteWorkstationClusterMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const createWorkstationConfigResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationConfig');
        const createWorkstationConfigMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const updateWorkstationConfigResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationConfig');
        const updateWorkstationConfigMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const deleteWorkstationConfigResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.WorkstationConfig');
        const deleteWorkstationConfigMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const createWorkstationResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.Workstation');
        const createWorkstationMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const updateWorkstationResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.Workstation');
        const updateWorkstationMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const deleteWorkstationResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.Workstation');
        const deleteWorkstationMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const startWorkstationResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.Workstation');
        const startWorkstationMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        const stopWorkstationResponse = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.Workstation');
        const stopWorkstationMetadata = protoFilesRoot.lookup('.google.cloud.workstations.v1beta.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.workstations.v1beta.Workstations', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.workstationsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.workstations.v1beta.Workstations')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.workstations.v1beta.Workstations, this._opts, this._providedCustomServicePath);
