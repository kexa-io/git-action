...
class AnalyticsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const exportAnalyticsMetricsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.ExportAnalyticsMetricsResponse');
        const exportAnalyticsMetricsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.ExportMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2.AnalyticsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.analyticsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2.AnalyticsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2.AnalyticsService, this._opts, this._providedCustomServicePath);
