...
class CompletionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importCompletionDataResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.ImportCompletionDataResponse');
        const importCompletionDataMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.ImportMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2.CompletionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.completionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2.CompletionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2.CompletionService, this._opts, this._providedCustomServicePath);
