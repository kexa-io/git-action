...
class UserEventServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const purgeUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.PurgeUserEventsResponse');
        const purgeUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.PurgeMetadata');
        const importUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.ImportUserEventsResponse');
        const importUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.ImportMetadata');
        const rejoinUserEventsResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.RejoinUserEventsResponse');
        const rejoinUserEventsMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.RejoinUserEventsMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2.UserEventService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.userEventServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2.UserEventService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2.UserEventService, this._opts, this._providedCustomServicePath);
