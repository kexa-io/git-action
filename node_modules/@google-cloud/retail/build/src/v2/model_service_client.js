...
class ModelServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.Model');
        const createModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.CreateModelMetadata');
        const tuneModelResponse = protoFilesRoot.lookup('.google.cloud.retail.v2.TuneModelResponse');
        const tuneModelMetadata = protoFilesRoot.lookup('.google.cloud.retail.v2.TuneModelMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.retail.v2.ModelService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.retail.v2.ModelService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.retail.v2.ModelService, this._opts, this._providedCustomServicePath);
