...
exports.DashboardsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./dashboards_service_client_config.json");
...
class DashboardsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            alertPolicyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/alertPolicies/{alert_policy}'),
            dashboardPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/dashboards/{dashboard}'),
        ...
        this.descriptors.page = {
            listDashboards: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'dashboards'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.monitoring.dashboard.v1.DashboardsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.dashboardsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.monitoring.dashboard.v1.DashboardsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.monitoring.dashboard.v1
                    .DashboardsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of dashboardsServiceStubMethods) {
            const callPromise = this.dashboardsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createDashboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getDashboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteDashboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateDashboard(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'dashboard.name': (_a = request.dashboard.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateDashboard(request, options, callback);
    }
    listDashboards(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listDashboardsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listDashboards.createStream(this.innerApiCalls.listDashboards, request, callSettings);
    }
    /**
    ...
    listDashboardsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDashboards.asyncIterate(this.innerApiCalls['listDashboards'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=dashboards_service_client.js.map