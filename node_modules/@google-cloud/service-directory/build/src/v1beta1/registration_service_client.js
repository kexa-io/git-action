...
class RegistrationServiceClient {
    ...
    initialize() {
        ...
        this.registrationServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ...
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.servicedirectory.v1beta1
                    .RegistrationService, this._opts, this._providedCustomServicePath);
    ...
    updateNamespace(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'namespace.name': (_a = request.namespace.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateService(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'service.name': (_a = request.service.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
