...
class NotebookServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const startInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const startInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const stopInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const stopInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const resetInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const resetInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const upgradeInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const upgradeInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const rollbackInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const rollbackInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        const diagnoseInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v2.Instance');
        const diagnoseInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v2.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.notebooks.v2.NotebookService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.notebookServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.notebooks.v2.NotebookService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.notebooks.v2.NotebookService, this._opts, this._providedCustomServicePath);
    ...
    checkInstanceUpgradability(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
