...
class NotebookServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const registerInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const registerInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const setInstanceAcceleratorResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const setInstanceAcceleratorMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const setInstanceMachineTypeResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const setInstanceMachineTypeMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const setInstanceLabelsResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const setInstanceLabelsMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const deleteInstanceResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const startInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const startInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const stopInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const stopInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const resetInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const resetInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const reportInstanceInfoResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const reportInstanceInfoMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const upgradeInstanceResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const upgradeInstanceMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const upgradeInstanceInternalResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Instance');
        const upgradeInstanceInternalMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const createEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.Environment');
        const createEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        const deleteEnvironmentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.notebooks.v1beta1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.notebooks.v1beta1.NotebookService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.notebookServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.notebooks.v1beta1.NotebookService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.notebooks.v1beta1.NotebookService, this._opts, this._providedCustomServicePath);
