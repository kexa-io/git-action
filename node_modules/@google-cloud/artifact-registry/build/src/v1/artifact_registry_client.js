...
class ArtifactRegistryClient {
    ...
    updateRepository(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'repository.name': (_a = request.repository.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateProjectSettings(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'project_settings.name': (_a = request.projectSettings.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    updateVPCSCConfig(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'vpcsc_config.name': (_a = request.vpcscConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
