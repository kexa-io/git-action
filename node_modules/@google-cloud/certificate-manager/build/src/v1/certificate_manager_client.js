...
class CertificateManagerClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            trustConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/trustConfigs/{trust_config}'),
        };
        ...
        this.descriptors.page = {
            ...
            listTrustConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'trustConfigs'),
        };
        ...
        const createTrustConfigResponse = protoFilesRoot.lookup('.google.cloud.certificatemanager.v1.TrustConfig');
        const createTrustConfigMetadata = protoFilesRoot.lookup('.google.cloud.certificatemanager.v1.OperationMetadata');
        const updateTrustConfigResponse = protoFilesRoot.lookup('.google.cloud.certificatemanager.v1.TrustConfig');
        const updateTrustConfigMetadata = protoFilesRoot.lookup('.google.cloud.certificatemanager.v1.OperationMetadata');
        const deleteTrustConfigResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteTrustConfigMetadata = protoFilesRoot.lookup('.google.cloud.certificatemanager.v1.OperationMetadata');
        this.descriptors.longrunning = {
            ...
            createTrustConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createTrustConfigResponse.decode.bind(createTrustConfigResponse), createTrustConfigMetadata.decode.bind(createTrustConfigMetadata)),
            updateTrustConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateTrustConfigResponse.decode.bind(updateTrustConfigResponse), updateTrustConfigMetadata.decode.bind(updateTrustConfigMetadata)),
            deleteTrustConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteTrustConfigResponse.decode.bind(deleteTrustConfigResponse), deleteTrustConfigMetadata.decode.bind(deleteTrustConfigMetadata)),
        };
    ...
    getTrustConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createTrustConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateTrustConfigProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    updateTrustConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'trust_config.name': (_a = request.trustConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkUpdateTrustConfigProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteTrustConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteTrustConfigProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listTrustConfigs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listTrustConfigsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTrustConfigs.createStream(this.innerApiCalls.listTrustConfigs, request, callSettings);
    }
    /**
     ...
     */
    listTrustConfigsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTrustConfigs.asyncIterate(this.innerApiCalls['listTrustConfigs'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    trustConfigPath(project, location, trustConfig) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromTrustConfigName(trustConfigName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromTrustConfigName(trustConfigName) {
        return this.pathTemplates.trustConfigPathTemplate.match(trustConfigName)
            .location;
    }
    /**
     ...
     */
    matchTrustConfigFromTrustConfigName(trustConfigName) {
        return this.pathTemplates.trustConfigPathTemplate.match(trustConfigName)
            .trust_config;
    }
    /**
