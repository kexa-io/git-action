 ...
 */
const gapicConfig = require("./resource_settings_service_client_config.json");
...
class ResourceSettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            folderSettingNamePathTemplate: new this._gaxModule.PathTemplate('folders/{folder}/settings/{setting_name}'),
            organizationSettingNamePathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/settings/{setting_name}'),
            projectNumberSettingNamePathTemplate: new this._gaxModule.PathTemplate('projects/{project_number}/settings/{setting_name}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listSettings: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'settings'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.resourcesettings.v1.ResourceSettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.resourceSettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.resourcesettings.v1.ResourceSettingsService')
        ...
        for (const methodName of resourceSettingsServiceStubMethods) {
            const callPromise = this.resourceSettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listSettingsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listSettings.createStream(this.innerApiCalls.listSettings, request, callSettings);
    }
    /**
    ...
    listSettingsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSettings.asyncIterate(this.innerApiCalls['listSettings'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.ResourceSettingsServiceClient = ResourceSettingsServiceClient;
//# sourceMappingURL=resource_settings_service_client.js.map