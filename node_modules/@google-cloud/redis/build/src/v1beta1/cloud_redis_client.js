...
class CloudRedisClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const createInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        const updateInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const updateInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        const upgradeInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const upgradeInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        const importInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const importInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        const exportInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const exportInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        const failoverInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1beta1.Instance');
        const failoverInstanceMetadata = protoFilesRoot.lookup('.google.protobuf.Any');
        ...
        this.descriptors.longrunning = {
            ...
            importInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importInstanceResponse.decode.bind(importInstanceResponse), importInstanceMetadata.decode.bind(importInstanceMetadata)),
            exportInstance: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportInstanceResponse.decode.bind(exportInstanceResponse), exportInstanceMetadata.decode.bind(exportInstanceMetadata)),
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.redis.v1beta1.CloudRedis', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudRedisStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.redis.v1beta1.CloudRedis')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.redis.v1beta1.CloudRedis, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of cloudRedisStubMethods) {
            const callPromise = this.cloudRedisStub.then(stub => (...args) => {
                if (this._terminated) {
