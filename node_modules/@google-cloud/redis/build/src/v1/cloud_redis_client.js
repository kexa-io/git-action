...
class CloudRedisClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const upgradeInstanceResponse = protoFilesRoot.lookup('.google.cloud.redis.v1.Instance');
        const upgradeInstanceMetadata = protoFilesRoot.lookup('.google.cloud.redis.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.redis.v1.CloudRedis', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.cloudRedisStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.redis.v1.CloudRedis')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.redis.v1.CloudRedis, this._opts, this._providedCustomServicePath);
