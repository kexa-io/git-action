...
class WebSecurityScannerClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.websecurityscanner.v1.WebSecurityScanner', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.webSecurityScannerStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.websecurityscanner.v1.WebSecurityScanner')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.websecurityscanner.v1
