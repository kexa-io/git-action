...
exports.AssuredWorkloadsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./assured_workloads_service_client_config.json");
...
class AssuredWorkloadsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            locationPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/locations/{location}'),
            organizationPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}'),
            violationPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/locations/{location}/workloads/{workload}/violations/{violation}'),
            workloadPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/locations/{location}/workloads/{workload}'),
        };
        ...
        this.descriptors.page = {
            ...
            listViolations: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'violations'),
        };
        ...
        const createWorkloadResponse = protoFilesRoot.lookup('.google.cloud.assuredworkloads.v1.Workload');
        const createWorkloadMetadata = protoFilesRoot.lookup('.google.cloud.assuredworkloads.v1.CreateWorkloadOperationMetadata');
        this.descriptors.longrunning = {
            createWorkload: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createWorkloadResponse.decode.bind(createWorkloadResponse), createWorkloadMetadata.decode.bind(createWorkloadMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.assuredworkloads.v1.AssuredWorkloadsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assuredWorkloadsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.assuredworkloads.v1.AssuredWorkloadsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.assuredworkloads.v1
        ...
        for (const methodName of assuredWorkloadsServiceStubMethods) {
            const callPromise = this.assuredWorkloadsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    updateWorkload(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'workload.name': (_a = request.workload.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateWorkload(request, options, callback);
    }
    restrictAllowedResources(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getViolation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    acknowledgeViolation(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    async checkCreateWorkloadProgress(name) {
    ...
    listViolations(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listViolationsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listViolations.createStream(this.innerApiCalls.listViolations, request, callSettings);
    }
    /**
    ...
    listViolationsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listViolations.asyncIterate(this.innerApiCalls['listViolations'], request, callSettings);
    }
    /**
...
exports.AssuredWorkloadsServiceClient = AssuredWorkloadsServiceClient;
//# sourceMappingURL=assured_workloads_service_client.js.map