...
class AssuredWorkloadsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createWorkloadResponse = protoFilesRoot.lookup('.google.cloud.assuredworkloads.v1beta1.Workload');
        const createWorkloadMetadata = protoFilesRoot.lookup('.google.cloud.assuredworkloads.v1beta1.CreateWorkloadOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.assuredworkloads.v1beta1.AssuredWorkloadsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.assuredWorkloadsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.assuredworkloads.v1beta1.AssuredWorkloadsService')
    ...
    analyzeWorkloadMove(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
