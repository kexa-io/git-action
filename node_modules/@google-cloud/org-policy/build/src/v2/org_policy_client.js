...
exports.OrgPolicyClient = void 0;
 ...
 */
const gapicConfig = require("./org_policy_client_config.json");
...
class OrgPolicyClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            customConstraintPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/customConstraints/{custom_constraint}'),
            folderConstraintPathTemplate: new this._gaxModule.PathTemplate('folders/{folder}/constraints/{constraint}'),
            folderPolicyPathTemplate: new this._gaxModule.PathTemplate('folders/{folder}/policies/{policy}'),
            organizationPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}'),
            organizationConstraintPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/constraints/{constraint}'),
            organizationPolicyPathTemplate: new this._gaxModule.PathTemplate('organizations/{organization}/policies/{policy}'),
            projectPathTemplate: new this._gaxModule.PathTemplate('projects/{project}'),
            projectConstraintPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/constraints/{constraint}'),
            projectPolicyPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/policies/{policy}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listConstraints: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'constraints'),
            listPolicies: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'policies'),
            listCustomConstraints: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'customConstraints'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.orgpolicy.v2.OrgPolicy', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.orgPolicyStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.orgpolicy.v2.OrgPolicy')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.orgpolicy.v2.OrgPolicy, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of orgPolicyStubMethods) {
            const callPromise = this.orgPolicyStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getEffectivePolicy(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createCustomConstraint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateCustomConstraint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'custom_constraint.name': (_a = request.customConstraint.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateCustomConstraint(request, options, callback);
    }
    getCustomConstraint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deleteCustomConstraint(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listConstraints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listConstraintsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listConstraints.createStream(this.innerApiCalls.listConstraints, request, callSettings);
    }
    /**
    ...
    listConstraintsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listConstraints.asyncIterate(this.innerApiCalls['listConstraints'], request, callSettings);
    }
    ...
    listCustomConstraints(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listCustomConstraintsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCustomConstraints.createStream(this.innerApiCalls.listCustomConstraints, request, callSettings);
    }
    /**
    ...
    listCustomConstraintsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listCustomConstraints.asyncIterate(this.innerApiCalls['listCustomConstraints'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.OrgPolicyClient = OrgPolicyClient;
//# sourceMappingURL=org_policy_client.js.map