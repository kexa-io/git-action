...
class EnvironmentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            environmentPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/environments/{environment}'),
            userWorkloadsConfigMapPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/environments/{environment}/userWorkloadsConfigMaps/{user_workloads_config_map}'),
            userWorkloadsSecretPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/environments/{environment}/userWorkloadsSecrets/{user_workloads_secret}'),
        };
        ...
        this.descriptors.page = {
            ...
            listWorkloads: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'workloads'),
            listUserWorkloadsSecrets: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'userWorkloadsSecrets'),
            listUserWorkloadsConfigMaps: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'userWorkloadsConfigMaps'),
        };
        ...
        const createEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.Environment');
        const createEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const updateEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.Environment');
        const updateEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const deleteEnvironmentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const restartWebServerResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.Environment');
        const restartWebServerMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const checkUpgradeResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.CheckUpgradeResponse');
        const checkUpgradeMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const saveSnapshotResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.SaveSnapshotResponse');
        const saveSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const loadSnapshotResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.LoadSnapshotResponse');
        const loadSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        const databaseFailoverResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.DatabaseFailoverResponse');
        const databaseFailoverMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1beta1.OperationMetadata');
        this.descriptors.longrunning = {
            ...
            restartWebServer: new this._gaxModule.LongrunningDescriptor(this.operationsClient, restartWebServerResponse.decode.bind(restartWebServerResponse), restartWebServerMetadata.decode.bind(restartWebServerMetadata)),
            checkUpgrade: new this._gaxModule.LongrunningDescriptor(this.operationsClient, checkUpgradeResponse.decode.bind(checkUpgradeResponse), checkUpgradeMetadata.decode.bind(checkUpgradeMetadata)),
            ...
            databaseFailover: new this._gaxModule.LongrunningDescriptor(this.operationsClient, databaseFailoverResponse.decode.bind(databaseFailoverResponse), databaseFailoverMetadata.decode.bind(databaseFailoverMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.orchestration.airflow.service.v1beta1.Environments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.environmentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.orchestration.airflow.service.v1beta1.Environments')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.orchestration.airflow.service
                    .v1beta1.Environments, this._opts, this._providedCustomServicePath);
    ...
    executeAirflowCommand(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    stopAirflowCommand(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    pollAirflowCommand(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createUserWorkloadsSecret(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getUserWorkloadsSecret(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateUserWorkloadsSecret(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'user_workloads_secret.name': (_a = request.userWorkloadsSecret.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateUserWorkloadsSecret(request, options, callback);
    }
    deleteUserWorkloadsSecret(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createUserWorkloadsConfigMap(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getUserWorkloadsConfigMap(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateUserWorkloadsConfigMap(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'user_workloads_config_map.name': (_a = request.userWorkloadsConfigMap.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateUserWorkloadsConfigMap(request, options, callback);
    }
    deleteUserWorkloadsConfigMap(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    fetchDatabaseProperties(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    restartWebServer(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkRestartWebServerProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    checkUpgrade(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCheckUpgradeProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    saveSnapshot(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkSaveSnapshotProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    loadSnapshot(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkLoadSnapshotProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    databaseFailover(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDatabaseFailoverProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listWorkloadsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listWorkloads.createStream(this.innerApiCalls.listWorkloads, request, callSettings);
    }
    /**
    ...
    listWorkloadsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listWorkloads.asyncIterate(this.innerApiCalls['listWorkloads'], request, callSettings);
    }
    listUserWorkloadsSecrets(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listUserWorkloadsSecretsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listUserWorkloadsSecrets.createStream(this.innerApiCalls.listUserWorkloadsSecrets, request, callSettings);
    }
    /**
    ...
    listUserWorkloadsSecretsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listUserWorkloadsSecrets.asyncIterate(this.innerApiCalls['listUserWorkloadsSecrets'], request, callSettings);
    }
    listUserWorkloadsConfigMaps(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listUserWorkloadsConfigMapsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listUserWorkloadsConfigMaps.createStream(this.innerApiCalls.listUserWorkloadsConfigMaps, request, callSettings);
    }
    /**
    ...
    listUserWorkloadsConfigMapsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listUserWorkloadsConfigMaps.asyncIterate(this.innerApiCalls['listUserWorkloadsConfigMaps'], request, callSettings);
    }
    /**
