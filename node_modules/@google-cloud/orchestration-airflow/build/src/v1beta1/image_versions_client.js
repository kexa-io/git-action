...
exports.ImageVersionsClient = void 0;
 ...
 */
const gapicConfig = require("./image_versions_client_config.json");
...
class ImageVersionsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listImageVersions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'imageVersions'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.orchestration.airflow.service.v1beta1.ImageVersions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.imageVersionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.orchestration.airflow.service.v1beta1.ImageVersions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.orchestration.airflow.service
                    .v1beta1.ImageVersions, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const imageVersionsStubMethods = ['listImageVersions'];
        for (const methodName of imageVersionsStubMethods) {
            const callPromise = this.imageVersionsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    listImageVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    listImageVersionsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listImageVersions.createStream(this.innerApiCalls.listImageVersions, request, callSettings);
    }
    /**
    ...
    listImageVersionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listImageVersions.asyncIterate(this.innerApiCalls['listImageVersions'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.ImageVersionsClient = ImageVersionsClient;
//# sourceMappingURL=image_versions_client.js.map