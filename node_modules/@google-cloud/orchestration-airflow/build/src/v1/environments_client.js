...
class EnvironmentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.Environment');
        const createEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        const updateEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.Environment');
        const updateEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        const deleteEnvironmentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteEnvironmentMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        const saveSnapshotResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.SaveSnapshotResponse');
        const saveSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        const loadSnapshotResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.LoadSnapshotResponse');
        const loadSnapshotMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        const databaseFailoverResponse = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.DatabaseFailoverResponse');
        const databaseFailoverMetadata = protoFilesRoot.lookup('.google.cloud.orchestration.airflow.service.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.orchestration.airflow.service.v1.Environments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.environmentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.orchestration.airflow.service.v1.Environments')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.orchestration.airflow.service.v1
                    .Environments, this._opts, this._providedCustomServicePath);
