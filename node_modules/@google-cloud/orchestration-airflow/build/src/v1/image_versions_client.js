...
class ImageVersionsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.orchestration.airflow.service.v1.ImageVersions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.imageVersionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.orchestration.airflow.service.v1.ImageVersions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.orchestration.airflow.service.v1
                    .ImageVersions, this._opts, this._providedCustomServicePath);
