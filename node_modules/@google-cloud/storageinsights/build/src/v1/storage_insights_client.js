...
exports.StorageInsightsClient = void 0;
 ...
 */
const gapicConfig = require("./storage_insights_client_config.json");
...
class StorageInsightsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            reportConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reportConfigs/{report_config}'),
            reportDetailPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/reportConfigs/{report_config}/reportDetails/{report_detail}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listReportConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reportConfigs'),
            listReportDetails: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reportDetails'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.storageinsights.v1.StorageInsights', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.storageInsightsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.storageinsights.v1.StorageInsights')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.storageinsights.v1.StorageInsights, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of storageInsightsStubMethods) {
            const callPromise = this.storageInsightsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getReportConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createReportConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateReportConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'report_config.name': (_a = request.reportConfig.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateReportConfig(request, options, callback);
    }
    deleteReportConfig(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getReportDetail(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listReportConfigs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listReportConfigsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listReportConfigs.createStream(this.innerApiCalls.listReportConfigs, request, callSettings);
    }
    /**
    ...
    listReportConfigsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listReportConfigs.asyncIterate(this.innerApiCalls['listReportConfigs'], request, callSettings);
    }
    listReportDetails(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listReportDetailsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listReportDetails.createStream(this.innerApiCalls.listReportDetails, request, callSettings);
    }
    /**
    ...
    listReportDetailsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listReportDetails.asyncIterate(this.innerApiCalls['listReportDetails'], request, callSettings);
    }
    /**
...
exports.StorageInsightsClient = StorageInsightsClient;
//# sourceMappingURL=storage_insights_client.js.map