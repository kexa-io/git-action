...
class ManagedIdentitiesServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createMicrosoftAdDomainResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const createMicrosoftAdDomainMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const updateDomainResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const updateDomainMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const deleteDomainResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDomainMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const attachTrustResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const attachTrustMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const reconfigureTrustResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const reconfigureTrustMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const detachTrustResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const detachTrustMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        const validateTrustResponse = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.Domain');
        const validateTrustMetadata = protoFilesRoot.lookup('.google.cloud.managedidentities.v1beta1.OpMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.managedidentities.v1beta1.ManagedIdentitiesService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.managedIdentitiesServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.managedidentities.v1beta1.ManagedIdentitiesService')
